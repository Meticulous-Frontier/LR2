...
label SB_fetish_anal_label(the_person):
    ...
    menu:
      "Accept":  #This begins the sex scene
        ...
        the_person.char "Oh! Thanks [mc.name], I'll be right back! You won't regret this!"
        $ the_person.draw_person(position = "walking_away")
        "You finish up what you were doing and say goodbye to your employees. You are just starting to wonder what [the_person.name] needs when she comes back into the room."
        $ the_person.outfit = SB_anal_outfit.get_copy()
        $ the_person.draw_person()
        "[the_person.name] has changed into some very nice lingerie. You notice as she walks up that she isn't wearing any panties..."
        "She walks up and stands next to you by your desk."
        the_person.char "So, [mc.name], I don't know why but... I decided recently I really want to try and get better at anal..."
        ...
        "[the_person.name] turns and bends over in front of you, with her hands on your desk."
        ...
        "You slowly pull out the pink jewelled butt plug from [the_person.name]'s rectum. She quivers in anticipation of what you are about to do to her."
        ...
        mc.name "You're such a buttslut, [the_person.name]. Are you sure you want it back there? Your pussy looks like it could use a proper fucking too..."
        "[the_person.name] tries to push back against you and begins to beg."
        the_person.char "No! I need you in my ass right now... I need the heat and intensity of you fucking my ass right now!"
        "When you're ready you push forward. Her back passage greedily accepts your erection, eliciting a satisfied sigh from [the_person.name]"
        ...
        "[the_person.name] takes a few minutes to recover, then turns to you."
        $ the_person.draw_person()
        the_person.char "Wow, that was amazing, [mc.name]. I don't know what has been coming over me lately... I just can't stop thinking about you bending me over..."
        "[the_person.name] blushes and pauses..."
        mc.name "...And doing what, [the_person.name]?"
        "You tease her."
        ...
        "[the_person.name] gets her butt plug. She slowly pushes it back into her ass."
        the_person.char "Thanks again, [mc.name]. We should do this again... and soon."
        "You wave goodbye to [the_person.name] and get ready to head home for the night."
...
label SB_fetish_anal_staylate_event_label(the_person):
    if not mc.is_at_work():
        "Your phone rings. It's [the_person.name]. You answer it."
        the_person.char "Hey, are you at work? I can't find you."
        "You forgot! You asked [the_person.name] to stay after work today."
        mc.name "Sorry, I had something come up and had to leave early."
        "[the_person.name] tries to mask disappointment in her voice but it is still obvious."
        the_person.char "Oh... okay... well try to let me know next time before I stay late. I thought... anyway, maybe some other time. Bye!"

        $ FETISH_ANAL_EVENT_INUSE = False
        $ SB_CALCULATE_RANDOM_EVENT_RATE()
        return
    "You finish up with your work for the day and return to your office. You are organizing some papers when [the_person.name] enters the room."
    show screen person_info_ui(the_person)
    $ the_person.outfit = SB_anal_outfit.get_copy()
    $ the_person.draw_person()
    "From the look of her attire, she seems to have guessed the purpose of your meeting correctly."
    the_person.char "Hey [mc.name]. You wanted to see me?"
    ...
    "[the_person.name] smiles slightly. She can see where you are going with this conversation."
    ...
    "You approach [the_person.name] and begin to inspect her shapely ass. Nestled between her cheeks, you can see the pink jewel of her butt plug."
    ...
    menu:
        "Spank Her":
            ...
            "SMACK"
            "[the_person.name]'s accomodating ass ripples in shockwaves out from where you hand spanks it."
            "You give her hind quarters a few more spanks, giving her few seconds in between."
            $ the_person.change_arousal(20)
            "[the_person.name] barely stifles a moan as you spank her again. Her cheeks are beginning to glow a rosey red. Her pussy lips are growing puffy with clear signs of arousal."
        ...
        "Fuck Her Ass" if mc.current_stamina > 0:
            ...
            if the_person.arousal > 100:
                "[the_person.name] lays over the desk for a while, recovering from her ass reaming."
                ...
                $ the_person.change_happiness(-5)
            $ the_person.reset_arousal()
            "[the_person.name] gets up and starts getting ready to go home."
    ...
    menu:
        "Fuck Her Ass" if mc.current_stamina > 0:
            ...
            if the_person.arousal > 100:
                "[the_person.name] lays over the desk for a while, recovering from her ass reaming and spanking."
                the_person.char "God... that felt so fucking good..."
                $ the_person.change_obedience(5)
                $ the_person.change_happiness(5)
        ...
        "Fuck Her Ass\n{size=22}Requires Stamina{/size} (disabled)" if mc.current_stamina == 0:
            pass
        "Send her home":
            mc.name "That's enough for today [the_person.name]."
            "[the_person.name] looks back at your, clearly surprised that you are sending her away already."
...
label SB_fetish_anal_recurring_label():
    ...
    "As you are packing up your stuff to head home for the day, you hear [the_person.name]'s sweet voice call out to you."

    if mc.business.is_open_for_business():
        $ the_person.draw_person()
        show screen person_info_ui(the_person)
        the_person.char "Hey, [mc.name]. Just wondering if... you know... you wanna stick around for a bit after work today?"
        ...
        the_person.char "Oh! Thanks [mc.name], I'll be right back! You won't regret this!"
        $ the_person.draw_person(position = "walking_away")
        "You finish up what you were doing and say goodbye to your employees. Your curiosity about what [the_person.name] needs is answered when she comes back into the room."
        $ the_person.outfit = SB_anal_outfit.get_copy()
        $ the_person.draw_person()
        "[the_person.name] has changed into her pink lingerie. You notice as she walks up that she isn't wearing any panties..."
        ...
        the_person.char "What do you say, [mc.name]? Want to replace my plug with something else?"
    else:
        $ the_person.outfit = SB_anal_outfit.get_copy()
        $ the_person.draw_person()
        show screen person_info_ui(the_person)
        the_person.char "Hey, [mc.name]. I was wondering if you would be here on the weekend! Want to have some fun before you head home?"
        "[the_person.name] is dressed to impress. You wonder if she has in that butt plug she showed you last time you stayed late at the office wit her..."
        "As if sensing your thoughts, [the_person.name] turns around."
        $ the_person.draw_person(position = "back_peek")
        "Between her pillowy cheeks is her pink jewelled butt plug."
        the_person.char "What do you say, [mc.name]? Want to replace my plug with something else?"
    menu:
        "Fuck her ass" if mc.current_stamina > 0:
            ...
            $ the_person.draw_person(position = "standing_doggy")
            "[the_person.name] walks over in front of you, with her hands on your desk."
            ###Anal Scene, standing variant###
            "You slowly pull out the pink jewelled butt plug from [the_person.name]'s rectum. She quivers in anticipation of what you are about to do to her."
            $ the_person.change_arousal(the_person.get_opinion_score("anal sex"))
            "You work a couple fingers into her bottom. It is clear she loves anal sex so much, she keeps herself lubed up with the plug in throughout the day hoping for you to come fuck it."
            ...
            "You wave goodbye to [the_person.name] and get ready to head home for the night."
        "No Thanks":
            "[the_person.name] is caught completely off gaurd by your refusal."
            $ the_person.change_obedience(-10)
            $ the_person.change_happiness(-10)
            the_person.char "Oh!... Okay... Well... hey I understand... Maybe some other time yeah?"
            "[the_person.name] quickly sulks off. Maybe you should've?"
        "Too Tired" if mc.current_stamina == 0:
            ...
            "[the_person.name] quickly sulks off."
    return
    ...
    while keep_stripping:
        ...
        if rand_strip_desc == 0:
                if tease_clothing is not None:
                    "[the_person.name] pulls at her [tease_clothing.name] seductively."
                    the_person.char "Mmm, I bet you want me to take this off, right?"
                    "[the_person.name] wiggles her hips side to side and bites her bottom lip, as if imagining some greater pleasure yet to come."
                else:
                    "[the_person.name] runs her hands down her body seductively."
                    the_person.char "Mmm, I bet you want to get your hands on me now, right?"
                    "[the_person.name] wiggles her hips side to side and bites her bottom lip, as if imagining some greater pleasure yet to come."

        elif rand_strip_desc == 1:
                if the_person.has_large_tits():
                    "[the_person.name] moves her body side to side for you, letting her large tits bounce and jiggle while you watch."
                    "[the_person.name] takes a wider stances and slides her hands down her own thighs, all while maintaining eye contact with you."
                    the_person.char "You're looking so good today [mc.name], did you know that?"
                else:
                    "[the_person.name] moves her body side to side for you while you watch."
                    "[the_person.name] takes a wider stances and slides her hands down her own thighs, all while maintaining eye contact with you."
                    the_person.char "You're looking so good today [mc.name], did you know that?"

        elif rand_strip_desc == 2:
                if tease_clothing is not None:
                    "[the_person.name] slips a hand under her [tease_clothing.name] and starts to pull it off."
                    the_person.char "Maybe I should just... slip this off. What do you think?"
                else:
                    if the_person.has_large_tits():
                        "[the_person.name]'s hands slide up and down her body. She cups one of her sizeable breast and squeezes it, pinching her own nipple while she does."
                        the_person.char "Oh [mc.name], I think I'm going to need more than your eyes on me soon..."
                    else:
                        "[the_person.name]'s hands slide up and down her body. She rubs her small breasts, paying special attention to their firm nipples."
                        the_person.char "Oh [mc.name], I think I'm going to need more than your eyes on me soon..."
        else:
                the_person.char "I hope you're enjoying the show [mc.name]."
        ...
        if strip_choice == "Watch":
            if renpy.random.randint(0,1) == 0:
                ...
                if renpy.random.randint(0,100) < 50: #She's independant enough to strip, change pose, etc. on her own.
                    if tease_item is not None : #A more obedient person is less willing to strip without being told to. A less obedient person will strip further on their own.
                        ...
                        "You watch as [the_person.name] grabs their [tease_item.name] and pulls it off."
                    else:
                        #She has nothing to strip off or she's as slutty as she's willing to get
                        "[the_person.name] seems comfortable just the way she is."

                else: #She doesn't quite know what to do without you telling her.
                    "Without any direction [the_person.name] just keeps doing what she was doing."
                ...
                if not new_pose[1] == picked_pose:
                    ...
                    "While you're watching [the_person.name] changes pose so you can see her from a different angle."
                else:
                    "[the_person.name] seems comfortable just the way she is."
            ...
            if pose_choice is not None:
                ...
                "[the_person.name] nods and moves for you."
            ...
            mc.name "Wow [the_person.name], that was amazing."
            ...
            "[the_person.name] strips off her [the_clothing.name]. She throws it playfully, hitting you in the face." #Hopefully this wasn't shoes, lol
...
label SB_mom_anal_pay_label(the_person):
    ...
    the_person.char "[mc.name], could we talk for a moment?"
    ...
    the_person.char "[mc.name], I'm really sorry about this. Some things have come up around the house that need repair but I'm not sure have the money to have the work done..."
    ...
    menu:
        "Strip and ride me. -$1000" if mc.business.funds >= 1000:
            ...
            the_person.char "Thank you [mc.name]! Now, are you ready a show?"
            ...
            the_person.char "Oh [mc.name], I've been thinking about this all week... I'm sorry I brought money into this... I won't ask you for money again!"
            #Cowgirl pose#
            ...
            if the_person.arousal > 100:
                ...
                the_person.char "Mmm, that was so good, thank you [mc.name]..."
            ...
            the_person.char "[mc.name]? Why don't you just stay in here tonight? Mommy loves you... its okay!"
            ...
            the_person.char "Yes... Please! Please [mc.name]! I don't know why I keep feeling this way, but I need you in my ass!"
            ...
            the_person.char "That's it [mc.name]! Fuck me good!"
...
label SB_mom_anal_friday_label(the_person):
    ...
    the_person.char "[mc.name], are you home? It's Friday night! Can you come to my room?"
    mc.name "Sure, down in a second."
    show screen person_info_ui(the_person)
    $ renpy.show(mom_bedroom.name,what=mom_bedroom.background_image)
    ...
    the_person.char "[mc.name]! Hey, it time for our Friday night date! Are you ready for your show and, well you know what comes afterword..."
    ...
    menu:
        "Strip and ride me." if mc.current_stamina > 0:
            ...
            the_person.char "Yes... Please! Please [mc.name]! Fuck me in the ass!"
            "You pick her up from behind and take her back to the bed. You throw her on the bed. She quickly gets on her hands and knees and starts wiggling her ass at you."
            #Draw doggystyle
            $ the_person.draw_person(position = "doggy")
            "You grab the lube leftover from the night before. You quickly apply another glob to mom's back side. You apply some more to your cock until it is good and slick."
...
label SB_lily_anal_dp_fetish_label(the_person):
    ...
    if starbuck.sluttiness > 50 or starbuck.love > 30:
        ...
        starbuck.char "Hello! Welcome to... Oh hey [mc.name]! Good to see you! Oh and you brought a partner! Hi I'm Starbuck!"
    else:
        $ starbuck.draw_person(emotion = "happy")
    ...
    the_person.char "That would be great! Come one [mc.name]!"
    $ the_person.draw_person(position = "walking_away")
    "[the_person.name] grabs your hand and you follow Starbuck to the backroom. It has a familiar smell of body fluids and sweat."
    $ the_person.draw_person(position = "stand4")
    "Come on [mc.name], I can't wait to feel you fuck me with this thing on..."
    "[the_person.name] quickly strips, eager to get started."
    $ the_person.outfit = SB_anal_nude_outfit.get_copy()
    $ the_person.draw_person(position = "stand4")
    "You get yourself naked as well. On a nearby shelf you spot a bulk size bottle of intimate lube."
    "[the_person.name] gets down on her knees and starts to secure the toy to your cock."
    $ the_person.draw_person(position = "blowjob")
    mc.name "Mmm, you look amazing on your knees Sis."
    "[the_person.name] looks up at you."
    ...
    $ the_person.draw_person(position = "doggy")
    "[the_person.name] turns over and gets on her hands and knees in front of you on the floor. She lifts her hips and starts waving her ass in the air."
    ...
    $ the_person.change_arousal(10)
    the_person.char "Oh! That feels good... but I'm ready for you. Let me have it [mc.name]!"
    ...
    if the_person.arousal > 150:
        "[the_person.name] is sweaty, heaving mess. You know she orgasmed multiple times from the intense sensations of the double penetration."
        "She looks back at you in awe."
    elif the_person.arousal > 100:
        "[the_person.name] is laying on the floor, exhausted from the intensity of the double penetration."
        "She looks back at you and smiles"
    the_person.char "[mc.name]... That felt amazing. I'm not sure though... are we going to able to keep this from mom? I don't think I can stay quiet enough when I'm getting fucked in both holes like that..."
