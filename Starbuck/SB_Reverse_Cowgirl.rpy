...
label intro_SB_reverse_cowgirl(the_girl, the_location, the_object, the_round):
    mc.name "[the_girl.name], why don't you ride me for a bit?"
    "You lay down on the [the_object.name], and [the_girl.name] gets on top, facing away from you."
...
label scene_SB_reverse_cowgirl_1(the_girl, the_location, the_object, the_round):
    ...
    "You lay back on the [the_object.name] while [the_girl.name] works your cock in and out of her."
    ...
    if SB_get_fetish(the_girl) == "Vaginal Fetish":   #Fetish serum, highly skilled and loves sex
        the_girl.char "Oh [mc.name], I love how full I feel when you fuck me... god I wish we could do this everyday!"
        "[the_girl.name] gives you a few quick, shallow dips then pull off you almost completely, leaving just your tip inside her."
        "She swirls her hips a couple times then impales herself on your again. [the_girl.name] works her hips relentlessly on top of you as she pleases herself on your erection."
        ...
        "[the_girl.name] stops moving her hips for a few seconds, but you can feel her contracting and relaxing the muscles around her pelvis, her cunt milking you without even having to move her hips."
        mc.name "Oh my god [the_girl.name], that feels amazing..."
        if the_girl.arousal > 130:
            "[the_girl.name] looks back at you with passion in her eyes while the contractions of her pussy around you suddenly strengthen. Her eyes start to glaze as she orgasms again."
            the_girl.char "[mc.name]! I'm cumming again! Cum for me... I need you to cum for me now!!!"
        ...
        "[the_girl.name] slows her pace for a bit, working your erection with her body with purpose."
        "She makes a couple shallow dips, then then sheathes you entirely."

    else:
        "[the_girl.name] works her hips up and down on you as best as she can."
        "She makes a couple shallow dips, then then sheathes you entirely."
...
label scene_SB_reverse_cowgirl_2(the_girl, the_location, the_object, the_round):
    ...
    "[the_girl.name] bounces up and down a few times on your cock, then and you holds you deep inside her."
    "Instead of bouncing up and down, she starts to grind herself back and forth."
    the_girl.char "Mmmm, [mc.name], its so big... I feel so full!"
    "[the_girl.name]'s shapely ass looks amazing on display in front of you. You grasp one of her pliant cheeks in your hand as she grinds."
    menu:
        "Spank it":
            "You bring your hand off [the_girl.name]'s ass and give it a firm slap"
            the_girl.char "Oh!"
            ...
            if the_girl.get_opinion_score("showing her ass") > 0:
                ...
                the_girl.char "You're gonna leave a mark, [mc.name]! Then everyone who sees it will know what a slut I am!"
                ...
                "[the_girl.name] moans as you give her a few more swats. A bright red handprint is beginning to form on her cheeks."
            elif SB_get_fetish(the_girl) == "Vaginal Fetish":
                "You give her irresistable ass another spank. [the_girl.name] times her thrust with your hand smacking her booty, swallowing your dick whole with her greedy cunt when you spank her."
                the_girl.char "Mmmm. I've been bad [mc.name], I can't get your dick off my mind!"
                ...
                the_girl.char "Do you like that, [mc.name]? Ah!"
                "[the_girl.name] is enjoying herself. You give her accommodating ass another squeeze and then spank it again."
                "You can feel [the_girl.name]'s pussy quivering as she grinds herself back into you."
                $ the_girl.change_arousal(5)
            "You leave a hand planted on [the_girl.name]'s butt while she fucks you, squeezing it and giving it the occasional slap."

        "Admire her":
            mc.name "Damn [the_girl.name],  your ass is amazing!"
            "[the_girl.name] wiggles back and forth a few more times, then looks back at you and smiles."
            if the_girl.get_opinion_score("taking control") > 0:
                the_girl.char "Do you like that, [mc.name]? Just lay back and let me take care of you..."
                ...
                if the_girl.arousal > 130:
                    ...
                    "[the_girl.name]'s pussy spasms again in orgasm. The combination of her orgasm and the view of her ass is incredibly arousing."
                ...
                if the_girl.get_opinion_score("creampies") > 0:
                    "[the_girl.name] reaches back between her legs and cups your balls."
                    the_girl.char "Mmm you feel so full... I want you to fill me up! I can't wait to milk all that cum out of you!"
                else:
                    "[the_girl.name] grabs your ankles to steady herself."
                    the_girl.char "You should... I love it when you cum. I want to make you cum!"
            else:
                the_girl.char "I'm glad you like it, [mc.name]. I love it when you fuck me, but sometimes it feels good to be on top once a while too..."
                if the_girl.get_opinion_score("masturbating") > 0:
                    "[the_girl.name] reaches down with one hand and begins to rub her clit as she grinds back against you."
                    $ the_girl.discover_opinion("masturbating")
                    $ the_girl.change_arousal(the_girl.get_opinion_score("masturbating" * 5))
                "You grab [the_girl.name]'s ass cheeks with both hands. Her smooth skin feels supple in your hands." ###TODO
            "After some time spent grinding, [the_girl.name] resumes her bouncing motion on top of you."

    return

label outro_SB_reverse_cowgirl(the_girl, the_location, the_object, the_round):
    "[the_girl.name]'s sweet cunt milks your cock, the wet friction pushes you past the point of no return."
    mc.name "Ah, I'm going to cum!"
    "[the_girl.name] looks back at you and smiles."
    if SB_get_fetish(the_girl) == "Internal Cum Fetish":
        "[the_girl.name]'s body goes rigid as your cum poors into her pussy. Goosebumps erupt all over her body as her brain registers her creampie."
        the_girl.char "Oh.. OH! Yes [mc.name]! Pump it deep! I want it it all inside me!"
        "[the_girl.name] revels in having her cum fetish fulfilled."
        $ the_girl.cum_in_vagina()
        $ SB_reverse_cowgirl.redraw_scene(the_girl)
        "When you finish, [the_girl.name] slowly pulls up off you."
        ...
        "[the_girl.name] lifts her hips up off of you, your twitching cock suddenly cold and aching to be back inside her."
        ...
        the_girl.char "Thank you [mc.name]. Oh my good its so good..."
        "You lay back and take a few moments to enjoy the view. [the_girl.name] is massaging your cum into her ass cheeks with both hands."
    elif the_girl.get_opinion_score("creampies") > 0:
        the_girl.char "Oh god, I can't wait to feel you shoot it up inside me... Cum for me [mc.name]!"
        "[the_girl.name]'s quivering hole feels too good, you can't hold it back anymore."
        ...
        "[the_girl.name] moans as the first wave of your cum floods her pussy. She holds herself still just as you dump your load deep inside her."
        $ the_girl.cum_in_vagina()
        $ SB_reverse_cowgirl.redraw_scene(the_girl)
        ...
        "When you finish, [the_girl.name] stays still for a few minuntes, keeping you deep inside her."
        ...
        the_girl.char "Thank you [mc.name], I love the feeling of your cum on my skin..."
        ...
        $ SB_reverse_cowgirl.redraw_scene(the_girl)
        "When the last of your cum splashes onto her ass, she stops stroking you."
        the_girl.char "Thank you [mc.name]. Do I look good? With your sticky seed painted all over my backside?"
        "[the_girl.name] shakes her hips side to side for you, showing off her prize. In a couple places your cum starts drip down from her shapely ass."
        "You lay back and take a few moments to enjoy the view."
    elif the_girl.sex_skills["Vaginal"] > 5:
        the_girl.char "Oh god, it feels to good to pull off now... just shoot it up inside me!"
        if the_girl.arousal > 130:
            "[the_girl.name] is riding you with wild abandon, as yet another orgasm wracks her body. Too late to stop, you begin cumming at the same time."
        elif the_girl.arousal > 100:
            "[the_girl.name] is riding you with wild abandon, and an orgasm wracks her body. Too late to stop, you begin cumming at the same time."
        $ the_girl.cum_in_vagina()
        $ SB_reverse_cowgirl.redraw_scene(the_girl)
        "[the_girl.name]'s expert cunt draws wave after wave of cum from you. For a second you lose the ability to process anything outside the feeling of her velvet pussy wrapped perfectly around your shaft."
        the_girl.char "Oh [mc.name]... I needed that so bad... Let's do that again soon okay?"
        ...
        $ the_girl.cum_in_vagina()
        $ SB_reverse_cowgirl.redraw_scene(the_girl)
        "You shoot your load up into [the_girl.name]. She moans in appreciation as she feels you filling her up."
        "[the_girl.name] pulls off you slowly, and you see a few drips of your seed escaping before she gets up."
...
label strip_SB_reverse_cowgirl(the_girl, the_clothing, the_location, the_object, the_round):
    "[the_girl.name] straightens up a bit and peaks back at you."
    $ the_girl.call_dialogue("sex_strip")
    $ the_girl.draw_animated_removal(the_clothing, position = SB_reverse_cowgirl.position_tag)
    "[the_girl.name] struggles out of her [the_clothing.name] and throws it to the side."
...
label transition_missionary_SB_reverse_cowgirl(the_girl, the_location, the_object, the_round):
    "Looking down at [the_girl.name], you decide it's time to change things up a little bit."
    ...
    if the_girl.get_opinion_score("taking control") > 0:
        ...
        the_girl.char "Sure, if that's what you want [mc.name]"
    ...
    if the_girl.get_opinion_score("showing her ass") > 0:
        ...
        $ the_girl.change_arousal(5)
        "[the_girl.name] winks at you, then climbs on top you, giving her ass a bit of a shake as she climbs on."
    else:
        "[the_girl.name] blushes, but soon swings her legs over you with her back facing you."
    $ the_girl.draw_person(position = "doggy")
    "[the_girl.name] reachs down between her legs and takes hold of your penis. She gives it a couple strokes then lines it up with her slit."
...
label transition_SB_reverse_cowgirl_doggy(the_girl, the_location, the_object, the_round):
    ...
    "You grab [the_person.name]'s hips and slowly push her up off you. She looks back at you for a moment in confusion."
    mc.name "Don't worry [the_person.name], I'm just gonna change things up. I'll be back inside you in a second."
...
label orgasm_SB_reverse_cowgirl(the_girl, the_location, the_object, the_round):
    "[the_girl.name]'s cunt quivers and spasms around you, and then suddenly tenses up."
    $ the_girl.call_dialogue("climax_responses")
    "[the_girl.name] stirs her womb with your erection aggressively through her climax"
