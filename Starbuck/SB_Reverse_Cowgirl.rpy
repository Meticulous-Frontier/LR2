...
label intro_SB_reverse_cowgirl(the_person, the_location, the_object, the_round):
    ...
    "You lay down on the [the_object.name], and [the_person.possessive_title] gets on top, facing away from you."
...
label scene_SB_reverse_cowgirl_1(the_person, the_location, the_object, the_round):
    ...
    "You lay back on the [the_object.name] while [the_person.possessive_title] works your cock in and out of her."
    ...
    if SB_get_fetish(the_person) == "Vaginal Fetish":   #Fetish serum, highly skilled and loves sex
        ...
        "[the_person.possessive_title] stops moving her hips for a few seconds, but you can feel her contracting and relaxing the muscles around her pelvis, her cunt milking you without even having to move her hips."
        mc.name "Oh my god [the_person.title], that feels amazing..."
        if the_person.arousal > 130:
            "[the_person.possessive_title] looks back at you with passion in her eyes while the contractions of her pussy around you suddenly strengthen. Her eyes start to glaze as she orgasms again."
        ...
        "[the_person.possessive_title] slows her pace for a bit, working your erection with her body with purpose."
        "She makes a couple shallow dips, then then sheathes you entirely."

    else:
        "[the_person.possessive_title] works her hips up and down on you as best as she can."
        "She makes a couple shallow dips, then then sheathes you entirely."
...
label scene_SB_reverse_cowgirl_2(the_person, the_location, the_object, the_round):
    ...
    "[the_person.possessive_title] bounces up and down a few times on your cock, then and you holds you deep inside her."
    ...
    "[the_person.possessive_title]'s shapely ass looks amazing on display in front of you. You grasp one of her pliant cheeks in your hand as she grinds."
    menu:
        "Spank it":
            "You bring your hand off [the_person.possessive_title]'s ass and give it a firm slap"
            the_person.char "Oh!"
            ...
            if the_person.get_opinion_score("showing her ass") > 0:
                ...
                "[the_person.possessive_title] is enjoying herself. You give her accommodating ass another squeeze and then spank it again."
                "You can feel [the_person.possessive_title]'s pussy quivering as she grinds herself back into you."
                $ the_person.change_arousal(5)
            "You leave a hand planted on [the_person.possessive_title]'s butt while she fucks you, squeezing it and giving it the occasional slap."
        ...
        "Admire her":
            ...
            if the_person.get_opinion_score("taking control") > 0:
                ...
                if the_person.arousal > 130:
                    ...
                    "[the_person.possessive_title]'s pussy spasms again in orgasm. The combination of her orgasm and the view of her ass is incredibly arousing."
                ...
                if the_person.get_opinion_score("creampies") > 0:
                    ...
                    "[the_person.possessive_title] grabs your ankles to steady herself."
                ...
                if the_person.get_opinion_score("masturbating") > 0:
                    "[the_person.possessive_title] reaches down with one hand and begins to rub her clit as she grinds back against you."
                    $ the_person.discover_opinion("masturbating")
                    $ the_person.change_arousal(the_person.get_opinion_score("masturbating" * 5))
                "You grab [the_person.possessive_title]'s ass cheeks with both hands. Her smooth skin feels supple in your hands." ###TODO
            "After some time spent grinding, [the_person.possessive_title] resumes her bouncing motion on top of you."
...
label outro_SB_reverse_cowgirl(the_person, the_location, the_object, the_round):
    ...
    if SB_get_fetish(the_person) == "Internal Cum Fetish":
        ...
        "You lay back and take a few moments to enjoy the view. [the_person.possessive_title] is massaging your cum into her ass cheeks with both hands."
    elif the_person.get_opinion_score("creampies") > 0:
        the_person.char "Oh god, I can't wait to feel you shoot it up inside me... Cum for me [the_person.mc_title]!"
        "[the_person.possessive_title]'s quivering hole feels too good, you can't hold it back anymore."
        ...
        "[the_person.possessive_title] moans as the first wave of your cum floods her pussy. She holds herself still just as you dump your load deep inside her."
        $ the_person.cum_in_vagina()
        $ SB_reverse_cowgirl.redraw_scene(the_person)
        ...
        "When you finish, [the_person.possessive_title] stays still for a few minuntes, keeping you deep inside her."
        ...
        "[the_person.possessive_title] shakes her hips side to side for you, showing off her prize. In a couple places your cum starts drip down from her shapely ass."
        "You lay back and take a few moments to enjoy the view."
    elif the_person.sex_skills["Vaginal"] > 5:
        the_person.char "Oh god, it feels to good to pull off now... just shoot it up inside me!"
        if the_person.arousal > 130:
            "[the_person.possessive_title] is riding you with wild abandon, as yet another orgasm wracks her body. Too late to stop, you begin cumming at the same time."
        elif the_person.arousal > 100:
            "[the_person.possessive_title] is riding you with wild abandon, and an orgasm wracks her body. Too late to stop, you begin cumming at the same time."
        $ the_person.cum_in_vagina()
        $ SB_reverse_cowgirl.redraw_scene(the_person)
        "[the_person.possessive_title]'s expert cunt draws wave after wave of cum from you. For a second you lose the ability to process anything outside the feeling of her velvet pussy wrapped perfectly around your shaft."
        ...
        $ the_person.cum_in_vagina()
        $ SB_reverse_cowgirl.redraw_scene(the_person)
        "You shoot your load up into [the_person.possessive_title]. She moans in appreciation as she feels you filling her up."
        "[the_person.possessive_title] pulls off you slowly, and you see a few drips of your seed escaping before she gets up."
...
label strip_SB_reverse_cowgirl(the_person, the_clothing, the_location, the_object, the_round):
    "[the_person.possessive_title] straightens up a bit and peaks back at you."
...
label transition_missionary_SB_reverse_cowgirl(the_person, the_location, the_object, the_round):
    "Looking down at [the_person.possessive_title], you decide it's time to change things up a little bit."
    ...
    if the_person.get_opinion_score("showing her ass") > 0:
        ...
        $ the_person.change_arousal(5)
        "[the_person.possessive_title] winks at you, then climbs on top you, giving her ass a bit of a shake as she climbs on."
    else:
        "[the_person.possessive_title] blushes, but soon swings her legs over you with her back facing you."
    $ the_person.draw_person(position = "doggy")
    "[the_person.possessive_title] reachs down between her legs and takes hold of your penis. She gives it a couple strokes then lines it up with her slit."
...
label transition_SB_reverse_cowgirl_doggy(the_person, the_location, the_object, the_round):
    ...
    "You grab [the_person.possessive_title]'s hips and slowly push her up off you. She looks back at you for a moment in confusion."
    ...
    if the_person.arousal > 60:
            "You rub the tip of your penis against [the_person.possessive_title]'s cunt, feeling how nice and wet she is already. She moans softly when you slide the head of your dick over her clit."
    else:
            "You rub the tip of your penis against [the_person.possessive_title]'s cunt, getting ready to slide yourself inside."
    "When you're ready you push forward, slipping your shaft deep inside of [the_person.possessive_title]. She gasps and quivers ever so slightly as you start to pump in and out."
    return

label orgasm_SB_reverse_cowgirl(the_person, the_location, the_object, the_round):
    "[the_person.possessive_title]'s cunt quivers and spasms around you, and then suddenly tenses up."
    $ the_person.call_dialogue("climax_responses")
    "[the_person.possessive_title] stirs her womb with your erection aggressively through her climax"
