...
label intro_SB_doggy_standing(the_girl, the_location, the_object, the_round):
    "You turn [the_girl.name] around, and she leans over [the_object.name], presenting her ass to you."
    mc.name "Good girl, [the_girl.name], I'm going to fuck you hard."
    ...
    if the_girl.arousal > 60:
        "You rub the tip of your cock against [the_girl.name]'s cunt, feeling how nice and wet she is already. She moans, anticipating your penetration."
        ...
        "You rub the tip of your cock against [the_girl.name]'s cunt."
...
label scene_SB_doggy_standing_1(the_girl, the_location, the_object, the_round):
    "Your hips slap against [the_girl.name]'s ass as you fuck her vigorously."
    ...
    if the_girl.sex_skills["Vaginal"] < 2: #Inexperienced
        ...
        "[the_girl.name] rocks her hips side to side each time you slam into her. Each time you pull back you can see her labia clinging to you."
        ...
        "[the_girl.name] reaches back with one hand and pulls an ass cheek back, giving you a great view of her pussy stretched wide to accomodate you."
        "Buried deep inside, you give her ass a smack. Her pussy trembles and caresses you in response."
    menu:
        "Spank her":
            "With your erection buried deep inside her, you give her ass a firm spank. Her sexy cheeks quake in response."
            mc.name "[the_girl.name], your ass looks amazing when I spank it. You are such a slut. I bet you love it don't you?"
            if the_girl.get_opinion_score("being submissive") > 0 or the_girl.obedience > 130:
                "[the_girl.name] moans at your words."
                ...
                "[the_girl.name] responds quietly."
            ...
            if mc.arousal > 70:
                "[the_girl.name]'s' tight pussy feels so good. You are getting close to cumming."
...
label scene_SB_doggy_standing_2(the_girl, the_location, the_object, the_round):
    ...
    if the_girl.arousal > 130:
        ...
        "[the_girl.name]'s legs are shaking. Her orifice clenches and spasms around you."
    ...
    menu:
        "Gentle Sex":
            ...
            mc.name "[the_girl.name], your pussy is so good. I love how eager you are to fuck me."
        ...
        "Rough Sex":
            ...
            "[the_girl.name] arches her back in response."
            ...
            if the_girl.get_opinion_score("being submissive") > 0 or the_girl.obedience > 130:
                ...
                "[the_girl.name] begs you for more."
...
label outro_SB_doggy_standing(the_girl, the_location, the_object, the_round):
    "[the_girl.name]'s creamy cunt draws you closer to your orgasm with each thrust. You finally pass the point of no return and speed up, fucking her as hard as you can manage."
    $the_girl.call_dialogue("sex_responses")
    ...
    menu:
        "Cum inside of her.":
            "[the_girl.name]'s drenched cunt is just too good. You decide to cum inside it."
            "You pull back on [the_girl.name]'s hips and drive your cock as deep inside of her as you cum. She gasps softly in time with each new shot of hot semen inside of her."
            if the_girl.get_opinion_score("creampies") > 0:
            ...
            if the_girl.get_opinion_score("risking getting pregnant") > 0:
                ...
                "[the_girl.name]'s voice starts to trail off."
            ...
            if the_girl.get_opinion_score("risking getting pregnant") > 0:
                "As your cum starts to leak out, [the_girl.name] reaches back and tries to keep it inside with her hand."
            else:
        ...
        "Cum on her face.":
            ...
            "You pull your cock out of [the_girl.name]. She immediately turns around on gets on her knees in front of you."
            ...
            if the_girl.get_opinion_score("being covered in cum") > 0 or the_girl.get_opinion_score("cum facials") > 0:
                "[the_girl.name] reaches up and strokes you off for your final few seconds."
...
label transition_default_SB_doggy_standing(the_girl, the_location, the_object, the_round):
    "[the_girl.name] turns and puts her hands on [the_object.name]. You bounce your hard shaft on her ass a couple of times before lining yourself up with her pussy."
...
label orgasm_SB_doggy_standing(the_girl, the_location, the_object, the_round):
    ...
    "You bury your cock in deep in [the_girl.name]'s cunt while she cums. Her pussy spasms around you."
