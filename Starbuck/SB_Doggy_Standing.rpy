...
label intro_SB_doggy_standing(the_person, the_location, the_object, the_round):
    "You turn [the_person.title] around, and she leans over [the_object.name], presenting her ass to you."
    ...
    if the_person.arousal > 60:
        "You rub the tip of your cock against [the_person.title]'s cunt, feeling how nice and wet she is already. She moans, anticipating your penetration."
        ...
        "You rub the tip of your cock against [the_person.title]'s cunt."
...
label scene_SB_doggy_standing_1(the_person, the_location, the_object, the_round):
    "Your hips slap against [the_person.title]'s ass as you fuck her vigorously."
    ...
    if the_person.sex_skills["Vaginal"] < 2: #Inexperienced
        ...
        "[the_person.title] rocks her hips side to side each time you slam into her. Each time you pull back you can see her labia clinging to you."
        ...
        "[the_person.title] reaches back with one hand and pulls an ass cheek back, giving you a great view of her pussy stretched wide to accomodate you."
        "Buried deep inside, you give her ass a smack. Her pussy trembles and caresses you in response."
    menu:
        "Spank her":
            ...
            if the_person.get_opinion_score("being submissive") > 0 or the_person.obedience > 130:
                "[the_person.title] moans at your words."
                ...
                "[the_person.title] responds quietly."
            ...
            if mc.arousal > 70:
                "[the_person.title]'s' tight pussy feels so good. You are getting close to cumming."
...
label scene_SB_doggy_standing_2(the_person, the_location, the_object, the_round):
    ...
    if the_person.arousal > 130:
        ...
        "[the_person.title]'s legs are shaking. Her orifice clenches and spasms around you."
    ...
    menu:
        ...
        "Rough Sex":
            ...
            "[the_person.title] arches her back in response."
            ...
            if the_person.get_opinion_score("being submissive") > 0 or the_person.obedience > 130:
                ...
                "[the_person.title] begs you for more."
...
label outro_SB_doggy_standing(the_person, the_location, the_object, the_round):
    "[the_person.title]'s creamy cunt draws you closer to your orgasm with each thrust. You finally pass the point of no return and speed up, fucking her as hard as you can manage."
    $the_person.call_dialogue("sex_responses")
    ...
    menu:
        "Cum inside of her.":
            "[the_person.title]'s drenched cunt is just too good. You decide to cum inside it."
            "You pull back on [the_person.title]'s hips and drive your cock as deep inside of her as you cum. She gasps softly in time with each new shot of hot semen inside of her."
            if the_person.get_opinion_score("creampies") > 0:
            ...
            if the_person.get_opinion_score("risking getting pregnant") > 0:
                ...
                "[the_person.title]'s voice starts to trail off."
            ...
            if the_person.get_opinion_score("risking getting pregnant") > 0:
                "As your cum starts to leak out, [the_person.title] reaches back and tries to keep it inside with her hand."
            else:
        ...
        "Cum on her face.":
            ...
            "You pull your cock out of [the_person.title]. She immediately turns around on gets on her knees in front of you."
            $ the_person.draw_person(position = "blowjob")
            if the_person.get_opinion_score("being covered in cum") > 0 or the_person.get_opinion_score("cum facials") > 0:
                "[the_person.title] reaches up and strokes you off for your final few seconds."
...
label transition_default_SB_doggy_standing(the_person, the_location, the_object, the_round):
    "[the_person.title] turns and puts her hands on [the_object.name]. You bounce your hard shaft on her ass a couple of times before lining yourself up with her pussy."
...
label orgasm_SB_doggy_standing(the_person, the_location, the_object, the_round):
    ...
    "You bury your cock in deep in [the_person.title]'s cunt while she cums. Her pussy spasms around you."
