...
label SB_fetish_vaginal_label(the_person):
    ...
    "You head to your front door and see [the_person.title] standing there... outside... in a very provacative outfit."
    ...
    "Once you close your door, [the_person.title] quickly turns and embraces you."
    ...
    "You are surprised, [the_person.title] isn't usually this forward."
    ...
    menu:
      "Accept":  #This begins the sex scene
        ...
        "[the_person.title] walks over to the windows and looks out of it. You see her hips move side to side for a second and the peaks back at you."
        $ the_person.draw_person(position = "back_peek")
        the_person.char "It so pretty out tonight... Why don't you come over here?"
        "You walk over and stand behind [the_person.title] as she looks by the window."
        ...
        "[the_person.title] walks over to your bed and lays down on her back and takes off any remaining clothing."
        ...
        "[the_person.title] moans and runs her hands through your hair."
        ...
        "You roll over on top of [the_person.title]. She wraps her arms around you as you slowly sink your cock into her moist cunt."
        ...
        "[the_person.title] excuses herself to your restroom. After a few minutes she comes back. She sits down on the side of the bed."
        ...
        "[the_person.title] smiles and gets down on her knees below you."
        ...
        "[the_person.title] reaches down and starts to stroke your mostly soft cock."
        ...
        if the_person.has_large_tits():
            ...
            "[the_person.title] smiles up at you."
            the_person.char "Anything for you, [the_person.mc_title]"
            "[the_person.title] looks up at you while she scoots closer to you, until her body is up against yours. She uses her hand to point your cock straight up while she moves it in position between her amazingly soft tits."
            "Once in position, she uses her hands to push her tits together, squashing your prick in her heavenly soft tit-flesh."
            "[the_person.title] starts to move up and down. Now and then when her tits are at the base of your dick she licks the sensitive tip."
            "The view of [the_person.title] on her knees before you, happy with you between her tits is extremely arousing. It isn't long until you are fully erect."

        else:
            mc.name "Why don't you put it in your mouth for a while?"
            "[the_person.title] smiles up at you."
            the_person.char "Anything for you, [the_person.mc_title]."
            "[the_person.title] looks up at you while she scoots closer to you, then lowers her head down and begins to lick and up down your groin."
            ...
            "[the_person.title] resumes blowing you with vigor."
            "The view of [the_person.title] on her knees before you, happy with your cock in her mouth is extremely arousing. It isn't long until you are fully erect."


        mc.name "Okay [the_person.title], how do you want it?"
        $ the_person.draw_person(position = "doggy")
        "[the_person.title] backs up a bit, then turns around on her hands and knees and points her ass at you."
        ###Draw girl doggystyle###
        the_person.char "Come and get it, [the_person.mc_title]... its yours for the taking!"
        "You get down on your knees and get behind [the_person.title]. You line yourself up with her soaking wet slit and push yourself in."
        ###Sex Doggy Style###
        ...
        ###Clear Arousal###
        $ the_person.reset_arousal()
        "Exhausted from your night with [the_person.title], you get back up into your bed. [the_person.title] joins you and you quickly fall asleep, cuddling together."

        "That night, you have many pleasant dreams involving [the_person.title] and sex in all kinds of crazy positions."
        $ SB_random_fetish_key = get_random_from_list( FETISH_VAGINAL_OPINION_LIST)
        if SB_random_fetish_key == "doggy style sex":
            "A couple times in the night, you stir slightly when you hear [the_person.title] making moaning noises in their sleep, and talking about doggy style sex!"
        if SB_random_fetish_key == "missionary style sex":
            "A couple times in the night, you stir slightly when you hear [the_person.title] making moaning noises in their sleep, and talking about missionary style sex!"
        if SB_random_fetish_key == "sex standing up":
            "A couple times in the night, you stir slightly when you hear [the_person.title] making moaning noises in their sleep, and talking about standing sex!"
        if SB_random_fetish_key == "vaginal sex":
            "A couple times in the night, you stir slightly when you hear [the_person.title] making moaning noises in their sleep, and talking about all kinds of vaginal sex!"
    ...
    if the_person == mom:
        ...
        menu:
            "Let's fuck!":
                ...
                "[the_person.title] gives you a lusty look. She smiles and bounces slightly on your bed."
            ...
            "Let's fuck!\n{size=22}Requires Stamina{/size} (disabled)" if mc.current_stamina == 0:
                    pass
            "Just cuddle.":
                "ACtually, [the_person.title], I'm really worn out. Would you wanna just cuddle for a bit and get some sleep?"
                "[the_person.title] is surprised by your answer, but happy that you want to be close to her."
                $ the_person.change_happiness(2)
                the_person.char "Oh! Well okay. I mean hey, tomorrow is a new day, and you know I like to be close to you..."
        "[the_person.title] lays down on your bed. You cuddle up behind her and slowly drift off to sleep."
        python:
            FETISH_VAGINAL_EVENT_INUSE = False
        ...
        menu:
            "Strip Tease":
                ...
                "[the_person.title] winks at you before beginning her routine."
                ...
                "[the_person.title] bites her lip, glancing down at your bulge. Her cheeks are flushed and rosey."
        ...
        "Your phones rings. Its [the_person.title]! You quickly pick it up"
        ...
        "Your hands start exploring her body immediately while you start to kiss. [the_person.title] breaks off for a second and looks into your eyes."
        ...
        menu:
            "Let's fuck!":
                ...
                "[the_person.title] gives you a lusty look."
            ...
            "Let's fuck!\n{size=22}Requires Stamina{/size} (disabled)" if mc.current_stamina == 0:
                    pass
            "Just cuddle.":
                "ACtually, [the_person.title], I'm really sorry about this, but I'm really worn out. Would you wanna just cuddle for a bit and get some sleep?"
                "[the_person.title] is surprised by your answer, and clearly a little disappointed."
                $ the_person.change_happiness(-2)
                the_person.char "Oh! Well okay. I mean hey, tomorrow is a new day, and you know I like to be close to you..."
        "[the_person.title] lays down on your bed. You cuddle up behind her and slowly drift off to sleep."
        python:
...
label SB_fetish_mom_vaginal_label(the_person):
    ...
    "[the_person.title] stumbles over her words for a second before resuming."
...
label SB_fetish_lily_vaginal_label(the_person):
    ...
    show screen person_info_ui(the_person)
    "[the_person.title] almost never comes to your room, unless she needs something."
    mc.name "Sure thing sis."
    $ the_person.outfit = SB_vaginal_lily_outfit.get_copy()
    $ the_person.draw_person()
    "[the_person.title] slowly opens your door and walks in."
    ...
    "Now completely naked, [the_person.title] walks over to you and sits on your lap."
    $ the_person.draw_person(position = "sitting")
    ...
    "Feeling the moment is right, you move your lips to hers and begin to make out. Your tongues dance around each other in unison."
    $ the_person.change_arousal(10)
    "[the_person.title] begins to pull off your clothes. It isn't long until you are naked, your flesh now against hers."
    ...
    "That night, after fucking [the_person.title], you share your bed together. As you fall asleep, you consider the implications of what happened. "
...
label SB_cowgirl_wakeup_label(the_person):
    "All night long, you have sexy dreams centered around [the_person.title]."
    ...
    show screen person_info_ui(the_person)
    "You slowly open your eyes and discover that [the_person.title] is on top of you, riding you in the reverse cowgirl position."
    "You reach up and grab her amazing ass cheeks. [the_person.title] looks back at your when she feels your hands on her."
    ...
    "[the_person.title] moans during one slow stroke."
    ...
    if the_person == mom:
        ...
        "[the_person.title] giggles for a second then says goodbye."
    ...
    "You fall back asleep. When you wake up, [the_person.title] has left."
...
label SB_fetish_vaginal_recurring_label():
    ...
    if the_person == mom:
        ...
        menu:
            "Not tonight":
                ...
                return
            "Sounds good":
                "You quickly embrace her. Your hands start exploring her body immediately while you start to kiss. [the_person.title] breaks off for a second and looks into your eyes."
                $ the_person.draw_person(position = "kissing")
                the_person.char "Thanks for letting me come in... I honestly... I just couldn't stop thinking about you tonight."
    else:
        "Before going to bed, you hear a text message on your phone. You pick if up and take a look. It's from [the_person.title]."
        ...
        menu:
            ...
            "Cum on over :)":
                ...
                show screen person_info_ui(the_person)
                ###Draw the girl###
                "[the_person.title] is standing there, and she looks amazing."
                "You quickly invite her inside and head up to your room."
                "When you get into your room and close the door, [the_person.title] immediately throws her arms around you. You wrap your arms around her and start to makeout."
                $ the_person.draw_person(position = "kissing")
                "Your hands start exploring her body immediately while you start to kiss. [the_person.title] breaks off for a second and looks into your eyes."
    ...
    if  the_person.get_opinion_score("doggy style sex") > 2:
        "[the_person.title] lets go of you, and starts to slowly back up."
        the_person.char "I don't know what has come over me lately... I can't stop thinking about you fucking me from behind..."
        $ the_person.draw_person(position = "doggy")
        $ the_person.change_arousal(20)
        "[the_person.title] turns away from you and gets down on her hands and knees. She sticks her ass up in the air and starts to wiggle it back and forth."
        ...
        "[the_person.title] resumes kissing you. You grab her ass with both hands and pick her up. She grinds her crotch into you."
        $ the_person.change_arousal(20)
        the_person.char "I need you so bad, just do me right here, up against the wall!"
        "You quickly pin [the_person.title] to the wall. She wraps her legs around you and sighs as you sink your cock into her greedy cunt."
        ...
        "You kiss [the_person.title] along her neck and ear. She shivers at the sensation and then whispers in your ear."
        $ the_person.change_arousal(20)
        ...
        "You roughly pick up [the_person.title] and carry her over to the bed. You throw her down and quickly jump on top of her."
        "[the_person.title] spread her legs wide, giving you easy access. She sighs as you sink your cock into her greedy cunt."
        ...
        "[the_person.title] reaches down and starts to stroke your crotch through your clothes."
        $ the_person.change_arousal(20)
    ...
    "After you finish your rutting, you and [the_person.title] get under the covers of your bed."
    "Spooning behind [the_person.title], you drift off to a wonderful night's sleep. Her body heat and the feeling of her naked skin against yours give you very pleasant dreams."
