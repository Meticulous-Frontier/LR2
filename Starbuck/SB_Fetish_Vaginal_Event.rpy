...
label SB_fetish_vaginal_label(the_person):
    ...
    "You head to your front door and see [the_person.name] standing there... outside... in a very provacative outfit."
    ...
    "Once you close your door, [the_person.name] quickly turns and embraces you."
    the_person.char "Oh, [mc.name], I'm sorry to just come over without asking like this but... I was at home... by myself... and I just..."
    ...
    "You are surprised, [the_person.name] isn't usually this forward."
    the_person.char "So I thought... surely [mc.name] has physical needs too... maybe I should just go over there and... maybe we could come to an agreement?"
    the_person.char "I'll take care of your needs whenever you need it... if you do the same for me?"
    "[the_person.name] looks at you with hopeful eyes."
    menu:
      "Accept":  #This begins the sex scene
        ###Set vaginal skill to 6
        $ the_person.sex_skills["Vaginal"] = 6
        "[the_person.name] walks over to the windows and looks out of it. You see her hips move side to side for a second and the peaks back at you."
        $ the_person.draw_person(position = "back_peek")
        the_person.char "It so pretty out tonight... Why don't you come over here?"
        "You walk over and stand behind [the_person.name] as she looks by the window."
        ...
        "[the_person.name] walks over to your bed and lays down on her back and takes off any remaining clothing."
        ...
        "[the_person.name] moans and runs her hands through your hair."
        "You turn your head and begin to lick and suck her nipple."
        ###The girl arousal + 20
        $ the_person.change_arousal(20)
        the_person.char "That feels so good [mc.name]... are you about ready for round two?"
        "You roll over on top of [the_person.name]. She wraps her arms around you as you slowly sink your cock into her moist cunt."
        ...
        the_person.char "Oh god [mc.name], tonight has been incredible... excuse me for a second."
        $ the_person.draw_person(position = "walking_away")
        ###The girl walking away draw
        "[the_person.name] excuses herself to your restroom. After a few minutes she comes back. She sits down on the side of the bed."
        ...
        "[the_person.name] smiles and gets down on her knees below you."
        ###Draw the girl on knees###
        $ the_person.draw_person(position = "blowjob")
        the_person.char "I'm sorry [mc.name]... I just can't help it. It feels so good inside of me..."
        "[the_person.name] reaches down and starts to stroke your mostly soft cock."
        ...
        if the_person.has_large_tits():
            ...
            "[the_person.name] smiles up at you."
            the_person.char "Anything for you, [mc.name]"
            "[the_person.name] looks up at you while she scoots closer to you, until her body is up against yours. She uses her hand to point your cock straight up while she moves it in position between her amazingly soft tits."
            "Once in position, she uses her hands to push her tits together, squashing your prick in her heavenly soft tit-flesh."
            "[the_person.name] starts to move up and down. Now and then when her tits are at the base of your dick she licks the sensitive tip."
            "The view of [the_person.name] on her knees before you, happy with you between her tits is extremely arousing. It isn't long until you are fully erect."

        else:
            mc.name "Why don't you put it in your mouth for a while?"
            "[the_person.name] smiles up at you."
            the_person.char "Anything for you, [mc.name]."
            "[the_person.name] looks up at you while she scoots closer to you, then lowers her head down and begins to lick and up down your groin."
            ...
            "[the_person.name] resumes blowing you with vigor."
            "The view of [the_person.name] on her knees before you, happy with your cock in her mouth is extremely arousing. It isn't long until you are fully erect."


        mc.name "Okay [the_person.name], how do you want it?"
        $ the_person.draw_person(position = "doggy")
        "[the_person.name] backs up a bit, then turns around on her hands and knees and points her ass at you."
        ###Draw girl doggystyle###
        the_person.char "Come and get it, [mc.name]... its yours for the taking!"
        "You get down on your knees and get behind [the_person.name]. You line yourself up with her soaking wet slit and push yourself in."
        ###Sex Doggy Style###
        ...
        ###Clear Arousal###
        $ the_person.reset_arousal()
        "Exhausted from your night with [the_person.name], you get back up into your bed. [the_person.name] joins you and you quickly fall asleep, cuddling together."

        "That night, you have many pleasant dreams involving [the_person.name] and sex in all kinds of crazy positions."
        $ SB_random_fetish_key = get_random_from_list( FETISH_VAGINAL_OPINION_LIST)
        if SB_random_fetish_key == "doggy style sex":
            "A couple times in the night, you stir slightly when you hear [the_person.name] making moaning noises in their sleep, and talking about doggy style sex!"
        if SB_random_fetish_key == "missionary style sex":
            "A couple times in the night, you stir slightly when you hear [the_person.name] making moaning noises in their sleep, and talking about missionary style sex!"
        if SB_random_fetish_key == "sex standing up":
            "A couple times in the night, you stir slightly when you hear [the_person.name] making moaning noises in their sleep, and talking about standing sex!"
        if SB_random_fetish_key == "vaginal sex":
            "A couple times in the night, you stir slightly when you hear [the_person.name] making moaning noises in their sleep, and talking about all kinds of vaginal sex!"
...
label SB_fetish_vaginal_event_label(the_person):
    if the_person == mom:
        ...
        "You invite your mom in. You immediately start to get aroused when you see what she is wearing."
        $ the_person.outfit = SB_vaginal_outfit.get_copy()
        $ the_person.draw_person()
        ...
        menu:
            "Let's fuck!":
                ...
                "[the_person.name] gives you a lusty look. She smiles and bounces slightly on your bed."
                ...
                if the_person.arousal >= 100:
                    "Your mom needs a few minutes to lie down when you're finished. Bit by bit her breathing slows down."
                    $ the_person.change_love(5)
                    the_person.char "Oh [mc.name], that was magical. I've never felt so close to you before..."
                    "After a while, your mom gives you a kiss on your forehead and stands up to leave."
                    $ the_person.draw_person(position = "back_peek")
                    the_person.char "Sweet dreams."
                else:
                    "When you're finished your mom gives you a kiss on your forehead and stands up to leave."
            ...
            "Let's fuck!\n{size=22}Requires Stamina{/size} (disabled)" if mc.current_stamina == 0:
                    pass
            "Just cuddle.":
                "ACtually, [the_person.name], I'm really worn out. Would you wanna just cuddle for a bit and get some sleep?"
                "[the_person.name] is surprised by your answer, but happy that you want to be close to her."
                $ the_person.change_happiness(2)
                the_person.char "Oh! Well okay. I mean hey, tomorrow is a new day, and you know I like to be close to you..."
        "[the_person.name] lays down on your bed. You cuddle up behind her and slowly drift off to sleep."
        python:
            FETISH_VAGINAL_EVENT_INUSE = False
    elif the_person == lily:
        "There is a quick a knock on your door. You hear your sister from the other side of the door."
        show screen person_info_ui(the_person)
        the_person.char "Hey bro, you still up? I hope you're ready for me!"
        "You invite your sister in. You immediately start to get aroused when you see what she is wearing."
        ...
        menu:
            "Strip Tease":
                mc.name "That sounds good sis... why don't you give me a show before we go to bed?"
                "[the_person.name] smiles at you."
                the_person.char "Aww, does my brother wanna see his sister get naked for him? What a pervert!"
                "[the_person.name] winks at you before beginning her routine."
                call SB_free_strip_scene(the_person) from _SB_free_strip_scene_2
                mc.name "Damn [the_person.name], you are really getting good at that."
                "[the_person.name] bites her lip, glancing down at your bulge. Her cheeks are flushed and rosey."
                the_person.char "Hey... if you want to I could... you know... take care of that tent you are sporting there bro."
                "You stand up and embrace her, your dick straining against your clothes, eager to begin another incestuous tryst with your sister."
                $ mc.current_stamina += -1
                call fuck_person(the_person) from _call_fuck_person_SBV21
                if the_person.arousal >= 100:
                    "Your sister needs a few minutes to lie down when you're finished. Bit by bit her breathing slows down."
                    $ the_person.change_happiness(5)
                    the_person.char "Oh god bro, your dick is sooooo good..."
                else:
                    the_person.char "Wow, you are done already bro? That's... disappointing..."
                    "[the_person.name] seems disappointed she didn't finish."
            ...
            "Just cuddle.":
                "ACtually, [the_person.name], I'm really worn out. Would you wanna just cuddle for a bit and get some sleep?"
                "[the_person.name] is surprised by your answer."
                the_person.char "Oh! Well okay. I mean hey, tomorrow is a new day..."
        "[the_person.name] lays down on your bed. You cuddle up behind her and slowly drift off to sleep."
        python:
            FETISH_VAGINAL_EVENT_INUSE = False
    else:
        "Your phones rings. Its [the_person.name]! You quickly pick it up"
        the_person.char "Hey [mc.name]! I'm here out front!"
        "You head to your front door and see [the_person.name] standing there... outside... in a very provacative outfit."
        $ the_person.outfit = SB_vaginal_outfit.get_copy()
        $ the_person.draw_person()
        show screen person_info_ui(the_person)
        ...
        "Your hands start exploring her body immediately while you start to kiss. [the_person.name] breaks off for a second and looks into your eyes."
        ...
        menu:
            "Let's fuck!":
                ...
                "[the_person.name] gives you a lusty look."
            ...
            "Let's fuck!\n{size=22}Requires Stamina{/size} (disabled)" if mc.current_stamina == 0:
                    pass
            "Just cuddle.":
                "ACtually, [the_person.name], I'm really sorry about this, but I'm really worn out. Would you wanna just cuddle for a bit and get some sleep?"
                "[the_person.name] is surprised by your answer, and clearly a little disappointed."
                $ the_person.change_happiness(-2)
                the_person.char "Oh! Well okay. I mean hey, tomorrow is a new day, and you know I like to be close to you..."
        "[the_person.name] lays down on your bed. You cuddle up behind her and slowly drift off to sleep."
        python:
...
label SB_fetish_mom_vaginal_label(the_person):
    ...
    $ the_person.outfit = SB_vaginal_outfit.get_copy()
    $ the_person.draw_person()
    "You mom slowly opens your door and walks in. Her outfit makes her body look incredible."
    mc.name "Everything ok mom?"
    "Your mom walks over beside your bed and sits down."
    $ the_person.draw_person(position = "sitting")
    ...
    "[the_person.name] stumbles over her words for a second before resuming."
    ...
    the_person.char "Oh [mc.name]... It has been so nice being close to you lately..."
    ...
    the_person.char "[mc.name]... why can't I stop thinking about you? I know its wrong but I just..."
    ...
    the_person.char "[mc.name]! Please, I need you inside me again. Will you please... make love to me?"
...
#SBV4
label SB_fetish_lily_vaginal_label(the_person):
    "You are just starting to drift off to sleep, when you hear a knock at your door."
    the_person.char "Hey bro... Are you still up? Can I come in for a bit?"
    show screen person_info_ui(the_person)
    "[the_person.name] almost never comes to your room, unless she needs something."
    mc.name "Sure thing sis."
    $ the_person.outfit = SB_vaginal_lily_outfit.get_copy()
    $ the_person.draw_person()
    "[the_person.name] slowly opens your door and walks in."
    mc.name "Hey sis, looking great! Are you going out tonight?"
    "[the_person.name] stutters for a second."
    the_person.char "Well bro, its been nice having some extra spending money, ya know? With the extra tasks you've been giving me..."
    "[the_person.name] stumbles over her words for a second before resuming."
    ...
    mc.name "Do you need more money, [the_person.name]?"
    ...
    "Now completely naked, [the_person.name] walks over to you and sits on your lap."
    $ the_person.draw_person(position = "sitting")

    the_person.char "[mc.name]... I love the way you look at me. It makes me feel so good."
    "Your sister begins to grind herself on your lap. Her breath catches in her throat and she looks at you."
    $ the_person.change_arousal(10)
    the_person.char "[mc.name]... why do you make me feel so good? I can't stop thinking about you..."
    ...
    "Feeling the moment is right, you move your lips to hers and begin to make out. Your tongues dance around each other in unison."
    $ the_person.change_arousal(10)
    "[the_person.name] begins to pull off your clothes. It isn't long until you are naked, your flesh now against hers."
    the_person.char "[mc.name]! Please, I need you inside me again. Fuck me bro!!!"
    "You moan into her mouth and quickly prepare yourself to penetrate your sister."
    $ the_person.sex_skills["Vaginal"] = 6
    ###Sex scene, missionary###   ###TODO: consider writing a variant of this because the default intro is going to be confusing###
    ...
    #$ the_person.SB_fetish = "vaginal sex"
    $ the_person.sexy_opinions["vaginal sex"] = [FETISH_OPINION_VALUE, True]
    the_person.char "Oh... that was so good. Bro... can I spend the night with you? I don't wanna sleep alone tonight..."
    "That night, after fucking [the_person.name], you share your bed together. As you fall asleep, you consider the implications of what happened. "
    "It is clear that your sister is now firmly under the influence of your serums and has developed a fetish for vaginal sex."
...
label SB_cowgirl_wakeup_label(the_person):
    "All night long, you have sexy dreams centered around [the_person.name]."
    ...
    show screen person_info_ui(the_person)
    "You slowly open your eyes and discover that [the_person.name] is on top of you, riding you in the reverse cowgirl position."
    "You reach up and grab her amazing ass cheeks. [the_person.name] looks back at your when she feels your hands on her."
    the_person.char "Good morning [mc.name]... Sorry but when I woke up I noticed you were hard so... I figured you wouldn't mind if I hopped on for a bit..."
    "[the_person.name] moans during one slow stroke."
    ...
    if the_person == mom:
        ...
        "[the_person.name] giggles for a second then says goodbye."
        the_person.char "Yeah well, just don't tell me other custumers about this, I can't make housecalls for everyone!"
    else:
        "[the_person.name] looks at you and winks."
        the_person.char "Anytime [mc.name]! I'd better go get ready!"
    $ the_person.review_outfit()
    "You fall back asleep. When you wake up, [the_person.name] has left."
...
init 2 python:
        ...
        if mc_asleep():
            if mc.business.get_employee_count() > 0:
                for person in mc.business.get_employee_list():
                    if SB_get_fetish(person) == "Vaginal Fetish":
                        return True
            if SB_get_fetish(mom) == "Vaginal Fetish":
                return True
        return False
    ...
    def SB_fetish_vaginal_lily_recurring_requirement():
        if time_of_day < 3:
            return False
        if mc_asleep():
            if SB_get_fetish(lily) == "Vaginal Fetish":
                return True
        return False
...
label SB_fetish_vaginal_recurring_label():
    ...
    if the_person == mom:
        ...
        menu:
            "Not tonight":
                ...
                return
            "Sounds good":
                "You quickly embrace her. Your hands start exploring her body immediately while you start to kiss. [the_person.name] breaks off for a second and looks into your eyes."
                $ the_person.draw_person(position = "kissing")
                the_person.char "Thanks for letting me come in... I honestly... I just couldn't stop thinking about you tonight."
    else:
        "Before going to bed, you hear a text message on your phone. You pick if up and take a look. It's from [the_person.name]."
        ...
        menu:
            ...
            "Cum on over :)":
                ...
                show screen person_info_ui(the_person)
                ###Draw the girl###
                "[the_person.name] is standing there, and she looks amazing."
                "You quickly invite her inside and head up to your room."
                "When you get into your room and close the door, [the_person.name] immediately throws her arms around you. You wrap your arms around her and start to makeout."
                $ the_person.draw_person(position = "kissing")
                "Your hands start exploring her body immediately while you start to kiss. [the_person.name] breaks off for a second and looks into your eyes."
    ...
    if  the_person.get_opinion_score("doggy style sex") > 2:
        "[the_person.name] lets go of you, and starts to slowly back up."
        the_person.char "I don't know what has come over me lately... I can't stop thinking about you fucking me from behind..."
        $ the_person.draw_person(position = "doggy")
        $ the_person.change_arousal(20)
        "[the_person.name] turns away from you and gets down on her hands and knees. She sticks her ass up in the air and starts to wiggle it back and forth."
        the_person.char "Come fuck me, [mc.name]. Don't worry, I'm ready for you!"
        ...
        "[the_person.name] resumes kissing you. You grab her ass with both hands and pick her up. She grinds her crotch into you."
        $ the_person.change_arousal(20)
        the_person.char "I need you so bad, just do me right here, up against the wall!"
        "You quickly pin [the_person.name] to the wall. She wraps her legs around you and sighs as you sink your cock into her greedy cunt."
        ...
        "You kiss [the_person.name] along her neck and ear. She shivers at the sensation and then whispers in your ear."
        $ the_person.change_arousal(20)
        the_person.char "Throw me down on your bed, [mc.name]. I want to feel your weight on top of me while you fuck my brains out!"
        "You roughly pick up [the_person.name] and carry her over to the bed. You throw her down and quickly jump on top of her."
        "[the_person.name] spread her legs wide, giving you easy access. She sighs as you sink your cock into her greedy cunt."
        ...
        "[the_person.name] reaches down and starts to stroke your crotch through your clothes."
        $ the_person.change_arousal(20)
        the_person.char "Mmm... I can't wait to get your cock inside me... how do you want me, [mc.name]?"
        call fuck_person(the_person) from _call_fuck_person_SB63

    "After you finish your rutting, you and [the_person.name] get under the covers of your bed."
    "Spooning behind [the_person.name], you drift off to a wonderful night's sleep. Her body heat and the feeling of her naked skin against yours give you very pleasant dreams."
...
label SB_fetish_vaginal_lily_recurring_label():
    if lily.sex_skills["Vaginal"] < 5:
        return #oops! We shouldn't be here!

    $ the_person = lily

    "Before going to bed, you hear a knock on your door. You hear your sister from the other side of the door."
    show screen person_info_ui(the_person)
    the_person.char "Hey bro, you still up? I was just wondering if I could come in for a bit?"
    ...
    menu:
        "Not tonight":
            mc.name "Sorry [the_person.name]... I had a long day and I'm pretty wore out... maybe tomorrow?"
            "She is clearly disappointed."
            the_person.char "Whatever bro... see you in the morning I guess?"
            "You head for bed, looking forward to a restful night's sleep."
            $ the_person.change_obedience(-2)
            $ the_person.change_happiness(-5)
            return
