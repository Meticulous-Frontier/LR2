...
label intro_SB_doggy_anal_dildo_dp(the_person, the_location, the_object, the_round):
    ...
    "You secure the strap on dildo to your cock. A quick lube application later, you get behind [the_person.title]"
    ...
    if the_person.arousal > 60:
        ...
        "You line yourself up with her ass while [the_person.title] reaches down and lines the dildo up with her pussy."
    ...
    if the_person.sex_skills["Anal"] < 2: #Inexperienced
        ...
        menu:
            "Masturbate for me":
                 ...
                 "[the_person.title] struggles to hold herself up with one hand while the other works circles around her clit"
        ...
        menu:
            "Fuck me with your ass":
                 ...
                 if mc.arousal > 70:
                      ...
                      if the_person.get_opinion_score("anal sex") > 0:
                           ...
                           "[the_person.title] sighs. You can tell the double penetration is very fulfilling for her."
                      else:
            ...
            "I'm in charge here":
                 ...
                 if SB_get_fetish(the_person) == "Anal Fetish":
                     "[the_person.title] whimpers in total submission to you."
...
label scene_SB_doggy_anal_dildo_dp_2(the_person, the_location, the_object, the_round):
    ...
    if the_person.arousal > 130:
        "[the_person.title]'s pussy is now constantly spasming in orgasm. Her juices are running out from around the dildo and down the inside of her legs."
    ...
    if the_person.arousal > 80:
        ...
        "[the_person.title] seems to be enjoying the double penetration you are giving her. She yelps in response to one particularly eager thrust."
    ...
    if the_person.get_opinion_score("masturbating") > 0:
        ...
        "[the_person.title] whimpers, her body now pinned between your body and [the_object.name]. The vibrating dildo stimulates her pussy mercilessly."
        if SB_get_fetish(the_person) == "Anal Fetish":
            ...
            "[the_person.title] is writhing in pleasure, having her fetish of anal sex fulfilled. The extra stimulation from the dildo just makes it even better."
...
label orgasm_SB_doggy_anal_dildo_dp(the_person, the_location, the_object, the_round):
    if the_person.arousal > 150:
        "[the_person.title] has stopped being able to put together coherant sentences. She moans and gasps as yet another orgasm wracks her body."
        "You bury your cock in deep in [the_person.title]'s ass while she cums. Her bowel grips you tightly. The vibrations from the dildo intensify her orgasm."
        ...
        return
    "[the_person.title]'s tight back passage start to quiver, and suddenly tenses up."
