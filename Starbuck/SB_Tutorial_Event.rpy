label SB_tutorial_event():
    ...
    "[the_person.title] smiles and bats her eyelashes a few times."
    ...
    menu:
        "Looking good girl!":
            ...
            "[the_person.title] looks your up and down a few times. Her eyes tend to linger on your crotch each time they pass."
            $ the_person.change_slut_temp(5)
            "You flirt back and forth with [the_person.title], but soon it is time to part ways."
            the_person.char "It was great seeing you! Take care [the_person.mc_title]!"
        "Thank you.":
            "You make some small talk with [the_person.title]. You catch up on a few various things, but soon it is time to part ways."
            the_person.char "It was great seeing you! Take care [the_person.mc_title]!"
