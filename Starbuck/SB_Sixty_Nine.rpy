...
label intro_SB_sixty_nine(the_girl, the_location, the_object, the_round):
    "You give her ass a good hard smack and then look at [the_girl.name]."
    mc.name "Hey, wanna sixty nine?"
    if SB_get_fetish(the_girl) == "Oral Fetish":
        "[the_girl.name] smiles wide and quickly responds."
    ...
    if the_girl.effective_sluttiness() > 45:
        "[the_girl.name] smiles and responds."
        the_girl.char "That sounds like fun! Let's do it!"
    else:
        "[the_girl.name] hesitates for a moment before responding."
        the_girl.char "I guess we could do that. But I'm on top!"
    "You lay down on the [the_object.name]. [the_girl.name] swings one leg over you, presenting her pussy to your face. You waste no time and start to flick your tongue around her slit."
    if the_girl.get_opinion_score("getting head") > 2 :
        the_girl.char "Oh! Yes that feels so good already! Oh [mc.name] your tongue feels amazing."
    if the_girl.get_opinion_score("giving blowjobs") > 2:
        the_girl.char "Mmm, that feels good [mc.name]... and your cock... it looks so good... I wanna swallow it whole!"
    "[the_girl.name] begins to please you in return. Taking you into her mouth, she begins sucking you off."
...
label scene_SB_sixty_nine_1(the_girl, the_location, the_object, the_round):
    ...
    if the_girl.sex_skills["Oral"] < 2: #Inexperienced.
        "You rest your hands on [the_girl.name]'s ass as she bobs her head up and down. She struggles to take your very deep, so she focuses on licking and sucking your tip."
        ...
        menu:
            "Focus on her." if mc.sex_skills["Oral"] > 2:
                ...
                "[the_girl.name] is overwhelmed by the sensations and momentarily pulls off your dick."
                the_girl.char "Mmm! God [mc.name] that feels so good..."
                $ the_girl.change_arousal(5)
                if the_girl.get_opinion_score("giving blowjobs") < 0:
                    $ the_girl.discover_opinion("giving blowjobs")
                    "[the_girl.name] looks down at your cock and hesitates."
                    ...
                    "[the_girl.name] slips you back into her soft mouth. She tries to take you a little deeper, but gags a bit and has to pull back off."
            ...
            "Focus on you.":
                ...
                if the_girl.sex_skills["Foreplay"] < 2:
                    "[the_girl.name] wraps one hand around the base of your cock. She tries to stroke you in time with her mouth, but she is gripping you way too hard"
                    mc.name "Easy girl! Don't grip so hard!"
                    the_girl.char "Sorry! I'm just not very good at this I guess."
                    "[the_girl.name] keeps stroking you, this time you can barely feel it. You sigh and decide to just keep eating her out while she does her thing."
                else:
                    "[the_girl.name] wraps her right hand around the base of your cock and starts to slide it back and forth in time with her sucking. Her other hand begins to lightly cup and kneed your balls."
                    if (the_girl.get_opinion_score("cum facials") > 0 or the_girl.get_opinion_score("being covered in cum") > 0 ) and the_girl.sluttiness > 40:
                        ...
                        $ the_girl.change_arousal(5)
                        "You give [the_girl.name]'s ass a hard smack and resume eating her pussy."
                        "[the_girl.name]'s cunt quivers as she slides your cock back into her mouth, sucking at it with renewed vigor."
                    elif the_girl.get_opinion_score("drinking cum") > 0 and the_girl.sluttiness > 40:
                        "After a moment she takes her lips off your dick and continues stroking you."
                        the_girl.char "Mmm, I can't wait to feel your cum sliding down my throat [mc.name]."
                        ...
                        "You lap at [the_girl.name]'s pussy leisurely while she services your cock, stroking your shaft and sucking gently on your tip."



    elif the_girl.sex_skills["Oral"] < 6: #competent at oral
        "[the_girl.name] bobs her head up and down to slide your cock in and out. The feeling of her soft, warm mouth sends shivers up your spine."
        "You circle her clit a few times with your tongue. You suck it into your mouth roughly a couple of times and then release it, you lips making a wet, lewd smackin noise"
        menu:
            "Focus on her." if mc.sex_skills["Oral"] > 2:
                "After a few teasing licks, you bury your face in her pussy. You make a few swiping licks across her clit and the lap up some of the juices flowing from her nethers."
                ...
                if the_girl.get_opinion_score("giving blowjobs") < 0:
                    $ the_girl.discover_opinion("giving blowjobs")
                    "[the_girl.name] looks down at your cock and hesitates. Then she slowly slides you back into her mouth and resumes stroking you with her pillowy soft lips."
                else:
                    $ the_girl.change_arousal(5)
                    "[the_girl.name] slips you back into her soft mouth. Her tongue swirls around you in large circles few a seconds and the resumes bobbing her head up and down."
                    "You pause your licking to give her some encouragement."
                    mc.name "That it, [the_girl.name], suck my cock!"
                "You kneed her ass cheeks with your hands a few times, then spread her cheeks apart and continue to eat her out."
            "Focus on her.\n{size=22}Requires Oral Skill{/size} (disabled)" if mc.sex_skills["Oral"] < 3:
                    pass
            "Focus on you.":
                ...
                if the_girl.get_opinion_score("taking control") > 0:
                    "[the_girl.name] pulls off you for a second and chuckles."
                    the_girl.char "[mc.name]... I think you've forgotten who is on top!"
                    "[the_girl.name] pushes her pussy back up against your face and begins to grind herself on your face."
                    "You are caught unready. When you have a chance, you gasp a deep breath of air and begin to start licking her."
                    the_girl.char "Mmm, thats it [mc.name]"
                    ...
                    "[the_girl.name] moans, the vibrations it causes around your shaft feels great."
                    ...
                    if the_girl.get_opinion_score("being submissive"):
                        ...
                        "[the_girl.name] moans again at your rough treatment, and immediately starts to slide her mouth back down around your cock."
                    ...
                    if SB_get_fetish(the_girl) == "External Cum Fetish":
                        ...
                        "You give [the_girl.name]'s ass a hard smack and resume eating her pussy."
                        "[the_girl.name]'s cunt quivers as she slides your cock back into her mouth, sucking at it with renewed vigor."
                    elif SB_get_fetish(the_girl) == "Internal Cum Fetish":
                        "After a moment she takes her lips off your dick and continues stroking you."
                        the_girl.char "Mmm, I can't wait to feel your cum sliding down my throat [mc.name]."
                        "She latches back onto your cock, sucking at the tip eagerly before letting it slip out again."
                        the_girl.char "I want you to flood my mouth with your cum. Ugh, I want it so badly!"
        ...
        "[the_girl.name] slides your cock all the way down into her throat. She uses one hand to cup and lightly stroke your balls while she hungrily throat you."
        "You circle her clit a few times with your tongue. You suck it into your mouth roughly a couple of times and then release it, you lips making a wet, lewd smackin noise"
        "You can feel [the_girl.name]'s throat contracting around you as she uses a swallowing motion to pleasure you. The sensation is intensly pleasurable."
        "It feels so good it is making it hard for you to concentrate on pleasuring her."
        menu:
            "Focus on her." if mc.sex_skills["Oral"] > 5:
                "Not to be outdone, you double down on your efforts to please [the_girl.name] orally."
                ...
                "The vibrations in [the_girl.name]'s throat feel amazing around your cock. You lick up some of her fluids that are beginning to drip down then lick up an down the length of slit a few times."
                if the_girl.get_opinion_score("drinking cum") > 0 and (the_girl.get_opinion_score("drinking cum") >= the_girl.get_opinion_score("cum facials")):
                    "[the_girl.name] pulls off you for a moment."
                    the_girl.char "Oh god, [mc.name], that feels so good. I can't wait to feel you blow your load straight down my throat!"
                    "[the_girl.name] licks up and down your shaft a few times, then slides your back into her mouth and slowly pushes herself down on to you, taking you all the way in."
                elif the_girl.get_opinion_score("cum facials") > 0:
                    "[the_girl.name] pulls off you for a moment."
                    the_girl.char "Oh god, [mc.name], that feels so good. Make sure you warn me before you cum though... I want you to spray your cum all over my face!"
                "You can feel [the_girl.name]'s tongue slithering back and forth across the base of your dick, and her nose brushes up against your scrotum."
                "You and [the_girl.name] continue to please each other orally. You often you hear a muffled moan, accompanied by a pleasant vibration in your groin."
            ...
            "Focus on you.":
                ...
                mc.name "[the_girl.name]! Holy hell girl that feels so good."
                "You can feel [the_girl.name]'s tongue slithering back and forth across the base of your dick."
                $ mc.change_arousal(5)
                if the_girl.get_opinion_score("taking control") > 0:
                    "Suddenly, [the_girl.name] pulls you out of her throat."
                    ...
                    "Lost in the pleasure, [the_girl.name] suddenly pulls you out of her throat."
                    the_girl.char "Hey now, don't forget about me!"
                    "Your eyes snap open. You resume licking [the_girl.name]'s pussy with renewed vigor, hoping she will go back to what she was doing a moment ago."
                    "After a few moments, [the_girl.name] lowers her head back to your cock. She circles the tip with her tongue a few times, and then you feel the wonderful sensation as she slides you back into her mouth."
...
label scene_SB_sixty_nine_2(the_girl, the_location, the_object, the_round):
    ...
    "[the_girl.name] pulls your cock out of her her mouth and starts to stroke you with her hand while her tongue circles around the tip."
    ...
    menu:
        "Play with her ass.":
            ...
            "[the_girl.name] moans as she working her tongue over your cock. She licks it bottom to top, then sucks on the tip, then licks it from the top back to the bottom."
            ...
            if the_girl.get_opinion_score("anal sex") > 0:
                "[the_girl.name] bucks her hips slightly as you start to push your finger into her tight back passage. Her back arches in pleasure."
                the_girl.char "Mmm! [mc.name] don't stop, that feels so good."
                ...
                "[the_girl.name] mimics your motions with her mouth, bouncing her face up and down on your cock as you finger fuck her asshole."

            elif the_girl.get_opinion_score("anal sex") < 0:
                the_girl.char "Hey! Wrong hole! Don't touch me back there!"
                "It seems that [the_girl.name] doesn't like having her ass played with."
                $ the_girl.discover_opinion("anal sex")
                $ the_girl.change_arousal(the_girl.get_opinion_score("anal sex"))
            elif the_girl.sluttiness > 60:
                "[the_girl.name] tenses slightly as you start to push your finger into her back passage, but otherwise doesn't resist."
                mc.name "Relax [the_girl.name], let me take care of you."
                ...
                the_girl.char "That feels good [mc.name]... just be careful with me back there!"
                ...
                "[the_girl.name] tenses slightly as you start to push your finger into her back passage and begins to protest."
                mc.name "Hush [the_girl.name], let me take care of you."
                "[the_girl.name] stays pretty tense, so for now you just leave your finger where it is."
                "You decide to resume licking her pussy, your finger halfway inside her rectum."
                "[the_girl.name] delicately licks the tip of your dick for a bit, before parting her lips and resuming her suckling motions."
            "You decide that is enough ass play for now, so you resume eating [the_girl.name] out."
        ...
        "Finger Her.":
            ...
            if mc.sex_skills["Foreplay"] > 2:   #MC is competent at foreplay
                "You push a second finger into her. [the_girl.name] moans around the base of your cock as she licks it up and down."
                ...
                "[the_girl.name] shudders as your start to stroke her special spot. Your manhood pops out of her mouth suddenly as she moans, distracted by the pleasure."
                ...
                "She stops stroking you with her hand, and you feel her welcoming lips around the tip of your cock as she resumes her sucking."
                "[the_girl.name]'s steamy cunt accepts your probing as you continue to lick and suck at her clit."
            if the_girl.arousal > 80:
                "[the_girl.name]'s drenched cunt pulsates around your finger."
            else:
                "[the_girl.name]'s creamy cunt melts around your finger."
            if the_girl.sex_skills["Oral"] < 6:
                "[the_girl.name] renews her vigor as she blows you. Her insistent mouth feels amazing around your shaft."
            else:
                "[the_girl.name] renews her vigor as she blows you. Her nose nestles into your balls as her easily swallows you into her greedy throat."
                "Her tongue feels amazing as she strokes you, her mouth nearly overloads your senses."
            "You continue to lick and tease [the_girl.name] as you slowly pull your finger out."
    ...
    if the_girl.get_opinion_score("cum facials") > 0: #She loves facials
        if the_girl.get_opinion_score("cum facials") == the_girl.get_opinion_score("drinking cum"):   #She likes them equally, so do one randomly
            if renpy.random.randint(0,100) < 50: #In her mouth
                if SB_get_fetish(the_girl) == "Oral Fetish":
                    "You feel [the_girl.name] take you all the way in her mouth as you start to orgasm."
                    ...
                    "[the_girl.title] pulls off until just the  tip of your cock is in her mouth and she begins to stroke you off eagerly."
                    "You erupt in orgasm into her greedy mouth. Her expert mouth milks you with every spurt."
                    "[the_girl.title] begins moaning uncontrollably around your spasming cock when her cum addicted brain registers her cum dosage."
                else:
                    "You feel [the_girl.name] leave just the tip of you in her mouth. She strokes you with her hand as you start to orgasm."
                ...
                "[the_girl.name] pulls you out of her mouth, and begins stroking you eagerly."
                the_girl.char "Thats it, [mc.name], cum all over me!"
                $ the_girl.cum_on_face()
                if SB_get_fetish(the_girl) == "External Cum Fetish":
                    "[the_girl.name] begins moaning uncontrollably as she receives the cum her addicted brain has been begging her for."
                #$ SB_sixty_nine.redraw_scene(the_girl)
                "You let out a shudder moaning as you cum, pumping your sperm onto [the_girl.name]'s face. She sighs when you're completely finished."
            ...
            "You let out a shudder moaning as you cum, pumping your sperm onto [the_girl.name]'s face. She sighs when you're completely finished."
            $ the_girl.call_dialogue("cum_face")
        "You give [the_girl.name]'s slit a few more appreciative licks, and then you both start to get up."
        ...
        "[the_girl.name] pulls you out of her mouth, and begins stroking you."
        $ the_girl.cum_on_face()
        #$ SB_sixty_nine.redraw_scene(the_girl)
        "You let out a shudder moaning as you cum, pumping your sperm onto [the_girl.name]'s face."
        $ the_girl.call_dialogue("cum_face")
    else:
        "You feel [the_girl.name] leave just the tip of you in her mouth. She strokes you with her hand as you start to orgasm."
        $ the_girl.cum_in_mouth()
...
label transition_default_SB_sixty_nine(the_girl, the_location, the_object, the_round):
    $ SB_sixty_nine.redraw_scene(the_girl)
    "You lay down on the [the_object.name]. [the_girl.name] swings one leg over your head and slowly moves her body into position on top of yours."
    return

label strip_SB_sixty_nine(the_girl, the_clothing, the_location, the_object, the_round):
    "[the_girl.name] pops off your cock."
    $ the_girl.call_dialogue("sex_strip")
    $ the_girl.draw_animated_removal(the_clothing)
    "[the_girl.name] wiggles out of her [the_clothing.name]. She throws it to the side, then slides your cock inside her mouth."
    $ SB_sixty_nine.redraw_scene(the_girl)
    return
...
label strip_ask_SB_sixty_nine(the_girl, the_clothing, the_location, the_object, the_round):
    ...
    menu:
        "Let her strip.":
            ...
            "[the_girl.name] wiggles out of her [the_clothing.name]. She throws it to the side, then slides your cock all the way to the back of her mouth."
            $ SB_sixty_nine.redraw_scene(the_girl)
...
label orgasm_SB_sixty_nine(the_girl, the_location, the_object, the_round):
    "Licking and probing all around [the_girl.name]'s clit, you can feel her start to quiver."
    "[the_girl.name] pauses suddenly. You hear her moaning, the sound muffled by your cock in her mouth."
    if the_girl.sex_skills["Oral"] < 4:
        "[the_girl.name] starts to pull back off until just the tip of your erection is left in her mouth."
    else:
        "[the_girl.name] pushes her face down on to your cock, burying it in her throat."
    ...
    "After several seconds [the_girl.name] sighs and then begins to bob her head up and down on your again."
