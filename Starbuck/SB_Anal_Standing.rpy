...
label intro_SB_anal_standing(the_girl, the_location, the_object, the_round):
    ...
    if SB_get_fetish(the_girl) == "Anal Fetish":
        if the_girl == mom:
            ...
            "[the_girl.title] tries to push back against you and begins to beg."
...
label scene_SB_anal_standing_1(the_girl, the_location, the_object, the_round):
    "Your hips slap against [the_girl.title]'s as you plunder her rectum."
    ...
    if the_girl.sex_skills["Anal"] < 2: #Inexperienced
        ...
        "[the_girl.title] reaches back with one hand and pulls an ass cheek back, giving you a great view of her booty hole stretched wide to accomodate you."
    ...
    menu:
        "Kneed her ass":
            ...
            if the_girl.get_opinion_score("being submissive") > 0 or the_girl.obedience > 130:
                "[the_girl.title] trembles at your words and touch. "
                ...
                "You give [the_girl.title] a good, hard thrust in response."
...
label scene_SB_anal_standing_2(the_girl, the_location, the_object, the_round):
    "[the_girl.title] quivers as you slow up the pace a bit. The sensation of burying yourself in her tight chute over and over is amazing."
    ...
    if the_girl.arousal > 130:
        ...
        "[the_girl.title]'s legs are shaking. She is thoroughly enjoying her anal plundering."
        if SB_get_fetish(the_girl) == "Anal Fetish":
    ...
    menu:
        ...
        "Talk Dirty":
            ...
            if SB_get_fetish(the_girl) == "Anal Fetish":
                "[the_girl.title] moans enthusiastically. She wiggles her hips back and forth, caressing your dick with her forbidden hole."
                ...
                $ the_girl.change_arousal(the_girl.get_opinion_score("anal sex"))
                "[the_girl.title] is moaning your name over and over. You continue to give her the anal reeming she is begging for."
                ...
                "[the_girl.title] looks back at you and manages to smile throug the intense sensation of having her ass fucked."
