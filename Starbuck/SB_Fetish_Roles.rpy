...
label SB_fetish_vaginal_visit_label(the_person):
    if the_person == mom:
        ...
        "[the_person.title] smiles at you before replying."
        ...
        "[the_person.title] frowns at you before replying."
        ...
        "[the_person.title] smiles, clearly enjoying your obvious innuendo."
        the_person.char "I'll see you tonight then!"
    python:
...
label SB_fetish_vaginal_mom_kitchen_label(the_person):
    ...
    "[the_person.title] hesitates for a second, clearly realizing you are up to something."
...
label SB_fetish_anal_staylate_label(the_person):
    ...
    "You give [the_person.title] a reassuring smile."
    ...
    "You look [the_person.title] in the eyes. Her pupils dilate a bit as she realizes the reasoning behind asking her to stay late."
...
label SB_fetish_cum_getdosage_label(the_person):
    ...
    "[the_person.title] immediately drops to her knees. She doesn't even seem to care that there could be other people around."
...
label SB_lily_anal_in_room_label(the_person):
    ...
    "[the_person.title] looks at you and smiles."
    ...
    $ the_person.draw_person(position = "standing_doggy")
    "[the_person.title] goes over to her dresser. She's going through a drawer looking for the toy."
    if the_person.outfit.vagina_available():
        mc.name "Mmmm, Sis, your ass looks amazing. I can't wait to see that hole stretched around my cock..."
    else:
        "You step up behind [the_person.title] and start to grope her ass. She sighs as you massage it."
    ...
    "[the_person.title] hands you a bottle of lube and the dildo, then heads over to her bed and gets on her hands and knees with her ass in the air."
    $ the_person.draw_person(position = "doggy")
    "You put the dildo on and lube yourself up. You get behind [the_person.title] on the bed and start to line yourself up."
