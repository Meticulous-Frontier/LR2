...
label SB_fetish_vaginal_visit_label(the_person):
    if the_person == mom:
        mc.name "Hey mom, it's been kind of a rough day, would you be willing to spend the night in my room tonight?"
        "[the_person.name] smiles at you before replying."
        the_person.char "Oh honey, I love it that we are so close that you feel comfortable asking me that. That souds fine."
        "You coordinate with your mom on what time you'll be home tonight."
        the_person.char "I'll see you tonight then!"
    elif the_person == lily:
        mc.name "Hey Lily. What are you up to tonight?"
        "[the_person.name] frowns at you before replying."
        ...
        "You coordinate with Lily on what time you'll be home tonight."
        the_person.char "I'll see you tonight then!"
    else:
        mc.name "Hey, [the_person.name], have any plans for tonight?"
        "[the_person.name] smiles at you before replying."
        ...
        the_person.char "Sounds great, [mc.name]!"

        mc.name "Don't forget to bring a toothbrush, [the_person.name]..."
        "[the_person.name] smiles, clearly enjoying your obvious innuendo."
        the_person.char "I'll see you tonight then!"
    python:
...
label SB_fetish_vaginal_mom_kitchen_label(the_person):
    ...
    mc.name "Hey mom, dinner sure smells good. Just keep working on it, don't mind me!"
    "[the_person.name] hesitates for a second, clearly realizing you are up to something."
    "You pretend to look in the fridge for something as your mom resumes dinner preperations. She bends over the counter and starts to chop up some vegetables."
    $ the_person.draw_person(position = "standing_doggy")
    if the_person.outfit.vagina_available():
        "You steal a few glances over at your mom's exposed ass. It looks soft and supple, and shakes a bit as she prepares dinner."
    else:
        "You steal a glance over at your mom's ass as she is bent over. It looks great in her [the_clothing.name]."
    "Getting a naughty idea, you quietly move behind your mom."
    if the_person.outfit.vagina_available():
    ...
    mc.name "Stop? But doesn't that feel good, mommy?"
    the_person.char "Of course it does... But your sister, she could walk in anytime..."
    if the_person.outfit.vagina_available():
        "Shhh, just be quiet. Your ass looks so amazing mom... I should just fuck you right here..."
    else:
    ...
    "Your mom stifles a moan, she pushes her hips back against you as you continue to stroke her."
    ...
    if the_person.arousal > 100:
        "Your mom is positively glowing. She knows that even while preparing dinner, you may come and fuck her at any time."
    else:
        "Your mom remains silent. She knows that even while preparing dinner, you may come use her for your pleasure at any time."

    $ the_person.reset_arousal()
    $ the_person.review_outfit()
    "As your mom continues dinner preparation, you take a quick look around. It doesn't look like Lily noticed anything happened between you and your mom."
    return

#Anal Fetish Events#
label SB_fetish_anal_staylate_label(the_person):
    mc.name "[the_person.name], I need you to stay after work today."
    the_person.char "Oh, of course sir. I'm not in trouble am I?"
    "You give [the_person.name] a reassuring smile."
    ...
    "You look [the_person.name] in the eyes. Her pupils dilate a bit as she realizes the reasoning behind asking her to stay late."
    the_person.char "Oh! Thank you sir! I'll look forward to it!"
    "You say goodbye to [the_person.name]."
    python:
...
label SB_fetish_cum_getdosage_label(the_person):
    mc.name "[the_person.name] get on your knees. Its time for your dosage of cum."
    "[the_person.name] smiles wide."
    the_person.char "Oh!? Yes! its my favorite!"
    "[the_person.name] immediately drops to her knees. She doesn't even seem to care that there could be other people around."
...
label SB_fetish_anal_mom_kitchen_label(the_person):
    ...
    the_person.char "Of course it does... But your sister, she could walk in anytime..."
    if the_person.outfit.vagina_available():
        mc.name "Shhh, just be quiet. Your ass looks so amazing mom... I should just fuck it right here..."
    else:
    ...
    "Your mom pulls some lube out of one of the kitchen drawers."
    mc.name "Wait... you keep lube in the...?"
    the_person.char "Shut up just fuck me before your sister notices!"
    "You rub some lube on your cock and on mom's ass hole. You grab her by the hips and then rougly pull her back until your cock is buried inside her rump."
...
label SB_lily_anal_in_room_label(the_person):
    "You give Lily a quick proposition."
    mc.name "Hey [the_person.name]. What do you say we get out that strap on again?"
    "[the_person.name] looks at you and smiles."
    the_person.char "Mmm that sounds pretty good bro... Here, let me take a couple... precautions."
    "Lily walks over and closes her door and locks it. She turns on some music and turns the volume up."
    the_person.char "Don't want mom to find out..."
    $ the_person.draw_person(position = "standing_doggy")
    "[the_person.name] goes over to her dresser. She's going through a drawer looking for the toy."
    if the_person.outfit.vagina_available():
        mc.name "Mmmm, Sis, your ass looks amazing. I can't wait to see that hole stretched around my cock..."
    else:
        "You step up behind [the_person.name] and start to grope her ass. She sighs as you massage it."
        ...
        python:
           for clothing in the_person.outfit.get_lower_ordered():
                ...
                renpy.say("","")
        mc.name "Mmmm, Sis, your ass looks amazing. I can't wait to see that hole stretched around my cock..."
    the_person.char "Ah! Here it is. I know I can't wait, you know I love when you fuck me in the ass bro."
    "[the_person.name] hands you a bottle of lube and the dildo, then heads over to her bed and gets on her hands and knees with her ass in the air."
    $ the_person.draw_person(position = "doggy")
    "You put the dildo on and lube yourself up. You get behind [the_person.name] on the bed and start to line yourself up."
    ...
    the_person.char "Oh thank god... I was starting to consider jumping you in the middle of the night. You know I need your cock in my ass bro..."
    ...
    $ the_person.reset_arousal()
    the_person.char "Yes... Thanks [mc.name]... Don't be a stranger now!"
    "Your sister wiggles her ass back and forth a bit, still lying face down on her bed. You politely excuse yourself."
    $ the_person.review_outfit()
    return
