...
label intro_SB_doggy_anal(the_person, the_location, the_object, the_round):
    ...
    "[the_person.title] gets onto all fours in front of you on the [the_object.name]. She arches her back and presents her ass."
...
label scene_SB_doggy_anal_1(the_person, the_location, the_object, the_round):
    "You give [the_person.title]'s ass a good hard spank. She lets out a loud yelp"
    $ the_person.call_dialogue("sex_responses")
    if the_person.sex_skills["Anal"] < 2: #Inexperienced
        "[the_person.title] reflexively starts to pull away after you spank her. You grab her hips to keep her from pulling off completely."
        ...
        menu:
            "Masturbate for me":
                 "Encouraged by your response, [the_person.title] reaches down with one hand and begins to rub her clit."
                 "You take it slow, and you revel in the delicious pleasure of each penetration as you thrust. [the_person.title] struggles to hold herself up with one hand while the other works circles around her clit"
                 if the_person.get_opinion_score("masturbating") > 0:
                     "[the_person.title] moves her fingers masterfully across her pussy. You can tell she masturbates often."
                 ...
                 if the_person.sluttiness > 100:
                     ...
                     "[the_person.title] seems to be enjoying the anal penetration a bit more now that she is touching herself"
            "Fuck me with your ass":
                 ...
                 "[the_person.title] slowly eases forward until just the tip remains inside, then slowly backs her ass back onto you. She is trying to obey but you can tell she is struggling to take you"
                 ...
                 "With the extra lube, [the_person.title] resumes fucking you. She still has a fairy slow pace, but is a bit quicker than before."

    else:
        "In response to your spanking, [the_person.title] thrusts herself back against you. Your penis is completely consumed by her bowel and she moans lewdly."
        ...
        "[the_person.title]'s ass feels so tight you are tempted to let her continue setting the pace, but you worry she might get the wrong idea if you let this little slut take charge."
        menu:
            "Fuck me with your ass":
                 "You decide to see what [the_person.title] can do if you let her take control of the pace. Encouraged by your words, she eagerly works your cock with her ass" ###FINISH
                 the_person.char "Mmm, does it feel good when I work it like this?"
                 "[the_person.title] begins to twerk up and down your shaft with quick, shallow movements."
                 if mc.arousal > 70:
                      ...
                      if SB_get_fetish(the_person) == "Anal Fetish":
                           ...
                           "[the_person.title] sighs. She is truly addicted to getting her tight back passage fucked"
                           ...
                           "[the_person.title] sighs. You can tell having your dick in her ass is very fulfilling for her."
                      else:
                 ...
                 "[the_person.title] continues to twerk her ass up and down on your penis. How does she make it look so easy?"
            "I'm in charge here":
                 ...
                 "You lean forward and whisper into [the_person.title]'s ear."
                 ...
                 if the_person.obedience > 130 or the_person.get_opinion_score("being submissive") > 0:
                     ...
                     if the_person.get_opinion_score("being submissive") > 0:
                         ...
                         "For once, [the_person.title] is speechless. She can only whimper softly in total submission to you."
                     else:
...
label scene_SB_doggy_anal_2(the_person, the_location, the_object, the_round):
    "[the_person.title] lowers her shoulders against the [the_object.name] and groans as you fuck her from behind."
    the_person.char "Ah... I feel so full!"
    "You reach forward and place your hands on [the_person.title]'s shoulders. With each thrust you pull her back onto you forcefully, your hips smacking her ass cheeks loudly. She arches her back and lets out a series of satisfied yelps."
    $the_person.call_dialogue("sex_responses")
    if the_person.arousal > 80:
        "[the_person.title]'s pussy is dripping wet. A damp spot has begun to accumulate below her pussy as a result of your rutting."
        the_person.char "Ohhh, you feel so fucking good in my ass."
    else:
        "[the_person.title] seems to be enjoying the fucking you are giving her. She yelps in response to one particularly eager thrust."
    ...
    if the_person.get_opinion_score("giving handjobs") > 0:
        "[the_person.title] reaches down and begins to stroke and rub your scrotum with one hand, while with the other hand she reaches back and pulls her ass cheeks apart."
        $ the_person.change_arousal(the_person.get_opinion_score("giving handjobs" * 2))
    elif the_person.get_opinion_score("masturbating") > 0:
        "You notice that[the_person.title] now has one hand on her pussy, rubbing her clit, and with the other hand she reaches back and pulls her ass cheeks apart."
        $ the_person.change_arousal(the_person.get_opinion_score("masturbating" * 3))
    else:
        "[the_person.title] reaches back with both hands and spreads her ass cheeks apart."
    ...
    menu:
            "Admire her ass":
                "You pull yourself out of [the_person.title]'s ass for moment and admire the soft, round cheeks of carnal pleasure in front of you."
                "Her asshole gapes a bit from your sudden pullout, and she quickly turns her head to see why she suddenly feels so empty."
                "[the_person.title] realizes you are taking a moment to check out her backside."
                if the_person.get_opinion_score("showing her ass"):
                    ...
                    "[the_person.title] moves her ass side to side, gyrating her hips for you while keeping her ass cheeks spread wide."
                    ...
                    $mc.change_arousal(5)
                    "The thought of painting [the_person.title]'s ass with your semen makes your cock twitch in anticipation."
                    ...
                    "[the_person.title] tries to push herself back on to you, but from her angle she is unable to get you to penetrate her again unless you help."
                    "She quickly gives up an resorts to rubbing her ass up and down along the length of your penis."
                elif the_person.obedience > 130:
                    "[the_person.title] blushes. The conflict of the dirtiness of the act of anal sex and her obedience to you are clear in her face."
                    ...
                    "[the_person.title]'s cheeks turn even redder with your dirty talk. She puts her head down again, but leaves her cheeks spread, ready for you to resume fucking her whenever you are ready."
                else:
                    the_person.char "Hey, why'd you pull out? I was just getting used to how thick you are..."
                "After taking a moment appraising [the_person.title]'s buttocks, you decide to get back to the act"
                "With gentle pressure, you slowly fill her ass with your erection again. [the_person.title] groans as you resume your thrusting"
            "Shove it in deep":
                "You decide with her cheeks spread wide to see how deep you can get yourself into [the_person.title]. "
                ...
                "[the_person.title] whimpers, her body now pinned between your body and [the_object.name]"
                if SB_get_fetish(the_person) == "Anal Fetish":
                    "Despite having no leverage, [the_person.title] wriggles her ass against you as best as she can. Even with no room to move, her love for anal sex drives her to try to milk your cock"
                    ...
                    "[the_person.title] is writhing in pleasure, having her fetish of anal sex fulfilled."
                    ...
                    "You can see goosebumps all over [the_person.title]'s skin. She moans and then begs you to keep fucking her."
                elif the_person.get_opinion_score("creampies") > 0:
                    the_person.char "Holy hell that is deep... tell me... tell me you'll push it this deep again when you cum... that would be so hot!"
                    $mc.change_arousal(5)
                    "In your mind, you play out the fantasy of cumming so deep in [the_person.title]'s ass, even when you pull out not a drop of your seed leaks out."
                    "You give the idea serious consideration. You can tell she would love it if you did."
                elif the_person.get_opinion_score("anal sex") > 0:
                    "Despite having no leverage, [the_person.title] wriggles her ass against you as best as she can. Even with no room to move, her love for anal sex drives her to milk your cock"
                    ...
                    "You can see goosebumps all over [the_person.title]'s skin. You wonder how many times you can make her cum before you blow your load."
                    $ the_person.change_slut_temp(2)
                elif the_person.sluttiness > 100:
                    the_person.char "Oh fuck, bury it in me [the_person.mc_title]! I don't think I've ever felt so full..."
                else:
                    "[the_person.title] lets out a loud groan. You can tell she isn't used to being penetrated like this, but she is taking it as best as she can."
                ...
                "After a minute or two slow, deep thrusts you decide to move back to doggy. You push yourself up off of [the_person.title]'s back, and she follows, getting on all fours again to resume your fucking."
...
label outro_SB_doggy_anal(the_person, the_location, the_object, the_round):
    ...
    menu:
        ...
        "Cum on her face.":
            ...
            if SB_get_fetish(the_person) == "External Cum Fetish":
                "[the_person.title] reaches up and begins stroking you off for your final few seconds."
...
label transition_SB_doggy_anal_doggy(the_person, the_location, the_object, the_round):
    "You decide to give [the_person.title] a break. She murmurs a bit in disappointment when you slowly pull your dick out of her ass completely."
    ...
    "You ignore her question and push forward, slipping your shaft deep inside of [the_person.title]'s cunt. She gasps and quivers ever so slightly as you start to pump in and out."
    return
...
label transition_doggy_SB_doggy_anal(the_person, the_location, the_object, the_round):
    ...
    "[the_person.title] slobbers all over your fingers for a few a seconds before you pull them out with a loud pop"
    "You use your fingers to crudely work in and out of her ass a few times to help get it lubricated. [the_person.title] moans at the feeling of your penis in one hole and your fingers in another"
...
label transition_default_SB_doggy_anal(the_person, the_location, the_object, the_round):
    "[the_person.title] gets on her hands and knees as you kneel behind her. You bounce your hard shaft on her ass a couple of times before lining yourself up with her sphincter."
...
label orgasm_SB_doggy_anal(the_person, the_location, the_object, the_round):
    "[the_person.title]'s tight back passage starts to quiver, and suddenly tenses up."
