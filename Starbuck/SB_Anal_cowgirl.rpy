...
label scene_SB_anal_cowgirl_1(the_person, the_location, the_object, the_round):
    if the_person.arousal > 50:
        ...
        if the_person == mom:
            the_person.char "Oh god [the_person.mc_title], you make [the_person.title] feel so good... You grew up into such good man!"
...
label scene_SB_anal_cowgirl_2(the_person, the_location, the_object, the_round):
    ...
    if the_person == mom:
        the_person.char "[the_person.mc_title]! [the_person.title] loves it when you play with her nipples."
    else:
...
label outro_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    ...
    if the_person.sluttiness > threshold:
        ...
        if the_person.char == mom:
            the_person.char "That's it baby! Give your cum to [the_person.title]!"
        else:
