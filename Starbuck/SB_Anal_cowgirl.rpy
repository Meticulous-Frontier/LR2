...
label intro_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    ...
    if SB_get_fetish(the_person) == "Anal Fetish":
        ...
        the_person.char "Ah..."
    "After pausing for a second to adjust [the_person.possessive_title] starts to ride your dick."
    return

label scene_SB_anal_cowgirl_1(the_person, the_location, the_object, the_round):
    if the_person.arousal > 50:
        "[the_person.possessive_title] leans back, putting her hands in line with your feet."
        ...
        if the_person == mom:
            the_person.char "Oh god [the_person.mc_title], you make mommy feel so good... You grew up into such good man!"
        ...
        "[the_person.possessive_title] leans back, putting her hands in line with your feet, and slows down her rhythm."
    ...
    "[the_person.possessive_title] rocks her hips back and forth. Each movement feels like her tight back passage is milking you, begging for you to cum in it."
    return

label scene_SB_anal_cowgirl_2(the_person, the_location, the_object, the_round):
    "[the_person.possessive_title] speeds up, working her thighs to pump herself up and down your cock."
        ...
        if the_person.outfit.tits_visible():
            ...
            menu:
                "Pull her [the_clothing.name] off.":
                    ...
                    "Now free of her [the_clothing.name], [the_person.possessive_title] resumes fucking you."
                    return
                "Play with her pussy.":
                    ...
                    if the_person.get_opinion_score("being fingered"):
                        "[the_person.possessive_title] moans as you start to play with her."
...
label scene_SB_anal_cowgirl_3(the_person, the_location, the_object, the_round):
    "You put your hands on [the_person.possessive_title]'s hips and guide her up and down at a steady pace."
    ...
    if SB_get_fetish(the_person) == "Anal Fetish":
        ...
        "With [the_person.possessive_title] in control you're able to relax and focus entirely on enjoying the feeling."
    return

label outro_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    "With each stroke of her hips [the_person.possessive_title]'s impossibly tight ass brings you closer and closer to cumming. You're finally driven past the point of no return."
    ...
    if the_person.sluttiness > threshold:
        ...
        "[the_person.possessive_title] drops herself down, grinding her hips against yours and pushing your cock as deep into her ass as possible."
        ...
        "[the_person.possessive_title] straddles you for a few more seconds as she catches her breath. Your cum drips out of her and onto your stomach."
        ...
        "[the_person.possessive_title] jerks up, pulls off your cock, and lowers herself back down."
        ...
        "You tense up and cum, shooting your thick load up and onto [the_person.possessive_title]'s stomach. She keeps grinding against your cock until you are completely spent."
        $ the_person.cum_on_stomach()
        $ SB_anal_cowgirl.redraw_scene(the_person)

    else:
        #She hesitates and you can decide to pull her down or not.
        "[the_person.possessive_title] starts to pull up and off of you. She hesistates with the tip of your cock just inside of her ass."
        ...
        menu:
            "Pull her down and cum inside her.":
                ...
                "The feeling of her tight, warm ass sliding down and engulfing your cock again pushes you over the edge. You pull [the_person.possessive_title] tight against you and unload inside of her."
                the_person.char "Ah! Fuck..."
                $ the_person.change_obedience(3)
                $ cum_in_ass(the_person)
                $ SB_anal_cowgirl.redraw_scene(the_person)
                "You give a few half-hearted pumps when you're done, then tap [the_person.possessive_title] on the ass. She slides off of your dick and collapses beside you."

            "Let her pull off and cum on her stomach.":
                "You stay silent. [the_person.possessive_title] waits another second, as if waiting to be convinced, then pulls off of your cock."
...
label transition_default_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    "You lie down on [the_object.name]. [the_person.possessive_title] swings a leg over your waist and straddles you."
    if the_person.sex_skills["Anal"] >= 3:
        "You nod. She grinds forward one last time, then lifts herself up. She reaches back behind her and guides your cock to the entrance of her puckered hole."
...
label strip_ask_SB_anal_cowgirl(the_person, the_clothing, the_location, the_object, the_round):
    ...
    menu:
        "Let her strip.":
            ...
            $ the_person.draw_animated_removal(the_clothing, position = SB_anal_cowgirl.position_tag)
            "[the_person.possessive_title] slows down her pace while she strips out of her [the_clothing.name]. When she's free of it she puts her hands on your chest and fucks you faster again."
...
label orgasm_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    "[the_person.possessive_title] works her hips faster and her breathing grows heavier."
