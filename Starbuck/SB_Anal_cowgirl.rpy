...
label intro_SB_anal_cowgirl(the_girl, the_location, the_object, the_round):
    ...
    "She grinds up against you for several seconds, until your cock glides pleasingly along her we slit."
    the_girl.char "Ready?"
    ...
    if SB_get_fetish(the_girl) == "Anal Fetish":
        ...
        "[the_girl.title] settles in with the familiar feeling of your dick in her ass."
    else:
        the_girl.char "Ah..."
    "After pausing for a second to adjust [the_girl.title] starts to ride your dick."
    return
...
label scene_SB_anal_cowgirl_1(the_girl, the_location, the_object, the_round):
    if the_girl.arousal > 50:
        ...
        if the_girl == mom:
            the_girl.char "Oh god honey, you make mommy feel so good... You grew up into such good man!"
    ...
    "[the_girl.title] rocks her hips back and forth. Each movement feels like her tight back passage is milking you, begging for you to cum in it."
    return
...
label scene_SB_anal_cowgirl_2(the_girl, the_location, the_object, the_round):
    ...
    if the_girl.has_large_tits():
        if the_girl.outfit.tits_visible():
            ...
            "[the_girl.title] reaches down and grabs your hands. She brings them up to her tits and plants them there."
            ...
            menu:
                "Pull her [the_clothing.name] off.":
                    ...
                    "Now free of her [the_clothing.name], [the_girl.title] resumes fucking you."
                    return
                "Play with her pussy.":
                    ...
                    if the_girl.get_opinion_score("being fingered"):
                        "[the_girl.title] moans as you start to play with her."
    ...
    if the_girl == mom:
        the_girl.char "[mc.name]! Mommy loves it when you play with her nipples."
    else:
...
label scene_SB_anal_cowgirl_3(the_girl, the_location, the_object, the_round):
    ...
    if the_girl.arousal > 75:
        "Your cock glides in and out of her tight, supple ass. [the_girl.title] is so excited her pussy is dripping her juices onto you."
    else:
        "Her ass is warm and tight. You glide in and out of her at her pace."
    if SB_get_fetish(the_girl) == "Anal Fetish":
        "[the_girl.title] leans forward. She runs one hand through your hair and the other she puts on your chest."
        the_girl.char "Mmmm, your cock feels so good [mc.name]. I crave it, stuffing my tight little asshole constantly."
        "[the_girl.title] stops rocking her hips for a few minutes. Pausing just to enjoy the exquisite fullness your erection gives her."
    else:
        "With [the_girl.title] in control you're able to relax and focus entirely on enjoying the feeling."
    return

label outro_SB_anal_cowgirl(the_girl, the_location, the_object, the_round):
    "With each stroke of her hips [the_girl.title]'s impossibly tight ass brings you closer and closer to cumming. You're finally driven past the point of no return."
    ...
    if the_girl.sluttiness > threshold:
        ...
        "[the_girl.title] drops herself down, grinding her hips against yours and pushing cock as deep into her ass as possible."
        "Her breath catches in her throat when you pulse out your hot load of cum deep inside of her."
        if the_girl.char == mom:
            the_girl.char "That's it baby! Give your cum to mommy!"
        else:
            the_girl.char "Oh my god... Give it all to me [mc.name]... Fill my ass up!"
        $ cum_in_ass(the_girl)
        ...
        "[the_girl.title] straddles you for a few more seconds as she catches her breath. Your cum drips out of her and onto your stomach."
        ...
        "[the_girl.title] jerks up, pulls off your cock, and lowers herself back down."
        "She leans back and uses one hand to push your shaft against the lips of her pussy, grinding against it until you climax."
        the_girl.char "Cum for me [mc.name], I want you to cum on me!"
        ...
        "[the_girl.title] starts to pull up and off of you. She hesistates with the tip of your cock just inside of her ass."
        ...
        menu:
            "Pull her down and cum inside her.":
                "You reach up and grab [the_girl.title] by the hips. With one confident pull she plunges back onto your cock, gasping with pleasure."
                "The feeling of her tight, warm ass sliding down and engulfing your cock again pushes you over the edge. You pull [the_girl.title] tight against you and unload inside of her."
            ...
            "Let her pull off and cum on her stomach.":
                "You stay silent. [the_girl.title] waits another second, as if waiting to be convinced, then pulls off of your cock."
...
label orgasm_SB_anal_cowgirl(the_girl, the_location, the_object, the_round):
    ...
    if SB_get_fetish(the_girl) == "Anal Fetish":
        the_girl.char "Everytime your in my ass, it's like I just can't stop cumming..."
    else:
