...
label intro_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    the_person.char "Lie down for me, I want to be on top."
    "You lie down on the [the_object.name] and undo your pants. [the_person.title] swings a leg over your body and straddles you."
    ...
    if the_person.sex_skills["Anal"] >= 3:
    ...
    if SB_get_fetish(the_person) == "Anal Fetish":
        ...
        "[the_person.title] settles in with the familiar feeling of your dick in her ass."
    else:
        the_person.char "Ah..."
    "After pausing for a second to adjust [the_person.title] starts to ride your dick."
    return

label scene_SB_anal_cowgirl_1(the_person, the_location, the_object, the_round):
    if the_person.arousal > 50:
        "[the_person.title] leans back, putting her hands in line with your feet."
        ...
        if the_person == mom:
            the_person.char "Oh god honey, you make mommy feel so good... You grew up into such good man!"
            mc.name "Mmm, mom your ass is amazing. Its so tight!"
        else:
            the_person.char "Does that feel good? It feels even bigger when its in my ass like this."
            mc.name "Mmm, [the_person.title] your ass is amazing. Its so tight!"

    else:
        "[the_person.title] leans back, putting her hands in line with your feet, and slows down her rhythm."
        the_person.char "I need to take it a little slow. I need to get warmed up before I can really take it hard when it's in my ass."
    ...
    "[the_person.title] rocks her hips back and forth. Each movement feels like her tight back passage is milking you, begging for you to cum in it."
    return

label scene_SB_anal_cowgirl_2(the_person, the_location, the_object, the_round):
    "[the_person.title] speeds up, working her thighs to pump herself up and down your cock."
    ...
    if the_person.has_large_tits():
        if the_person.outfit.tits_visible():
            ...
            the_person.char "Fuck, hold onto these!"
            "[the_person.title] reaches down and grabs your hands. She brings them up to her tits and plants them there."
            ...
            menu:
                "Pull her [the_clothing.name] off.":
                    ...
                    $ the_person.draw_animated_removal(the_clothing, position = SB_anal_cowgirl.position_tag) #Hopefully this copy paste works.
                    "Now free of her [the_clothing.name], [the_person.title] resumes fucking you."
                    return
                "Play with her pussy.":
                    ...
                    if the_person.get_opinion_score("being fingered"):
                        "[the_person.title] moans as you start to play with her."
                        the_person.char "Oh! That feels good. Makes it easier to handle buttsex when you touch me like that."
                        $ the_person.change_arousal(5)
                    else:
                        the_person.char "That feels good... Keep going that makes this easier."
    ...
    if the_person == mom:
        the_person.char "[the_person.mc_title]! Mommy loves it when you play with her nipples."
    else:
        the_person.char "Mmm, I love it when you play with my tits!"
    if the_person.has_large_tits:
...
label scene_SB_anal_cowgirl_3(the_person, the_location, the_object, the_round):
    "You put your hands on [the_person.title]'s hips and guide her up and down at a steady pace."
    if the_person.arousal > 75:
        "Your cock glides in and out of her tight, supple ass. [the_person.title] is so excited her pussy is dripping her juices onto you."
    else:
        "Her ass is warm and tight. You glide in and out of her at her pace."
    if SB_get_fetish(the_person) == "Anal Fetish":
        "[the_person.title] leans forward. She runs one hand through your hair and the other she puts on your chest."
        ...
        "[the_person.title] stops rocking her hips for a few minutes. Pausing just to enjoy the exquisite fullness your erection gives her."
    else:
        "With [the_person.title] in control you're able to relax and focus entirely on enjoying the feeling."
    return

label outro_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    "With each stroke of her hips [the_person.title]'s impossibly tight ass brings you closer and closer to cumming. You're finally driven past the point of no return."
    mc.name "Fuck, I'm going to cum!"

    #Perhaps an option where she hesitates and you grab her hips and pull her down while you cum.
    $ threshold = 120 + (-20 * the_person.get_opinion_score("creampies")) + (-20 * the_person.get_opinion_score("anal sex"))
    if the_person.sluttiness > threshold:
        #She drops down on you as you cum.
        the_person.char "Yes! Ah!"
        "[the_person.title] drops herself down, grinding her hips against yours and pushing your cock as deep into her ass as possible."
        "Her breath catches in her throat when you pulse out your hot load of cum deep inside of her."
        if the_person.char == mom:
            the_person.char "That's it baby! Give your cum to mommy!"
        else:
            the_person.char "Oh my god... Give it all to me [the_person.mc_title]... Fill my ass up!"
        $ cum_in_ass(the_person)
        $ SB_anal_cowgirl.redraw_scene(the_person)
        the_person.char "Oh yes... so full..."
        ...
        "[the_person.title] straddles you for a few more seconds as she catches her breath. Your cum drips out of her and onto your stomach."
        ...
        the_person.char "Oh shit, don't cum in my ass!"
        "[the_person.title] jerks up, pulls off your cock, and lowers herself back down."
        "She leans back and uses one hand to push your shaft against the lips of her pussy, grinding against it until you climax."
        the_person.char "Cum for me [the_person.mc_title], I want you to cum on me!"
        "You tense up and cum, shooting your thick load up and onto [the_person.title]'s stomach. She keeps grinding against your cock until you are completely spent."
        $ the_person.cum_on_stomach()
        $ SB_anal_cowgirl.redraw_scene(the_person)

    else:
        #She hesitates and you can decide to pull her down or not.
        "[the_person.title] starts to pull up and off of you. She hesistates with the tip of your cock just inside of her ass."
        the_person.char "I... I really shouldn't let you..."
        "She bites her lip and moans, unsure of what to do."
        menu:
            "Pull her down and cum inside her.":
                "You reach up and grab [the_person.title] by the hips. With one confident pull she plunges back onto your cock, gasping with pleasure."
                "The feeling of her tight, warm ass sliding down and engulfing your cock again pushes you over the edge. You pull [the_person.title] tight against you and unload inside of her."
                the_person.char "Ah! Fuck..."
                $ the_person.change_obedience(3)
                $ cum_in_ass(the_person)
                $ SB_anal_cowgirl.redraw_scene(the_person)
                "You give a few half-hearted pumps when you're done, then tap [the_person.title] on the ass. She slides off of your dick and collapses beside you."

            "Let her pull off and cum on her stomach.":
                "You stay silent. [the_person.title] waits another second, as if waiting to be convinced, then pulls off of your cock."
                "She grinds the lips of her pussy against your shaft as you climax. You fire your hot load over her stomach."
                $ the_person.cum_on_stomach()
                $ SB_anal_cowgirl.redraw_scene(the_person)
                the_person.char "Whew, that was close..."
                "She rolls off and lies next to you on the [the_object.name]."
    return

label transition_default_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    "You lie down on [the_object.name]. [the_person.title] swings a leg over your waist and straddles you."
    if the_person.sex_skills["Anal"] >= 3:
        "You nod. She grinds forward one last time, then lifts herself up. She reaches back behind her and guides your cock to the entrance of her puckered hole."
...
label strip_SB_anal_cowgirl(the_person, the_clothing, the_location, the_object, the_round):
    $ the_person.call_dialogue("sex_strip")
    $ the_person.draw_animated_removal(the_clothing, position = SB_anal_cowgirl.position_tag)
    "[the_person.title] struggles out of her [the_clothing.name] and throws it to the side."
    return

label strip_ask_SB_anal_cowgirl(the_person, the_clothing, the_location, the_object, the_round):
    the_person.char "Sir, I'd like to take off my [the_clothing.name], would you mind?"
    menu:
        "Let her strip.":
            mc.name "Take it off for me."
            $ the_person.draw_animated_removal(the_clothing, position = SB_anal_cowgirl.position_tag)
            "[the_person.title] slows down her pace while she strips out of her [the_clothing.name]. When she's free of it she puts her hands on your chest and fucks you faster again."

        "Leave it on.":
            mc.name "No, I like how you look with it on."
            if the_person.sluttiness < 70:
                the_person.char "Yeah? Do I look sexy in it?"
                "She sighs happily while she rides you."
            else:
                the_person.char "Yeah? Do I look like a good little slut in it? Because that's what I feel like right now!"
                "She sighs happily while she rides your cock hard and fast."
    return

label orgasm_SB_anal_cowgirl(the_person, the_location, the_object, the_round):
    "[the_person.title] works her hips faster and her breathing grows heavier."
    ...
    "After a second [the_person.title] regains control of herself. Her breath is warm against your ear as she whispers to you."
    if SB_get_fetish(the_person) == "Anal Fetish":
