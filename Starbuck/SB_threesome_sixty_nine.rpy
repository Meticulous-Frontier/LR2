...
label intro_SB_threesome_sixty_nine(the_girl_1, the_girl_2, the_location, the_object, the_round, current_girl):
    ...
    "You push yourself into [the_girl_1.possessive_title]'s steamy cunt and start to fuck her while [the_girl_2.title] rides on her face."
    return
    ...
    if current_girl == 1:
        ...
        menu:
            ...
            "Suck her nipples." if the_girl_2.outfit.tits_available():
                ...
                "You suck one of [the_girl_2.possessive_title] into your mouth. You flip it up and down with your tongue a few times."
        ...
        "You rest one hand on [the_girl_2.title]'s head, guiding her as she sucks you off. With you other hand you continue to finger fuck [the_girl_1.possessive_title]."
        ...
        if the_girl_2.get_opinion_score("cum facials") > the_girl_2.get_opinion_score("drinking cum"):
            ...
            if SB_get_fetish(the_girl_1) == "External Cum Fetish" or SB_get_fetish(the_girl_1) == "Internal Cum Fetish":
...
label scene_SB_threesome_sixty_nine_2(the_girl_1, the_girl_2, the_location, the_object, the_round, current_girl):
    if current_girl == 1:
        "[the_girl_1.possessive_title]'s whole body is jostling forward and backward as you fuck her roughly. Her tight pussy feels silky smooth around your dick."
        ...
        "You decide its time for [the_girl_2.possessive_title] to put her mouth to better use."
        ...
        "You give [the_girl_1.possessive_title] a few slow thrusts, making sure to give [the_girl_2.title] room to work."
        the_girl_1.char "Mmmm..."
        ...
        "The view is incredible. [the_girl_2.possessive_title] is service you while she rides [the_girl_1.title]'s face."
        "You can't believe how lucky you are."
        "You push your fingers deep into [the_girl_1.possessive_title]. She moans into [the_girl_2.title]'s pussy, who in turn moans around your cock."
    ...
    if current_girl == 1:
        ...
        menu:
            "Cum inside [the_girl_1.title].":
                "You thrust yourself deep inside of [the_girl_1.possessive_title]'s cunt as you climax."
                ...
                if SB_get_fetish(the_girl_2) == "External Cum Fetish" or SB_get_fetish(the_girl_2) == "Internal Cum Fetish":
                    the_girl_2.char "Hey! No fair! I want some of that!"
                    "As you slowly pull out of [the_girl_1.possessive_title], a trickle of your cum starts to escape her."
                    ...
                    "As you slowly pull out of [the_girl_1.possessive_title], a trickle of your cum starts to escape her."
                "You give a sigh, deeply contented with having dumped your load inside of [the_girl_1.possessive_title]."
            ...
            "Cum on [the_girl_2.title]'s face.":
                ...
                $ SB_threesome_sixty_nine.redraw_scene(the_girl_1, the_girl_2)
                if SB_get_fetish(the_girl_1) == "External Cum Fetish":
                    "You can see [the_girl_1.title]'s pupils dilate as you fulfil her cum fetish."
                    "[the_girl_1.possessive_title] revels in bliss as your dick sprays jet after jet of seed across her face. She moans lewdly."
                    "She truly is addicted to your cum."
                "Some of your cum runs down off [the_girl_1.title]'s face and onto [the_girl_2.title]'s belly."
                $ the_girl_1.cum_on_stomach()
                $ SB_threesome_sixty_nine.redraw_scene(the_girl_1, the_girl_2)
                if SB_get_fetish(the_girl_2) == "External Cum Fetish":
                    "[the_girl_2.possessive_title]'s body quivers as your cum splashes down onto her. She runs her hands through your cum and rubs it into her belly."
        ...
        menu:
            "Cum inside [the_girl_2.title]'s mouth'.":
                ...
                if SB_get_fetish(the_girl_2) == "Internal Cum Fetish":
