...
label SB_fetish_cum_label(the_person):
    ...
    "You are just finishing up with with some work before you grab some lunch. You hear a friendly voice greet you as a you pull our your packed lunch from your desk."
    the_person.char "Hey [mc.name]! That sure looks good!"
    ...
    menu:
        "Help yourself" if mc.current_stamina > 0:  #This begins the sex scene
            ...
            the_person.char "Oh! That's okay, [mc.name]."
            "[the_person.name] lowers her voice and whispers huskily in your ear."
            ...
            if the_person.outfit.tits_available():
                "You check out [the_person.name]. Her delicious looking tits are on full display."
            else:
                "You check out [the_person.name]. You decide it might be easier to get off if you have a little more skin to look at while she sucks you."
                ...
                while not the_person.outfit.tits_available():
                    ...
                    "[the_person.name] takes off her [the_clothing.name]"
                    $ the_person.draw_animated_removal(the_clothing)
            "[the_person.name] gropes her breasts with both hands, looking for your approval."
            mc.name "Mmm, that looks great. I think I'll eat my lunch now..."
            "[the_person.name] giggles."
            the_person.char "Mmm... me too!"
            "[the_person.name] quickly gets down underneath your desk, before you sit down."
            ...
            "[the_person.name] begins bobbing her head up and down eagerly, hungry for your delicious cum."
            ...
            "[the_person.name] is moaning ecstatically below your desk."
            if SB_get_fetish(the_person) == "External Cum Fetish":
                "Glancing down, you see [the_person.name] running her hands along her face, then down to her chest. She is rubbing your cum into her skin."
                ...
                "Glancing down, you see [the_person.name] licking her fingers. There isn't a trace of your cum anywhere, she has swallowed every drop."
                the_person.char "Mmm... it's all inside me now... right where it belongs!"
            "[the_person.name] stands up."
            $ the_person.draw_person()
            the_person.char "Wow, that was amazing, [mc.name]. I don't know what has been coming over me lately..."
            ...
            "[the_person.name] runs her hand through her hair. She licks her lips and smiles at you."
            the_person.char "Thanks again, [mc.name]. We should do this again... and soon."
            "You wave goodbye to [the_person.name] and finish eating your lunch."
...
label SB_fetish_cum_dosage_label():
    ...
    $ the_person.draw_person()
    show screen person_info_ui(the_person)
    "You look up and see [the_person.name] at your door."
    if mc.business.is_open_for_business():
        mc.name "Hello [the_person.name], come in."
        "[the_person.name] walks into your office."
        the_person.char "Hey [mc.name]. So... I saw you walk into your office a minute ago and I was just thinking that its been a while..."
        ...
        "[the_person.name] voice trails off. It seems she is craving some of your cum again."
    else:
        "You are surprised to see her, since the business is closed."
        mc.name "Hello [the_person.name], come in."
        "[the_person.name] walks into your office."
        the_person.char "Oh [mc.name]! Thank goodness you are here, you are just the man I wanted to see."
    ...
    menu:
        "Suck me off" if mc.current_stamina > 0:
            the_person.char "Yes! Oh thank you [mc.name]!"
            "[the_person.name] walks over to you and immediately drops down on her knees. You consider asking her to strip down a bit, but she is already stroking your cock."
            $ the_person.draw_person(position = "blowjob")
            ###cum Scene, standing variant###
            ...
            $ the_person.reset_arousal()
            ###Reset Arousal
            the_person.char "Oh my god, thank you [mc.name]... I wish I could make you cum again... but I know you're a busy a man..."
            "[the_person.name] starts to get up. Her hunger for cum satisfied for now."
            the_person.char "Thanks again, [mc.name]. Don't hesitate to ask if you ever need to be... you know... serviced."
            "You wave goodbye to [the_person.name] as she leaves your office. Damn that was good!"
        "No Thanks":
...
label SB_fetish_mom_cum_label():
    ...
    "You are having some very pleasant dreams. [the_person.possessive_title] is posing for you in some sexy lingerie, then gets dwon on her knees..."
    "Her velvet soft mouth wraps around your cock, and she begins to bob her head eagerly up and down on your erection."
    ...
    "She opens her mouth and goes back to work. Her skilled mouth is quickly brining you to an orgasm!"
    ...
    menu:
        ...
        "Cum on her face":
            ...
            $ the_person.sexy_opinions["being covered in cum"] = [FETISH_OPINION_VALUE, True]
            $ SB_give_cum_external_role(the_person)
            "Slowly recovering, you look at [the_person.name]'s cum covered face. Her eyes are closed and she is absentmindedly playing with some of the cum that is starting to run down her neck."
...
label SB_fetish_shower_cum_label():
    ...
    the_person.char "Oh my god, thank you [mc.name]. I needed that so bad."
    "[the_person.name] stands up. Her hunger for cum satisfied for now."
