init 1 python:
    ...
    def SB_generate_premade_list():
        ...
        starbuck = Sex_Shop_Owner( name = "Starbuck", last_name = "Thrace", age = 32, body_type = "curvy_body", tits="E",  height = 0.95,  body_images = white_skin, expression_images = Expression("Starbuck\'s Expression Set", "white", "Face_4"), hair_colour="blond", hair_style = messy_short_hair.get_copy(), skin="white" , \
            ...
            home = start_home, font = get_random_font(), work = None, name_color = "#ff2c2c", dialogue_color = "#ff2c2c" , face_style = "Face_4", special_role = None)
...
label starbuck_vaginal_skillup_label(the_person):
    ...
    "[the_person.name] picks one off the shelf, it looks like it has a number of features, like vibration and heat. You eye the price tag warily"
    mc.name "I dunno... is it really worth that much?"
    the_person.char "DEFINITELY. If you can afford it, [mc.name], it will help take your girl's orgasms to the next level..."
    menu:
        "Purchase ($5000)":
            $ mc.business.funds += -5000
            $ mc.sex_skills["Vaginal"] = 10
            the_person.char "Oh! I'll ring this right up. You won't regret it, [mc.name]!"
            if the_person.sluttiness > 70:
                "[the_person.name] hands you your purchase after she rings you up. She smiles at you and blushes a bit."
                ...
                menu:
                    "Fuck her" if  mc.current_stamina > 0:
                        ...
                        mc.name "Sounds good, [the_person.name]. Since you recommended it, its only fair you be the first to feel it."
                        the_person.char "Ah... I can't wait! Let's go!"
                        $ mc.current_stamina += -1
                        call fuck_person(the_person) from _call_fuck_person_SBS10
                        if the_person.arousal > 160:
                            ...
                            "You leave [the_person.name] to get cleaned up and get back to work."
...
label starbuck_anal_skillup_label(the_person):
    #TODO you offer to make dinner. It takes up time, but you can slip serum to your mom and sister.
    "You explain to [the_person.name] that you feel like you need something to help take anal sex to the next level. You ask if she has any tips or products for further improvement."
    the_person.char "Oh [mc.name], I have just the thing to help!"
    "[the_person.name] leads you over to an area of the store where she sells a number of lubrications."
    the_person.char "You see [mc.name], the key to great anal sex, is using the perfect lube!"
    the_person.char "Personally, I recommend this one, although it is definitely a little pricey..."
    "[the_person.name] picks one off the shelf. You eye the price tag warily"
    the_person.char "This company has made a ton of advances in lube technology recently."
    the_person.char "This one has full effectiveness with just a small application, and is designed to both lubricate, AND increases bloodflow to the nerve endings, making anal more pleasurable for the receiver!"
    mc.name "I dunno... is it really worth that much?"
    the_person.char "DEFINITELY. If you can afford it, [mc.name], it will help take butt play to the next level..."
    menu:
        "Purchase ($8000)":
            ...
            if the_person.sluttiness > 90:
                ...
                menu:
                    "Fuck her ass" if  mc.current_stamina > 0:
                        "You take a quick look at the instructions. Looks like it should be fairly easy to keep with you and use with your partners from now on..."
                        mc.name "Sounds good, [the_person.name]. Since you recommended it, its only fair I use it on you first!"
                        the_person.char "Ah... I can't wait! Let's go!"
                        $ mc.current_stamina += -1
                        call sex_description(the_person, SB_anal_standing , make_desk(), 0, private = True) from _call_sex_description_SBS20
                        if the_person.arousal > 160:
                            the_person.char "Oh wow... I've never... I came so many times!"
                            $ the_person.change_obedience (5)
                            $ the_person.change_slut_temp (5)
...
label starbuck_oral_skillup_label(the_person):
    #TODO you offer to make dinner. It takes up time, but you can slip serum to your mom and sister.
    "You explain to [the_person.name] that you feel like you've stopped improving your skill at oral sex. You ask if she has any tips or products for further improvement."
    the_person.char "Oh [mc.name]... I think I can probably help you with that!"
    "[the_person.name] leads you over to an area of the store where she sells a number of instructional books and videos."
    the_person.char "Personally, I recommend this one, although it is definitely a little pricey..."
    "[the_person.name] picks a video off the shelf. You eye the price tag warily."
    mc.name "Cunnilingus, multiple orgasms, and squirting. The all in one how to guide."
    mc.name "I dunno... is it really worth that much?"
    the_person.char "DEFINITELY. If you can afford it, [mc.name], it will help you make your girl orgasm over and over again..."
    menu:
        "Purchase ($2500)":
            ...
            if the_person.sluttiness > 45:
                ...
                menu:
                    "Eat her pussy" if  mc.current_stamina > 0:
                        mc.name "Sounds good, [the_person.name]."
                        ...
                        "You head to the back of hte store with [the_person.name]. Watching the video, you learn several new tips and tricks for giving awesome oral."
                        "When you finish, you see [the_person.name] looking at you."
                        the_person.char "Wow, that was interesting!... you ready to give it a try, [mc.name]?"
                        $ mc.current_stamina += -1
...
label starbuck_foreplay_skillup_label(the_person):
    #TODO you offer to make dinner. It takes up time, but you can slip serum to your mom and sister.
    "You explain to [the_person.name] that you feel like you've stopped improving your skill at foreplay. You ask if she has any tips or products for further improvement."
    the_person.char "Oh [mc.name], I have just the thing to help!"
    "[the_person.name] leads you over to an area of the store where she sells a number of sex toys."
    the_person.char "Personally, I recommend this one, although it is definitely a little pricey..."
    "[the_person.name] picks one off the shelf, it looks like it has a number of features, like vibration and heat. You eye the price tag warily"
    mc.name "I dunno... is it really worth that much?"
    the_person.char "DEFINITELY. If you can afford it, [mc.name], it will help take your girl's orgasms to the next level..."
            ...
            if the_person.sluttiness > 30:
                ...
                menu:
                    "Finger her" if  mc.current_stamina > 0:
                        ...
                        the_person.char "Ah... I can't wait! Let's go!"
                        $ mc.current_stamina += -1
                        call fuck_person(the_person) from _call_fuck_person_SBS40
                        if the_person.arousal > 160:
                            the_person.char "Oh wow... I've never... I came so many times..."
                            $ the_person.change_obedience (5)
                            $ the_person.change_slut_temp (5)
...
label starbuck_arousal_reduction_one_label(the_person):
    ...
    "You explain to [the_person.name] that you feel like you're having trouble pleasing the women you've been with lately. You ask if she has anything that can help you last longer during sex"
    the_person.char "Oh [mc.name], I have just the thing to help!"
    "[the_person.name] leads you over to an area of the store where she sells a number of numbing creams and similar products."
    ...
    "[the_person.name] picks a cream off the shelf. You eye the price tag warily"
    mc.name "I dunno... is it really worth that much?"
...
label starbuck_arousal_reduction_two_label(the_person):
    #TODO you offer to make dinner. It takes up time, but you can slip serum to your mom and sister.
    $ global SB_MOD_MC_AROUSAL_MULT
    "You explain to [the_person.name] that you feel like you're still having trouble pleasing the women you've been with lately, even with the numbing cream. You ask if she has anything that can help you last longer during sex"
    the_person.char "Oh [mc.name], I have just the thing to help!"
    "[the_person.name] leads you over to an area of the store where she sells a number of pharmacutical products."
    the_person.char "While there are a ton of products on the market to help with you are talking about, the one I've gotten the best feedback from is this one."
    "[the_person.name] picks a pill off the shelf. You eye the price tag warily"
    mc.name "I dunno... is it really worth that much?"
...
label starbuck_sex_store_investment_one_label(the_person):
    ...
    menu:
        "Invest $1000":
            "You discuss with [the_person.name] for a while what the terms of your investment are. Once you are both happy, you write her a check from your business account."
            $ mc.business.funds += (-1000)
            $ the_person.change_happiness (20)
            $ the_person.change_obedience (5)
            the_person.char "Don't worry, [mc.name]! You won't regret this!"
        ...
        "Reconsider":
            ...
            mc.name "Sorry, [the_person.name], I haven't made up my mind yet. Thanks for the info though, I'll be back when I've reconsidered."
            "[the_person.name] frowns, but she nods in understanding."
            the_person.char "Of course, [mc.name]. It is a lot of money we are talking about, you should be careful with your hard earned money!"
    return

label starbuck_sex_store_investment_two_label(the_person):
    "While things at [the_person.name]'s sex shop have definitely picked up, you can't help but notice there are several sections of the store that lack variety."
    "There are some dildos, but only a couple varieties. Same with condoms, lubricants, and other items."
    "You decide to bring it up with [the_person.name]."
    mc.name "Hey [the_person.name]. I see things are going good around here, but I'm curious. You've got basic items around the store, but why don't you have more variety?"
    ...
    "You interrupt her."
    mc.name "How much?"
    "[the_person.name] clears her throat."
    ...
    if starbuck.shop_investment_rate == 3.0 :
        "It might also open up new opportunities with [the_person.name]. You wouldn't mind a few more excuses to get intimate with her..."
    "Do you want to invest?"
    menu:
        "Invest $5000":
            "You discuss with [the_person.name] for a while what the terms of your investment are. Once you are both happy, you write her a check from your business account."
...
label starbuck_sex_store_investment_three_label(the_person):
    ...
    mc.name "Hey [the_person.name]. Looks like things are going great here, how is business?"
    ...
    "So far, all of your investments in the shop have paid off... plus, you start to imagine what it would be like to try some of these items with [the_person.name]..."
    mc.name "Let's say I was interested in investing again... How much would you need to make all that happen?"
    "[the_person.name]'s mouth drops in surprise."
    ...
    menu:
        "Invest $15000":
            ...
            if starbuck.shop_investment_rate > 3.0:
                mc.name "[the_person.name], I'd be lying if I said I don't thoroughly enjoy the time we've spent together. So yeah, we would be business partners, but I'd also love the excuse to spend more time with you."
                $ the_person.draw_person(emotion = "happy")
                if starbuck.love > 60:
                    the_person.char "Oh, [mc.name]... I'm so glad to hear that. I feel the same way."
                else:
            ...
            the_person.char "Wow... this is it! The opportunity of a lifetime. I'm speechless [mc.name]. Thank you so much!"
...
label starbuck_sex_store_promo_one_label(the_person):
    the_person.char "Well, it is going okay. Thanks to your investment, I'm finally turning a profit atleast!"
    ...
    "You check out [the_person.name]. She has an amazing body. Maybe you should get her to pose with some of her product, take some pictures and turn it into an ad!"
    "[the_person.name] sees you checking her out, and the wheels turning in your head as you think about it."
    the_person.char "[mc.name]? Are you still with me here? Or are you too busy checking me out?"
    "You give her a smile as a plan comes together."
    mc.name "I know just what you need to do [the_person.name], that will help drive traffic here. You need to do some advertising!"
    "[the_person.name] shakes her head."
    ...
    the_person.char "That sounds great, [mc.name], but... where am I going to find a model for something like that? Let alone pay her?"
    "You pretend to think hard about it."
    mc.name "Well, [the_person.name], I think YOU are pretty fucking sexy..."
    "[the_person.name] quickly realizes you are suggesting that she dresses up in lingerie for some advertising."
    ...
    elif the_person.sluttiness > 20 :  #Barely passes the sluttness check.
        the_person.char "Oh... I don't know [mc.name]. I mean, believe me, I love sex, I even opened a shop... But to put myself out there in public like that? Are you sure I'm sexy enough for that?"
    ...
    else: #She failes the sluttiness check. Give dialogue to come back when shes sluttier.
        the_person.char "Wow, [mc.name]. I'm sorry I just... I don't think I could do that. To put myself out there in public like that?"
        "[the_person.name] considers for a bit."
        the_person.char "No, I'm sorry [mc.name]. It's a great idea, I just don't think I'm ready to do something like that. I'm sorry!"
        "You understand she's just not ready for something like that. Maybe at somepoint in the future she'd be willing to do something like that."
        return
    ...
    $ the_person.wardrobe.add_outfit(SB_advert_one_outfit)
    $ the_person.wardrobe.add_outfit(SB_advert_two_outfit)
    $ the_person.wardrobe.add_outfit(SB_advert_three_outfit)

    "Yes! [the_person.name] is gonna show off her amazing body of hers while you take pictures!"
    "You coordinate with her on the items you want to advertise and some outfits that would be suitable to show them off."
    #Pose walking away#
    "You collect the items, while [the_person.name] grabs a few sets of lingerie. You meet her in the back room."
    #pose standing#
    "Once in the backroom, you can see that [the_person.name] has three outfits picked out. Some classic black lingerie with fishnet and garter belt, a light blue nightgown, and a pink lacy one piece."
    ...
    menu:
        "The classic black set":
            "[the_person.name] starts to strip down."
            while strip_choice is not None:
                $ the_person.draw_animated_removal(strip_choice)
                "You watch as [the_person.name] take off her [strip_choice.name]."
                $ strip_choice = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True)
        ...
        "the pink one piece":
            ...
            $ the_person.draw_person()
    "Now dressed in her outfit, [the_person.name] hands you her phone. She grabs the first item, the bottle of lubricant."
    ...
    "[the_person.name] strikes a pose for you. You take several pictures, trying to find the best angles to show off her body... and the product."
    "You can tell that [the_person.name] is actually enjoying herself and your attention. Her cheeks are starting to get a little flushed."
    $ the_person.change_arousal(10)
    "The next item for her to model will be a male masturbation sleeve."
    "It is designed to look like a famous porn actress' asshole, so you figure to model this product, [the_person.name] should have her back to you."
    "Which lingerie should you have her use for this?"
    $ strip_choice = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True)
    menu:
        "The classic black set":
        ...
        "the pink one piece":
            ...
            $ the_person.outfit = SB_advert_three_outfit.get_copy()
            $ the_person.draw_person()
    "Now dressed in her outfit, [the_person.name] looks to you for direction."
    mc.name "[the_person.name]. You look incredible..."
    ...
    "[the_person.name] turns around and looks back at you. You get a bunch of pictures of her amazing ass. You almost forget to get pictures of the product!"
    mc.name "Perfect! These pictures are perfect, you are going to get a flood of guys in here looking for this!"
    "Once you are done [the_person.name] turns back to face you."
    $ starbuck.draw_person(position = "stand2", emotion = "happy")
    $ the_person.change_arousal(20)
    "The attention you are giving her is really starting to excite [the_person.name]. You can see her nipples sticking out proudly in her outfit."
    "The last item for her to model is a dildo. You figure since you are mainly targetting a male audience with this advertisement, a good pose for her would be on her knees, like shes getting ready to put it in her mouth."
    "Which lingerie should you have her use for this?"
    $ strip_choice = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True)
    menu:
        "The classic black set":
    ...
    the_person.char "Don't worry [mc.name], we're almost done. What should I do for this one?"
    mc.name "I think you sould get down on your knees, you know, like you are getting ready to suck on it."
    the_person.char "Oh! That sounds like fun... sucking on a... a dildo, right!"
    $ starbuck.draw_person(position = "blowjob")
    "[the_person.name] gets down on her knees. She looks at the dildo longingly. You take multiple pictures of her."
    $ the_person.change_arousal(30)
    the_person.char "Mmm... it looks so tasty..."
    "[the_person.name] opens her mouth, and slowly starting to run her tongue along the dildo. You see one of her hands slowly drift down between her legs and she begins to touch herself."
    ...
    menu:
        "Want a real dick?" if mc.current_stamina > 0:
            "[the_person.name] looks up at you, still on her knees."
            the_person.char "Oh [mc.name], getting all dressed up has me all turned on. If you'd let me do that, I would really appreciate it."
            mc.name "Go ahead, you look amazing. I can't wait to feel your mouth."
            "You walk up to [the_person.name]. She unzips your pants and pulls your cock out from your pants."
            ...
            if the_person.arousal > 100:
                "[the_person.name] takes a few minutes to recover from her orgasm. Eventually she gets up."
            else:
                "After you finish, [the_person.name] takes a second, then gets up."
            $ starbuck.draw_person(position = "stand2", emotion = "happy")
            $ mc.current_stamina += -1
            $ the_person.reset_arousal()
...
label starbuck_sex_store_promo_two_label(the_person):
    ...
    "[the_person.name]'s voice trails off for a second before she continues."
    ...
    "[the_person.name] thinks about what you are saying."
    ...
    if the_person.sluttiness > 70 : #We easily pass the sluttiness check.
        ...
        "[the_person.name] seems to really like the idea."
        mc.name "Hey, that's a good idea too! Let's do it!"
    elif the_person.sluttiness > 40 :  #Barely passes the sluttness check.
        the_person.char "Oh... I don't know [mc.name]. I mean, it sounds like it would work... but videos of me, on the internet? Using sex toys?"
        ...
        the_person.char "Wow, [mc.name]. I'm sorry I just... I don't think I could do that. To put myself out there on the internet like that?"
        "[the_person.name] considers for a bit."
        the_person.char "No, I'm sorry [mc.name]. It's a great idea, I just don't think I'm ready to do something like that. I'm sorry!"
        "You understand she's just not ready. Maybe at somepoint in the future she'd be willing to do something like that."
        return
    "[the_person.name] looks at you for a moment."
    ...
    "[the_person.name] walks away. You see her going around and grabbing a few things from around the store. You decide to head to the back room and wait for her there."
    ...
    $ the_person.draw_person()
    $ the_person.wardrobe.add_outfit(SB_advert_four_outfit.get_copy())
    "You check out [the_person.name] in her outfit. Damn she looks hot!"
    the_person.char "Okay, so here's what I'm thinking..."
    "[the_person.name] starts going over the details of how she wants to do it. You take mental notes. Soon you are ready to begin."
    "You get the camera recording as [the_person.name] begins her reviews."
    ...
    "[the_person.name] lays down on the floor. She begins by stroking herself with the dildo a few times up and down her slit."
    ...
    "[the_person.name] begins working the dildo in and out of her."
    ...
    $ the_person.change_arousal(15)
    "[the_person.name] is now fucking herself earnestly with the dildo. The sights and sounds are starting to turn you on. You absentmindedly begin to stroke yourself through your pants."
    the_person.char "Okay... now seems like a good time to test the curve, and see how well it stimulates the g-spot."
    "She pulls the dildo mostly out, then changes the angle of pentration. She gives herself short, shallow thrusts, focusing on her g-spot."
    the_person.char "YES! Okay this toy stimulates the g-spot... SO GOOD."
    $ the_person.change_arousal(20)
    "[the_person.name] looks up and notices you stroking yourself. Her mouth goes wide in a moan as her orgasm approaches."
    ...
    "[the_person.name]'s body begins to spasm as she orgasms. She shoves the toy in deep inside her. Her juices are trickling down beneath her out of her cunt."
    ...
    if (the_person.love > 50):
        the_person.char "Oh [mc.name]. That toy was so good... but honestly the whole time I was imagining it was you fucking me..."
        "She pushes herself up on her elbows, but makes no motion to stand up."
        the_person.char "Don't get me wrong, toys are great, but I want you! Seeing you touching yourself... looking at me... Please fuck me [mc.name]!"
    else:
        the_person.char "Damn [mc.name]. I'm glad you were enjoying the show..."
        "She pushes herself up on her elbows, but makes no motion to stand up."
        the_person.char "Toys are great... but nothing beats a real cock inside me. Would you please fuck me [mc.name]?"
    menu:
        "Fuck Her" if mc.current_stamina > 0:
            mc.name "[the_person.name], that was so hot! I can't wait to bury myself into your amazing cunt."
            ...
            if (the_person.love > 50):
                "[the_person.name] wraps her arms around you and holds you close. You move your face in for a kiss and she greedily accepts your tongue in your mouth."
                ...
                "[the_person.name] runs her hands along your sides as you get into position."
            ...
            $ mc.current_stamina += -1
            "[the_person.name] lays there in a daze. Between the toy and your cock, she had multiple orgasms."
            if (the_person.love > 50):
                "As your start getting dressed again, out of the corner of your eye you see [the_person.name] begin to shudder."
                "You see a tear roll down one of her eyes."
                the_person.char "Thank you [mc.name]... It means so much to me, everything you've done for me... and for the shop."
            else:
                "You get up and start getting dressed. [the_person.name] calls out to you."
                the_person.char "Thank you [mc.name], for all your help. I wouldn't have made it this far without you."
            mc.name "Thanks [the_person.name]. It has been a pleasure helping you out. Please let me know if you'd like... help... again in the future with your reviews!"
            $ the_person.change_love(5)
            $ the_person.change_happiness(10)
            $ the_person.change_slut_core(3)
            $ the_person.change_slut_temp(5)
            "You go back and take a look at the camera. You accidentally left it recording! It has a recording of you and [the_person.name] fucking!"
            ...
            $ the_person.draw_person(position = "stand2")
            "[the_person.name] hops up and takes a look at the camera."
        ...
        "Refuse":  #Lol really? I guess some people may not have the stamina.
            mc.name "Sorry, I've had a long day, and I should probably get to work on editting this video."
            "She seems surprised by your answer."
            the_person.char "Oh... right, I'm sure that's going to be a lot of hard work..."
            "You chat with her for a few minutes about the details of setting up a review site, but eventually its time to say goodbye."
            the_person.char "Thanks for the help [mc.name], if you find yourself needing anything later... just ask okay?"
            $ the_person.change_love(-5)
...
label starbuck_sex_store_promo_three_label(the_person): #Cunnilingus, ends in rough sex
    ...
    "[the_person.name] gives you a bright, beaming smile."
    ...
    $ the_person.draw_person(position = "stand4")
    "[the_person.name] enters the room."
    ...
    "Wow... so at her suggestion, you are about to eat panties off of [the_person.name]... and then hand cuff her... all on camera."
    "[the_person.name] starts to strip down."
    $ strip_choice = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True)
    while strip_choice is not None:
        $ the_person.draw_animated_removal(strip_choice)
    ...
    "You step into frame next to [the_person.name]"
    the_person.char "This is [mc.name], and we are going to review some edible underwear by skinworks, and some neat fuzzy handcuffs by PowerTrips Inc..."
    "[the_person.name] gives some of the details on the products."
    the_person.char "Ok, I guess we're ready to get started! Are you ready [mc.name]?"
    "You nod. [the_person.name] lays down in the table and spreads her legs, angled in such a way that the camera can get a good view of her barely hidden pussy."
    $ the_person.draw_person(position = "missionary")
    ...
    "[the_person.name] runs her hands through your hair, gently urging your face down into her edible panty clad cunt."
    "You push your face into her mound, and begin to nibble at the gummi panties that are between your tongue and [the_person.name]'s sweet cunt."
    $ the_person.change_arousal(10)#10
    the_person.char "Mmm, how do they taste, [mc.name]?"
    ...
    the_person.char "Oh! Mmm that felt good. These panties would be good if you had a signficant other who... maybe doesn't usually like to go down on you..."
    ...
    "[the_person.name] reaches down and tears a piece of her panties off, now giving you almost free reign to eat her pussy."
    ...
    the_person.char "Yes! Mmm they actually taste pretty good, I can see why [mc.name] here is so eager..."
    $ strip_choice = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True)
    $ the_person.draw_animated_removal(strip_choice)
    $ the_person.draw_person(position = "missionary")
    "Her panties now in shreds, [the_person.name] gathers what is left of them and pulls them off."
    $ the_person.change_arousal(20)#70
    "[the_person.name]'s juices are beginning to flow freely from her slit. You lap them up before circling your tongue aroud her clit a few times."
    ...
    "[the_person.name] has stopped providing commentary and is now just moaning and encouraging you."
    the_person.char "Oh [mc.name]! That feels so good..."
    "She starts to rock her hips, grinding herself against your face."
    $ the_person.change_arousal(10)#90
    "[the_person.name] is bucking her hips wildy as you lick her. Suddenly, she grabs the back of your head and gasps."
    ...
    the_person.char "Oh fuck [mc.name], your tongue feels so good. Wow!"
    "You slowly push yourself back from her pussy. [the_person.name]'s juices are dripping down your chin. You lick up as much as you can."
    ...
    "You approach [the_person.name] with the handcuffs. She sits up and puts her hands behind her back. As you put the handcuffs on her hands, she whispers in your ear."
    the_person.char "[mc.name] that was amazing. I want you to be rough with me now. Don't worry, I can take it, and I want to show off how sturdy the cuffs are for the camera..."
    "You nod in acknowledgement. While the camera is running, you know that the real reason [the_person.name] has you here isn't for the video, but because she wants you to dominate her."
    ...
    the_person.char "So, these handcuffs are soft enough they don't hurt or dig into the skin, but they are very sturdy. [mc.name] can do whatever he wants to me now, theres no way I'll be able to break free."
    ...
    "You hold onto [the_person.name]'s hips and settle into a steady rhythm, pumping your cock in and out of her tight pussy."
    "You take a hand off of [the_person.name]'s hips and squeeze her ass cheeks with it. She moans happily in response you give her a hard slap."
    $ the_person.change_arousal(20)
    $ mc.change_arousal(20)#40
    "[the_person.name] struggles a bit against her handcuffs, but she is helpless to defend herself from your spanking."
    "[the_person.name]'s moaning intensifies rapidly, until finally she takes a sharp breath and tenses up."
    $ the_person.call_dialogue("climax_responses")
    $ the_person.change_slut_temp(5)
    $ the_person.change_slut_core(2)
    $ the_person.change_happiness(4)
    "You keep up your pace while [the_person.name] cums. With each pulse of her pussy around your cock you spank her ass."
    the_person.char "Ah!"
    ...
    the_person.char "OHHH! Fuck me [mc.name]! HOLY FUCK!"
    "[the_person.name]'s entire body begins to tremble as another orgasm hits her. Her pussy spasms wildly all around you and you can see her hips quaking."
    $ the_person.call_dialogue("climax_responses")
    $ the_person.change_slut_temp(5)
    $ the_person.change_slut_core(2)
    $ the_person.change_happiness(4)
    ...
    "[the_person.name]'s orgasm is milking your cock. It is rapidly pushing you past the point of no return."
    "You can't help but grunt with each thrust as you fuck her roughly. [the_person.name] is having trouble speaking intelligable words."
    the_person.char "[mc.name]! Oh cum for me baby... please cum! I want it so bad!"
    $ the_person.change_arousal(20)
    ...
    "You bottom out and explode deep inside of [the_person.name]. The heat of your semen painting her vaginal walls sends her into another orgasm."
    the_person.char "OH! I'M CUMMING AGAIN! YES [mc.name]!"
    $ the_person.change_slut_temp(5)
    $ the_person.change_slut_core(2)
    $ the_person.change_happiness(4)
    $ the_person.cum_in_vagina()
    $ the_person.draw_person(position = "doggy")
    "You are completely spent. [the_person.name] is a sweaty, handcuffed mess beneath you. She takes a few seconds to recover."
    ...
    "You move of the side to exit the frame. You can see in the camera your seed slowly dripping out of [the_person.name], when you press the stop button."
    mc.name "Wow, that amazing. I'd be surprised if we don't get atleast a little bit of traffic from couples out of that!"
    "[the_person.name] turns her head to look at you. You laugh when you realize you forgot to uncuff her."
    ...
    if the_person.love > 60:
        ...
        if the_person.get_opinion_score("being submissive") < 1:
            ...
            "[the_person.name] now likes being submissive!"
    the_person.char "So... I'm just gonna throw this out there. I have atleast 4 other sets of fuzzy cuffs... we could totally try them out anytime you want..."
    "[the_person.name] slowly stands up. She walks over toward you."
    $ the_person.reset_arousal()
    the_person.char "Except right now... I'm going to need some time to recover from that."
    $ the_person.draw_person(position = "kissing")
    "[the_person.name] wraps her arms around you. She kisses you twice on the neck, then whispers in your ear."
...
label starbuck_sex_store_promo_four_label(the_person): #DP, ends in ???
    ...
    "[the_person.name] stutters as she tries to figure out the best way to explain what she means."
    ...
    "[the_person.name] enters the room. When you see what she is carrying you start to get excited."
    ...
    "[the_person.name] starts to strip down in front of you."
    $ strip_choice = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True)
    while strip_choice is not None:
        $ the_person.draw_animated_removal(strip_choice)
        "You watch as [the_person.name] take off her [strip_choice.name]."
    ...
    $ the_person.draw_person()
    $ the_person.wardrobe.add_outfit(SB_advert_six_outfit.get_copy())
    mc.name "[the_person.name]... thats... you look amazing."
    "[the_person.name] gives you a wide smile."
    the_person.char "Thank you! You know I can't give ALL my investors special views like this..."
    $ the_person.draw_person(position = "back_peek")
    "[the_person.name] turns around and wiggles her hips a bit. She peeks back at you and teases."
    ...
    "You step over to the camera. When [the_person.name] is in frame you hit the record button."
    the_person.char "Hello! This is [the_person.name], from [the_person.name]'s Sex Shop! Here to review another couple of products."
    ...
    "[the_person.name] talks about the whip she has in her hand. After explaining tips and tricks to proper usage, she cues you."
    the_person.char "And now, to demonstrate proper usage, I'm going to invite [mc.name] back to help me demonstrate it..."
    ...
    "[the_person.name] bends over a chair nearby."
    ...
    "You are partially mesmerized by [the_person.name]'s ass when she bends over. In her pink lingerie, you can't wait to fuck her... you are startled when she prompts you."
    the_person.char "...[mc.name]? I said I'm ready now. Show the viewed how to use that thing!"
    "You move behind her, but at an angle so that the camera can still see what is going on."
    "For your first strike, you spank her modestly. You arent sure how much pain tolerance she has."
    "SMACK"
    ...
    "[the_person.name] wiggles her hips back and forth a couple times."
    the_person.char "Don't worry [mc.name], you can give it to me harder than that."
    ...
    "[the_person.name] wiggles her hips again."
    the_person.char "Okay [mc.name], that was about a 5 out of 10 for how hard you can spank... I want you give me a 7 this time..."
    "You'd never thought about rating how hard you swing the whip, but it makes total sense after [the_person.name] says that. It's pretty sexy the way she tells you the way she wants to get spanked..."
    ...
    the_person.char "YES! Oh [mc.name]... okay... I think the viewers get the idea now..."
    "SMACK"
    ...
    "[the_person.name] takes a second to gather her thoughts."
    ...
    "[the_person.name] explains the basics of the strap on in her hand. When she gets done talking about it, she gets down on her knees."
    ...
    "[the_person.name] gazes intently at your meat. She licks her lips and then runs her tongue along the side of it a couple times before she stands up."
    $ mc.change_arousal(5)
    $ the_person.draw_person(position = "stand4")
    ...
    "[the_person.name] takes your cock in her hand and started to lube it up. She takes the bottle and squirts some more into her hand, getting you nice and slick."
    ...
    $ the_person.draw_person(position = "doggy")
    "[the_person.name] gets down on her hands and knees and sticks her ass up in the air. Her puckered hole glistens from the lube she put on it, and her lips are puffy with arousal."
    the_person.char "[mc.name]... I want you to go slow when you put your cock in my ass... I'll guide the strap on into my vagina..."
    "Her ass looks supple and firm. You are about to fuck [the_person.name]'s ass, while a dildo penetrates her pussy. You can't believe how lucky you are to able to do this with her."
    ...
    "[the_person.name] reaches one hand between her legs and grabs the dildo. She lines it up with her other hole."
    "When you're ready you slowly push forward. It takes several seconds of steady pressure until you finally bottom out."
    the_person.char "Oh my god! I'm so full... Its so good [mc.name]! This thing is amazing..."
    ...
    "[the_person.name] is in a sex induced daze after you finish. She struggles to make a coherant end to the video."
    ...
    mc.name "Well... that was incredible. [the_person.name] if that doesn't bring in customers, I don't know what would."
    if the_person.love > 60:
        the_person.char "[mc.name]... you are amazing. Look... I'm going to be honest here. I couldn't care less about bringing in more business... I just wanted you to fuck me with that thing."
        $ the_person.draw_person(position = "stand2")
        "[the_person.name] slowly stands up. Her feet are a bit wobbly."
        the_person.char "It has been amazing having you around [mc.name]. It just feels so right every time we have sex. It almost feels wrong... recording it just to bring in more business..."
        "You decide to interrupt her."
        mc.name "[the_person.name]. It has been great being your business partner. I know what you are saying, but don't worry. I'd be doing this with you even if we weren't recording it."
        ...
        the_person.char "I can't imagine it though... doing this whole venture with anyone else as my partner. Thank you, [mc.name]."
    else:
        the_person.char "Thanks [mc.name]. That was amazing... UGH I can barely get up."
        $ the_person.draw_person(position = "stand2", emotion = "happy")
        "[the_person.name] slowly stands up. Her feet are a bit wobbly."
    "[the_person.name] rubs her ass a bit where you spanked her earlier."
    ...
    if the_person.get_opinion_score("being submissive") < 2:
        ...
        "[the_person.name] now loves being submissive!"
    if the_person.get_opinion_score("anal sex") < 1:
        $ the_person.sexy_opinions["anal sex"] = [1, True]
        "[the_person.name] now likes being anal sex!"
    ...
    $ the_person.draw_person(position = "walking_away")
    "[the_person.name] starts to walk away. She is walking a little funny."
...
label starbuck_sex_store_promo_five_label(the_person): #Swingset anal, ends in ???
    ...
    "[the_person.name] gives you a big smile."
    ...
    the_person.char "Well... I got in a special.. ermm... swingset... with straps that I can get up in, so you can fuck me in while I'm suspended up in the air..."
    mc.name "Wow... do you need help setting it up?"
    the_person.char "Yes, actually. That would be really helpful!"
    "You and [the_person.name] head to the back room. To the side of the room you can see a box that has the swing in it."
    "You pull it out and start going through the directions. It seems pretty straightforward to set up!"
    $ the_person.draw_person(position = "back_peek")
    "While working on the set up, you look over and see [the_person.name] working on something with her back to you. You walk up behind her."
    "You run your hands along her hips, admiring their shape and form."
    if the_person.love > 70:
        the_person.char "Mmm... I love it when you run your hands all over me [mc.name]."
        ...
        "[the_person.name] pushes her ass back against you. She starts to grind her hips against your hardening erection."
        $ the_person.change_arousal(20)
        the_person.char "[mc.name] it is so nice having you close... lets get done with this swing. I want you!"
    else:
        the_person.char "That feels good... Lets focus on the swing though. I need a good fucking!"
    "You get back to work. It isn't long until the whole thing is finished. You stand with [the_person.name] and admire your handywork."
    $ the_person.draw_person(position = "stand3")
    the_person.char "Alright. Before we get started, let me get ready. You should probably get naked too!"
    "You start to strip down, but watch intently while [the_person.name] strips down along side you."
    $ strip_choice = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True)
    while strip_choice is not None:
        $ the_person.draw_animated_removal(strip_choice)
        "You watch as [the_person.name] take off her [strip_choice.name]."
        $ strip_choice = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True)
    "Now that she is naked, [the_person.name] grabs some of her anal lube of a shelf. You raise an eyebrow as she squirts some onto her hand."
    mc.name "Anal lube? Wow... going all out are we?"
    "[the_person.name] chuckles as she reaches back and starts to spread the lube around her backside."
    ...
    "[the_person.name] walks over to you and starts lubing up your cock. It feels great when she gives you a couple of strokes."
    the_person.char "Okay! I'm ready to do this! Go ahead and start up the camera, this is gonna be great!"
    "You step behind the camera. You make sure everything is in frame, then hit record. You give [the_person.name] a thumbs up."
    ...
    "[the_person.name] starts talking about the swing set. As she talks, she is using hand gestures to illustrate some of the set up methods."
    ...
    $ the_person.draw_person(position = "sitting")
    the_person.char "And now to help me demonstrate one of the ways you could use it, the always amazing [mc.name]!"
    ...
    "[the_person.name] forces herself to relax her sphincter, and you penetrate her with wonderful pop. With more gentle pressure you are soon deep inside her bowel."
    ...
    "The feeling is exquisite. You grab her hips and get ready to fuck [the_person.name]'s brains out."
    #Call sex scene#
    ...
    "Turning off the video camera, you turn to [the_person.name]."
    $ the_person.shop_investment_rate = 6.0
    mc.name "Wow, that was good. You are so sexy."
    the_person.char "Aww, thanks [mc.name]. Now, I promised that if you helped me make the video, I'd give you a swing for you to have."
    ...
    "[the_person.name] gives you a big hug."
    ...
    $ the_person.draw_person(position = "stand4")
    "You and [the_person.name] head back to your place. Having already put one together, you and her quick have it all set up."
    ...
    if the_person.love > 70:
        ...
        the_person.char "[mc.name], getting this shop up and running... and everything you've done for me. You really don't have any idea how much it all means to me. Thank you so much!"
        $the_person.draw_person(position = "kissing")
        "She wraps her arms around you and hugs you close."
        the_person.char "Look... I don't know any other way of saying this, so I'm just gonna say it. I'm falling for you, [mc.name]. And I know you have a busy job and theres other girls and I'm not saying..."
        ...
        menu:
            "It's mutual.":
                mc.name "Don't worry, [the_person.name]. The feeling is mutual. I love spending time with you."
                $ the_person.draw_person(position = "stand2", emotion = "happy")
                ...
                mc.name "Thanks [the_person.name]. It will be nice to be able to share a warm bed with a beautiful woman like you once in a while."
                $the_person.draw_person(position = "kissing")
                "She hugs you again and begins kissing you on your neck."
                the_person.char "You make me feel so good, [mc.name]... come visit me soon okay?"
                $ the_person.shop_owner_relationship_stage = 1.0
                "NOTE FROM THE AUTHOR: This is the final event in Starbuck's storyline... for now..."
            #TODO its not mutual
    $the_person.draw_person(position = "stand2")
    the_person.char "Okay, its time for me to get to the shop. See you soon [mc.name]!"
    "You walk her to the door and say goodbye. Wow, you are now the proud owner of a sex swing! And with everything going on with [the_person.name], you brain is swimming a bit."
...
label starbuck_intro():
    ...
    if SB_STARBUCK_INTRO_COMPLETE == 0:
        ...
        "You smile at [starbuck.name] and promise to take a look."
        starbuck.char "Sounds great, [mc.name]! I'll be here if you have any questions!"
        hide screen person_info_ui
    elif (starbuck.shop_progress_stage) == 1:
        starbuck.char "Hey there, [mc.name]! Its good to see you!"
        if the_person.sluttiness > 60:
            "[the_person.name] smiles playfully."
        ...
        starbuck.char "[mc.name]! I'm so glad to see you! This place is starting to do really well, thanks to you!"
        if the_person.sluttiness > 60:
            "[the_person.name] smiles playfully."
        ...
        starbuck.char "[mc.name]! Thanks for checking in! Thing are going amazing here, all thanks to you and your generous investments!"
        if the_person.sluttiness > 60:
            "[the_person.name] smiles playfully."
...
label starbuck_greetings(the_person):
    if SB_STARBUCK_INTRO_COMPLETE == 1:
        if the_person.obedience > 130:
            if the_person.sluttiness > 60:
                the_person.char "Welcome back [mc.name], can I help you with something?"
                "[the_person.name] crosses her arms behind her back."
            else:
                the_person.char "Hello sir. Welcome to Starbuck's sex shop!"
        else:
            if the_person.sluttiness > 60:
                the_person.char "Oh hey [mc.name], can I help you with something?"
                "[the_person.name] smiles playfully."
...
label starbuck_clothing_reject(the_person):
    if the_person.obedience > 140:
        the_person.char "Oh, I wish I could wear this [mc.name], but even at a sex shop you can go too far..."
    else:
        if the_person.sluttiness > 60:
            the_person.char "Oh my god [mc.name]... It's hot, but I can't wear this here!"
        else:
            the_person.char "Oh my god [mc.name], an outfit like that should only be worn in private!"
    return

label starbuck_clothing_review(the_person):
    if the_person.obedience > 130:
        the_person.char "Sorry [mc.name], I should really get myself dressed properly again! Just a second!"
    else:
...
label starbuck_strip_reject(the_person):
    if the_person.obedience > 130:
        ...
        the_person.char "Sorry [mc.name], but I love being a tease. I'm going to leave that on for a bit."
    else:
        the_person.char "I can't take that off right now [mc.name]!"
    return

label starbuck_sex_accept(the_person):
    if the_person.sluttiness > 70:
        if the_person.obedience < 100:
            "[the_person.name] gives you a wink."
            the_person.char "I was thinking the same thing!"
        else:
            the_person.char "You want to do that with me, [mc.name]? You're lucky I'm just as perverted."
    else:
...
label starbuck_sex_obedience_accept(the_person):
    if the_person.sluttiness > 70:
        the_person.char "Oh god [mc.name], I don't think I could do this for anyone else..."
...
label starbuck_sex_gentle_reject(the_person):
    if the_person.sluttiness > 50:
        ...
        the_person.char "I... we can't do that [mc.name]. You're one of my customers, after all!"
    return
...
label starbuck_seduction_response(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 50:
            the_person.char "What's up [mc.name]? Do you need any help testing the merchandise?"
        else:
        ...
        if the_person.sluttiness > 50:
            ...
            the_person.char "I... what do you mean [mc.name]?"
    return

label starbuck_seduction_accept_crowded(the_person):
    if the_person.sluttiness < 20:
        "[the_person.name] grabs your arm and smiles."
        the_person.char "That sounds great. Let's head to the backroom and get started... let's at least find someplace quiet."

    elif the_person.sluttiness < 50:
        the_person.char "I... I mean, we shouldn't do anything like that without atleast going to the back room... right?"
...
label starbuck_seduction_accept_alone(the_person):
    if the_person.sluttiness < 20:
        ...
        the_person.char "Oh [mc.name], I can't wait!"
    return

label starbuck_seduction_refuse(the_person):
    if the_person.sluttiness < 20:
        "[the_person.name] blushes and looks away from you awkwardly."
        the_person.char "I, uh... Sorry [mc.name], I just don't feel that way about you."

    elif the_person.sluttiness < 50:
        the_person.char "Oh, it's tempting, but I'm just not feeling like it right now. Maybe some other time?"
        "[the_person.name] smiles and gives you a wink."

    else:
        "[the_person.name] looks at you and frowns"
        the_person.char "It's so, so tempting, but I've had a rough day and just don't feel up to it right now [mc.name]. Hold onto that thought though."
    return
...
label starbuck_cum_mouth(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 60:
            the_person.char "Oh god, you taste so good. Thank you for the treat [mc.name]."
        else:
            the_person.char "Mmm, thank you sir. Feel free to browse while I clean myself up!"
    else:
        if the_person.sluttiness > 80:
            the_person.char "Mmm, your cum tastes so great [mc.name], are you sure there isn't any more of it for me?"
            "[the_person.name] licks her lips and sighs happily."
        else:
            "[the_person.name] licks her lips and smiles at you."
...
label starbuck_talk_busy(the_person):
    if the_person.obedience > 120:
        the_person.char "I wish I could talk more, but I have other customers. Can we talk later [mc.name]?"
    else:
...
label starbuck_sex_watch(the_person, the_sex_person, the_position):
    if the_person.sluttiness < the_position.slut_requirement - 20:
        ...
        $ the_person.change_happiness(-1)
        "[the_person.name] tries to avert her gaze and ignore you and [the_sex_person.name] [the_position.verb]."
        ...
        "[the_person.name] watches for a moment, then turns away  while you and [the_sex_person.name] keep [the_position.verb]."
        ...
        "[the_person.name] watches you and [the_sex_person.name] [the_position.verb]."

    else:
        $ the_person.draw_person(emotion = "happy")
        the_person.char "Come on [mc.name], [the_sex_person.name] is going to fall asleep at this rate! You're going to have to give her a little more than that."
        "[the_person.name] watches eagerly while you and [the_sex_person.name] [the_position.verb]."
    return

label starbuck_being_watched(the_person, the_watcher, the_position):
    if the_person.sluttiness >= the_position.slut_cap and the_watcher.sluttiness >= the_position.slut_cap:
        #They agree you should give it to her harder
        the_person.char "I can handle it [mc.name]. Let's show [the_watcher.name] how it's done!"
        ...
        the_person.char "Oh [mc.name], [the_wather.name] is watching you fuck my brains out!"
        $ the_person.change_arousal(2)
        "[the_person.name] seems turned on by [the_watcher.name] watching you and her [the_position.verb]."

    elif the_person.sluttiness < the_position.slut_cap and the_watcher.sluttiness < the_position.slut_requirement:
        #She's into it but shamed by the prude watching her.
        the_person.char "Fuck [mc.name], maybe we should have gone to the back room?"
        $ the_person.change_arousal(-1)
        $ the_person.change_slut_temp(-1)
        "[the_person.name] seems uncomfortable with [the_watcher.name] nearby."
