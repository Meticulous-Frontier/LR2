...
label intro_SB_cum_fetish_blowjob(the_girl, the_location, the_object, the_round):
    "[the_girl.name] eagerly begins opening your pants. She pulls out your cock and gives it a few gentle strokes."
    the_girl.char "How about I take care of this for you?"
    "[the_girl.name] looks up at your from her knees. She looks you right in the eyes as she leans foward and slides her lips over the tip of your dick."
...
label scene_SB_cum_fetish_blowjob_1(the_girl, the_location, the_object, the_round):
    ...
    menu:
            "Talk dirty to her.":
                ...
                "[the_girl.name] strokes you a few more times with her skill mouth. She twirls her tongue around the tip a few times before taking a second to respond."
            ...
            "Stay quiet.":
                ...
                "With a little encouragement, you pull [the_girl.name]'s head down a little further with each stroke."
                if the_girl.get_opinion_score("masturbating") > 0:
                    if the_girl.outfit.vagina_available():
                        "[the_girl.name] puts a hand between her legs and starts to touch herself while she she blows you."
                        ...
                        if the_girl.arousal > 60:
                            "[the_girl.name] puts a hand between her legs and eagerly rubs at her crotch through her clothing."
                        else:
                            "[the_girl.name] puts a hand between her legs and rubs at her crotch absentmindedly."
                else:
                    "[the_girl.name] keeps up a steady pace, bobbing her head back and forth and running your cock in and out of her soft mouth."
...
label scene_SB_cum_fetish_blowjob_2(the_girl, the_location, the_object, the_round):
    ...
    "When [the_girl.name] opens her mouth and resumes blowing you, you put your hand on the back of her head, intent to push yourself down her throat."
    if the_girl.get_opinion_score("being submissive") > 0:
            "[the_girl.name] looks up at you. You can see her pupils dilate as you slowly pull her head towards you, until your cock is buried in her throat."
            "[the_girl.name]'s knees quiver while her throat spasms around your shaft. You hold her deep while her body twitches with pleasure."
            ...
            "[the_girl.name] grabs your hands in hers. She holds your hands as she looks up at you, making eye contant."
            ...
            "Still making eye contact, [the_girl.name] begins to bob her head up and down, completely deepthroating you with every stroke."
            ...
            "[the_girl.name] turns her eyes up and meets your gaze. She eagerly swallows as your push yourself down her throat, her tongue eagerly licking at the bottom of your shaft."
            mc.name "Fuck that feels good [the_girl.name]."
...
label outro_SB_cum_fetish_blowjob(the_girl, the_location, the_object, the_round):
    ...
    if the_girl.get_opinion_score("drinking cum") > the_girl.get_opinion_score("cum facials"):
        "[the_girl.name] moans and looks you in the eyes. She pulls off until just the  tip of your cock is in her mouth and she begins to stroke out off eagerly."
        ...
        "[the_girl.name] is moaning uncontrollably around your spasming cock."
        $ the_girl.cum_in_mouth()
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
        if the_girl.arousal > 100:
            "[the_girl.name]'s legs quiver as she convulses. She is so addicted to your cum, blowing in her mouth has set off another orgasm for her."
            $ the_girl.change_obedience(5*the_girl.get_opinion_score("drinking_cum"))
        "Once you've had a second to recover, [the_girl.name] closes her mouth and swallows loudly. It takes a few big gulps to get every last drop of your cum down, but when she opens up again it's all gone."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
        $ the_girl.call_dialogue("cum_mouth")

    else:
        "[the_girl.name] moans and looks you in the eyes. She pulls off your cock and strokes you eagerly, waiting for the first splash across her face."
        ...
        "[the_girl.name] moans uncontrollably with every spurt"
        $ the_girl.discover_opinion("cum facials")
        $ the_girl.cum_on_face()
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
        if the_girl.arousal > 100:
            "[the_girl.name]'s legs quiver as she convulses. She is so addicted to your cum, blowing on her face has set off another orgasm for her."
            $ the_girl.change_obedience(5*the_girl.get_opinion_score("drinking_cum"))
        "Slowly recovering, you look at [the_girl.name]'s cum covered face. Her eyes are closed and she is absentmindedly playing with some of the cum that is starting to run down her neck."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
...
label strip_SB_cum_fetish_blowjob(the_girl, the_clothing, the_location, the_object, the_round):
    ...
    "[the_girl.name] pops off your cock and looks up at you."
    $ the_girl.call_dialogue("sex_strip")
    $ the_girl.draw_animated_removal(the_clothing)
    "[the_girl.name] stands and strips off her [the_clothing.name]. She drops it to the ground, then gets back on her knees and slides your cock inside her mouth."
    $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
    $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
    return
...
label strip_ask_SB_cum_fetish_blowjob(the_girl, the_clothing, the_location, the_object, the_round):
    ...
    "[the_girl.name] pops off your cock and looks up at you from her knees."
    ...
    menu:
        "Let her strip.":
            ...
            "[the_girl.name] stands up and strips out of her [the_clothing.name]. Then she gets back onto her knees and slides your cock all the way to the back of her mouth."
            $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
            $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
...
label orgasm_SB_cum_fetish_blowjob(the_girl, the_location, the_object, the_round):
    $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
    $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
    "[the_girl.name] pauses suddenly. You hear her whimper softly - the noise party muffled by your cock."

    "[the_girl.name] starts to pull back off of your cock. You place a firm hand on the back of her head."
    mc.name "Did I tell you to stop sucking, you dirty little slut?"
    "You push her back down, hard. [the_girl.name] keeps her mouth open wide and fits you all the way in, quivering as she climaxes."
    mc.name "A cock sleeve like you deserves to have her throat stuffed when she cums."
    if the_girl.get_opinion_score("being submissive") > 0:
        if the_girl.sluttiness > the_girl.core_sluttiness and the_girl.core_sluttiness < SB_cum_fetish_blowjob.slut_cap:
        ...
        "[the_girl.name] closes her eyes tight. You can feel her throat spasm around your shaft in time with her orgasmic contractions."
        if the_girl.outfit.vagina_visible():
            "You can see that [the_girl.name]'s pussy is dripping wet as she cums."
        else:
            $ top_piece = the_girl.outfit.get_lower_ordered()[-1]
            if top_piece.underwear:
                "[the_girl.name]'s dripping wet pussy has managed to soak through her underwear, leaving a wet mark on her [top_piece.name]."
            else:
                "[the_girl.name] clenches her thighs together and rides out her orgasm."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
        "When she's stopped twitching and moaning you let [the_girl.name] slide back. She pants loudly, then licks along the length of your cock."
        the_girl.char "That was... incredible... Okay, I came... now its your turn!"
        "She slides you back into her mouth and presses you all the way to the back, rubbing your tip against the back of her throat for a second before she goes back to blowing you."
    else:
        "[the_girl.name] closes her eyes as her orgasm peaks. She holds almost perfectly still, your dick still sitting in her mouth, until she's finished."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
