...
label intro_SB_cum_fetish_blowjob(the_girl, the_location, the_object, the_round):
    "[the_girl.title] eagerly begins opening your pants. She pulls out your cock and gives it a few gentle strokes."
    the_girl.char "How about I take care of this for you?"
    "[the_girl.title] looks up at your from her knees. She looks you right in the eyes as she leans foward and slides her lips over the tip of your dick."
...
label scene_SB_cum_fetish_blowjob_1(the_girl, the_location, the_object, the_round):
    ...
    menu:
            "Talk dirty to her.":
                ...
                "[the_girl.title] strokes you a few more times with her skill mouth. She twirls her tongue around the tip a few times before taking a second to respond."
            ...
            "Stay quiet.":
                ...
                "With a little encouragement, you pull [the_girl.title]'s head down a little further with each stroke."
...
label scene_SB_cum_fetish_blowjob_2(the_girl, the_location, the_object, the_round):
    ...
    "When [the_girl.title] opens her mouth and resumes blowing you, you put your hand on the back of her head, intent to push yourself down her throat."
    if the_girl.get_opinion_score("being submissive") > 0:
            "[the_girl.title] looks up at you. You can see her pupils dilate as you slowly pull her head towards you, until your cock is buried in her throat."
            "[the_girl.title]'s knees quiver while her throat spasms around your shaft. You hold her deep while her body twitches with pleasure."
            ...
            "[the_girl.title] grabs your hands in hers. She holds your hands as she looks up at you, making eye contant."
            ...
            "Still making eye contact, [the_girl.title] begins to bob her head up and down, completely deepthroating you with every stroke."
            ...
            "[the_girl.title] turns her eyes up and meets your gaze. She eagerly swallows as your push yourself down her throat, her tongue eagerly licking at the bottom of your shaft."
...
label outro_SB_cum_fetish_blowjob(the_girl, the_location, the_object, the_round):
    ...
    if the_girl.get_opinion_score("drinking cum") > the_girl.get_opinion_score("cum facials"):
        "[the_girl.title] moans and looks you in the eyes. She pulls off until just the  tip of your cock is in her mouth and she begins to stroke out off eagerly."
        ...
        "[the_girl.title] is moaning uncontrollably around your spasming cock."
        $ the_girl.cum_in_mouth()
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
        if the_girl.arousal > 100:
            "[the_girl.title]'s legs quiver as she convulses. She is so addicted to your cum, blowing in her mouth has set off another orgasm for her."
            $ the_girl.change_obedience(5*the_girl.get_opinion_score("drinking_cum"))
        "Once you've had a second to recover, [the_girl.title] closes her mouth and swallows loudly. It takes a few big gulps to get every last drop of your cum down, but when she opens up again it's all gone."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
        $ the_girl.call_dialogue("cum_mouth")

    else:
        "[the_girl.title] moans and looks you in the eyes. She pulls off your cock and strokes you eagerly, waiting for the first splash across her face."
        ...
        "[the_girl.title] moans uncontrollably with every spurt"
        $ the_girl.discover_opinion("cum facials")
        $ the_girl.cum_on_face()
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
        if the_girl.arousal > 100:
            "[the_girl.title]'s legs quiver as she convulses. She is so addicted to your cum, blowing on her face has set off another orgasm for her."
            $ the_girl.change_obedience(5*the_girl.get_opinion_score("drinking_cum"))
        "Slowly recovering, you look at [the_girl.title]'s cum covered face. Her eyes are closed and she is absentmindedly playing with some of the cum that is starting to run down her neck."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
...
label transition_SB_cum_fetish_blowjob_blowjob(the_girl, the_location, the_object, the_round):
    $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
    $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
    "[the_girl.title] gets onto her knees in front of you and takes your hard cock in her hands. She strokes it tentativly a few times, then leans in and slides the tip into her mouth."
...
label strip_SB_cum_fetish_blowjob(the_girl, the_clothing, the_location, the_object, the_round):
    ...
    "[the_girl.title] stands and strips off her [the_clothing.name]. She drops it to the ground, then gets back on her knees and slides your cock inside her mouth."
    $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
    $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
    return
...
label strip_ask_SB_cum_fetish_blowjob(the_girl, the_clothing, the_location, the_object, the_round):
    ...
    menu:
        "Let her strip.":
            ...
            "[the_girl.title] stands up and strips out of her [the_clothing.name]. Then she gets back onto her knees and slides your cock all the way to the back of her mouth."
            $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
            $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
...
label orgasm_SB_cum_fetish_blowjob(the_girl, the_location, the_object, the_round):
    ...
    "[the_girl.title] starts to pull back off of your cock. You place a firm hand on the back of her head."
    ...
    if the_girl.get_opinion_score("being submissive") > 0:
        ...
        "[the_girl.title] closes her eyes tight. You can feel her throat spasm around your shaft in time with her orgasmic contractions."
        ...
        "[the_girl.title] closes her eyes as her orgasm peaks. She holds almost perfectly still, your dick still sitting in her mouth, until she's finished."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_girl)
