...
label SB_fetish_vaginal_family_threesome_label():
    ...
    menu:
        ...
        "Strip first":
            ...
            the_person_one.char "Aww, does my [the_person_one.mc_title] wanna see his sister get naked for him? What a pervert!"
    ...
    the_person_two.char "Is that... [the_person_one.name]!?! What are you... why are you naked? In your brother's room?"
