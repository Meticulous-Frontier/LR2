...
label SB_fetish_vaginal_family_threesome_label():
    ...
    the_person_one.char "Hey bro, you still up? I was just wondering if I could come in for a bit?"
    ...
    menu:
        "Not tonight":
            ...
            the_person_one.char "Whatever bro... see you in the morning I guess?"
        ...
        "Strip first":
            ...
            "[the_person_one.title] smiles at you."
            the_person_one.char "Aww, does my brother wanna see his sister get naked for him? What a pervert!"
            "[the_person_one.title] winks at you before beginning her routine."
    ...
    "You are so busy checking out your sister, your brain barely registers a knock on your door. Lily is just sitting down in your lap when you hear a gasp from your door."
    ...
    the_person_two.char "Is that... [the_person_one.title]!?! What are you... why are you naked? In your brother's room?"
    "Your mom is shocked to discover you and Lily in your room, clearly about to get busy."
    the_person_one.char "Mom! Nothing was... wait... what are you wearing?"
    "Your mother quickly realizes that Lily is here... doing exactly what she was coming here to do. Her cheeks turn red with embarassment."
    "You think quickly. Maybe you can salvage this situation?"
    mc.name "Hey mom... you look amazing! Want to come in for a little bit? [the_person_one.title] and I are just getting started."
    "You can see a clear look of conflict in your mom's eyes. Up until now, your antics have been isolated to you and her, in her mind anyway. She's slowly processing that you have a similar relationship with [the_person_one.title]"
    the_person_two.char "I mean... I suppose I could... for a bit..."
    "Still in a bit of a daze, your mom comes into your room, closing the door behind her. She sits over at your desk and looks over at you and [the_person_one.title]."
    $ SB_draw_two_person_scene(person_one = the_person_one, person_two = the_person_two, one_pos_x = 0.7, two_position = "sitting")
    "[the_person_one.title] looks back at you, still a little unsure of herself. You stand up and move in close to her."
    ...
    the_person_two.char "Oh my... [mc.name]... [the_person_one.title]..."
    ...
    "You glance over at your mom. She is watching you and Lily intently and has one hand between her legs, stroking the outer lips of her pussy."
    ...
    "Wow, you just had sex with [the_person_one.title] and [the_person_two.title]! You can't believe how lucky you are."
    ...
    "Lily says goodnight and then turns to leave."
