...
label intro_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    "You run your hands along [the_person.title]'s hips. You grab her ass and pull her close to you."
    ...
    "[the_person.title] opens her legs wide as your get to her cunt. You breath in sharply through your nose, enjoying the tangy, musky scent of her arousal."
    if the_person.arousal > 50:
        "[the_person.title]'s pussy lips are engorged. They glisten with moisture from her excitement. You can't wait to taste it."
    else:
        "[the_person.title]'s pussy is like a pristine flower. You can't wait to taste it."
    "A moan escapes her lips as you run your tongue up [the_person.title]'s slit."
    return

label scene_SB_Oral_Laying_1(the_person, the_location, the_object, the_round):
    ...
    if the_person.arousal > 70:
        ...
        "[the_person.title]'s pussy is still getting wet. You lick it slow, giving her time to warm up."

    menu:
        "Finger Her.":
            #Generic choice with bonus based on girl opinion and MC foreplay skill
            "As you continue to lick all around [the_person.title]'s cunt, you slowly push a finger up inside of her."
            if mc.sex_skills["Foreplay"] > 2:
                ...
                if the_person.get_opinion_score("being fingered") > 0:
                    ...
                    $ the_person.change_arousal(the_person.get_opinion_score("being fingered") + mc.sex_skills["Foreplay"])
                the_person.char "[the_person.mc_title]! Oh [the_person.mc_title] that feels so good."
                ...
                "You do your best to split your focus between kissing [the_person.title]'s pussy and fingering her, but you find yourself struggling to do both."
                "You take a break from licking her and focus pleasing her with your finger for a bit."
                if the_person.get_opinion_score("being fingered") > 0:
                    $ the_person.discover_opinion("being fingered")
                    $ the_person.change_arousal(the_person.get_opinion_score("being fingered"))
                    the_person.char "Mmmm, I love it when you stick your fingers inside me..."
                else:
                    "[the_person.title] enjoys your fingering, but soon you feel her hands running through your hair. She's lightly pulling your head down, trying to get you to resume licking her."
        ...
        "Push Your Tongue Deep.":
            ...
            if mc.sex_skills["Oral"] > 3:
                ...
                if the_person.get_opinion_score("taking control") > 0:
                    "[the_person.title] puts her hand on the back of your head, urging your tongue deeper and your nose more firmly against her clit."
                    "She starts to rock her hips, grinding herself against your face."
                    the_person.char "Mmm, that's it [the_person.mc_title]! Fuck that feels good!"
                ...
                "[the_person.title] moans and trembles as you please her."
            else:
                ...
                "[the_person.title] puts her hand on the back of your head. She starts to pull your head back a bit, guiding you back to her clit."
                the_person.char "That feels good [the_person.mc_title], but it feels even better when you kiss me here..."
                "You accept her guidance and begin to lick and suck at her clit again."
    if mc.arousal > 70:
        "[the_person.title]'s constant moans and gasps are incredibly arousing. You can't help but stroke yourself as you eat her out."
        "You should probably fuck her soon before you cum in your pants!"
    elif mc.arousal > 40:
        "[the_person.title]'s moaning and heavy breathing are arousing. You give yourself a couple strokes through your clothes while you eat her."
    else:
        "While you aren't being stimulated, [the_person.title]'s gasps and breathing are starting to turn you on."
    return

label scene_SB_Oral_Laying_2(the_person, the_location, the_object, the_round):
    # CHOICE CONCEPT: Submit // Control her
    "[the_person.title]'s hips are beginng to rock side to side, grinding against you as you lick her."
    ...
    "It feels like [the_person.title] is trying to take control!"
    menu:
        "Let Her Take Control":
            "You take her enthusiasm as a sign that you must be doing well. You double down on her clit, sucking and licking at it."
            if the_person.get_opinion_score("taking control") > 0:
                "[the_person.title] uses the leverage her legs give her, wrapped around your back, to force your face down into her cunt roughly."
                "She starts to rock her hips, grinding herself against your face."
                the_person.char "Mmm, that's it [the_person.mc_title]! Fuck that feels good!"
                $ the_person.discover_opinion("taking control")
                $ the_person.change_arousal(the_person.get_opinion_score("taking control") * 3)
        ...
        "Subdue Her":
            ...
            if the_person.get_opinion_score("being submissive") > 0:
                the_person.char "Sorry! But maybe you should spank me... I've been a pretty bad girl lately."
                "You give her pussy a moderate spank."
                mc.name "I wasn't talking about your ass."
                "[the_person.title] quivers at your rough touch and words. She pretends she doesn't like it."
                the_person.char "Sorry sir! It won't happen again, I promise!"
            else:
                the_person.char "Sorry! It won't happen again!"
    ...
    if mc.arousal > 70:
        "[the_person.title]'s constant moans and gasps are incredibly arousing. You can't help but stroke yourself as you ear her out."
        "You should probably fuck her soon before you cum in your pants!"
    elif mc.arousal > 40:
        "[the_person.title]'s moaning and heavy breathing are arousing. You give yourself a couple strokes through your clothes while you eat her."
    else:
...
label outro_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    ...
    "You get to hear every little gasp and moan from [the_person.title] as you lick up and down her cunt. As you stroke yourself you accidentally push yourself past the point of no return."

    "You finally let out a low moan and hold [the_person.title] close. A shiver runs up your spine as your climax, shooting your load out into your underwear."
...
label transition_default_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    "You put [the_person.title] on her back and lie down on top of her, lining your hard cock up with her tight cunt."
...
label strip_SB_Oral_Laying(the_person, the_clothing, the_location, the_object, the_round):
    $ the_person.call_dialogue("sex_strip")
    $ the_person.draw_animated_removal(the_clothing, position = SB_Oral_Laying.position_tag)
...
label strip_ask_SB_Oral_Laying(the_person, the_clothing, the_location, the_object, the_round):
    the_person.char "Sir, I'd like to take off my [the_clothing.name], would you mind?"
    "[the_person.title] pants as you lick her."
    menu:
        "Let her strip.":
...
label orgasm_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    ...
    the_person.char "Oh fuck [the_person.mc_title], your tongue feels so good."
    return

label transition_SB_Oral_Laying_missionary(the_person, the_location, the_object, the_round):
    "You push yourself up on your hands, satisfied with the licking you gave her pussy. You slowly start to crawl up [the_person.title]'s body."
    "[the_person.title] wraps her arms around you and holds you close as you line your cock up with her pussy. She sighs happily into your ear as you slide into her."
    if the_person.arousal > 100:
...
label transition_missionary_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    ...
    "[the_person.title] opens her legs wide as your get to her cunt. You breath in sharply through your nose, enjoying the tangy, musky scent of her arousal."
    if the_person.arousal > 50:
        "[the_person.title]'s pussy lips are engorged. They glisten with moisture from your previous fucking. You can't wait to taste it."
    else:
        "[the_person.title]'s pussy is like a pristine flower. You can't wait to taste it."
    "A moan escapes her lips as you run your tongue up [the_person.title]'s slit."
    return
