...
label intro_SB_Oral_Laying(the_girl, the_location, the_object, the_round):
    "You run your hands along [the_girl.name]'s hips. You grab her ass and pull her close to you."
    ...
    "[the_girl.name] opens her legs wide as your get to her cunt. You breath in sharply through your nose, enjoying the tangy, musky scent of her arousal."
    if the_girl.arousal > 50:
        "[the_girl.name]'s pussy lips are engorged. They glisten with moisture from her excitement. You can't wait to taste it."
    else:
        "[the_girl.name]'s pussy is like a pristine flower. You can't wait to taste it."
    "A moan escapes her lips as you run your tongue up [the_girl.name]'s slit."
    return
...
label scene_SB_Oral_Laying_1(the_girl, the_location, the_object, the_round):
    ...
    if the_girl.arousal > 70:
        "[the_girl.name]'s juices are beginning to flow freely from her slit. You lap them up before circling your tongue aroud her clit a few times."
    else:
        "[the_girl.name]'s pussy is still getting wet. You lick it slow, giving her time to warm up."

    menu:
        "Finger Her.":
            #Generic choice with bonus based on girl opinion and MC foreplay skill
            "As you continue to lick all around [the_girl.name]'s cunt, you slowly push a finger up inside of her."
            if mc.sex_skills["Foreplay"] > 2:
                ...
                "You do your best to split your focus between kissing [the_girl.name]'s pussy and fingering her, but you find yourself struggling to do both."
                ...
                if the_girl.get_opinion_score("being fingered") > 0:
                    ...
                    "[the_girl.name] enjoys your fingering, but soon you feel her hands running through your hair. She's lightly pulling your head down, trying to get you to resume licking her."
        ...
        "Push Your Tongue Deep.":
            ...
            if mc.sex_skills["Oral"] > 3:
                ...
                if the_girl.get_opinion_score("taking control") > 0:
                    "[the_girl.name] puts her hand on the back of your head, urging your tongue deeper and your nose more firmly against her clit."
                ...
                "[the_girl.name] moans and trembles as you please her."
            else:
                ...
                "[the_girl.name] puts her hand on the back of your head. She starts to pull your head back a bit, guiding you back to her clit."
    ...
    if mc.arousal > 70:
        "[the_girl.name]'s constant moans and gasps are incredibly arousing. You can't help but stroke yourself as you eat her out."
        "You should probably fuck her soon before you cum in your pants!"
    elif mc.arousal > 40:
        "[the_girl.name]'s moaning and heavy breathing are arousing. You give yourself a couple strokes through your clothes while you eat her."
    else:
        "While you aren't being stimulated, [the_girl.name]'s gasps and breathing are starting to turn you on."
    return

label scene_SB_Oral_Laying_2(the_girl, the_location, the_object, the_round):
    # CHOICE CONCEPT: Submit // Control her
    "[the_girl.name]'s hips are beginng to rock side to side, grinding against you as you lick her."
    ...
    "It feels like [the_girl.name] is trying to take control!"
    menu:
        "Let Her Take Control":
            "You take her enthusiasm as a sign that you must be doing well. You double down on her clit, sucking and licking at it."
            if the_girl.get_opinion_score("taking control") > 0:
                "[the_girl.name] uses the leverage her legs give her, wrapped around your back, to force your face down into her cunt roughly."
                "She starts to rock her hips, grinding herself against your face."
                the_girl.char "Mmm, that's it [mc.name]! Fuck that feels good!"
                $ the_girl.discover_opinion("taking control")
                $ the_girl.change_arousal(the_girl.get_opinion_score("taking control") * 3)
        ...
        "Subdue Her":
            ...
            if the_girl.get_opinion_score("being submissive") > 0:
                ...
                "[the_girl.name] quivers at your rough touch and words. She pretends she doesn't like it."
    ...
    if mc.arousal > 70:
        "[the_girl.name]'s constant moans and gasps are incredibly arousing. You can't help but stroke yourself as you ear her out."
        "You should probably fuck her soon before you cum in your pants!"
    elif mc.arousal > 40:
        "[the_girl.name]'s moaning and heavy breathing are arousing. You give yourself a couple strokes through your clothes while you eat her."
    else:
...
label outro_SB_Oral_Laying(the_girl, the_location, the_object, the_round):
    ...
    "You get to hear every little gasp and moan from [the_girl.name] as you lick up and down her cunt. As you stroke yourself you accidentally push yourself past the point of no return."
...
label strip_ask_SB_Oral_Laying(the_girl, the_clothing, the_location, the_object, the_round):
    ...
    "[the_girl.name] pants as you lick her."
    menu:
        "Let her strip.":
...
label orgasm_SB_Oral_Laying(the_girl, the_location, the_object, the_round):
    "[the_girl.name] is bucking her hips wildy as you lick her. Suddenly, she grabs the back of your head and gasps."
...
label transition_SB_Oral_Laying_missionary(the_girl, the_location, the_object, the_round):
    "You push yourself up on your hands, satisfied with the licking you gave her pussy. You slowly start to crawl up [the_girl.name]'s body."
...
label transition_missionary_SB_Oral_Laying(the_girl, the_location, the_object, the_round):
    ...
    "[the_girl.name] opens her legs wide as your get to her cunt. You breath in sharply through your nose, enjoying the tangy, musky scent of her arousal."
    if the_girl.arousal > 50:
        "[the_girl.name]'s pussy lips are engorged. They glisten with moisture from your previous fucking. You can't wait to taste it."
    else:
        "[the_girl.name]'s pussy is like a pristine flower. You can't wait to taste it."
    "A moan escapes her lips as you run your tongue up [the_girl.name]'s slit."
    return
