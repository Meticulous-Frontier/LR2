...
label intro_SB_anal_swing(the_girl, the_location, the_object, the_round):
    "[the_girl.name] sits down in the [the_object.name]. Her ass is hanging off the back end."
    ...
    if SB_get_fetish(the_girl) == "Anal Fetish":
        if the_girl == mom:
            ...
            "You work your cock up and down [the_girl.name]'s slit a few times, her wetness lubricating it."
            "You lean forward and whisper into her ear."
            ...
            "[the_girl.name] begs you not to stick it in her pussy."
...
label scene_SB_anal_swing_1(the_girl, the_location, the_object, the_round):
    "Your hips slap against [the_girl.name]'s as you plunder her rectum. You keep a slow but steady pace."
    "With each bounce in the swing, [the_girl.name]'s ass pulls off you almost completely, but you grab the ropes of the swing and forcefully slam her ass back into you."
    $ the_girl.call_dialogue("sex_responses")

    if SB_get_fetish(the_girl) == "Anal Fetish":           #Anal fetish
        "After a particularly hard bounce, [the_girl.name] moans ecstatically."
        if the_girl == mom:
        ...
        "Fucking her hard, [the_girl.name] moans. She clutches onto the swing, holding on while you have your way with her ass."
...
label scene_SB_anal_swing_2(the_girl, the_location, the_object, the_round):
    "[the_girl.name] quivers as you slow up the pace a bit. You pull the straps on the swing towards you and thrust your hips forward, burying your cock as deep in her ass as you can."
    if the_girl.outfit.tits_available():
        ...
        mc.name "[the_person.name]... I need to feel your skin!"
        while not the_girl.outfit.tits_available():    #If covered up, have her take her top off
            ...
            "You take off [the_person.name]'s [the_clothing.name]"
        ...
        if the_girl.get_opinion_score("showing her tits") > 0:
            "You can see a blush in [the_girl.name]'s cheeks. She likes to show off her [the_girl.tit_size] tits!"
            $ the_girl.discover_opinion("showing her tits")
            $ the_girl.change_arousal(5)
    "You roll each of nipples between your thump and index fingers. [the_girl.name] arches her back and moans."
    ...
    if the_girl.arousal > 130:
        ...
        "[the_girl.name]'s ass is quivering non stop."
        if SB_get_fetish(the_girl) == "Anal Fetish":
    ...
    menu:
        "Kiss her neck":
            "You lean down and start to kiss [the_girl.name]'s neck. She tilts her head to the side to let you."
            if mc.sex_skills["Foreplay"] > 2:
                ...
                "You do your best to split your focus between kissing [the_girl.name] and pumping your hips, but you find yourself slipping out of the steady rhythm you had established."
                "[the_girl.name] sighs happily."
        ...
        "Talk Dirty":
            ...
            if SB_get_fetish(the_girl) == "Anal Fetish":
                "[the_girl.name] moans enthusiastically. She reaches back with one hand and grabs your hip, urging you to fuck her harder."
                ...
                $ the_girl.change_arousal(the_girl.get_opinion_score("anal sex"))
                "[the_girl.name] is moaning your name over and over. Her whole body bounces and sways as you fuck her on the swing."
                ...
                "[the_girl.name] looks back at you and manages to smile through the intense sensation of having her ass fucked."
...
label outro_SB_anal_swing(the_girl, the_location, the_object, the_round):
    ...
    menu:
        ...
        "Cum on her tits.":
            mc.name "Fuck, get ready [the_girl.name], I wanna cum on your tits!"
            "You pull your cock out of [the_girl.name]'s ass with a satisfying pop. You spin the swing around quickly so she faces you."
            if the_girl.get_opinion_score("being covered in cum") > 0:
                ...
                if SB_get_fetish(the_girl) == "External Cum Fetish":
                    ...
                    "[the_girl.name] revels in bliss as your dick sprays jet after jet of seed across her body. She moans lewdly."
                    "She truly is addicted to your cum."
                else:
                    "[the_girl.name] moans as your dick sprays jet after jet of seed across her body."
            elif the_girl.sluttiness > 80:
                "[the_girl.name] presses her tits together with her hands, eager to take your hot load."
                $ the_girl.cum_on_tits()
                $ the_girl.draw_person(position = "sitting")
                "You let out a shudder moaning as you cum, pumping your sperm onto [the_girl.name]'s chest. She makes sure to wait until you're completely finished."
                the_girl.char "Oh god... it feels so good on my skin..."
            elif the_girl.sluttiness > 60:
                "[the_girl.name] looks up at you and waits patiently for you to cum."
                $ the_girl.cum_on_tits()
                $ the_girl.draw_person(position = "sitting")
                "You let out a shudder moaning as you cum, pumping your sperm onto [the_girl.name]'s chest. She waits until she's sure you're finished."
            else:
                "[the_girl.name] closes her eyes and turns away."
                $ the_girl.cum_on_tits()
                $ the_girl.draw_person(position = "sitting")
                "You let out a shudder moaning as you cum, pumping your sperm onto [the_girl.name]'s chest. She flinches as the first splash of warm liquid lands on her body, but doesn't pull away entirely."
            "You take a deep breath to steady yourself once you've finished orgasming. [the_girl.name] looks up at you from the swing, her tits covered in your seed."
...
label orgasm_SB_anal_swing(the_girl, the_location, the_object, the_round):
    "[the_girl.name]'s whole body starts to tremble, and then suddenly she tenses up."
