init 2:
    ...
    screen outfit_select_manager(target_wardrobe = the_person.wardrobe, slut_limit = 999, show_export = False, show_sets = False, show_overwear = True, show_underwear = True, show_outfits = True): ##Brings up a list of the players current saved outfits, returns the selected outfit or None.
                        ...
                        viewport:
                            ...
                            vbox:
                                ...
                                for outfit in mc.designed_wardrobe.get_outfit_list():
                                    ...
                                    null height 15
                        vbox:
                            textbutton "Import Design" action ToggleVariable("import_selection") style "textbutton_style" text_style "textbutton_text_style" text_text_align 0.5 text_xalign 0.5 xsize 225 xanchor 0.0
                            if import_selection:
                                viewport:
                                    scrollbars "vertical"
                                    mousewheel True
