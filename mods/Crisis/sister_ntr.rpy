...
label sister_ntr_crisis_action:
    ...
    if the_person.sluttiness >= 60:
        ...
        $ encounter = 1
    ## Now determine how many clothes Lily will take off
    ...
    if encounter is 1: ## a scene with one man
        if the_person.sluttiness < 15:
            ...
            "They go back to kissing. [man_name] moves his hands to your sis butt and starts caressing it."
            the_person.char "Mmmmm... Your hands are so gentle..."
            if the_person.outfit.tits_available() or the_person.outfit.vagina_available():
                pass
            else:
                "You see [man_name] starts to undress your sis."
                while (the_person.outfit.tits_available() or the_person.outfit.vagina_available()) is not True:
                    $ sis_clothing = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True, exclude_feet = True)
                    $ the_person.draw_animated_removal (sis_clothing)
                    "He takes off her [sis_clothing.name] and throws it on a chair."
            ...
            if clothes_number is 1:
                $ sis_clothing = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True, exclude_feet = True)
                $ the_person.draw_animated_removal (sis_clothing)
            elif clothes_number is 2:
                $ sis_clothing = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True, exclude_feet = True)
                $ the_person.draw_animated_removal (sis_clothing)
                $ sis_clothing = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True, exclude_feet = True)
                $ the_person.draw_animated_removal (sis_clothing)
            elif clothes_number is 3:
                $ sis_clothing = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True, exclude_feet = True)
                $ the_person.draw_animated_removal (sis_clothing)
                $ sis_clothing = the_person.outfit.remove_random_any(top_layer_first = True, do_not_remove = True, exclude_feet = True)
                $ the_person.draw_animated_removal (sis_clothing)
            ...
            if the_person.outfit.vagina_available():
                ...
                if the_person.get_opinion_score("anal sex") > 0 or the_person.sluttiness > 60:
                ...
                pass
            $ positions.append ("bj")
            $ position = get_random_from_list(positions)
            if position == "missionary":
                ...
                if finish == "facial":
                    ...
                    "[the_person.name] closes the tip with her hand so that no sperm would be split around."
    ...
    if encounter is 2: ## a scene with two men
        ...
        if position == "missionary":
            ...
            if finish == "facial":
                ...
                "After few seconds they both get off from [the_person.name]. You see a trace of his white liquid dripping from her pussy and anus."
                man_name "What a nice view! [the_person.name] [the_person.last_name] fucked in both holes and creampied."
                man_name2 "It felt so good to fill you, [the_person.name]!"
                the_person.char "Hope you like the view. Now I go wash myself and then we have to finish the tasks. Don't wanna get bad grade on that test."
                "You go back to you room to finally have some sleep."
                if submission is 1 or the_person.sluttiness > 60:
                    "While trying to sleep, you hear some loud noises from outside the bedroom."
                ...
                "She gets off from hiom, grabs his dick and strokes it for a while. Once he reaches an orgasm, [the_person.name] closes the tip with a hand so that the semen won't stain anything."
                the_person.char "You really fucked me good, guys! Now I go wash my hands and then we have to finish the tasks. Don't wanna get bad grade on that test."
                "You go back to you room to finally have some sleep."
                if submission is 1 or the_person.sluttiness > 60:
                    "While trying to sleep, you hear some loud noises from outside the bedroom."
                    the_person.char "Please, take me once more, guys. I want to feel your hard dicks inside again!"
                    man_name "Sure, [the_person.name]. Get your little pussy ready!"
                    man_name2 "Spread your ass, [the_person.name], I'm gonna have fun with it."
                    "Screams go on long into the night..."
                else:
                    "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.name]'s room."
        elif position == "bj":
            ...
            if finish == "facial":
                ...
                man_name2 "I'm gonna cum too, [the_person.name]."
                "She grabs his dick and strokes it for a while. Once he reaches an orgasm, [the_person.name] closes the tip with a hand so that the semen won't stain anything."
                the_person.char "You have suck sweet and tasty cocks, guys! Now I go wash my hands and then we have to finish the tasks. Don't wanna get bad grade on that test."
                "You go back to you room to finally have some sleep."
                if submission is 1 or the_person.sluttiness > 60:
                    "While trying to sleep, you hear some loud noises from outside the bedroom."
                    man_name "Suck me again, [the_person.name]. I really loved it."
                    the_person.char "Let's finish this one first and then I will reward you."
                    man_name2 "You really loved our dicks, don't you, [the_person.name]?"
                    "Moans go on long into the night..."
                else:
                    "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.name]'s room."
