...
label mom_ntr_mod_action:
    ...
    "You drag yourself out of bed and enter the hallway. There is some rustling in mom's bedroom."
    ...
    if encounter is 1: ## a scene with one man
        if bj:
            ...
            "Mom takes his dick out of her mouth, look up to [man_name]'s face, while her hand starts jerking him off."
        ...
        menu:
            "Keep looking.":
                ...
                "They go on kissing. After a while [man_name] places his hands on mom's ass, slightly caressing it."
                if the_person.sluttiness <= 20 or (the_person.get_opinion_score("taking control") > 0 and the_person.sluttiness <= 35):
                    "Mom seems to be taken aback by [man_name] actions."
                    ...
                    if man_aggro < 1:
                        ...
                        "Mom can't refuse [man_name]'s force as she obeys him. She gets down on her knees while he lowers his pants and underwear."
                        ...
                        if the_person.outfit.vagina_available():
                            ...
                            if submissive:
                                ...
                                "For a time being there is silence in a room. Only the wet sounds of [man_name]'s dick going in and out of your mom vagina and slapping sounds as their bodies collide can be heard."
                                ...
                                "[man_name] goes on pumping your mom and then slaps her ass with a force."
                                ...
                                "For a time being there is slilence in a room. Only wet sounds of [man_name]'s dick going in and out of your mom vagina and pumping sounds as their bodies collapse."
                                "[man_name] grabs her hair and pull her upwards."
                                man_name "Like it, [the_person.name]? Do you like it, whore?"
                            ...
                            if finish == "facial":
                                ...
                                "[man_name] can't hold for much longer and he starts cumming over mom's body."
                                $ the_person.cum_on_face()
                                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                "First he covers mom face with his semen."
                                $ the_person.cum_on_tits()
                                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                "But the load is big so the sperm also covers [the_person.name]'s tits."
                                ...
                                $ the_person.draw_person(position = "doggy")
                                "You see [man_name] body shivers as he explodes inside of your mom."
                                the_person.char "Yes, yes! Fill me! Drench my pussy in your cum!"
                                "He makes a few more thrusts and with a wet sound takes his cock out of [the_person.name]'s vagina."
                                ...
                                $ the_person.draw_person(position = "blowjob")
                                "Saying that, he takes his softening dick out of [the_person.name]'s mouth."
                                "Mom gulps and drinks [man_name]'s cum in one shot but you still see traces of it around her mouth and something is still inside."
                                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                ...
                                if submissive or the_person.sluttiness > 60:
                                    ...
                                    "[man_name] keeps rimming your mom pussy and after a few seconds starts to cum on her ass."
                                    $ the_person.cum_on_ass()
                                    $ the_person.draw_person(position = "doggy")
                                    "His white liquid covers her butt."
                                    man_name "That's it, [the_person.name]. You got what you deserved."
                                    $ the_person.draw_person(position = "kissing", emotion = "happy")
                                    "Mom get's up and kisses [man_name] with a passion."
                                    ...
                                    "Mom get's up. You see tears in her eyes."
                                    ...
                                    "Mom sits on her bed, sobbing."
                        else:
                            "Mom keeps on sucking [man_name] cock, clearly putting him on an edge."
                            $ finish = get_random_from_list(finishes)
                            if finish == "facial":
                                "While it seemed rough at the beginning, mom seems to enjoy at least part of it.She takes his dick out of her mouth and looks up."
                                $ the_person.draw_person(position = "blowjob")
                                ...
                                "While it seemed rough at the beginning, mom seems to enjoy at least part of it. She takes his dick out of her mouth."
                                $ the_person.draw_person(position = "blowjob")
                                the_person.char "Now I want you to fill my mouth with your hot jizz."
                                ...
                                if submissive or the_person.sluttiness > 60:
                                    ...
                                    "They both go into the bathroom and you decide to get back to your room."
                                    "Some time later at night you awoke again by the sounds coming from mom's room."
                                    the_person.char "Mrmh... Blgrhm..."
                                    man_name "That's it, [the_person.name]. Take it into your slutty mouth!"
                                    "Seems [man_name] liked the idea of face fucking your mom. She doesn't seem to object."
                                    "It seems that mom now does not wish the encounter to end as her and [man_name] moans keep on..."
                                    ...
                                    $ the_person.draw_person(position = "blowjob", emotion = "sad")
                                    "She looks up to him. You see tears in her eyes."
                    ...
                    menu:
                        "Mom lays on the bed..." if the_person.outfit.vagina_available():
                            $ the_person.draw_person(position = "missionary", emotion = "happy")
                            "You see as mom lays on her bed and spreads her legs, inviting [man_name] to enter her."
                            the_person.char "Oh, [man_name], how about you do me the traditional way?"
                            "He quickly drops down his underwear and climbs atop of [the_person.name], entering her pussy in one go."
                            the_person.char "Oh yes, [man_name]! Do it! I really needed that."
                            "[man_name] speeds up, pumping your mom wet vagina and kissing her hard."
                            ...
                            if detected or not hidden:
                                ...
                                if the_person.sluttiness >=50 or the_person.get_opinion_score("public sex") > 0 or the_person.arousal > 35:
                                    ...
                                    "[man_name] does not mind you joining the show as he keeps fucking [the_person.name]'s pussy."
                                    man_name "Go on, boy. You see she is quite ready for both of us. Aren't you, [the_person.name]?"
                                    the_person.char "I don't mind [mc.name] seeing me like this. Now, come closer, dear."
                                    "You come close to your mom and take your dick out of your pants."
                                    the_person.char "Good boy! Now let mom take care of you."
                                    ...
                                    man_name "Wow, [the_person.name]. You really don't care about your son seeing his mom being fucked liked that?"
                                    ...
                                    if finish == "facial":
                                        ...
                                        $ the_person.cum_on_face()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "[man_name] shrugs and starts spraying his semen over your mom face."
                                        ...
                                        the_person.char "We will discuss it later, [man_name]! Now let's finish with [mc.name]."
                                        $ the_person.cum_on_tits()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "Mom speeds up her hand around your dick and in few seconds you cum on her tits."
                                        ...
                                        $ the_person.cum_in_vagina()
                                        $ the_person.draw_person(position = "missionary", emotion = "happy")
                                        "After a few hard thrusts, [man_name] starts spilling his semen into your mom."
                                        the_person.char "Yes, [man_name]! I want it in me!"
                                        "After few seconds [man_name] gets off your mom. You see a trace of his white liquid dripping from mom's pussy."
                                        the_person.char "Wow, [man_name]! You really neded to get some steam off! That was a huge load."
                                        man_name "And you look gorgeous, [the_person.name] lying there, full of my cum. And with your son cock in hands."
                                        the_person.char "Glad you like it, [man_name]! Now let's finish with [mc.name]."
                                        $ the_person.cum_on_tits()
                                        $ the_person.draw_person(position = "missionary", emotion = "happy")
                                        "Mom speeds up her hand around your dick and in few seconds you cum on her tits."
                                        the_person.char "Here we go. All finished!"
                                        ...
                                        the_person.char "We will discuss it later, [man_name]! Now let's finish with [mc.name]. I want to drink his stuff too."
                                        $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                        "With that she takes your cock with her hot lips."
                                        man_name "Never thought you are such cum drinking fan, [the_person.name]!"
                                        $ the_person.cum_in_mouth()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "Mom speeds up mouth around your dick and in few seconds you cum inside. She retreats back and gulps."
                                        ...
                                        $ the_person.draw_person(position = "missionary", emotion = "happy")
                                        the_person.char "Indeed, [man_name]! It was great! Best fuck I had in some time! Now let's finish with [mc.name]."
                                        "Mom speeds up her hand around your dick and in few seconds you cum in her arms."
                                        the_person.char "Here we go. All finished!"
                                    ...
                                    "You go back to your bedroom accompanied by bed sqeaking from mom's room as [man_name] keeps doing her."
                            else:
                                while the_person.arousal < 100:
                                        "[man_name] thrusts his dick into your mom pussy. It goes in and out with a wet sound. Clearly mom is having great time."
                                ...
                                if finish == "facial":
                                    ...
                                    $ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "His load is so huge that it spills from mom's face on her breast."
                                    the_person.char "Liked that, [man_name]? Seeing a girl on her knees with your sperm over her face?"
                                    man_name "It really turns me on! I feel I can do another round shortly."
                                    ...
                                    "Mom spreads her legs even further, offering a full view of her cum-drenched pussy."
                                    ...
                                    "Mom stands up from the bed and heads towards bathroom. [man_name] slaps her ass."
                                    ...
                                    "[man_name] clearly liked the idea of doing it with his wife."
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "His weakened dick falls out from [the_person.name]'s mouth. She looks up and smiles, while swallowing the sperm, but you still see traces of it."
                                    the_person.char "Liked that, [man_name]? [wife_name] is just stupid, it's a wonderful feeling when a man cums in your mouth."
                                    man_name "It really turned me on! I feel I can do another round shortly."
                        ...
                        "Mom poses next to bed..." if the_person.outfit.vagina_available():
                            ...
                            "He quickly drops down his underwear and comes to [the_person.name], entering her pussy in one go."
                            the_person.char "Oh yes, [man_name]! Do it! I really needed that."
                            ...
                            if detected or not hidden:
                                ...
                                if the_person.sluttiness >=50 or the_person.get_opinion_score("public sex") > 0 or the_person.arousal > 35:
                                    ...
                                    the_person.char "I don't mind [mc.name] seeing me like this. Now, come closer, dear."
                                    "You lay down on bed in front of your mom and take your dick out of your pants."
                                    the_person.char "Good boy! Now let mom take care of you."
                                    "She starts sucking your penis while [man_name] keeps driving his dick into her soaking vagina."
                                    "Mom takes your cock out of her mouth and turns back to [man_name]."
                                    ...
                                    if finish == "facial":
                                        ...
                                        $ the_person.cum_in_vagina()
                                        $ the_person.draw_person(position = "standing_doggy")
                                        "After a few hard thrusts, [man_name] starts spilling his semen into your mom, while grabbing her ass with both hands."
                                        the_person.char "Yes, [man_name]! I want it in me!"
                                        "After few seconds [man_name] gets off from your mom. You see a trace of his white liquid dripping from mom's pussy down her legs."
                                        the_person.char "Wow, [man_name]! You really neded to get some steam off! That was a huge load."
                                        man_name "And you look gorgeous, [the_person.name], posing there, full of my cum. And with your son cock in hands."
                                        the_person.char "Glad you like it, [man_name]! Now let's finish with [mc.name]."
                                        "Mom lowers her head, taking your dick back into her mouth."
                                        $ the_person.cum_in_mouth()
                                        "Mom speeds up her lips around your dick and in few seconds you cum in her mouth."
                                        the_person.char "Here we go. All finished!"
                                        $ the_person.draw_person(position = "stand2", emotion = "happy")
                                        "Mom stands up from the bed and smiles."
                                        the_person.char "Now go to your room, dear. Me and [man_name] need to take a bath."
                                        ...
                                        $ the_person.cum_in_mouth()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "Mom speeds up mouth around your dick and in few seconds you cum inside. She moves her head back and gulps."
                                        the_person.char "Here we go. Double sweet load."
                                        $ the_person.draw_person(position = "stand2", emotion = "happy")
                                        "Mom stands up from the floor and smiles."
                                        the_person.char "Now go to your room, dear. Me and [man_name] need to take a bath."
                                        ...
                                        man_name "Ow, fuck! That was great!"
                                        the_person.char "Indeed, [man_name]! It was great! Best fuck I had in some time! Now let's finish with [mc.name]."
                                        "Mom begin to jerk you off fast. You cannot hold for long an finish in her hand."
                                        the_person.char "Here we go. All finished!"
                                ...
                                if finish == "facial":
                                    ...
                                    "[man_name] shrugs and starts spraying his semen over your mom face."
                                    man_name "Oh, yes! Get it, you bitch! Jizz all over your slutty face, [wife_name]!"
                                    "Mom decides to back up his play."
                                    ...
                                    the_person.char "Yes! Do it, [man_name]! I want you to fill me."
                                    $ the_person.cum_in_vagina()
                                    "After a few hard thrusts, [man_name] starts spilling his semen into your mom, grabbing her ass with both hands."
                                    the_person.char "Yes, [man_name]! I want it in me!"
                                    "After few seconds [man_name] gets off from your mom. You see a trace of his white liquid dripping from mom's pussy over her legs."
                                    the_person.char "Wow, [man_name]! You really neded to get some steam off! That was a huge load."
                                    man_name "And you look gorgeous, [the_person.name] standing there, full of my cum. I wish my wife would allow this."
                                    the_person.char "Glad you like it, [man_name]! Want a better picture?"
                                    $ the_person.draw_person(position = "doggy")
                                    "Mom bends even further, offering a full view of her cum-drenched pussy."
                                    the_person.char "Here we go. Remember the view next time you fuck your wife."
                                    $ the_person.draw_person(position = "back_peek", emotion = "happy")
                                    "Mom stands up from the bed and heads towards bathroom. [man_name] slaps her ass."
                                    the_person.char "Now I need to take a bath. Then we will see"
                        ...
                        "Mom gets on her knees...":
                            ...
                            "His erected dick is right in front of mom's face."
                            ...
                            if detected or not hidden:
                                ...
                                if the_person.sluttiness >=50 or the_person.get_opinion_score("public sex") > 0 or the_person.arousal > 35:
                                    ...
                                    "[the_person.name] doesn't bother to answer as she goes back to sucking him."
                                    "You come close to your mom and take your dick out of your pants."
                                    ...
                                    if finish == "facial":
                                        ...
                                        $ the_person.cum_on_tits()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "[man_name] starts grinning as he ejaculates to your mom's large boobs."
                                        man_name "Ow, fuck! That was great!"
                                        "Mom looks up to him and smiles."
                                        the_person.char "Indeed, [man_name]! Now let's finish with [mc.name]."
                                        $ the_person.cum_on_tits()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "Mom speeds up her hand around your dick and in few seconds you also cum on mom's tits."
                                        $ the_person.draw_person(position = "stand2", emotion = "happy")
                                        "Mom stands up from the floor and smiles."
                                        the_person.char "Now go to your room, dear. Me and [man_name] need to take a bath."
                                    ...
                                    the_person.char "[mc.name]! Don't spy on your mom! Get beck to your room now!"
                                    "You go back to your bedroom accompanied by bed sqeaking from mom's room as she keeps sucking [man_name]'s dick."
                            else:
                                while the_person.arousal < 100:
        ...
        if bj:
            ...
            $ the_person.draw_person(position = "blowjob", emotion="happy") 
            "Your mom notice that. She stops sucking the other man and looks to the confused one with a broad smile."
            ...
            $ the_person.draw_person(position = "kissing", emotion = "happy")
            "Mom just smiles then gets up, embraces and kiss [man_name] passionately."
            ...
            "As you open the door a little more, you recognize them . It's [man_name] and [man_name2], your mom colleagues."
            "You are unsure what to do here."
        menu:
            "Keep looking.":
                "You decide to see what they are up to."
                ...
                menu:
                    "Mom lays on the table..." if the_person.outfit.vagina_available():
                        $ the_person.draw_person(position = "missionary", emotion = "happy")
                        "You see as mom lays on her table and spreads her legs, smiling broadely."
                        ...
                        "In one powerful move he enters your mom. She rolls her eyes and moans."
                        ...
                        if detected or not hidden:
                            ...
                            if the_person.sluttiness >=70 or the_person.get_opinion_score("public sex") > 0:
                                ...
                                "You and [man_name] come to the table from both sides and mom starts stroking your dicks."
                                ...
                                if finish == "facial":
                                    ...
                                    $ the_person.draw_person(position = "blowjob")
                                    "She pushes [man_name2] backwards. With a wet sound his dick leaves her pussy. [the_person.name] gets on her knees in front of [man_name2] cock."
                                    ...
                                    "She looks into [man_name2]'s eyes while jerking your and [man_name]'s cocks with both hands. [man_name2] is jerking his member pointing into mom's face."
                                    ...
                                    $ the_person.cum_on_face()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "[man_name2] shrugs and starts spraying his semen over your mom face."
                                    ...
                                    $ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "Mom speeds up her hand around [man_name] dick and in few seconds he cums on her tits."
                                    the_person.char "Two out, one to go!"
                                    $ the_person.cum_on_stomach()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "Seeing your mom covered in cum is show enough and you start to ejaculate. You finish on mom's tits and there is so much of jizz so it starts falling on her belly."
                                    $ the_person.draw_person(position = "stand2", emotion = "happy")
                                    "Mom stands up from the floor and smiles."
                                    ...
                                    $ the_person.cum_in_vagina()
                                    $ the_person.draw_person(position = "missionary", emotion = "happy")
                                    "After a few hard thrusts, [man_name2] starts spilling his semen into your mom."
                                    the_person.char "Yes, [man_name2]! I want it in me!"
                                    "After few seconds [man_name2] gets away your mom. You see a trace of his white liquid dripping from mom's pussy."
                                    ...
                                    "[man_name] comes to your mom's vagina and starts doing her again. As he is well aroused, after a few frictions he grins."
                                    ...
                                    the_person.char "Hold it, [man_name]! I have a better idea."
                                    $ the_person.draw_person(position = "blowjob")
                                    "She pushes him backwards. With a wet sound his dick leaves her pussy. [the_person.name] gets on her knees in front of [man_name2] cock."
                                    the_person.char "[man_name], [mc.name], come here!"
                                    "Both of you come closer. Now your mom is on her knees with three erected dicks in front of her."
                                    the_person.char "I want to taste your hot cum. Don't think that your wife allows you to do this!"
                                    ...
                                    $ the_person.cum_in_mouth()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "Mom speeds up mouth around [man_name]'s dick and in few seconds he cums inside. She retreats back and gulps."
                                    the_person.char "Here we go. Double sweet load. Now for [mc.name]."
                                    man_name "Well, her mouth is really something."
                                    $ the_person.cum_in_mouth()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "Mom take you dick in her mouth and in a short time you also explode inside."
                                    ...
                                    $ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "missionary", emotion = "happy")
                                    "Mom speeds up her hand around your dicks and in few seconds you both cum on her tits."
                                    the_person.char "Here we go. All finished!"
                                    man_name "I don't believe it, [the_person.name]. You just let your son watch us fuck and then jerked him off!"
                                    $ the_person.draw_person(position = "stand2", emotion = "happy")
                                    "Mom stands up from the bed and smiles."
                                ...
                                $ the_person.draw_person(position = "missionary", emotion = "angry")
                                the_person.char "[mc.name]! Don't spy on your mom! Get beck to your room now!"
                                "You go back to your bedroom accompanied by bed sqeaking from mom's room as men keep doing her."
                        else:
                            while the_person.arousal < 100:
                            ...
                            if finish == "facial":
                                ...
                                $ the_person.cum_on_tits()
                                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                "Second load is so huge that it spills from mom's face on her breast."
                                the_person.char "Liked that, [man_name]? Seeing a girl on her knees with your sperm over her face?"
                                man_name "It really turns me on! I feel I can do another round shortly."
                                ...
                                "After a few hard thrusts, [man_name2] starts spilling his semen into your mom."
                                the_person.char "Yes, [man_name2]! I want it in me!"
                                "After few seconds [man_name2] gets off your mom. You see a trace of his white liquid dripping from mom's pussy."
                                the_person.char "Wow, [man_name2]! You really neded to get some steam off! That was a huge load."
                                man_name "And you look gorgeous, [the_person.name] lying there, full of my cum. I wish my wife would allow this."
                                ...
                                "He comes over, enter's your mom pussy and after a few moves starts to grin."
                                $ the_person.cum_in_vagina()
                                $ the_person.draw_person(position = "missionary", emotion = "happy")
                                the_person.char "Yes! Inside. Fill me!"
                                "After [man_name] finshes, he pulls out. Mom is laying on the table with white liquid flows out of her."
                                $ the_person.draw_person(position = "back_peek", emotion = "happy")
                                "Mom stands up from the bed and heads towards bathroom. [man_name] slaps her ass."
                                the_person.char "Now I need to take a bath. Then we will see"
                                $ the_person.draw_person(position = "walking_away")
                                ...
                                $ the_person.cum_in_mouth()
                                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                "[man_name] comes into your mom's mouth and pulls his cock away. You see her mouth is full of cum. Then she gulpes it and stands up."
                                $ the_person.draw_person(position = "walking_away")
                                "You see them walking away to bathroom."
                                ...
                                $ the_person.cum_on_tits()
                                $ the_person.draw_person(position = "missionary", emotion = "happy")
                                "After being stroked for so long, he finally cums on mom's tits."
                                $ the_person.draw_person(position = "stand2", emotion = "happy")
                                "Mom stands up from the bed and smiles."
                                the_person.char "Didn't that event paid off, dear?"
                    ...
                    "Mom shows on the bed..." if the_person.outfit.vagina_available() and (the_person.sluttiness > 70 or the_person.get_opinion_score("anal sex") > 0):
                        ...
                        $ the_person.draw_person(position = "doggy")
                        "Mom gets over him and puts his cock inside."
                        ...
                        if detected or not hidden:
                            if the_person.sluttiness >=70 or the_person.get_opinion_score("public sex") > 0:
                                ...
                                "The guys go on doing mom's two holes at once."
                                ...
                                "Both men don't stop there, they keep on going. [the_person.name] seems to have reached multiple orgasms."
                                ...
                                if finish == "facial":
                                    the_person.char "Hold it, giys! I have a better idea."
                                    $ the_person.draw_person(position = "blowjob")
                                    "She pushes away from man's crouches. With a wet sound their dicks leaves her holes. [the_person.name] gets on her knees on the bed."
                                    ...
                                    "After a few hard thrusts, [man_name] starts spilling his semen into your mom."
                                    the_person.char "Yes, [man_name]! I want it in me!"
                                    "After few seconds [man_name] gets away your mom. You see a trace of his white liquid dripping from mom's pussy."
                                    the_person.char "Wow, [man_name]! You really neded to get some steam off! That was a huge load."
                                    ...
                                    "[man_name2] takes his cock from her ass and puts it into your mom's vagina and starts doing her. As he is well aroused, after a few frictions he grins."
                                    the_person.char "Cum in me! Give it all to me!"
                                    $ the_person.cum_in_vagina()
                                    $ the_person.draw_person(position = "doggy")
                                    ...
                                    the_person.char "Hold it, guys! I have a better idea."
                                    $ the_person.draw_person(position = "blowjob")
                                    "She pushes away from them. With a wet sound their dicks leaves her pussy and anus. [the_person.name] gets on her knees on the bed."
                                    the_person.char "[man_name], [man_name2], [mc.name], come here!"
                                    "Three of you come closer. Now your mom is on her knees with three erected dicks in front of her."
                                    the_person.char "I want to taste your hot cum. Don't think that your wife allows you to do this!"
                                    man_name2 "No, [wife_name2] never allows anything other than missionary with a condom, she is so prudent and boring at times."
                                    ...
                                    $ the_person.cum_on_tits()
                                    "Aroused by the view you cum on mom's tits."
                                    the_person.char "Here we go. All finished!"
                            ...
                            the_person.char "Aaaaaahhh...! Fuuuuuuck! Cumming!"
                            "Guys do not stop there, they keep on going. [the_person.name] seems to have reached multiple orgasms."
                            ...
                            if finish == "facial":
                                ...
                                $ the_person.cum_in_mouth()
                                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                "Mom speeds up mouth around [man_name]'s dick and in few seconds he cums inside. She retreats back and gulps. With a happy smile she gets up."
                                $ the_person.draw_person(position = "walking_away")
                                ...
                                $ the_person.cum_on_ass()
                                $ the_person.draw_person(position = "doggy")
                                "[man_name2] take his dick out of mom's ass and covers it with his liquid."
                                $ the_person.draw_person(position = "stand2", emotion = "happy")
                                "Mom stands up from the bed and smiles."
                    ...
                    "Mom gets on her knees":
                        ...
                        if detected or not hidden:
                            ...
                            if the_person.sluttiness >=70 or the_person.get_opinion_score("public sex") > 0:
                                ...
                                the_person.char "[mc.name], don't just stay there, come on it. Mom will help you relax as well."
                                "Both [man_name] and [man_name2] do not mind you joining the show as [the_person.name] goes back to sucking them."
                                "You come close to your mom and take your dick out of your pants."
                                "She starts stoking you along with [man_name] while [man_name2] keeps driving his dick into her mouth."
                                ...
                                if finish == "facial":
                                    ...
                                    "As he starts to cum, mom closes the tip with her hand so he finishes in it."
                                    man_name "Now help me too!"
                                    "[man_name2] places his instrument into mom's hand and she starts moving it. In few moments he cums in her hand."
                                    the_person.char "OK, now for you. [mc.name]."
                                ...
                                $ the_person.draw_person(position = "blowjob", emotion = "angry")
                                the_person.char "[mc.name]! Don't spy on your mom! Get beck to your room now!"
                                "You go back to your bedroom accompanied by bed sqeaking from mom's room as she keeps sucking both [man_name]'s and [man_name2]'s dicks."
                        else:
                            man_name2 "Oh, [the_person.name], your toungue is driving me crazy! I think I will come soon!"
                            $ finish = get_random_from_list(finishes)
                            if finish == "facial":
