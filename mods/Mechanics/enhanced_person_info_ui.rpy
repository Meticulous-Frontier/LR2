    ...
    screen person_info_ui(the_person): #Used to display stats for a person while you're talking to them.
        ...
        frame:
            ...
            hbox:
                ...
                spacing 100
                vbox:
                    text the_person.name style "menu_text_style" font the_person.char.what_args["font"] color the_person.char.what_args["color"] size 40
                ...
                vbox:
                    ...
                    if hasattr(the_person, "weight"):
                        $ weight = get_person_weight_string(the_person)
