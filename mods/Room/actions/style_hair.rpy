...
label hair_colors(the_person):
        $ page = 1
        $ leave = 0
        while(leave ==0):

            menu:
                "Choose a hair color for [the_person.name], currently has [the_person.hair_colour] hair"
                # Page 1, four elements per page
                "Blond" if page == 1:
                    $ the_person.hair_colour = "blond"
                    $ salon_redraw_hair()

                "Brown" if page == 1:
                    $ the_person.hair_colour = "brown"
                    $ salon_redraw_hair()

                "Black" if page == 1:
                    $ the_person.hair_colour = "black"
                    $ salon_redraw_hair()

                "Red" if page == 1:
                    $ the_person.hair_colour = "red"
                    $ salon_redraw_hair()

                # Page 2
                "Hot Pink" if page == 2:
                    $ the_person.hair_colour = "hot pink"
                    $ salon_redraw_hair()

                "Alt Blond" if page == 2:
                    $ the_person.hair_colour = "alt blond"
                    $ salon_redraw_hair()

                "Sky Blue" if page == 2:
                    $ the_person.hair_colour = "sky blue"
                    $ salon_redraw_hair()

                "Grey" if page == 2:
                    $ the_person.hair_colour = "light grey"
                    $ salon_redraw_hair()

                # Page 3
                "Fire Red" if page == 3:
                    $ the_person.hair_colour = "fire red"
                    $ salon_redraw_hair()

                "Knight Red" if page == 3:
                    $ the_person.hair_colour = "knight red"
                    $ salon_redraw_hair()

                "Purple" if page == 3:
                    $ the_person.hair_colour = "purple"
                    $ salon_redraw_hair()

                "Dark Grey" if page == 3:
                    $ the_person.hair_colour = "dark grey"
                    $ salon_redraw_hair()

                #Page 4

                "Turquoise" if page == 4:
                    $ the_person.hair_colour = "turquoise"
                    $ salon_redraw_hair()

                "Lime" if page == 4:
                    $ the_person.hair_colour = "lime green"
                    $ salon_redraw_hair()

                "Mango" if page == 4:
                    $ the_person.hair_colour = "mango"
                    $ salon_redraw_hair()

                "Ocean" if page == 4:
                    $ the_person.hair_colour = "ocean"
                    $ salon_redraw_hair()

                #Page 5

                "Pulp" if page == 5:
                    $ the_person.hair_colour = "pulp"
                    $ salon_redraw_hair()

                "Saturated" if page == 5:
                    $ the_person.hair_colour = "saturated"
                    $ salon_redraw_hair()

                "Emerald" if page == 5:
                    $ the_person.hair_colour = "emerald"
                    $ salon_redraw_hair()

                "Light Brown" if page == 5:
                    $ the_person.hair_colour = "light brown"
                    $ salon_redraw_hair()
...
label hair_style(the_person):
    ...
    while(leave == 0):
                menu:
                    "Choose hair style, [the_person.name] currently has [the_person.hair_style.name]"
                    # Page 1, have four elements per page
                    "Short hair" if page == 1:
                        $ the_person.hair_style = short_hair
                        $ salon_redraw_hair()

                    "Twin Ponytails" if page == 1:
                        $ the_person.hair_style = twintail
                        $ salon_redraw_hair()

                    "Ponytail" if page == 1:
                        $ the_person.hair_style = ponytail
                        $ salon_redraw_hair()

                    "Messy Ponytail" if page == 1:
                        $ the_person.hair_style = messy_ponytail
                        $ salon_redraw_hair()

                    # Page 2
                    "Shaved Side Hair" if page == 2:
                        $ the_person.hair_style = shaved_side_hair
                        $ salon_redraw_hair()

                    "Long Hair" if page == 2:
                        $ the_person.hair_style = long_hair
                        $ salon_redraw_hair()

                    "Bow Hair" if page == 2:
                        $ the_person.hair_style = bow_hair
                        $ salon_redraw_hair()

                    "Messy Short Hair" if page == 2:
                        $ the_person.hair_style = messy_short_hair
                        $ salon_redraw_hair()

                    # Page 3
                    "Messy Long Hair" if page == 3:
                        $ the_person.hair_style = messy_hair
                        $ salon_redraw_hair()
