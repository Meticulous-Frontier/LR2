init -1 python: # Declare variables to use
    ...
    mall_salon = Room("salon", "Hair Salon", [], Image("Salon_Background.png"), [], [], [], True, [], None, False)
    business_salon = Room("salon", "Hair Salon", [], Image("Salon_Background.png"), [], [], [], True, [], None, False)
