...
init 3 python:
    ...
    def generic_people_actions_requirement():
        True

    def generic_people_actions_initialization(self):
        renpy.call("generic_people_actions_creation")
    ...
    generic_people_actions = ActionMod("Generic People Actions", generic_people_actions_requirement, "generic_people_actions_dummy", initialization = generic_people_actions_initialization,
        menu_tooltip = "Gives extra actions for all people in their Special Role Actions...", category = "Role Actions")
...
label generic_people_actions_dummy():
    return

label generic_people_actions_creation():
    ...
    $ schedule_person = Action("Schedule clone", schedule_person_requirement, "schedule_menu",
    ...
    $ hire_person = Action("Employ [the_person.title]", hire_person_requirement, "hire_person",
        menu_tooltip = "Hire the the target to work for you in your business.")
