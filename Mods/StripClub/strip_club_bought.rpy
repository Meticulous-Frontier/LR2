...
label strip_club_bought_strippers_selection_label(the_person): # Talk event
    ...
    mc.name "Good, come, lets go inside."
    ...
    the_person.char "Ok [mc.name], we're all here... Actually, what are we doing here? You wanted a private party?"
    ...
    mc.name "For your back pay, I cant do anything about that, the money [name_string] owed you is gone."
    mc.name "I'm not stupid, so I recognize that hiring skilled and experienced workers has its advantages."
    mc.name "Here's my offer, you girls show me your skills on the stage and will decide if I'm going to give you your old job back..."
    ...
    if len(stripclub_strippers) > 1:
        ...
        "Damn, I bought a stripclub and now I don't have any strippers..."
        "I better hurry and find someone to work here fast, if I want to re-open this place."
    ...
    "As the last one left in the club, you turn off the lights, close the doors, and move back to your home eager for a good nights rest."
