        ...
        vbox:
            ...
            frame:
                ...
                vbox:
                    ...
                    text "    Supply Procurement: " + str(the_candidate.supply_skill*3 + the_candidate.focus*5 + the_candidate.charisma*3 + 20) + " Units of supply per time chunk." style "menu_text_style" size 16
