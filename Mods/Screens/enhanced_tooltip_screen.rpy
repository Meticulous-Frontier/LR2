            ...
            if hovered_enough_time:
                ...
                frame:
                    if mouse_xy[1] > 1080/2:
                        background "#222222" xsize 450 xpos mouse_xy[0] ypos mouse_xy[1] yanchor 1.0 # Find  a better colour scheme, clashes with disabled actions
                    else:
                        background "#222222" xsize 450 xpos mouse_xy[0] ypos mouse_xy[1]
                    text "[tooltip]":
