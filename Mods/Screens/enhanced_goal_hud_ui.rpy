            ...
            vbox:
                ...
                for goal in [x for x in [mc.stat_goal,mc.work_goal,mc.sex_goal] if x]:
                    frame:
                        ...
                        textbutton goal.name + "\n" + goal.get_reported_progress() style "transparent_style" text_style "menu_text_style" xalign 0.5 yanchor 0.5 yalign 0.5 action NullAction() sensitive True tooltip goal.description
