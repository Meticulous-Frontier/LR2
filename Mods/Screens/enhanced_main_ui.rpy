    ...
    screen main_ui(): #The UI that shows most of the important information to the screen.
        ...
        frame:
            ...
            vbox:
                ...
                textbutton "Arousal: [mc.arousal]/[mc.max_arousal] {image=arousal_token_small}":
                ...
                textbutton "Energy: [mc.energy]/[mc.max_energy] {image=energy_token_small}":
                    style "transparent_style"
                    text_style "menu_text_style"
                ...
                textbutton "Clarity: [mc.free_clarity]": #TODO:
                    style "transparent_style"
                    text_style "menu_text_style"
                ...
                textbutton "Lust: [mc.locked_clarity]":
                    style "transparent_style"
                    text_style "menu_text_style"
