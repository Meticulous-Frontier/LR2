    ...
    screen main_ui(): #The UI that shows most of the important information to the screen.
        ...
        frame:
            ...
            vbox:
                ...
                textbutton "Arousal: "+ str(__builtin__.int(mc.arousal)) + "/"+ str(__builtin__.int(mc.max_arousal)) + " {image=arousal_token_small}":
                ...
                textbutton "Energy: " + get_energy_string(mc):
                    style "transparent_style"
                    text_style "menu_text_style"
                ...
                textbutton "Clarity: "+ str(__builtin__.int(mc.free_clarity)):
                    style "transparent_style"
                    text_style "menu_text_style"
                ...
                textbutton "Lust: "+ str(__builtin__.int(mc.locked_clarity)):
                    style "transparent_style"
                    text_style "menu_text_style"
