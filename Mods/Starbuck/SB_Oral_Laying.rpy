...
label intro_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    "You run your hands along [the_person.possessive_title]'s hips. You grab her ass and pull her close to you."
    ...
    "[the_person.possessive_title] opens her legs wide as your get to her cunt. You breath in sharply through your nose, enjoying the tangy, musky scent of her arousal."
    if the_person.arousal > 50:
        "[the_person.possessive_title]'s pussy lips are engorged. They glisten with moisture from her excitement. You can't wait to taste it."
    else:
        "[the_person.possessive_title]'s pussy is like a pristine flower. You can't wait to taste it."
    "A moan escapes her lips as you run your tongue up [the_person.possessive_title]'s slit."
    return
...
label scene_SB_Oral_Laying_1(the_person, the_location, the_object, the_round):
    ...
    if the_person.arousal > 70:
        ...
        "[the_person.possessive_title]'s pussy is still getting wet. You lick it slow, giving her time to warm up."

    menu:
        "Finger Her.":
            #Generic choice with bonus based on girl opinion and MC foreplay skill
            "As you continue to lick all around [the_person.possessive_title]'s cunt, you slowly push a finger up inside of her."
            if mc.sex_skills["Foreplay"] > 2:
                ...
                "You do your best to split your focus between kissing [the_person.possessive_title]'s pussy and fingering her, but you find yourself struggling to do both."
                ...
                if the_person.get_opinion_score("being fingered") > 0:
                    ...
                    "[the_person.possessive_title] enjoys your fingering, but soon you feel her hands running through your hair. She's lightly pulling your head down, trying to get you to resume licking her."
        ...
        "Push Your Tongue Deep.":
            ...
            if mc.sex_skills["Oral"] > 3:
                ...
                if the_person.get_opinion_score("taking control") > 0:
                    "[the_person.possessive_title] puts her hand on the back of your head, urging your tongue deeper and your nose more firmly against her clit."
                ...
                "[the_person.possessive_title] moans and trembles as you please her."
            else:
                ...
                "[the_person.possessive_title] puts her hand on the back of your head. She starts to pull your head back a bit, guiding you back to her clit."
    ...
    if mc.arousal > 70:
        ...
        "While you aren't being stimulated, [the_person.possessive_title]'s gasps and breathing are starting to turn you on."
    return

label scene_SB_Oral_Laying_2(the_person, the_location, the_object, the_round):
    # CHOICE CONCEPT: Submit // Control her
    "[the_person.possessive_title]'s hips are beginng to rock side to side, grinding against you as you lick her."
    ...
    "It feels like [the_person.possessive_title] is trying to take control!"
    menu:
        "Let Her Take Control":
            "You take her enthusiasm as a sign that you must be doing well. You double down on her clit, sucking and licking at it."
            if the_person.get_opinion_score("taking control") > 0:
                "[the_person.possessive_title] uses the leverage her legs give her, wrapped around your back, to force your face down into her cunt roughly."
                "She starts to rock her hips, grinding herself against your face."
                the_person.char "Mmm, that's it [the_person.mc_title]! Fuck that feels good!"
                $ the_person.discover_opinion("taking control")
                $ the_person.change_arousal(the_person.get_opinion_score("taking control") * 3)
        ...
        "Subdue Her":
            ...
            if the_person.get_opinion_score("being submissive") > 0:
                ...
                "[the_person.possessive_title] quivers at your rough touch and words. She pretends she doesn't like it."
...
label outro_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    ...
    "You get to hear every little gasp and moan from [the_person.possessive_title] as you lick up and down her cunt. As you stroke yourself you accidentally push yourself past the point of no return."

    "You finally let out a low moan and hold [the_person.possessive_title] close. A shiver runs up your spine as your climax, shooting your load out into your underwear."
...
label transition_default_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    "You put [the_person.possessive_title] on her back and lie down on top of her, lining your hard cock up with her tight cunt."
...
label strip_ask_SB_Oral_Laying(the_person, the_clothing, the_location, the_object, the_round):
    ...
    "[the_person.possessive_title] pants as you lick her."
    menu:
        "Let her strip.":
...
label transition_SB_Oral_Laying_missionary(the_person, the_location, the_object, the_round):
    "You push yourself up on your hands, satisfied with the licking you gave her pussy. You slowly start to crawl up [the_person.possessive_title]'s body."
    "[the_person.possessive_title] wraps her arms around you and holds you close as you line your cock up with her pussy. She sighs happily into your ear as you slide into her."
    if the_person.arousal > 100:
...
label transition_missionary_SB_Oral_Laying(the_person, the_location, the_object, the_round):
    ...
    "[the_person.possessive_title] opens her legs wide as your get to her cunt. You breath in sharply through your nose, enjoying the tangy, musky scent of her arousal."
    if the_person.arousal > 50:
        "[the_person.possessive_title]'s pussy lips are engorged. They glisten with moisture from your previous fucking. You can't wait to taste it."
    else:
        "[the_person.possessive_title]'s pussy is like a pristine flower. You can't wait to taste it."
    "A moan escapes her lips as you run your tongue up [the_person.possessive_title]'s slit."
    return
