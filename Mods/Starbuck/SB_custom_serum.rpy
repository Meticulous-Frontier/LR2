...
label SB_instantiate_serum_traits(): #Creates all of the default LR2 serum trait objects.
    python:
        ...
        pher_ther = SerumTrait(name = "Pheremone Therapy",
        ...
        sub_ther = SerumTrait(name = "Submission Therapy",
        ...
        ovulation_ther = SerumTrait(name = "Hormonal Ovulation",
        ...
        fetish_basic_ther = SerumTrait(name = "Initial Fetish Therapy",
        ...
        fetish_vaginal_ther = SerumTrait(name = "Vaginal Fetish Therapy",
        ...
        fetish_anal_ther = SerumTrait(name = "Anal Fetish Therapy",
        ...
        fetish_cum_ther = SerumTrait(name = "Cum Fetish Therapy",
        ...
        constant_stimulation_ther = SerumTrait(name = "Constant Stimulation",
        ...
        dopamine_therapy_ther = SerumTrait(name = "Dopamine Therapy",
        ...
        behavior_adjustment_ther = SerumTrait(name = "Behavior Adjustment",
        ...
        list_of_traits.append(pher_ther)
        ...
        list_of_traits.append(fetish_cum_ther)
        list_of_traits.append(constant_stimulation_ther)
        list_of_traits.append(dopamine_therapy_ther)
        list_of_traits.append(behavior_adjustment_ther)
