...
label scene_SB_cum_fetish_blowjob_1(the_person, the_location, the_object, the_round):
    ...
    menu:
            "Talk dirty to her.":
                ...
                "[the_person.possessive_title] strokes you a few more times with her skill mouth. She twirls her tongue around the tip a few times before taking a second to respond."
            ...
            "Stay quiet.":
                ...
                if the_person.get_opinion_score("masturbating") > 0:
                    if the_person.outfit.vagina_available():
                        "[the_person.possessive_title] puts a hand between her legs and starts to touch herself while she she blows you."
                        ...
                        if the_person.arousal > 60:
                            "[the_person.possessive_title] puts a hand between her legs and eagerly rubs at her crotch through her clothing."
                        else:
                            "[the_person.possessive_title] puts a hand between her legs and rubs at her crotch absentmindedly."
                else:
                    "[the_person.possessive_title] keeps up a steady pace, bobbing her head back and forth and running your cock in and out of her soft mouth."
...
label scene_SB_cum_fetish_blowjob_2(the_person, the_location, the_object, the_round):
    ...
    "[the_person.possessive_title] pulls your cock out of her her mouth and leans in even closer. She runs her tongue along the bottom of your shaft, pausing at the top to kiss the tip a few times."
    ...
    "When [the_person.possessive_title] opens her mouth and resumes blowing you, you put your hand on the back of her head, intent to push yourself down her throat."
    if the_person.get_opinion_score("being submissive") > 0:
            "[the_person.possessive_title] looks up at you. You can see her pupils dilate as you slowly pull her head towards you, until your cock is buried in her throat."
            "[the_person.possessive_title]'s knees quiver while her throat spasms around your shaft. You hold her deep while her body twitches with pleasure."
            ...
            "[the_person.possessive_title] grabs your hands in hers. She holds your hands as she looks up at you, making eye contant."
            ...
            "Still making eye contact, [the_person.possessive_title] begins to bob her head up and down, completely deepthroating you with every stroke."
            ...
            "[the_person.possessive_title] turns her eyes up and meets your gaze. She eagerly swallows as your push yourself down her throat, her tongue eagerly licking at the bottom of your shaft."
...
label outro_SB_cum_fetish_blowjob(the_person, the_location, the_object, the_round):
    ...
    if the_person.get_opinion_score("drinking cum") > the_person.get_opinion_score("cum facials"):
        "[the_person.possessive_title] moans and looks you in the eyes. She pulls off until just the  tip of your cock is in her mouth and she begins to stroke out off eagerly."
        ...
        if the_person.arousal > 100:
            "[the_person.possessive_title]'s legs quiver as she convulses. She is so addicted to your cum, blowing in her mouth has set off another orgasm for her."
            $ the_person.change_obedience(5*the_person.get_opinion_score("drinking_cum"))
        "Once you've had a second to recover, [the_person.possessive_title] closes her mouth and swallows loudly. It takes a few big gulps to get every last drop of your cum down, but when she opens up again it's all gone."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_person)
        ...
        $ SB_cum_fetish_blowjob.redraw_scene(the_person)
        if the_person.arousal > 100:
            "[the_person.possessive_title]'s legs quiver as she convulses. She is so addicted to your cum, blowing on her face has set off another orgasm for her."
            $ the_person.change_obedience(5*the_person.get_opinion_score("drinking_cum"))
...
label transition_SB_cum_fetish_blowjob_blowjob(the_person, the_location, the_object, the_round):
    $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
    $ SB_cum_fetish_blowjob.redraw_scene(the_person)
    "[the_person.possessive_title] gets onto her knees in front of you and takes your hard cock in her hands. She strokes it tentativly a few times, then leans in and slides the tip into her mouth."
...
label strip_SB_cum_fetish_blowjob(the_person, the_clothing, the_location, the_object, the_round):
    ...
    "[the_person.possessive_title] pops off your cock and looks up at you."
    $ the_person.call_dialogue("sex_strip")
    $ the_person.draw_animated_removal(the_clothing)
    "[the_person.possessive_title] stands and strips off her [the_clothing.name]. She drops it to the ground, then gets back on her knees and slides your cock inside her mouth."
    $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
    $ SB_cum_fetish_blowjob.redraw_scene(the_person)
    return
...
label strip_ask_SB_cum_fetish_blowjob(the_person, the_clothing, the_location, the_object, the_round):
    ...
    "[the_person.possessive_title] pops off your cock and looks up at you from her knees."
    ...
    menu:
        "Let her strip.":
            ...
            "[the_person.possessive_title] stands up and strips out of her [the_clothing.name]. Then she gets back onto her knees and slides your cock all the way to the back of her mouth."
            $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
            $ SB_cum_fetish_blowjob.redraw_scene(the_person)
...
label orgasm_SB_cum_fetish_blowjob(the_person, the_location, the_object, the_round):
    $ SB_cum_fetish_blowjob.current_modifier = "blowjob"
    $ SB_cum_fetish_blowjob.redraw_scene(the_person)
    "[the_person.possessive_title] pauses suddenly. You hear her whimper softly - the noise party muffled by your cock."

    "[the_person.possessive_title] starts to pull back off of your cock. You place a firm hand on the back of her head."
    mc.name "Did I tell you to stop sucking, you dirty little slut?"
    "You push her back down, hard. [the_person.possessive_title] keeps her mouth open wide and fits you all the way in, quivering as she climaxes."
    ...
    if the_person.get_opinion_score("being submissive") > 0:
        ...
        "[the_person.possessive_title] closes her eyes tight. You can feel her throat spasm around your shaft in time with her orgasmic contractions."
        if the_person.outfit.vagina_visible():
            "You can see that [the_person.possessive_title]'s pussy is dripping wet as she cums."
        else:
            $ top_piece = the_person.outfit.get_lower_ordered()[-1]
            if top_piece.underwear:
                "[the_person.possessive_title]'s dripping wet pussy has managed to soak through her underwear, leaving a wet mark on her [top_piece.name]."
            else:
                "[the_person.possessive_title] clenches her thighs together and rides out her orgasm."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_person)
        "When she's stopped twitching and moaning you let [the_person.possessive_title] slide back. She pants loudly, then licks along the length of your cock."
        the_person.char "That was... incredible... Okay, I came... now its your turn!"
        "She slides you back into her mouth and presses you all the way to the back, rubbing your tip against the back of her throat for a second before she goes back to blowing you."
    else:
        "[the_person.possessive_title] closes her eyes as her orgasm peaks. She holds almost perfectly still, your dick still sitting in her mouth, until she's finished."
        $ SB_cum_fetish_blowjob.current_modifier = None
        $ SB_cum_fetish_blowjob.redraw_scene(the_person)
