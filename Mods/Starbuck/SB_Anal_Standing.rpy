...
label intro_SB_anal_standing(the_person, the_location, the_object, the_round):
    "With you arms wrapped around [the_person.possessive_title], you make out for a bit with her back to the [the_object.name]"
...
label scene_SB_anal_standing_1(the_person, the_location, the_object, the_round):
    "Your hips slap against [the_person.possessive_title]'s as you plunder her rectum."
    ...
    if the_person.sex_skills["Anal"] < 2: #Inexperienced
    ...
    elif SB_check_fetish(the_person, anal_fetish_role):           #Anal fetish
        ...
        if the_person == mom:
            ...
            the_person.char "That's it [the_person.mc_title]! Fuck me harder! God I wish I could walk around with you inside me all day..."
        else:
    ...
    menu:
        "Kneed her ass":
            ...
            if the_person.get_opinion_score("being submissive") > 0 or the_person.obedience > 130:
                "[the_person.possessive_title] trembles at your words and touch. "
                ...
                "You give [the_person.possessive_title] a good, hard thrust in response."
...
label scene_SB_anal_standing_2(the_person, the_location, the_object, the_round):
    "[the_person.possessive_title] quivers as you slow up the pace a bit. The sensation of burying yourself in her tight chute over and over is amazing."
    ...
    if the_person.arousal > 130:
        ...
        "[the_person.possessive_title]'s legs are shaking. She is thoroughly enjoying her anal plundering."
        if SB_check_fetish(the_person, anal_fetish_role):
    ...
    menu:
        ...
        "Talk Dirty":
            ...
            if SB_check_fetish(the_person, anal_fetish_role):
                "[the_person.possessive_title] moans enthusiastically. She wiggles her hips back and forth, caressing your dick with her forbidden hole."
                ...
                $ the_person.change_arousal(the_person.get_opinion_score("anal sex"))
                "[the_person.possessive_title] is moaning your name over and over. You continue to give her the anal reeming she is begging for."
                ...
                "[the_person.possessive_title] looks back at you and manages to smile throug the intense sensation of having her ass fucked."
