init -3 python:
    ...
    FETISH_PRODUCTION_COST = 50     #Default 100
    ...
    def SB_GET_VAGINAL_EVENT_ACTIVE():
        return FETISH_VAGINAL_EVENT_INUSE

    def SB_VAGINAL_EVENT_ACTIVE_TRUE():
        global FETISH_VAGINAL_EVENT_INUSE
        FETISH_VAGINAL_EVENT_INUSE = True

    def SB_VAGINAL_EVENT_ACTIVE_FALSE():
        global FETISH_VAGINAL_EVENT_INUSE
        FETISH_VAGINAL_EVENT_INUSE = False
