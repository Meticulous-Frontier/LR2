...
init 3304 python:
    ...
    stripclub_waitress_role = Role("Waitress", [promote_to_manager_action, strip_club_stripper_move_action, strip_club_stripper_fire_action, strip_club_stripper_performance_review_action],
