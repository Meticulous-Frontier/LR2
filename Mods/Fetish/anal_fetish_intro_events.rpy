...
label anal_fetish_employee_intro_label(the_person):
    ...
    "Even now, as you walk around he business in your closing rounds, [the_person.possessive_title!l] bends over her desk when she notices you are nearby."
...
label anal_fetish_mom_intro_label():
    ...
    $ clear_scene()
    "You head to the kitchen and start a pot of coffee while [the_person.possessive_title!l] goes to the restroom. It takes a few minutes, but soon its done."
...
label anal_fetish_stephanie_bimbo_label(the_person):
    ...
    "You say goodbye, and [the_person.possessive_title!l] turns and walks out of your office, her plug just peaking out between her rosy ass cheeks."
