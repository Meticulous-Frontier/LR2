...
########
#Copy another personality with the dialogue that you want to use.
#IF you comment out a label or if a dialogue label does not exist, it will check the default_prefix personality type for that dialogue

### DIALOGUE ###
label ellie_introduction(the_person):
...
label ellie_greetings(the_person):
...
label ellie_sex_responses_oral(the_person):
    if the_person.arousal_perc < 40:
        ...
        if the_person.sluttiness > 50:
            ...
            "You're so good at that... Stars, it's starting to drive me crazy!"
    else:
        if the_person.sluttiness > 50:
            if the_person.relationship == "Single":
...
label ellie_sex_responses_vaginal(the_person):
    if the_person.arousal_perc < 40:
        ...
        if the_person.sluttiness > 50:
            ...
            the_person "Stars... Oh my... My pussy..."
    else:
        if the_person.sluttiness > 50:
            if the_person.relationship == "Single":
                the_person "Ah! Do me, make me cum!"
            else:
                $ so_title = SO_relationship_to_title(the_person.relationship)
                the_person "Do me, do me harder! My [so_title] never does me like this, it feels so good!"
        else:
...
label ellie_sex_responses_anal(the_person):
    if the_person.arousal_perc < 40:
        ...
        if the_person.sluttiness > 50:
            ...
            the_person "Oh stars... You're so big!"
    else:
        if the_person.sluttiness > 50:
            if the_person.relationship == "Single":
...
label ellie_climax_responses_foreplay(the_person):
    if the_person.sluttiness > 50:
    ...
    if ellie_is_a_squirter():
        if "the_position" in globals():
            if the_position == standing_finger:
                ...
                "[the_person.possessive_title]'s pussy gets significantly wetter as she cums."
            elif the_position == drysex_cowgirl:
                "An incredible amount of fluid leaks from [the_person.possessive_title]'s pussy as she cums."
            elif the_position == standing_dildo:
                "[the_person.possessive_title] fluids start actively running down the dildo as she cums."
            else:
                "[the_person.possessive_title]'s pussy gushes as she cums."
        else:
            "[the_person.possessive_title]'s pussy gushes as she cums."
    return

label ellie_climax_responses_oral(the_person):  #This function is only called if giving ellie oral.
    if the_person.sluttiness > 70:
        the_person "Oh stars! Oh, make me cum [the_person.mc_title]!"
        "She closes her eyes and squeals with pleasure."
    else:
        the_person "Oh stars, I'm going to cum. I'm going to cum!"
        "She closes her eyes and squeals with pleasure."
    if ellie_is_a_squirter():
        "You prepare yourself as the waves begin. Each wave brings a torrent as [the_person.possessive_title] starts to squirt."
    return

label ellie_climax_responses_vaginal(the_person):
    if the_person.sluttiness > 70:
        the_person "I'm going to cum! Ah! Do me [the_person.mc_title], I want to cum so badly! Ah!"
        "She closes her eyes and squeals with pleasure."
    else:
        the_person "Ah! I'm cumming! Oh stars! Ah!"
    if ellie_is_a_squirter():
        "You can feel [the_person.title]'s pussy floods as she begins to orgasm."
    return

label ellie_climax_responses_anal(the_person):
    if the_person.sluttiness > 80:
        the_person "I'm going to cum! Oh stars I'm going to cum!"
    else:
        the_person "Oh stars, I think... I think I'm going to cum!"

    return

label ellie_clothing_accept(the_person):
    if the_person.obedience > 130:
...
label ellie_clothing_review(the_person):
...
label ellie_strip_reject(the_person, the_clothing, strip_type = "Full"):
    if the_person.obedience > 130:
...
label ellie_strip_obedience_accept(the_person, the_clothing, strip_type = "Full"):
...
label ellie_grope_body_reject(the_person):
...
label ellie_sex_angry_reject(the_person):
    if not the_person.relationship == "Single":
        ...
        the_person "What!?! Do you think I'm just some whore who puts out for anyone who asks?"
        the_person "Ugh! Get away from me, I don't even want to talk to you after that."
    else:
        the_person "What the heck do you think you're doing, that's disgusting!"
        the_person "Get away from me, I don't even want to talk to you after that!"
    return

label ellie_seduction_response(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 50:
...
label ellie_seduction_accept_crowded(the_person):
    if the_person.relationship == "Single":
...
label ellie_seduction_accept_alone(the_person):
    if the_person.relationship == "Single":
        if the_person.sluttiness < 20:
...
label ellie_seduction_refuse(the_person):
    if the_person.sluttiness < 20:
...
label ellie_flirt_response(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 50:
...
label ellie_flirt_response_high(the_person):
    if mc.location.get_person_count() > 1 and the_person.effective_sluttiness("kissing") < (25 - (5*the_person.get_opinion_score("public_sex"))):
        ...
        menu:
            "Find someplace quiet":
                ...
                call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_ellie_47
        ...
        menu:
            "Kiss her":
                ...
                $ the_person.draw_person(position = "kissing", special_modifier = "kissing")
                "You close the final gap and kiss her. She returns the kiss immediately, leaning her body against yours."
                call fuck_person(the_person, start_position = kissing, private = mc.location.get_person_count() < 2, skip_intro = True) from _call_fuck_ellie_48
                $ the_person.call_dialogue("sex_review", the_report = _return)
                $ the_person.review_outfit()
...
label ellie_flirt_response_girlfriend(the_person):
    ...
    if mc.location.get_person_count() > 1:
        ...
        if the_person.effective_sluttiness("kissing") < (25 - (5*the_person.get_opinion_score("public_sex"))):
            ...
            menu:
                "Find someplace quiet":
                    ...
                    call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_ellie_71
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    $ the_person.review_outfit()
            ...
            menu:
                "Make out":
                    ...
                    call fuck_person(the_person, start_position = kissing, private = False, skip_intro = True) from _call_fuck_ellie_72
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    $ the_person.review_outfit()
        ...
        menu:
            "Kiss her":
                ...
                call fuck_person(the_person, start_position = kissing, skip_intro = True) from _call_fuck_ellie_73
                $ the_person.call_dialogue("sex_review", the_report = _return)
                $ the_person.review_outfit()
...
label ellie_flirt_response_affair(the_person):
    ...
    if mc.location.get_person_count() > 1: #There are other people around, she's nervous about people finding out what you're doing.
        if (the_person.get_opinion_score("cheating on men") *15) + the_person.effective_sluttiness() > 50: #SHe's turned on by flirting in public or doesn't think anything is wrong with it
            ...
            menu:
                "Find someplace quiet":
                    ...
                    call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_ellie_74
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    $ the_person.review_outfit()
        ...
        menu:
            "Make out":
                ...
                call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_ellie_75
                $ the_person.call_dialogue("sex_review", the_report = _return)
                $ the_person.review_outfit()
            "Just flirt":
...
label ellie_flirt_response_text(the_person):
...
label ellie_condom_ask(the_person):
...
label ellie_condom_bareback_demand(the_person): # Lead in: mc.name "One sec, let me just get a condom on..."
    if the_person.wants_creampie(): #Just likes raw sex
        ...
        if the_person.on_birth_control:
            the_person "Forget it, I'm on the pill [the_person.mc_title]. I want you to feel your skin, no condom."
            $ the_person.update_birth_control_knowledge()
        else:
            the_person "Don't waste time with that, just pull out if you're worried about getting me pregnant."
            the_person "Come on, hurry up and stick it in!"
    return

label ellie_cum_face(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 60:
        ...
        if the_person.sluttiness > 80:
            ...
            the_person "Stars! You really pumped it out, didn't you?"
            "[the_person.title] runs a finger along her cheek, wiping away some of your semen."
    return

label ellie_cum_mouth(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 60:
...
label ellie_cum_condom(the_person):
...
label ellie_cum_vagina(the_person):
    ...
    if the_person.wants_creampie():
        if the_person.event_triggers_dict.get("preg_knows", False):
            ...
            if the_person.relationship != "Single":
                ...
                the_person "Oh stars, it's so warm. I can feel it inside me..."
                "She sighs happily as you cum inside her."
            ...
            if the_person.relationship != "Single":
                ...
                the_person "Stars, I hope you didn't knock me up though. I don't want to have to explain that to my [so_title]."
            else:
                the_person "Oh stars, there it all is... It's so warm."

    else: #She's angry
        if not the_person.on_birth_control:
            if the_person.relationship != "Single":
                $ so_title = SO_relationship_to_title(the_person.relationship)
                the_person "Heck! I told you to pull out! I have a [so_title], what if I got pregnant?"
                the_person "Whatever, I guess it's already done."
            else:
                the_person "Heck, I told you to pull out! What if I got pregnant."
                the_person "Whatever, I guess it's already done."
            ...
            the_person "Ugh, I told you to pull out! Stars, you made such a mess..."
...
label ellie_cum_anal(the_person):
...
label ellie_surprised_exclaim(the_person):
    $rando = renpy.random.choice(["Stars!","Crap!","Oh heck!","Ah! Oh stars!", "Ah!", "Holy crap!", "No way!"])
    the_person "[rando]"
    return
...
label ellie_sex_watch(the_person, the_sex_person, the_position):
...
label ellie_being_watched(the_person, the_watcher, the_position):
...
label ellie_work_enter_greeting(the_person):
...
label ellie_date_seduction(the_person):
    if the_person.has_role(girlfriend_role):
        ...
        if the_person.effective_sluttiness(["vaginal_sex", "condomless_sex"]) > 60 and the_person.wants_creampie() and the_person.effective_sluttiness() > the_person.get_no_condom_threshold() and the_person.get_opinion_score("bareback sex") >= 0 and the_person.get_opinion_score("creampies") >= 0 and not the_person.on_birth_control and not the_person.event_triggers_dict.get("preg_knows", False):
            ...
            the_person "Would you like to come home with me? Only one rule though: no condoms allowed. I want you to take me raw."
        ...
        if the_person.wants_creampie() and the_person.effective_sluttiness() > the_person.get_no_condom_threshold() and the_person.get_opinion_score("bareback sex") >= 0 and the_person.get_opinion_score("creampies") >= 0 and not the_person.on_birth_control and not the_person.event_triggers_dict.get("preg_knows", False):
            ...
            the_person "Would you like to come home and slide yourself into my tight pussy?"
            the_person "You'd have the whole night to do me however you want."
            ...
            the_person "Would you like to come home with me? For you I'll be the slut my [so_title] wishes I was."
        else:
...
label ellie_improved_serum_unlock(the_person):
...
label ellie_kissing_taboo_break(the_person):
...
label ellie_touching_body_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 30:
...
label ellie_touching_penis_taboo_break(the_person):
...
label ellie_touching_vagina_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 35:
...
label ellie_sucking_cock_taboo_break(the_person):
...
label ellie_licking_pussy_taboo_break(the_person):
...
label ellie_vaginal_sex_taboo_break(the_person): #TODO: add a "I dont do anal""you do for me" stle taboo break
...
label ellie_anal_sex_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 75:
        "[the_person.title] takes a few deep breaths."
        the_person "Whew, I think I'm ready!"
        the_person "Put it in my ass [the_person.mc_title]! Stretch me out and ruin me!"
        ...
        if the_person.has_taboo("vaginal_sex"):
            the_person "Stars, you must really like it tight. We've never even done it and you're going right for my asshole!"
            the_person "Are you even sure it's going to fit?"
            mc.name "I'll make it fit, but you might not be walking right for a few days."
            the_person "Oh stars..."
        else:
            the_person "Oh my god, you're actually going to do it! Stars, I hope you even fit!"
            mc.name "Don't worry, I'll stretch out your ass like I've stretched out all your other holes."
    return

label ellie_condomless_sex_taboo_break(the_person):
...
label ellie_underwear_nudity_taboo_break(the_person, the_clothing):
...
label ellie_bare_tits_taboo_break(the_person, the_clothing):
...
label ellie_bare_pussy_taboo_break(the_person, the_clothing):
...
label ellie_facial_cum_taboo_break(the_person):

    return

label ellie_mouth_cum_taboo_break(the_person):

    return

label ellie_body_cum_taboo_break(the_person):
...
label ellie_anal_creampie_taboo_break(the_person):

    return

label ellie_sex_toy_taboo_break(the_person):
    pass
    return

label ellie_roleplay_taboo_break(the_person):
    pass
    return

label ellie_sleepover_yourplace_response(the_person): #Invited her over to spend the night
    if the_person.sluttiness < 80:
...
label ellie_sleepover_herplace_response(the_person): #Spending the night at her place
    if the_person.sluttiness < 80:
...
label ellie_sleepover_yourplace_sex_start(the_person): #Right before sexy times at your place
...
label ellie_sleepover_herplace_sex_start(the_person): #Right before sexy times at her place
...
label ellie_sleepover_impressed_response(the_person):  #If you've made her cum a lot
...
label ellie_sleepover_good_response(the_person):  #If you've made her cum
    the_person "Ahhh, that was nice..."
    "[the_person.title] lies down in bed and catches her breath."
    the_person "I'm ready to go again if you are!"
    return

label ellie_sleepover_bored_response(the_person):  #If she hasn't cum yet
...
label ellie_lingerie_shopping_tame_response(the_person):
    the_person "Are you sure? This seems kinda tame..."
    mc.name "I know. I just want to see what it looks like on you."
    return

label ellie_lingerie_shopping_excited_response(the_person):
    the_person "Ah, this look great! I bet you will like this!"
    return

label ellie_lingerie_shopping_wow_response(the_person):
...
label ellie_GIC_finish_response(the_person, the_goal):
    if the_goal is None:
