...
label activate_myrabelle_mod_core(stack):
    python:
        ...
        alexia_myra_teamup_scene_init()
        # continue on the hijack stack if needed
        if alexia_myra_teamup_scene not in list_of_progression_scenes:
            list_of_progression_scenes.append(alexia_myra_teamup_scene)
...
label update_myrabelle_mod_core(stack):
    python:
        ...
        if "alexia_myra_teamup_scene" not in globals():
            alexia_myra_teamup_scene_init()
        else:
            alexia_myra_teamup_scene.compile_scenes(alexia_myra_teamup_scene)
