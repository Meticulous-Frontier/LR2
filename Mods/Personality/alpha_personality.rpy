    ...
    if the_person.arousal < 25:
        ...
        if the_person.sluttiness > 50:
            if the_person.relationship == "Single":
                ...
                $ so_title = SO_relationship_to_title(the_person.relationship)
                the_person.char "My [so_title] give me some anal, but I never felt like this, you can take my ass anytime, [the_person.mc_title]!"
        else:
            the_person.char "Oh lord, this is actually starting to feel good, keep this up, Yes, I'm going to cum!"
    return
...
label alpha_seduction_refuse(the_person):
    if the_person.sluttiness < 30:
        ...
        the_person.char "I'm sorry [the_person.mc_title], I know how much you appreciate me, but now isn't a good time for me."
    return
...
label alpha_flirt_response_low(the_person):
    if the_person.outfit == the_person.planned_uniform:
        if the_person.judge_outfit(the_person.outfit):
            ...
            the_person.char "Well, thank you, I agree, I do look good."
        else:
            #She's in uniform, but she thinks it's a little too slutty.
            if the_person.outfit.vagina_visible():
                # Her pussy is on display.
                the_person.char "I would not call it much of an uniform, this is not how a lady like me should dress."
                ...
                if the_person.has_large_tits():
                    the_person.char "Thank you, but I can tell this uniform was designed by an overexcited, horny man."
                    the_person.char "Large chested women, like myself, appreciate a little more support in their outfits to show off their best feature."
                else:
                    the_person.char "Thank you, but I do think you should consider a more respectable uniform in the future."
                    the_person.char "It's not my first choice to show my goods in the workplace, like a cheap bimbo."
                ...
                the_person.char "Thank you. But this is not appropriate for a lady, it should be more decent and respectable, like me."
                ...
                the_person.char "My wardrobe is damn perfect! Don't you suggest otherwise."
    ...
    if the_person.outfit == the_person.planned_uniform:
        if the_person.judge_outfit(the_person.outfit):
            if the_person.outfit.tits_visible():
                ...
                the_person.char "With my body and your fashion taste, how could I look bad? This uniforms is very flattering."
            ...
            the_person.char "The workplace isn't my best choice to show so much skin, someone else would have much bigger problem than me."
            mc.name "It may take some time to adjust, but with enough time you'll feel perfectly comfortable in it."
            "She smiles and nods."
            the_person.char "I already feel perfectly comfortable in it, I just don't know if everybody else here would feel the same way!"
    else:
        if the_person.effective_sluttiness() < 20 and mc.location.get_person_count() > 1:
            ...
            the_person.char "Thank you [the_person.mc_title]. I'm glad you like it."
            the_person.char "What do you think of it from the back? Do I look good from this angle?"
            $ the_person.draw_person(position = "back_peek")
            ...
            if not the_person.outfit.wearing_panties() and not the_person.outfit.vagina_visible(): #Not wearing underwear, but you can't see so she coments on it.
                the_person.char "My panties were always leaving unpleasant lines, so I had to stop wearing them."
            else:
...
label alpha_flirt_response_high(the_person):
    if mc.location.get_person_count() > 1 and the_person.effective_sluttiness() < (25 - (5*the_person.get_opinion_score("public_sex"))): # There are other people here, if she's not slutty she asks if you want to find somewhere quiet
        ...
        the_person.char "But if we were alone, I might show you a little more, if you behave."
        menu:
        ...
        if mc.location.get_person_count() == 1: #She's shy but you're alone
            ...
            the_person.char "I don't know what you mean [the_person.mc_title]."
            mc.name "It's just the two of us, you don't need to hide your feelings... I feel the same way."
            "She nods and takes a deep breath..."
            the_person.char "Okay, you might be right. What are your intentions now?"
        ...
        menu:
            ...
            "Just flirt":
                ...
                the_person.char "Well maybe if you take me out for dinner we can talk about those ideas, I would like you to elaborate."
    return
...
label alpha_flirt_response_girlfriend(the_person):
    if mc.location.get_person_count() > 1:
        ...
        if the_person.effective_sluttiness("kissing") < (25 - (5*the_person.get_opinion_score("public_sex"))):
            ...
            the_person.char "I wish we had a little more privacy, but that will have to wait."
            menu:
                "Find someplace quiet":
                ...
                "Just flirt":
                    ...
                    the_person.char "I'm sure we can find a way for you to satisfy me, but let's take it easy while other people are around."
            ...
            the_person.char "That was nice, you do know how to kiss."
            menu:
                "Make out":
                ...
                "Just flirt":
                    ...
                    if the_person.effective_sluttiness("sucking_cock") >= 60 or the_person.get_opinion_score("giving blowjobs") > 0:
                        ...
                        the_person.char "We will see about that, [the_person.mc_title]! I might have some places you may kiss..."
    else:
        # You're alone, so she's open to fooling around.
        "She smiles happily."
        the_person.char "Oh, well thank you [the_person.mc_title]. You might pleasure me again soon."
        ...
        menu:
            ...
            "Just flirt":
                ...
                the_person.char "Mmm, that's nice, when we have some more time together you can show me what else you can do."
...
label alpha_flirt_response_affair(the_person):
    ...
    if mc.location.get_person_count() > 1: #There are other people around, she's nervous about people finding out what you're doing.
        if (the_person.get_opinion_score("cheating on men") *15) + the_person.effective_sluttiness() > 50: #SHe's turned on by flirting in public or doesn't think anything is wrong with it
            the_person.char "Oh [the_person.mc_title], stop. If you keep talking like that you might get me excited."
            mc.name "And what would be so bad about that?"
            the_person.char "It would be so frustrating being in public and not being able to get my satisfaction."
            menu:
                "Find someplace quiet":
            ...
            the_person.char "You don't want my [so_title] to hear any rumours, do you? This thing would end so fast, you would regret it."
            "She runs a hand discretely along your arm."
            the_person.char "That would be a real shame, wouldn't it?"
        ...
        menu:
            ...
            "Just flirt":
                ...
                the_person.char "I understand. When we have the chance you can take your time and give me some pleasure."
    return
...
label alpha_flirt_response(the_person):
    if the_person.obedience > 130:
        ...
        if the_person.sluttiness > 50:
            ...
            the_person.char "I know you cannot take those greedy eyes off me."
        else:
            the_person.char "Well, I do look good, don't I [the_person.mc_title]?"
    return
...
label alpha_cum_face(the_person):
    if the_person.has_cum_fetish() or the_person.obedience > 130:
        if the_person.has_cum_fetish() or the_person.effective_sluttiness() > 70 or the_person.get_opinion_score("cum facials") > 0:
            ...
            the_person.char "Do you like to see my face covered [the_person.mc_title]? Am I your good [pronoun]?"
        else:
            the_person.char "It's everywhere! Next time point that thing somewhere else, I'm only doing this for you as a favor."
    else:
        if the_person.effective_sluttiness() > 70  or the_person.get_opinion_score("cum facials") > 0:
            the_person.char "Oh, yes [the_person.mc_title], I'm covered with your load, this is soo good for my skin!"
        else:
            if the_person.sex_record.get("Cum Facials", 0) < 3:
                ...
                the_person.char "Again? Are you not listening? Cum messes up my make up. Perhaps I should not do this anymore."
            else:
...
label alpha_cum_mouth(the_person):
    if the_person.has_cum_fetish() or the_person.obedience > 130:
        if the_person.has_cum_fetish() or the_person.effective_sluttiness() > 60 or the_person.get_opinion_score("drinking cum") > 0:
            the_person.char "It seems I did a good job, you do taste pretty good, [the_person.mc_title]."
        else:
            if the_person.sex_record.get("Cum in Mouth", 0) < 3:
                the_person.char "I'm really not into this, but I will make an exception for now, [the_person.mc_title]."
            else:
        ...
        if the_person.effective_sluttiness() > 70 or the_person.get_opinion_score("drinking cum") > 0:
            the_person.char "You do taste better than others [the_person.mc_title], you may fill my mouth with your load when I feel like it..."
        else:
            "She spits your cum on the floor..."
            if the_person.sex_record.get("Cum in Mouth", 0) < 4:
                the_person.char "You need to give me a warning next time, [the_person.mc_title]."
    return

label alpha_cum_vagina(the_person):
    if mc.condom:
        if the_person.sluttiness > 75 or the_person.get_opinion_score("creampies") > 0:
            the_person.char "Your seed is so close to me. Just a thin layer of latex separates it from me..."
        else:
        ...
        if the_person.sluttiness > 75 or the_person.get_opinion_score("creampies") > 0:
            if the_person.relationship!= "Single":
                ...
                if the_person.on_birth_control:
                    ...
                    the_person.char "If I become pregnant I will tell my [so_title]'s its his, I'm sure he will accept that."
            else:
                if the_person.on_birth_control:
            ...
            if the_person.relationship!= "Single":
                $ so_title = SO_relationship_to_title(the_person.relationship)
                if the_person.on_birth_control:
                    the_person.char "Oh yes, give me your hot cum right now."
                    the_person.char "My [so_title] hasn't satisfied me like this for months."
                else:
                    the_person.char "Oh shit, you needed to cum outside, [the_person.mc_title]."
                    the_person.char "What would I tell my [so_title] if I got pregnant, he might not believe it's his!"
            else:
                if the_person.on_birth_control:
                    the_person.char "Oh yes, shoot that hot cum right inside me."
                    the_person.char "Perhaps I should stop taking the pill and get pregnant, it would be nice to be a mother."
                else:
                    the_person.char "Oh FUCK, [the_person.mc_title], I told you not to cum inside me."
    ...
    if the_person.relationship == "Single":
        ...
        if the_person.sluttiness > the_person.love:
            ...
            if the_person.love > 40:
                ...
                the_person.char "Why don't you come over to my place so we can spend more time together."
            else:
                the_person.char "Tonight was fantastic. I think my [so_title] is out for the night."
                the_person.char "So come with me to my place and you can open a bottle of wine for us."
    return
    ...
    if the_person.sluttiness > 50:
        if the_person.love > 40:
            if the_person.arousal > 60:
                the_person.char "Is that it? You think you can drive me crazy [the_person.mc_title], well I'm really horny..."
            else:
                the_person.char "All done? I was expecting a little more from you."
        else:
            if the_person.arousal > 60:
                the_person.char "Already done? You can't stop now, I'm so excited at the moment..."
            else:
                the_person.char "Leaving already? Well, that's very disappointing."

    else:
        if the_person.love > 40:
            if the_person.arousal > 60:
                the_person.char "That's it? Well, you could at least pleasure me too."
            else:
                the_person.char "All done? Fine, we will pick this up another time."
        else:
            if the_person.arousal > 60:
                the_person.char "Already tired [the_person.mc_title]? Did I exhaust you? We definitely need to do something about that."
            else:
                the_person.char "That's all you wanted? This is far from over, but for now you can go."
    return
...
label alpha_kissing_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 30:
        the_person.char "Oh, well hello there! Do you want to pleasure me?"
        ...
        the_person.char "Alright, one kiss, for starters."
    return
...
label alpha_touching_body_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 30:
        ...
        mc.name "What?"
        the_person.char "I've had dreams just like this before, you giving my body the pleasure it deserves."
        ...
        the_person.char "Somehow it's harder to deny you."
    else:
        the_person.char "You shouldn't be doing this [the_person.mc_title]. We barely know each other."
        mc.name "You don't want me to stop though, do you?"
        the_person.char "For now, hmm, you may continue."
        mc.name "Then let me show you."
    return

label alpha_touching_penis_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 35:
        the_person.char "Look at how big your penis is. Darn, did I just find the right one for me?"
        the_person.char "Relax [the_person.mc_title], and let me enjoy it, okay?"
    elif the_person.love >= 20:
        the_person.char "Oh dear, if I'm honest I wasn't expecting it to be quite so substantial."
        mc.name "Don't worry, it doesn't bite. Go ahead and touch it, I want to feel your hand on me."
        "She bites her lip playfully."
    else:
        the_person.char "We will stop here, I don't want you to get the wrong idea about me."
        ...
        the_person.char "It is very large, I just need to feel it for a moment."
...
label alpha_touching_vagina_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 35:
        ...
        the_person.char "I'm as excited as a little girl. Does a woman like me make you feel that way too [the_person.mc_title]?"
        mc.name "Just take a deep breath and relax. You trust me, right?"
        the_person.char "We will see if I can trust you."
    else:
        the_person.char "We shouldn't be doing this [the_person.mc_title]."
        mc.name "Just take a deep breath and relax. I'm just going to touch you a little, and if you don't like it I'll stop."
        the_person.char "Be very meticulous with your motions or this will end very fast."
...
label alpha_sucking_cock_taboo_break(the_person):
    ...
    if the_person.effective_sluttiness() >= 45:
        the_person.char "I should say no."
        mc.name "But you aren't going to."
        "She shakes her head."
        the_person.char "I've told all my male partners that I don't do that, but with you, I can see me doing it."
        ...
        the_person.char "I'm curious... and I've decided that I'll just give it a taste and see how it feels."
        mc.name "Alright, we can start slow and go from there."
    else:
        the_person.char "Did you just say something I don't want to hear?"
        mc.name "No you didn't. I want you to put my cock in your mouth and suck on it."
        the_person.char "I will not do something like that [the_person.mc_title], who do you think I am?"
        the_person.char "I'm not some kind of cheap floozy that you pickup on a street corner, I don't \"suck cocks\"."
        mc.name "Yeah you do, and you're going to do it for me."
        the_person.char "And why should I do that?"
        ...
        the_person.char "You shouldn't be able to do this to me, [the_person.mc_title], I'm better than this..."
    return
...
label alpha_licking_pussy_taboo_break(the_person):
    ...
    if the_person.effective_sluttiness() >= 45:
        ...
        the_person.char "You're such a gentleman [the_person.mc_title], but I don't want to, thank you."
        ...
        the_person.char "Alright then, I've changed my mind, you can go to work now."
    else:
        the_person.char "You're a gentleman [the_person.mc_title], but I don't feel like it."
        ...
        "[the_person.title] won't admit it..."
        the_person.char "Alright then, I've changed my mind, I usually just tell them they have to satisfy me."
...
label alpha_vaginal_sex_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 60:
        ...
        if the_person.has_taboo("anal_sex"):
            ...
            the_person.char "Alright, get over here and show me what you can do."
        else:
...
label alpha_anal_sex_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 75:
        ...
        the_person.char "This is really something I want you to do [the_person.mc_title]."
        ...
        if the_person.has_taboo("vaginal_sex"):
            ...
            the_person.char "I don't want to do this [the_person.mc_title]... I'm not even sure if you can fit inside me there."
...
label alpha_condomless_sex_taboo_break(the_person):
    if the_person.get_opinion_score("bareback sex") > 0:
        ...
        if the_person.on_birth_control:
            ...
            the_person.char "You will pull out, I hate having it dripping out of me all day."
        else:
            the_person.char "You will pull out, I don't want to get pregnant."

    elif the_person.love > 60:
        the_person.char "If you think you're ready for this commitment, I am to. I want to feel close to you."
        if the_person.get_opinion_score("creampies") > 0:
            if the_person.on_birth_control:
                the_person.char "When you're going to finish, I want you to fill me up with your hot load."
            else:
                the_person.char "Although I would like to feel you're cum filling me up, you can't cum inside me, understood!"
        elif the_person.get_opinion_score("creampies") < 0:
            if the_person.kids == 0:
                the_person.char "You will pull out, do you understand? I really don't plan to become a mother."
            else:
                the_person.char "You will pull out, do you understand? I've been pregnant before and it isn't nice."
        else:
            if the_person.kids == 0:
                the_person.char "You will pull out. I really don't plan to become a mother."
            else:
                the_person.char "You will pull out, understood! You are definitely not ready for little babies."
        ...
        if the_person.has_taboo("vaginal_sex"):
            ...
            if the_person.on_birth_control:
                the_person.char "You really want to do it raw? Well, I'm on birth control, so lets make this special."
            else:
                the_person.char "I want you to be very careful where you finish, do you understand?"
        else:
            mc.name "It will feel so much better raw, for both of us."
            the_person.char "You might be right about that."
            "She takes a moment to think, then nods."
            if the_person.on_birth_control:
                "She takes a moment to think, then nods."
            else:
                the_person.char "Fine, you don't need a condom, but be very careful where you finish, do you understand?"
    return
...
label alpha_underwear_nudity_taboo_break(the_person, the_clothing):
    if the_person.effective_sluttiness() > 30 - (the_person.get_opinion_score("skimpy outfits") * 5):
        ...
        if the_person.has_taboo(["bare_tits","bare_pussy"]):
            ...
            the_person.char "Yes, you are right, lets go."
    return
...
label alpha_bare_tits_taboo_break(the_person, the_clothing):
    if the_person.effective_sluttiness() > (40 - the_person.get_opinion_score("showing her tits") * 5):
        ...
        the_person.char "Well I'm glad I have that effect on you. And you always know the right thing to say to me."
        "She takes a moment to think, then nods."
        the_person.char "You can take off my [the_clothing.display_name] and have a look."
    return
...
label alpha_bare_pussy_taboo_break(the_person, the_clothing):
    if the_person.effective_sluttiness() > (50 - the_person.get_opinion_score("showing her ass") * 5):
        ...
        the_person.char "Well! I'm not that kind of woman [the_person.mc_title]!"
        if the_person.has_taboo("touching_vagina"):
            mc.name "Don't you want to be though? Don't you want me to enjoy your body?"
            the_person.char "I might, but I shouldn't, it's not appropriate."
        else:
            mc.name "Of course you are! I've touched you before, I just want to feel what I was feeling before."
            the_person.char "This wasn't what I intended."
