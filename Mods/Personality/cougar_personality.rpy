...
label cougar_flirt_response_low(the_person):
    if the_person.outfit == the_person.planned_uniform:
        if the_person.judge_outfit(the_person.outfit):
            ...
            the_person.char "Well, thank you, young man, I appreciate the complement."
        else:
            ...
            if the_person.outfit.vagina_visible():
                ...
                the_person.char "I understand it's the company uniform, but a woman my age would like a little more coverage."
                ...
                if the_person.has_large_tits():
                    the_person.char "Thank you, but I can tell this uniform was designed by a horny boy."
                    ...
                    the_person.char "It still doesn't feel natural showing my goods off like a young girl."
                ...
                the_person.char "Thank you. But this is not appropriate for my age, it should be more descent and respectable, like me."
        ...
        the_person.char "Boys will be boys."
    return
    ...
    if the_person.outfit == the_person.planned_uniform:
        if the_person.judge_outfit(the_person.outfit):
            if the_person.outfit.tits_visible():
                ...
                "She smiles softly."
                the_person.char "You know just what to say to make a woman my age feel special."
    ...
    if mc.location.get_person_count() > 1 and the_person.effective_sluttiness() < (25 - (5*the_person.get_opinion_score("public_sex"))): # There are other people here, if she's not slutty she asks if you want to find somewhere quiet
        ...
        menu:
            "Find someplace quiet":
                ...
                the_person.char "And what are you planning now, my young stud?"
            ...
            "Just flirt":
                ...
                the_person.char "You're a smart boy, you'll figure something out."
        ...
        if mc.location.get_person_count() == 1: #She's shy but you're alone
            ...
            the_person.char "Okay, you're right. What are you're intentions young man?"
            ...
            the_person.char "Well, have you made up your mind, my young stud?"
...
label cougar_flirt_response_girlfriend(the_person):
    ...
    if mc.location.get_person_count() > 1:
        ...
        "She smiles happily."
        the_person.char "Oh, well thank you [the_person.mc_title]. I'm lucky to have such a handsome boy."
...
label cougar_cum_pullout(the_person):
    ...
    if mc.condom:
        the_person.char "Come on [the_person.mc_title], shoot your fertile semen right into me!"

    else:
        if the_person.wants_creampie():
            if the_person.event_triggers_dict.get("preg_knows", False): #She's already knocked up, so who cares!
                the_person.char "Cum for me [the_person.mc_title], I want feel your fertile seed shooting right into me!"
            elif the_person.get_opinion_score("creampies") > 0:
                "[the_person.possessive_title] moans happily."
                if the_person.on_birth_control: #She just likes creampies.
                    the_person.char "Oh [the_person.mc_title], I want you to cum inside me! I want to feel every last drop of your cum!"
                else: #Yeah, she's not on BC and asking for you to creampie her. She's looking to get pregnant.
                    the_person.char "Oh [the_person.mc_title], I want your strong cum inside me! I want you to become pregnant from my beautiful stud!"
            elif the_person.on_birth_control: #She's on the pill, so she's probably fine
                the_person.char "Cum for me! You can let it out whenever you want!"
            ...
            if not the_person.on_birth_control: #You need to pull out, I'm not on the pill!
                the_person.char "Wait! You need to pull out, I don't want to become pregnant!"
            elif the_person.get_opinion_score("creampies") < 0:
...
label cougar_cum_condom(the_person):
    if the_person.effective_sluttiness() > 75 or the_person.get_opinion_score("creampies") > 0:
        the_person.char "Oh... your fertile seed is so close to me. Just thin condom keeping your semen from my womb..."
    else:
        the_person.char "I can feel your young seed pulsing against the condom, it's so strong."
    return
    ...
    if mc.condom:
        ...
        if the_person.event_triggers_dict.get("preg_knows", False):
            ...
            if the_person.relationship != "Single":
                ...
                the_person.char "Oh [the_person.mc_title], you turn in me into such a slutty woman."
            else:
        ...
        if not the_person.on_birth_control:
            ...
            the_person.char "I know you're having a good time, but I still have an [so_title], you need to respect my boundaries."

        elif the_person.get_opinion_score("creampies") < 0:
            the_person.char "[the_person.mc_title], I told you to pull out. Now look at the mess you've made... It's everywhere."
...
label cougar_touching_body_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 30:
        ...
        the_person.char "You're young and reckless. I always get the feeling you're bad news for me, but..."
        the_person.char "But somehow I just can't say no to you."
    else:
...
label cougar_touching_penis_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 35:
        the_person.char "Look at how big your penis is. You poor boy, that must be very uncomfortable."
...
label cougar_touching_vagina_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 35:
        ...
        the_person.char "I'm as nervous as a little girl. Does a grown woman make you feel that way too [the_person.mc_title]?"
...
label cougar_sucking_cock_taboo_break(the_person):
    ...
    if the_person.effective_sluttiness() >= 45:
        ...
        the_person.char "Well, I think I'm a little more sophisticated than that."
...
label cougar_vaginal_sex_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 60:
        ...
        the_person.char "Come on and show me what you can do with that monster!"
...
label cougar_anal_sex_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 75:
        ...
        if the_person.has_taboo("vaginal_sex"):
            ...
            the_person.char "Oh lord, what happened to me..."
            the_person.char "I used to think I was a respectable lady, now I'm about to get fucked in the ass..."
...
label cougar_condomless_sex_taboo_break(the_person):
    if the_person.get_opinion_score("bareback sex") > 0:
        ...
        if the_person.on_birth_control:
            ...
            the_person.char "You will need to pull out though, I hate having it dripping out of me all day or worse getting pregnant."
        ...
        if the_person.get_opinion_score("creampies") > 0:
            ...
            mc.name "Are you on the pill?"
            if the_person.on_birth_control:
                the_person.char "I'm taking birth control, but I would like you to cum on me instead of inside me."
            else:
                "She shakes her head."
                if the_person.kids == 0:
                    the_person.char "I don't want you to make me a mother."
                else:
                    the_person.char "I've been pregnant enough and you are definitely not ready for daddy duty."
    else:
...
label cougar_bare_tits_taboo_break(the_person, the_clothing):
    if the_person.effective_sluttiness() > (40 - the_person.get_opinion_score("showing her tits") * 5):
        ...
        the_person.char "Young man! If you take off my [the_clothing.display_name] I won't be decent any more!"
        ...
        the_person.char "Well I'm glad I have that effect on you. I suppose...I could make an exception..."
