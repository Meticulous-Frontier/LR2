...
label public_sex_post_round(the_person, position_choice, report_log):
    ...
    if mc.location.privacy_level == 0:  #Its a private room, don't do anything
        ...
        if scrutiny < 25:
            ...
            if "police_chief" not in globals() or police_chief is None: # Nobody can arrest you
                "Now is when the police would normally show up, but they are missing for some reason."
            elif the_person == police_chief: #Exclude scrutiny when doing the police chief
