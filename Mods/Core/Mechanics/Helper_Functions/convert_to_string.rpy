    ...
    def get_person_weight_string(person):
        ...
        if use_imperial_system:
            ...
            if person.pregnancy_is_visible():
                ...
                weight += (1 - ((person.get_due_day() - day) / (person.get_due_day() - person.pregnancy_show_day()))) * 25
            ...
            if person.pregnancy_is_visible():
                ...
                weight += (1 - ((person.get_due_day() - day) / (person.get_due_day() - person.pregnancy_show_day()))) * 11.4
