...
label set_uniform_description_enhanced():
    ...
    call screen import_outfit_manager(mc.designed_wardrobe, slut_limit = slut_limit, underwear_limit = underwear_limit, limited_to_top = limited_to_top, show_export = False)
