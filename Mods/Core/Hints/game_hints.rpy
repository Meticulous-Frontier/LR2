...
init -1 python:
    ...
    game_hints.append(Hint("Nora's Research Motherly Devotion", "Interview your Mom when her sluttiness > 75 and love > 75. nPermanently increases the recipient's Love by 1 per turn for every 10 points that their Sluttiness is higher than Love.", "bool(exists_in_location_action_list(university, 'nora_special_research')) and the_person is nora and not nora_reward_mother_trait in list_of_traits", "nora_reward_mother_trait in list_of_traits"))
    game_hints.append(Hint("Nora's Research Sisterly Obedience", "Interview your Sister when her sluttiness > 75 and obedience > 130. Permanently increases the recipient's Sluttiness by 1 per day for every 10 points that their Obedience is above 100.", "bool(exists_in_location_action_list(university, 'nora_special_research')) and the_person is nora and not nora_reward_sister_trait in list_of_traits", "nora_reward_sister_trait in list_of_traits"))
