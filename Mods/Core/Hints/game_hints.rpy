...
init -1 python:
    ...
    game_hints.append(Hint("Nora's Trance Inducer", "Interview anyone who is in a very heavy trance role. Instantly puts some in a trance, does not deepen trance.", "bool(exists_in_location_action_list(university, 'nora_special_research')) and the_person is nora and not nora_reward_instant_trance in list_of_traits", "nora_reward_instant_trance in list_of_traits"))
