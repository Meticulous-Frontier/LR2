...
init -1 python:
    ...
    # Hints for Kaya
    game_hints.append(Hint("Ask Kaya Out", "Go to the coffee shop and increase Kaya's love to greater than 20 and in the evening ask Kaya on a date.", "kaya.event_triggers_dict.get('intro_complete', False)", "not kaya.event_triggers_dict.get('drink_date_complete', False)"))
