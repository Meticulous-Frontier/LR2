init 1 python:
    ...
    market_targeted_advertising_project = IT_Project(name = "Targeted Advertising",
    ...
    production_equipment_selftest_project = IT_Project(name = "Equipment Selftesting",
        desc = "Production equipment now runs an end of the day self test. Reduces supplies wasted for manual chemical testing. Supply usage -5%.",
        cost = 0,
        requirement = None,
        toggleable = False,
        on_buy_function = None,
