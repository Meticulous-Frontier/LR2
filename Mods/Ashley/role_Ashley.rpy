...
label ashley_stephanie_saturday_coffee_intro_label(the_person):
    ...
    stephanie.char "Hey boss! Me and Ash are just having a cup of coffee before we go our separate ways. It's kind of become our little tradition every Sunday morning, since she moved in with me."
    "She looks over at her sister and starts to tease her. "
    stephanie.char "I think she said something about hitting up the gym today... I think there's a guy she's trying to impress!"
    the_person.char "Oh my gosh Steph, stop it!"
    ...
    the_person.char "Ah. Errm... Well..."
    "She's sputtering out unintelligible mumbles."
    stephanie.char "Don't worry Ash. I'm sure whoever it is will appreciate you putting in the time to keep your body fit!"
    "[the_person.possessive_title] is relieved when her sister intervenes and changes the subject."
    stephanie.char "Hey, why don't you grab a coffee and join us? It's kind of nice to hang out in a non-work environment."
    ...
    the_person.char "It's fine! We live together, remember?"
    ...
    the_person.char "I mean... It would be okay, right? We don't mind at all..."
    ...
    stephanie.char "No thanks! We're good for now, but maybe another time we'll let you buy us coffees!"
    ...
    menu:
        ...
        "[stephanie.title]" if not ashley_is_normal_path():
            ...
            stephanie.char "Have a seat, [stephanie.mc_title]."
    ...
    the_person.char "... but yeah, I have to say I [text_one] [text_two]"
    ...
    stephanie.char "Well, I'd better get going. I've got some errands to run!"
    "You stand up and both girls also get up."
    mc.name "Thank you for the pleasant morning. You two have a good day."
    stephanie.char "You bet boss! We do this pretty much every Sunday. Feel free to join us!"
    ...
    stephanie.char "Next week you're buying the coffees though!"
...
label coffee_time_innocent_chat_label():
    ...
    $ text_one = person_opinion_to_string(the_person, overhear_topic)[1]
    $ text_two = get_topic_text(overhear_topic)
    the_person.char "... but yeah, I'm not sure he realizes I [text_one] [text_two]"
    if the_person.discover_opinion(overhear_topic):
        "Oh! You didn't realize that [the_person.title] felt that way."
    ...
    $ text_two = get_topic_text(overhear_topic)
    stephanie.char "...But I [text_one] [text_two], so I'm not sure what to do."
...
label coffee_time_sexy_chat_label():
    ...
    $ text_one = person_opinion_to_string(stephanie, overhear_topic)[1]
    $ text_two = get_topic_text(overhear_topic)
    stephanie.char "... but yeah, I have to say I [text_one] [text_two]"
    if stephanie.discover_opinion(overhear_topic):
    ...
    $ text_one = person_opinion_to_string(the_person, overhear_topic)[1]
    $ text_two = get_topic_text(overhear_topic)
    the_person.char "...But I [text_one] [text_two], so I'm not sure what to do."
    if the_person.discover_opinion(overhear_topic):
                    ...
                    "Stop":
                        ...
                        if stephanie.is_girlfriend():
                            ...
                            menu:
                                ...
                                "Not tonight":
                                    mc.name "I can't tonight, maybe another night..."
                        "[stephanie.possessive_title] release your erection, leaving it aching with need. You quickly put yourself away and zip up as [the_person.title] finishes pulling up a picture on her phone."
