...
label HR_director_mod_init():
    python:
        ...
        HR_director_role = Role("HR Director", []) #Actions go in block
    return
...
label HR_director_monday_meeting_label(the_person):
    ...
    $ the_person.draw_person(postion = "sitting")
    the_person.char "Here are my plans for the week. I think I have a few tweeks to efficiency I can make, but overally I wouldn't expect to see a big change company wide."
    ...
    menu:
        ...
        "Call one in":
            ...
            the_person.char "Ok! Let me see who I have on my list here..."
            call HR_director_personnel_interview_label(the_person, max_opinion = (business_HR_tier - 1)) from HR_DIR_INTERVIEW_CALL_2
    mc.name "Alright, I think that is all for today. Unless something comes up, same time next week?"
    $ the_person.draw_person(position = "stand2")
    the_person.char "Sounds great! I'll see you then!"
...
label HR_director_personnel_interview_label(the_person, max_opinion = 0):
    ...
    "The girl sit down across from you at your desk. [the_person.title] takes the lead."
