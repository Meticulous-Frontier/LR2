...
label enhanced_special_training_crisis_label():
    ...
    menu:
        "Send [the_person.title] to the Seminar. -$500" if mc.business.funds >= 500:
            ...
            if not mc.is_at_work():#NOTE: So far the branches expect you to be in the office.
                return
            ...
            if the_person.sluttiness >= 20:
                ...
                $ the_clothing = None
            elif the_person.sluttiness >= 90 or (the_person.sluttiness >= 60 and the_person.get_opinion_score("being covered in cum")) > 0 or (the_person.sluttiness >= 60 and the_person.get_opinion_score("giving blowjobs") > 0) or (the_person.sluttiness >= 60 and the_person.get_opinion_score("big dicks") > 0):
