    ...
    if person_one.effective_sluttiness() < 30: #If our slutty person isn't very slutty in the first place.
        ...
        menu:
            "Stop to listen":
                ...
                person_two "Hey! That's... Come on [person_one.name], we should get back to work. Goodbye [person_two.mc_title]."
        ...
        menu:
            "Investigate":
                ...
                if person_two.effective_sluttiness() < 20:
                    ...
                    $ person_two.change_stats(slut = 2, obedience = 2)
                    ...
                    mc.name "Settle what?"
                    person_one "[person_two.name] won't admit she's got the better tits of the two of us. Talk some sense into her for me."
                        ...
                        "I'm going to need a closer look" if not person_one.outfit.tits_visible() or not person_two.outfit.tits_visible(): #Requires high obedience, sluttiness, or a uniform policy for the less slutty girl.
                            ...
                            if not person_two.outfit.tits_visible():
                                ...
                                if person_two.get_opinion_score("showing her tits") > 0:
                                    ...
                                    mc.name "Just consider this a temporary change to your uniform, [person_two.name]. I could have you walking around topless all day if I wanted to."
                            ...
                            menu:
                                ...
                                "[person_two.name] has nicer tits": # She gets a sluttiness boost along with a small love boost.
                                    ...
                                    $ person_two.change_stats(slut = 1 + person_one.get_opinion_score("showing her tits"), love = 1 + person_one.get_opinion_score("showing her tits"))
                                    $ scene_manager.update_actor(person_one, emotion = "happy")
                    ...
                    if person_two.effective_sluttiness("sucking_cock") < 50: #She's embarrassed, but wants to do it
                        ...
                        if person_two.sex_record.get("Blowjobs", 0) == 0:
                            ...
                            person_one "[person_two.name] really liked sucking your cock and wants to do it again, but was too scared to ask."
                        $ scene_manager.update_actor(person_two, emotion = "default")
