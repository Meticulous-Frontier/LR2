    ...
    if the_person.effective_sluttiness(["touching_penis", "sucking_cock"]) > 50:
        ...
        if mc.energy < 50:
            ...
            if the_person.has_taboo("condomless_sex") and the_person.is_willing(tit_fuck): #Mid sluttiness path.
                ...
                call fuck_person(the_person, start_position = handjob, start_object = make_floor(), skip_intro = True, position_locked = True) from _call_fuck_person_mom_outfit_help_crisis_04
