...
init 2 python:
    def mom_sister_snooping_requirement():
        if not day%7 == 5 and time_of_day == 0 and mc_at_home(): # not on saturday mornings
            return True
        return False
...
label mom_sister_snooping_action_label():
    ...
    if mom.sluttiness < 20 and lily.sluttiness < 20:
        ...
        lily.char "... but yeah, I'm not sure he realizes I [text_one] [text_two]"
        ...
        $ text_two = get_topic_text(overhear_topic)
        mom.char "...But I [text_one] [text_two], so I'm not sure what to do."
        ...
        $ text_one = person_opinion_to_string(mom, overhear_topic)[1]
        $ text_two = get_topic_text(overhear_topic)
        mom.char "... but yeah, I'm not sure he realizes I [text_one] [text_two]"
        if mom.discover_opinion(overhear_topic):
        ...
        $ text_one = person_opinion_to_string(lily, overhear_topic)[1]
        $ text_two = get_topic_text(overhear_topic)
        lily.char "...But I [text_one] [text_two], so I'm not sure what to do."
        if lily.discover_opinion(overhear_topic):
        ...
        lily.char "You keep saying that, but I wish they were more like yours..."
        "[lily.title] reaches over and puts one of her hands on [mom.possessive_title]'s tits."
        lily.char "They're so full and soft."
        "Damn. What are they doing in there? Comparing assets?"
        mom.char "Honey, you just have to work with what you've been given. Let mama help. Show me what you're working with."
        lily.char "Okay mom..."
        ...
        mom.char "See? Any man would be love to get their hands on you. You just have to learn to work with what you have."
        mom.char "I have to actively cover up, to keep from getting too much attention..."
        lily.char "Why would you do that!?! I'd kill to have your figure..."
        ...
        mom.char "I don't know, I just feel like they are such a distraction sometimes..."
        "[mom.title] is holding her own tits, a bit self conciously."
        lily.char "Don't say that, they are so beautiful..."
        ...
        lily.char "What do you mean?"
        mom.char "A beautiful young woman like you, maybe you could fold the top of your skirt? Show those beautiful legs of yours!"
        lily.char "Mom!"
        mom.char "Or leave a couple buttons open on your blouse?"
        lily.char "Stop! I don't want guys to think I'm a slut."
        "[mom.title] gives a laugh."
        mom.char "Honey, they won't think you're a slut. A body as young and firm as yours needs to be shown off a little!"
        mom.char "Sure you might get a little extra attention, but there's nothing wrong with that!"
        "[lily.title] laughs this time."
        lily.char "I guess it couldn't hurt to try..."
        $ lily.change_slut_temp(5)
        "They keep talking, but you decide to keep headed to bathroom. You wouldn't want to get caught snooping around, anyway!"
        ...
        lily.char "It's fine mom. I just roll it up a little at the top, no one even notices. Well, except for this one professor... I like to sit in the front and..."
        mom.char "That's enough... I don't need to hear about this! Young lady unroll that skirt right now."
        lily.char "Mom! It's fine! There's nothing wrong with a little fun. Besides, he really enjoys it. Especially if I leave the top couple buttons open on the blouse..."
        mom.char "Oh my. Lily, what am I gonna do with you."
        "[lily.title] gives a little laugh."
        lily.char "Its okay mom. Say, you should try something like this sometime!"
        mom.char "Why I would never..."
        lily.char "Didn't you say it felt like your boss was checking you out? It wouldn't hurt to get on his good side..."
        mom.char "I'm not gonna dress like a slut to get my boss to like me!"
        lily.char "I'm not saying to go to work naked! Besides, a body like yours needs to be shown off once in a while!"
        lily.char "Sure, you might get a little extra attention, but there's nothing wrong with that!"
        "[mom.title] gives a laugh."
        mom.char "I guess it couldn't hurt to try..."
        $ mom.change_slut_temp(5)
        "They keep talking, but you decide to keep headed to bathroom. You wouldn't want to get caught snooping around, anyway!"
