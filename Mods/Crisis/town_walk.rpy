...
label town_walk_crisis_action_label:
    ...
    "While walking around town, you see that the window in [the_person.possessive_title!l]'s house is open..."
    menu:
        "Get closer":
            pass
        "Ignore it":
    ...
    "You see [the_person.possessive_title!l] is standing in front of a mirror, studying herself."
    ...
    if (the_person.strip_outfit_to_max_sluttiness(narrator_messages = [
        ...
        if the_person.outfit.vagina_available():
            ...
            "You see that [the_person.possessive_title!l] also studies her pussy."
            ...
            "You see that [the_person.possessive_title!l] is looking at her breasts."
    ...
    if the_person.outfit.vagina_available() and (the_person.sluttiness >=50 or the_person.get_opinion_score("masturbating") > 0 or the_person.arousal > 35):
        ...
        if the_person.outfit.vagina_available():
            ...
            "You notice that with one hand [the_person.possessive_title!l] squeezes her tits, while shoving the other between her legs."
        ...
        $ mc.change_locked_clarity(20)
        #"You see [the_person.possessive_title!l]'s body shiver as she reaches orgasm." NOTE: Things like this gets mentioned in the climax_responses
