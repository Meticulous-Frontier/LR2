...
label sister_ntr_crisis_action_label:
    ...
    "You drag yourself out of bed and enter the hallway. There is a trace of light down the door to [the_person.possessive_title!l]'s bedroom."
    ...
    if ran_num == 1: ## a scene with one man
        if the_person.sluttiness < 40:
            ...
            "Now you recognize the man - it is [man_name], [the_person.possessive_title!l]'s coed."
