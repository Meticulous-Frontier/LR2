...
init 3 python:
    ...
    sister_ntr_mod_action = ActionMod("Sister NTR",sister_ntr_crisis_requirement,"sister_ntr_crisis_action_label",
        menu_tooltip = "At night you hear strange sounds out of [lily.possessive_title!l]'s bedroom", category = "NTR",
...
label sister_ntr_crisis_action_label:
    ...
    "You drag yourself out of bed and down the hallway. There is a trace of light under the door to [the_person.possessive_title!l]'s bedroom and it is slightly cracked."
    ...
    if ran_num == 1: ## a scene with one man
        if the_person.sluttiness < 40:
            ...
            "You see [the_person.possessive_title!l] kissing a young man. On the table there are some college books lying around. Seems they decided to take a break from studying."
            the_person "Oh, [man_name]. You are so sweet, agreeing to help me with homework. I could not have done this myself!"
            "Now you recognize the man. It is [man_name], [the_person.possessive_title!l]'s friend."
            man_name "No a problem at all!"
            "They go back to kissing. [man_name] moves his hands to [the_person.possessive_title!l] butt and starts caressing it."
            the_person "Mmmmm... Your hands are so gentle..."
            "You see [man_name] starts to undress [the_person.possessive_title!l]."
            $ the_person.strip_outfit_to_max_sluttiness(narrator_messages = "He takes off [the_person.possessive_title!l]'s [strip_choice.name] and throws it on a chair.")
            ...
            "He gets away from [the_person.possessive_title!l] and starts picking up his books from the table."
            ...
            if target_position == "missionary":
                ...
                "You take a look inside the room and you see [the_person.possessive_title!l] lying on the table with wide spread legs. And some young man is between them with his pants down."
                ...
                if the_person.get_opinion_score("being submissive") > 0:
                    "[man_name] grabs [the_person.possessive_title!l] legs and thrusts himself into her with some force."
                    the_person "Yes, [man_name]. Fuck me harder! Be rough with me!"
                $ the_person.change_arousal (26)
                "After a few more moves, [the_person.possessive_title!l] seems to have reached an orgasm."
                ...
                if finish == "facial":
                    ...
                    "He strokes his dick for few moments and starts to cover [the_person.possessive_title!l]'s face with hot semen."
                    ...
                    "After few seconds [man_name] gets off from [the_person.possessive_title!l]. You see a trace of his white liquid dripping from her pussy."
                    ...
                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                    "His weakened dick falls out from [the_person.possessive_title!l]'s mouth. She looks up and smiles. She swallows most of it, but you still see traces around her mouth."
                ...
                "You take a look inside the room and you see [the_person.possessive_title!l] pushed against the wall. And some young man is doing her with his pants down."
                the_person "Oh, [man_name]! You are so good! Keep going!"
                ...
                if the_person.get_opinion_score("being submissive") > 0:
                    "[man_name] grabs [the_person.possessive_title!l]'s buttocks and squeezes them with some force."
                    the_person "Oh, yes, [man_name]. Be rough with me! I love being owned by a man."
                $ the_person.change_arousal (26)
                "After a few more thrusts, [the_person.possessive_title!l] seems to have reached an orgasm."
                ...
                if finish == "facial":
                    ...
                    "He strokes his dick for few moments and starts to cover [the_person.possessive_title!l] face with hot semen."
                    $ cum_on_face_ntr(the_person)
                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                    the_person "Yes! That's it! Cover my face!"
                    "After [man_name] finishes, she looks him in the eyes."
                ...
                "You take a look inside the room and you see [the_person.possessive_title!l] bend over the chair. And some young man thrusts his dick into [the_person.possessive_title!l] little ass."
                the_person "Oh, [man_name]! You are so good! I like it in my ass."
                "You see some books lying on the table. Seems they were studying and got little bored. Judging by the sweat on their bodies and loud moans, the seem to be relaxing for some time now."
                if the_person.get_opinion_score("being submissive") > 0:
                    "[man_name] slaps [the_person.possessive_title!l]'s buttocks. You see some red there. He must done so before."
                ...
                if finish == "facial":
                    ...
                    $ cum_in_vagina_ntr(the_person)
                    $ the_person.draw_person(position = "standing_doggy")
                    "The man take his cock from [the_person.possessive_title!l] ass and sticks it into her vagina."
                    "After a few hard thrusts, [man_name] starts spilling his semen into [the_person.possessive_title!l]."
                    the_person "Yes, [man_name]! I want it in me!"
                    "After few seconds [man_name] gets off from [the_person.possessive_title!l]. You see a trace of his white liquid dripping from her pussy."
                    man_name "What a nice view! [the_person.name] [the_person.last_name] fucked and creampied."
                ...
                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                "You take a look inside the room and you see [the_person.possessive_title!l] on her knees. And some young man thrusts his dick into [the_person.possessive_title!l] mouth."
                man_name "You mouth feels great, [the_person.name]. Keep going."
                "You see some books lying on the table. Seems they were studying and got little bored. Judging by the sweat on their bodies and loud moans, the seem to be relaxing for some time now."
                "The man grabs [the_person.possessive_title!l]'s head and tries to force her to take his member all way long."
                if the_person.get_opinion_score("being submissive") > 0:
                ...
                $ the_person.change_arousal (26)
                "You notice that with one hand [the_person.possessive_title!l] is rubbing between her legs."
    ...
    if ran_num == 2: ## a scene with two men
        ...
        if target_position == "missionary":
            ...
            "You see some books lying on the table. Seems they were studying and got little bored. Judging by the sweat on their bodies and loud moans, the seem to be relaxing for some time now."
            if the_person.get_opinion_score("being submissive") > 0:
                "[man_name] grabs [the_person.possessive_title!l] legs and thrusts himself to her with some force."
            ...
            "[man_name2] stands up and comes to the table. He starts playing with [the_person.possessive_title!l] clit while [man_name] keeps doing her."
            $ the_person.change_arousal (26)
            "After a few more moves, [the_person.possessive_title!l] seems to have reached an orgasm."
            $ the_person.draw_person(position = "missionary", emotion = "orgasm")
            $ the_person.run_orgasm()
            ...
            if finish == "facial":
                ...
                "They stroke their dicks for few moments and start to cover [the_person.possessive_title!l] face with hot semen."
                $ cum_on_face_ntr(the_person)
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                the_person "Yes! That's it! Cover my face!"
                $ cum_on_tits_ntr(the_person)
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                "Their load is so huge that it starts do drip on [the_person.possessive_title!l] breast."
                ...
                "The man comes up to her and enters [the_person.possessive_title!l] cum filled pussy. Since he is pretty aroused, it doesn't take him long to cum."
                man_name2 "Take it all in, [the_person.name]!"
                the_person "Yes! Fill me more!"
                "After both men shot their loads into [the_person.possessive_title!l], she is lying on the table and sperm is flowing out of her vagina."
                the_person "Hope you like the view. Now I go wash myself and then we have to finish the tasks. Don't wanna get bad grade on that test."
                "You go back to you room to finally have some sleep."
                if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                    "While trying to sleep, you hear some loud noises from outside the bedroom."
                ...
                "His weakened dick falls out from [the_person.possessive_title!l]'s mouth. She looks up and smiles. She swallows the sperm, but you still see traces of it."
                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                "After finishing with [man_name], [the_person.possessive_title!l] starts sucking [man_name2]'s cock."
                man_name2 "Shit, your mouth is so good! I'm gonna explode right now!"
                $ cum_in_mouth_ntr(the_person)
                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                "You see [man_name2] body shrugs as he starts to shoot his load into [the_person.possessive_title!l] mouth."
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                ...
                "She grabs his dick and strokes it for a while. Once he reaches an orgasm, [the_person.possessive_title!l] closes the tip with a hand so that the semen won't stain anything."
            ...
            $ the_person.draw_person(position = "standing_doggy")
            "You take a look inside the room and you see [the_person.possessive_title!l] bent over the bed. And some young man is doing her with his pants down."
            "There is another man, sitting on the bed in front of [the_person.possessive_title!l]. She is playing with his dick."
            the_person "Oh, [man_name]! You are so good! Keep going!"
            man_name "Wow, [man_name2], you really turned our little classmate on!"
            "You see some books lying on the table. Seems they were studying and got little bored. Judging by the sweat on their bodies and loud moans, the seem to be relaxing for some time now."
            if the_person.get_opinion_score("being submissive") > 0:
                "[man_name] slaps [the_person.possessive_title!l]'s buttocks with a loud sound."
            ...
            if finish == "facial":
                ...
                $ cum_in_vagina_ntr(the_person)
                $ the_person.draw_person(position = "standing_doggy")
                "After both men shot their loads into [the_person.possessive_title!l], you see sperm flowing out of her vagina and down on her legs."
                ...
                man_name "Take it all, [the_person.name]. Get you protein cocktail of the day!"
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                "He pull his dick out of [the_person.possessive_title!l]'s mouth. She looks up, swallows and smiles."
                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                "After finishing with [man_name], [the_person.possessive_title!l] starts sucking [man_name2]'s cock."
                man_name2 "Shit, your mouth is so good! I'm gonna explode right now!"
                $ cum_in_mouth_ntr(the_person)
                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                "You see [man_name2] body convulse as he shoots his load into [the_person.possessive_title!l] mouth."
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
            ...
            "You take a look inside the room and you see [the_person.possessive_title!l] squeezed between two men. One is fucking her pussy while the other is working on her ass."
            the_person "Oh, [man_name]! You are so good! I like it in my ass."
            ...
            "You see some books lying on the table. Seems they were studying and got little bored. Judging by the sweat on their bodies and loud moans, the seem to be relaxing for some time now."
            if the_person.get_opinion_score("being submissive") > 0:
                "[man_name] slaps [the_person.possessive_title!l]'s buttocks. It's red from spanking."
                the_person "Oh, [man_name]. Slap me more! I like that!"
                man_name2 "Oh, like it rough? Then you gonna like this."
                "He speeds up in [the_person.possessive_title!l] pussy"
            ...
            if finish == "facial":
                ...
                "They stroke their dicks for few moments and start to cover [the_person.possessive_title!l]'s face with hot semen."
                $ cum_on_face_ntr(the_person)
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                the_person "Yes! That's it! Cover my face!"
                $ cum_on_tits_ntr(the_person)
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                "Their loads are so huge that it slowly drips down on [the_person.possessive_title!l]'s breasts."
                ...
                "You go back to you room to finally have some sleep."
                if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                    "While trying to sleep, you hear some loud noises from [the_person.possessive_title!l]'s bedroom."
                ...
                $ cum_in_vagina_ntr(the_person)
                $ the_person.draw_person(position = "doggy")
                "After a few hard thrusts, both men start spilling his semen into [the_person.possessive_title!l] holes."
                the_person "Yes! I want it in me! Fill me with cum!"
                "After few seconds they both get off inside [the_person.possessive_title!l]. You see a trace of their love juice dripping from her pussy and anus."
                ...
                man_name "Take it all, [the_person.name]. Get you protein cocktail of the day!"
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                "He pulls his cock out of [the_person.possessive_title!l]'s mouth. She looks up, and swallows his load."
                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                "After finishing with [man_name], [the_person.possessive_title!l] starts sucking [man_name2]'s cock."
                man_name2 "Shit, your mouth is so good! I'm gonna explode right now!"
                $ cum_in_mouth_ntr(the_person)
                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                "You see [man_name2] body shiver as he starts to shoot his load into [the_person.possessive_title!l] mouth."
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                ...
                "She gets off from him, grabs his dick and strokes it for a while. Once he reaches an orgasm, [the_person.possessive_title!l] also catches all his semen so it won't stain anything."
            ...
            $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
            "You take a look inside the room and you see [the_person.possessive_title!l] on her knees. She sits in front of two men and sucks their dicks."
            ...
            if finish == "facial":
                ...
                $ cum_on_tits_ntr(the_person)
                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                "Their load is so huge that it starts do drip on [the_person.possessive_title!l] breasts."
                "After both men finishes, she looks up to them."
                the_person "Do I look cute this way?"
                man_name "You look like a real porn actress, [the_person.name]."
                man_name2 "Our little coed just got her sperm bath. What a view!"
                ...
                "[man_name] pulls out his cock from [the_person.possessive_title!l]'s mouth, [the_person.possessive_title!l] grabs it and starts stroking. In a few moments the man begins to cum."
