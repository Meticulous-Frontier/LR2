...
label SB_fetish_vaginal_family_threesome_label():
    ...
    if mc.business.event_triggers_dict.get("family_threesome", False) == True:
        ...
        "[mom.possessive_title] quickly realizes that [the_person.possessive_title!l] is here... doing exactly what she was coming here to do. Her cheeks turn red with embarassment."
