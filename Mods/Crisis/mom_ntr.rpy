...
init 2 python:
    ...
    mom_ntr_mod_action = ActionMod("Mom NTR",mom_ntr_mod_requirement,"mom_ntr_mod_action_label",
        menu_tooltip = "At night, you hear strange sounds out of [mom.possessive_title!l]'s bedroom.", category = "NTR",
...
label mom_ntr_mod_action_label:
    ...
    "You drag yourself out of bed and enter the hallway. There is some rustling in [the_person.possessive_title!l]'s bedroom."
    ...
    if ran_num == 1: ## a scene with one man
        if the_person.get_opinion_score("giving blowjobs") > 0:
            ...
            "You take a look inside the room and your eyes widen. You see [the_person.possessive_title!l] sitting in front of an unknown man, sucking his cock."
            ...
            the_person "Well, [man_name], you were so nice with me this evening that I felt you deserve a little present."
            $ the_person.discover_opinion("giving blowjobs")
            the_person "Besides, I just love to feel strong, hard dick in my mouth."
            ...
            "[the_person.possessive_title] smiles and gets up to embrace and kiss her man passionately."
            "You are unsure what to do here."
        else:
            $ the_person.draw_person(position = "kissing", emotion = "happy")
            "You see [the_person.possessive_title!l] embracing some man, kissing him deeply."
            the_person "Oh [man_name], you are so nice. I had a wonderful evening!"
            "You recognize the man. It's [man_name], one of [the_person.possessive_title!l] colleagues."
            "You are unsure what to do here."
        menu:
            "Keep looking":
                "You decide to see what they are up to."
                "They go on kissing. After a while, [man_name] places his hands on [the_person.possessive_title!l]'s ass, caressing it."
                if the_person.sluttiness <= 30 or (the_person.is_dominant() and the_person.sluttiness <= 45):
                    ...
                    the_person "No, [man_name]. We work together, we should not cross some lines."
                    ...
                    if ran_num < 1:
                        ...
                        "You go back to your room and through half-closed door you see [man_name] leaving the house, head low in shameful disappointment."
                    else:
                        if the_person.get_opinion_score("giving blowjobs") > 0:
                            man_name "What the fuck, [the_person.name]?! You've been flirting around me the whole evening, brought me to your room, sucked my cock, and now you want to stop?"
                        else:
                            man_name "Oh, no, [the_person.name]. You've been flirting around me the whole evening, brought me to your room, and now you want to stop?"
                        ...
                        if mom_clothing is None:
                            ...
                            "He tears off [the_person.possessive_title!l]'s [mom_clothing.name] and throws it on a floor."
                            if the_person.get_opinion_score("being submissive") > 0:
                                "[the_person.possessive_title] just keeps standing there, shocked into submission, while [man_name] undresses her."
                            else:
                        ...
                        if clothes_number >1:
                            ...
                            if not mom_clothing is None:
                                ...
                                $ the_person.draw_animated_removal (mom_clothing, position = "stand3", emotion = "sad")
                                "You watch as [the_person.possessive_title!l]'s [mom_clothing.name] is forcibly removed, despite her objections."
                                if the_person.get_opinion_score("being submissive") > 0:
                                    "[the_person.possessive_title] stands there in submission while [man_name] undresses her."
                                else:
                        ...
                        if clothes_number >2:
                            ...
                            if not mom_clothing is None:
                                ...
                                if the_person.get_opinion_score("being submissive") > 0:
                                    "[the_person.possessive_title] keeps still, letting [man_name] undress her like a doll."
                                else:
                        ...
                        if clothes_number >3:
                            ...
                            if not mom_clothing is None:
                                ...
                                if the_person.get_opinion_score("being submissive") > 0:
                                    "Completely broken, [the_person.possessive_title!l] seems not to care what [man_name] sees or does."
                                else:
                                    "Afraid to anger him further, [the_person.possessive_title!l] just stands there, sobbing."
                        $ mom_clothing = None
                        if the_person.get_opinion_score("giving blowjobs") < 0:
                        ...
                        if the_person.outfit.vagina_available():
                            ...
                            "You watch as [man_name] enters [the_person.possessive_title!l]'s pussy, bottoming out with one brutal thrust."
                            if the_person.get_opinion_score("being submissive") > 0:
                                ...
                                "For a while, there is silence in a room, aside from the wet sounds of [man_name]'s dick going in and out of [the_person.possessive_title!l]'s willing hole and the slapping of flesh on flesh."
                                ...
                                "[man_name] goes on pumping [the_person.possessive_title!l] and then slaps her ass, leaving a red handprint on her sweaty, quivering flesh."
                                ...
                                "[man_name] answers [the_person.possessive_title!l]'s plea with even harder thrusts, beating his hips against her ass like a weapon."
                            ...
                            if finish == "facial":
                                if the_person.get_opinion_score("being submissive") > 0:
                                    ...
                                    "[man_name] steps back, sliding out of [the_person.possessive_title!l]. She hurries off the bed and drops to her knees before him."
                                    $ the_person.draw_person(position = "blowjob")
                                    the_person "Now shower me with your hot jizz. Cover my body with it!"
                                    man_name "Want me to paint your face, eh, [the_person.name]? You're such a good little slut!"
                                    "[the_person.possessive_title] grins, reaching up toward him. You can hear the wet slapping as she desperately jerks his cock for her reward."
                                    "[man_name] can't hold for much longer and he starts cumming over [the_person.possessive_title!l]'s cock-drunk face."
                                    ...
                                    "[man_name] grabs [the_person.possessive_title!l] by the hips and yanks her back off the bed, manhandling her down onto her knees. You can see that she's a mess, tears and makeup smeared into a mask of misery."
                                    $ the_person.draw_person(position = "blowjob")
                                    man_name "Hold still while I mark you, bitch!"
                                    "[man_name] beats his cock furiously. He practically roars in triumph as he starts to cum, shooting cum all over [the_person.possessive_title!l]'s face and tits."
                                    $ cum_on_face_ntr(the_person) #$ the_person.cum_on_face()
                                    $ the_person.draw_person(position = "blowjob", emotion = "sad")
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion = "sad")
                                ...
                                if the_person.get_opinion_score("being submissive") > 0:
                                    ...
                                    "[man_name] groans and shudders as he explodes inside of [the_person.possessive_title!l]."
                                else:
                                    ...
                                    "[man_name] shoves [the_person.possessive_title!l] down again, driving his cock into her. He growls possessively and his hips spasm as he blasts her womb full of his seed."
                                $ cum_in_vagina_ntr(the_person)
                                $ the_person.draw_person(position = "doggy")
                                if the_person.get_opinion_score("being submissive") > 0:
                                    the_person "Yes, yes! Fill me! Drench my pussy in your cum!"
                                    "[man_name] makes a few more thrusts and with a wet sound takes his cock out of [the_person.possessive_title!l]'s pussy."
                                    ...
                                    "You can hear [the_person.possessive_title!l] whimper miserably as her last vestige of dignity is stripped away."
                                ...
                                if the_person.get_opinion_score("being submissive") > 0:
                                    ...
                                    "[man_name] groans as [the_person.possessive_title!l] shoves her mouth down around his cock, bobbing her head and sucking hungrily."
                                    $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                    ...
                                    $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                    "[man_name] grabs [the_person.possessive_title!l]'s face in both hands and starts to fuck her mouth. She chokes loudly and pushes on his hips with her hands, but is powerless to resist him."
                                    man_name "Get used to being face fucked, [the_person.name]. As of today, you're my own personal slut. Fuck, here it comes!"
                                    "[man_name] roars in triumph as he starts cumming into [the_person.possessive_title!l]'s throat."
                                    "[the_person.possessive_title] gags and squirms as the cum overflows. She coughs loudly, shooting ropes of it across [man_name]'s merciless shaft."
                                ...
                                "He takes his softening dick out of [the_person.possessive_title!l]'s mouth."
                                if the_person.get_opinion_score("being submissive") > 0:
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    ...
                                    the_person "Ah, you taste so good, [man_name]. I hope there be more of it."
                                    ...
                                    $ the_person.draw_person(position = "blowjob", emotion = "sad")
                                    "[man_name] releases [the_person.possessive_title!l] from his grip. She gags and pulls away, pressing her shaking hands on the floor to keep from collapsing while she coughs up some of the load."
                                ...
                                if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                    ...
                                    "The man keeps pumping her and slapping her already reddening ass. With each slap, [the_person.possessive_title!l] moans with pleasure."
                                    man_name "Didn't I say that you were just a slut, needing a push? I promised to give you a proper one, so you still owe me!"
                                    "[man_name] keeps reaming [the_person.possessive_title!l]'s pussy. After a few more thrusts, he pulls out and starts to cum on her ass."
                                    ...
                                    the_person "Damn you, [man_name]! I wish I never met even you. Now get out of my house. I never want to see you again!"
                            ...
                            if the_person.get_opinion_score("being submissive") > 0:
                                ...
                                "Some time later at night you are awoken again by screams coming from [the_person.possessive_title!l]'s room."
                                ...
                                "It seems that [the_person.possessive_title!l] now does not wish the encounter to end as her screams and [man_name]'s moans keep on..."
                            else:
                                if the_person.sluttiness > 60:
                                    ...
                                    "You go back to bed, ignoring the sounds of sobbing from [the_person.possessive_title!l]'s room. After a while, you hear her shuffle down the hall and run a shower, no doubt cleaning the evidence of her shameful encounter from her body."
                        else:
                            if the_person.get_opinion_score("giving blowjobs") > 0 :
                                "Letting her instincts take over, [the_person.possessive_title!l] keeps on sucking [man_name]'s cock. Soon he is moaning in pleasure and approaching climax."
                            else:
                                "[man_name] keeps fucking [the_person.possessive_title!l]'s face, holding her head so she can't pull away. It doesn't take long before he starts to approach climax."
                            $ finish = mom_ntr_select_finish(the_person)
                            if finish == "facial":
                                if the_person.get_opinion_score("being submissive") > 0:
                                    "Despite a rough start, [the_person.possessive_title!l] seems to have started enjoying herself. She takes his dick out of her mouth and looks up."
                                    $ the_person.draw_person(position = "blowjob")
                                    ...
                                    $ cum_on_face_ntr(the_person) #$ the_person.cum_on_face()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "First he shoots [the_person.possessive_title!l]'s face and hair with his semen."
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                ...
                                if the_person.get_opinion_score("being submissive") > 0:
                                    "Despite a rough start, [the_person.possessive_title!l] seems to have started enjoying herself. Eventually, he pulls back to give her a chance to breathe."
                                    $ the_person.draw_person(position = "blowjob")
                                    ...
                                    $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                    "[man_name] resumes thrusting into [the_person.possessive_title!l]'s mouth, but no longer needs to hold her head to do it."
                                    "[the_person.possessive_title] sucks him hungrily, eager for the load he's about to deliver into her throat."
                                    "She starts sucking harder while playing with man's balls. Soon he is on the edge."
                                    man_name "Oh fuck, here it comes! Take it, baby!"
                                    "[the_person.possessive_title] barely flinches as he drives into her, groaning and pumping blast after blast of thick cum directly into her stomach."
                                    "Eventually, the tension drains from him, and he pulls back. [the_person.possessive_title] swallows loudly, then opens wide to show her empty mouth."
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    the_person "That was amazing, there was so much I thought I was going to drown!"
                                    "She looks up at him and smiles."
                                    the_person "I hope there be more next time."
                                    man_name "You're a perverted cum-slut, [the_person.name]. You know that?"
                                    $ the_person.draw_person(position = "stand2", emotion = "happy")
                                    "[the_person.possessive_title] gets up and smiles."
                                else:
                                    man_name "No slacking off for you, whore!"
                                    "He grabs [the_person.possessive_title!l]'s head and impales it on his big cock."
                                    "It goes all the way inside with man's balls hitting [the_person.title]'s jaw. She squirms, choking and struggling for air."
                                    man_name "I bet you love being face fucked, [the_person.name]. Don't worry, I'll make sure you get exactly what you deserve."
                                    "[the_person.possessive_title]'s eyes lose focus and her struggles weaken. Ignoring her plight, [man_name] grips her head tighter and starts pulling her into him rapidly, using her throat as an onahole."
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                    "Tears, spit, and slime drip from her mouth onto her tits as they swing back and forth from [man_name]'s violent use of her."
                                    "Finally, [man_name] roars in triumph and pulls her down, holding her at the base of his cock. His hips twitch as he starts dumping a massive load of cum directly into [the_person.possessive_title!l]'s stomach."
                                    $ cum_in_mouth_ntr(the_person) #$ the_person.cum_in_mouth()
                                    $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                    "You almost barge into the room, convinced you are about to watch [the_person.possessive_title!l] suffocate to death, but [man_name] finally pulls back, throwing her to the floor in a messy, broken heap."
                                    man_name "Wow, that was something. It's like that mouth of yours is meant for sucking cock."
                                    $ the_person.draw_person(position = "doggy")
                                    "[the_person.possessive_title] wheezes, coughing up some of the steaming load onto the carpet. Shaking and sobbing, she lifts herself back up again."
                                    $ the_person.draw_person(position = "blowjob", emotion = "sad")
                                ...
                                "[man_name] pulls back, letting [the_person.possessive_title!l] breathe."
                                ...
                                if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                    ...
                                    "[the_person.possessive_title] whimpers as [man_name] starts pulling her breasts up and down, using them like an onahole to jack himself off."
                                    ...
                                    "[the_person.possessive_title] looks away, tears staining her cheeks while [man_name] fucks her chest. After a few more thrusts, he starts to cum."
                                    man_name "Oh fuck, yeah! Ungh!!"
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion="sad")
                                    "[man_name] groans as he shoots his load up between [the_person.possessive_title!l]'s tits. It covers them in seconds, and some flies off to stain the floor as he keeps roughly pulling her mounds up and down until he finishes."
                            ...
                            if the_person.get_opinion_score("being submissive") > 0:
                                the_person "How about a shower, [man_name]?"
                                "They both go into the bathroom and you decide to get back to bed."
                                "Some time later at night you awoke again by the noise coming from [the_person.possessive_title!l]'s room."
                                ...
                                "It seems that [the_person.possessive_title!l] now does not wish the encounter to end as her gagging and [man_name]'s moans continue."
                            else:
                                if the_person.sluttiness > 60:
                                    the_person "Yes, [man_name]. I'm sorry. You were right, it was scary... intense... but I feel good."
                                    man_name "Good girl. Let's get you cleaned up, then maybe I'll fuck your throat again."
                                    "They both go into the bathroom and you decide to get back to bed."
                                    "You have trouble getting back to sleep. [the_person.possessive_title] is making a lot of noise in the shower."
                    ...
                    if the_person.get_opinion_score("giving blowjobs") > 0:
                        ...
                        "She caresses the bulge on his pants."
                    the_person "I like those plans, as well as my little friend here. Now let me help you get rid of those clothes."
                    "You see them help each other undress."
                    $ mom_clothing = the_person.choose_strip_clothing_item()
                    if not mom_clothing is None:
                        man_name "I don't think you need your [mom_clothing.name] anymore."
                        $ the_person.draw_animated_removal (mom_clothing, position = "kissing")
                        "He takes off [the_person.possessive_title!l]'s [mom_clothing.name] and throws it on a nearby chair."
                    if clothes_number >1:
                        $ mom_clothing = the_person.choose_strip_clothing_item()
                        if not mom_clothing is None:
                            the_person "I like the touch of your soft hands, [man_name]."
                            $ the_person.draw_animated_removal (mom_clothing, position = "kissing")
                            "You watch as [the_person.possessive_title!l]'s [mom_clothing.name] is also removed. [man_name]'s hands are softly caressing her naked skin."
                    if clothes_number >2:
                        $ mom_clothing = the_person.choose_strip_clothing_item()
                        if not mom_clothing is None:
                            the_person "Ooooh, [man_name], I love the way you touch me. It makes me so excited..."
                            $ the_person.draw_animated_removal (mom_clothing, position = "kissing")
                            "[man_name] takes off [the_person.possessive_title!l]'s [mom_clothing.name]. His hands are all over her body."
                    if clothes_number >3:
                        $ mom_clothing = the_person.choose_strip_clothing_item()
                        if not mom_clothing is None:
                    ...
                    menu:
                        "[the_person.possessive_title] lays on the bed..." if the_person.outfit.vagina_available():
                            ...
                            "You watch as [the_person.possessive_title!l] lays on her bed and spreads her legs, inviting [man_name] to enter her."
                            ...
                            "He quickly drops his shorts and climbs atop of [the_person.possessive_title!l], entering her pussy in one smooth thrust."
                            the_person "Oh yes, [man_name]! I really needed that. Do it!"
                            "[man_name] speeds up, pumping [the_person.possessive_title!l]'s wet vagina and kissing her hard."
                            ...
                            if the_person.get_opinion_score("being submissive") > 0:
                                ...
                                $ the_person.discover_opinion("being submissive")
                                "[man_name] amplifies his movements. Now with each move he presses [the_person.possessive_title!l] against the bed, producing heavy squeaking sounds and the rhythmic slap of flesh on flesh."
                            ...
                            if not hidden or renpy.random.randint(0,2) == 1:
                                ...
                                if the_person.sluttiness >=50 or the_person.get_opinion_score("public sex") > 0 or the_person.arousal > 35:
                                    ...
                                    "[man_name] does not mind you joining the show as he keeps fucking [the_person.possessive_title!l]'s pussy."
                                    ...
                                    "You come close to [the_person.possessive_title!l] and take your dick out of your pants."
                                    the_person "Good boy! Now let [the_person.possessive_title!l] take care of you."
                                    ...
                                    while the_person.arousal < 100:
                                        "[man_name] thrusts his dick into [the_person.possessive_title!l]'s pussy. You can hear the wet sound of her sex taking his; clearly [the_person.possessive_title!l] is having great time."
                                        ...
                                        $ the_person.change_arousal(renpy.random.randint(10,50))
                                    "After being fucked by [man_name] for so long, [the_person.possessive_title!l] seems to be approaching orgasm."
                                    the_person "Oh, God! I'm cumming! Fuck me! Fuck me more! Fuck me as fast as you can, [man_name]!"
                                    "He starts to pump [the_person.possessive_title!l] with some ferocity, grunting with effort and fully burying his dick in her ove rand over again."
                                    ...
                                    if finish == "facial":
                                        ...
                                        the_person "Would you like to cover my face with your hot cum? I bet your wife never lets you to do this!"
                                        ...
                                        $ cum_on_face_ntr(the_person) #$ the_person.cum_on_face()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "[man_name] groans and starts spraying his semen over [the_person.possessive_title!l] face."
                                        ...
                                        if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                            "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                            ...
                                            "You go back to your bedroom and drift to sleep, listening to quiet moans and sounds of bedsprings from [the_person.possessive_title!l]'s room."
                                    elif finish == "inside":
                                        the_person "Yes! Do it, [man_name]! I want you to fill me."
                                        $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                        $ the_person.draw_person(position = "missionary", emotion = "happy")
                                        "After a few hard thrusts, [man_name] starts spilling his semen into [the_person.possessive_title!l]."
                                        the_person "Yes, [man_name]! I want all inside me!"
                                        "After few seconds, [man_name] gets off of [the_person.possessive_title!l]. You see a trace of his cum dripping from [the_person.possessive_title!l]'s pussy."
                                        ...
                                        "As [the_person.possessive_title!l] starts walking toward the bathroom, you see several white drops falling on the floor."
                                        ...
                                        if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 60:
                                            ...
                                            "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.possessive_title!l]'s room."
                                    elif finish == "drink":
                                        the_person "Hold it, [man_name]! I have a better idea."
                                        $ the_person.draw_person(position = "blowjob")
                                        "She pushes him backward and his dick leaves her pussy with a wet sound . [the_person.possessive_title] gets on her knees in front of [man_name]'s cock."
                                        ...
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "His weakened dick falls out from [the_person.possessive_title!l]'s mouth. She looks up and smiles. She swallows the sperm, but you still see traces of it on her face."
                                        ...
                                        $ cum_in_mouth_ntr(the_person) #$ the_person.cum_in_mouth()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "[the_person.possessive_title] slides her mouth down and up your dick, and in few seconds you cum inside. She leans back and gulps once more."
                                        the_person "There we go. Double the sweet load."
                                        $ the_person.draw_person(position = "stand2", emotion = "happy")
                                        "[the_person.possessive_title] stands up from the floor and smiles."
                                        the_person "Now go to your room, [the_person.mc_title]. Me and [man_name] need to take a shower."
                                        if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 60:
                                            "You go back to your bedroom. Soon afterward, you hear screams from [the_person.possessive_title!l]'s room."
                                        ...
                                        "[man_name] pulls out his cock, [the_person.possessive_title!l] grabs it and starts stroking. In a few moments the man begins to cum."
                                        "[the_person.possessive_title] closes the tip with her free hand so that no sperm is spilled."
                                        ...
                                        man_name "I don't believe it, [the_person.name]. You just let your [the_person.possessive_title!l] watch us fuck, then jerked him off!"
                                        $ the_person.draw_person(position = "stand2", emotion = "happy")
                                        "[the_person.possessive_title] stands up from the bed and smiles."
                                        the_person "Didn't that turn you on, [the_person.mc_title]?"
                                        the_person "Now go to your room. Me and [man_name] need to take a shower."
                                        if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 60:
                                            "You go back to your bedroom and soon begin to hear screams from [the_person.possessive_title!l]'s room."
                                    ...
                                    the_person "[the_person.mc_title]! Don't spy on [the_person.possessive_title!l]! Get back to your room now!"
                                    "You go back to your bedroom accompanied by the squeaking sounds from [the_person.possessive_title!l]'s room as [man_name] keeps pounding her."
                            else:
                                while the_person.arousal < 100:
                                        "[man_name] thrusts his dick into [the_person.possessive_title!l]'s pussy. It goes in and out with a wet sound. [the_person.title] moans loudly, and seems to be enjoying every thrust."
                                        ...
                                        $ the_person.change_arousal(renpy.random.randint(10,50))
                                "After being several minutes of fucked by [man_name], [the_person.possessive_title!l] draws close to orgasm."
                                the_person "Oh, God! I'm cumming! Fuck me! Fuck me more! As fast as you can, [man_name]!"
                                "He starts to pump [the_person.possessive_title!l] with some ferocity, fully burying his dick in her."
                                $ the_person.draw_person(position = "missionary", emotion = "orgasm")
                                $ the_person.run_orgasm()
                                ...
                                if finish == "facial":
                                    ...
                                    $ cum_on_face_ntr(the_person) #$ the_person.cum_on_face()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "[man_name] shudders and starts spraying his semen over [the_person.possessive_title!l]'s face."
                                    ...
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "His load is so huge that it spills from [the_person.possessive_title!l]'s face onto her tits."
                                    ...
                                    "You hide in your room and watch them walking away to the bathroom. [the_person.possessive_title] leaves a sticky trail on the floor as the cum drips off her face and tits."
                                    "[man_name]'s hand is on [the_person.title]'s ass, but she does not object. As they close the door, you see [the_person.possessive_title!l] caresses his balls while his dick shows signs of already returning to life."
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 60:
                                    ...
                                    $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                    $ the_person.draw_person(position = "missionary", emotion = "happy")
                                    "Hammering down desperately into her, [man_name] starts spilling his semen into [the_person.possessive_title!l]'s pussy."
                                    the_person "Yes, [man_name]! I want it all inside me!"
                                    "After final thrust, [man_name] gets off [the_person.possessive_title!l]. You see a trace of his white liquid dripping from [the_person.title]'s wet and gaping hole."
                                    the_person "Wow, [man_name]! You really needed to blow off some steam! That was a huge load."
                                    ...
                                    the_person "Now I need to take a shower. Then maybe we'll do it all again."
                                    $ the_person.draw_person(position = "walking_away")
                                    "You hide behind your bedroom door and watch [the_person.possessive_title!l] walk towards bathroom, leaving a trail of dripping goo on the floor."
                                    if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                        "You go back to bed. Soon you again hear screams from [the_person.possessive_title!l]'s room."
                                        the_person "Do me again, [man_name]. It feels so good to be filled with your semen!"
                                        man_name "Take it all in, [the_person.name]! You're such a perfect breeding whore!"
                                        "Screams go on long into the night..."
                                    else:
                                        "You go back to bed. While drifting to sleep, you hear quiet moans from [the_person.possessive_title!l]'s room."
                                elif finish == "drink":
                                    ...
                                    "[man_name] clearly liked the idea of cumming in his wife's mouth."
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "His weakened dick falls out of [the_person.possessive_title!l]'s mouth. She looks up and smiles, while swallowing the sperm, but you still see traces where it overflowed onto her chin."
                                    ...
                                    $ the_person.draw_person(position = "walking_away")
                                    "You hide in your room and watch them walking away to bathroom."
                                    "[man_name]'s hand is on [the_person.possessive_title!l]'s ass, but she does not object. As they close the door, you see [the_person.title] caress his balls while his dick shows signs of returning to life." ###bookmark###
                                    if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                        "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                        ...
                        "[the_person.possessive_title] poses next to bed..." if the_person.outfit.vagina_available():
                            ...
                            "You see as [the_person.possessive_title!l] turns back and poses on her bed spreading her legs, inviting [man_name] to enter her from behind."
                            ...
                            "He quickly drops down his underwear and comes to [the_person.possessive_title!l], entering her pussy in one go."
                            the_person "Oh yes, [man_name]! Do it! I really needed that."
                            "[man_name] speeds up, pumping [the_person.possessive_title!l] wet vagina while playing with her tits."
                            ...
                            menu:
                                ...
                                "Don't hide...":
                                    $ hidden = False
                            if not hidden or renpy.random.randint(0,2) == 1:
                                "In a mirror next to the bed [the_person.possessive_title!l] sees that the door is slightly ajar and you standing there."
                                if the_person.sluttiness >=50 or the_person.get_opinion_score("public sex") > 0 or the_person.arousal > 35:
                                    the_person "[the_person.mc_title], don't just stay there, come on in. [the_person.possessive_title] will help you relax as well."
                                    ...
                                    "You lay down on bed in front of [the_person.possessive_title!l] and take your dick out of your pants."
                                    the_person "Good boy! Now let [the_person.possessive_title!l] take care of you."
                                    ...
                                    the_person "Oh, [man_name], please go on. Keep fucking me! Your hand feel so good on my ass."
                                    man_name "Sure, [the_person.name]. You really look lovely from this position."
                                    the_person "Enjoy the view. But don't forget - you must do good if wish to have this again. So keep going, [man_name]!"
                                    while the_person.arousal < 100:
                                        "[man_name] thrusts his dick into [the_person.possessive_title!l] pussy. With each move [the_person.possessive_title!l] moans. Clearly she is having great time."
                                        the_person "Please, [man_name], more. Do me! Do me!"
                                        if the_person.get_opinion_score("being submissive") > 0:
                                        ...
                                        $ the_person.change_arousal(renpy.random.randint(10,50))
                                    "After being fucked by [man_name] for quite some time, [the_person.possessive_title!l] seems to be closing to orgasm."
                                    the_person "Oh, God! I'm cumming! Fuck me! Fuck me more! Fuck me as fast as you can, [man_name]!"
                                    "He starts to pump [the_person.possessive_title!l] with some ferocity, his balls slam into her clit. And there is a loud sound as he slaps into her ass."
                                    $ the_person.run_orgasm()
                                    the_person "Yes! Yes! That's it! I love it, [man_name]!"
                                    if the_person.get_opinion_score("being submissive") > 0:
                                    ...
                                    if finish == "facial":
                                        ...
                                        $ cum_on_face_ntr(the_person) #$ the_person.cum_on_face()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "[man_name] shrugs and starts spraying his semen over [the_person.possessive_title!l] face."
                                        ...
                                        $ the_person.draw_person(position = "stand2", emotion = "happy")
                                        "[the_person.possessive_title] stands up from the floor and smiles."
                                        the_person "Now go to your room, [the_person.mc_title]. Me and [man_name] need to take a bath."
                                        "As you turn to leave, you see [man_name]'s balls being caressed by [the_person.possessive_title!l] and his thing starting to rise."
                                        if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                            "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                            the_person "Do me again, [man_name]. Fuck me harder! Shower your whore's face again!"
                                        ...
                                        $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                        $ the_person.draw_person(position = "standing_doggy")
                                        "After a few hard thrusts, [man_name] starts spilling his semen into [the_person.possessive_title!l], while grabbing her ass with both hands."
                                        the_person "Yes, [man_name]! I want it in me!"
                                        "After few seconds [man_name] gets off from [the_person.possessive_title!l]. You see a trace of his white liquid dripping from [the_person.title]'s pussy down her legs."
                                        the_person "Wow, [man_name]! You really needed to blow off some steam! That was a huge load."
                                        ...
                                        the_person "Now go to your room, [the_person.mc_title]. Me and [man_name] need to take a bath."
                                        $ the_person.draw_person(position = "walking_away")
                                        "As [the_person.possessive_title!l] starts walking towards bathroom, you see several white drops falling on the floor."
                                        "While she walks past [man_name], he places his hand on her butt."
                                        if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                            "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                            the_person "Do me again, [man_name]. It feels so good to be filled with your semen!"
                                        ...
                                        "[man_name] clearly liked the idea of doing it with his wife."
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "His weakened dick falls out from [the_person.possessive_title!l]'s mouth. She looks up and smiles, while swallowing the sperm, but you still see traces of it."
                                        ...
                                        $ the_person.draw_person(position = "standing_doggy")
                                        "[man_name] pulls out his cock and starts stroking it with [the_person.possessive_title!l]'s buttocks."
                                    ...
                                    the_person "[the_person.mc_title]! Don't spy on [the_person.possessive_title!l]! Get beck to your room now!"
                                    "You go back to your bedroom accompanied by the squeaking sounds from [the_person.possessive_title!l]'s room as [man_name] keeps pounding her."
                            else:
                                while the_person.arousal < 100:
                                    "[man_name] thrusts his dick into [the_person.possessive_title!l] pussy. As he slaps her ass, she moans."
                                ...
                                "He starts to pump [the_person.possessive_title!l] with some ferocity, fully burying his dick in her. His balls smash against [the_person.title]'s pussy."
                                $ the_person.run_orgasm()
                                ...
                                if finish == "facial":
                                    ...
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "His load is so huge that it spills from [the_person.possessive_title!l]'s face on her breast."
                                    the_person "Liked that, [man_name]? Seeing a girl on her knees with your sperm over her face?"
                                    man_name "It really turns me on! I feel I can do another round shortly."
                                    ...
                                    "[man_name]'s hand is on [the_person.possessive_title!l]'s ass, but she does not object. As they close the door, you see that [the_person.title] caresses his balls while his dick shows signs of returning to life."
                                    if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                        "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                        the_person "Do me again, [man_name]. Fuck me harder! Shower your whore's face again!"
                                        man_name "On your face, slut!"
                                    ...
                                    the_person "Yes! Do it, [man_name]! I want you to fill me."
                                    $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                    "After a few hard thrusts, [man_name] starts spilling his semen into [the_person.possessive_title!l], grabbing her ass with both hands."
                                    the_person "Yes, [man_name]! I want it in me!"
                                    "After few seconds [man_name] gets off from [the_person.possessive_title!l]. You see a trace of his white liquid dripping from [the_person.possessive_title!l]'s pussy over her legs."
                                    the_person "Wow, [man_name]! You really needed to blow off some steam! That was a huge load."
                                    ...
                                    the_person "Here we go. Remember the view next time you fuck your wife."
                                    $ the_person.draw_person(position = "back_peek", emotion = "happy")
                                    "[the_person.possessive_title] stands up from the bed and heads towards bathroom. [man_name] slaps her ass."
                                    the_person "Now I need to take a bath. Then we will see"
                                    $ the_person.draw_person(position = "walking_away")
                                    "As [the_person.possessive_title!l] walks towards bathroom, you see several white drops falling on the floor."
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 60:
                                        "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                        the_person "Do me again, [man_name]. It feels so good to be filled with your semen!"
                                        man_name "Take it all in, [the_person.name]!"
                        ...
                        "[the_person.possessive_title] gets on her knees...":
                            $ the_person.draw_person(position = "blowjob")
                            "You see as [the_person.possessive_title!l] gets on her knees, taking down [man_name]'s underwear."
                            "His erected dick is right in front of [the_person.possessive_title!l]'s face."
                            ...
                            if not hidden or renpy.random.randint(0,2) == 1:
                                ...
                                if the_person.sluttiness >=50 or the_person.get_opinion_score("public sex") > 0 or the_person.arousal > 35:
                                    ...
                                    while the_person.arousal < 100:
                                        ...
                                        if the_person.get_opinion_score("being submissive") > 0:
                                            "[the_person.possessive_title] grabs [man_name]'s ass and impales her mouth on his cock. His ball hit [the_person.possessive_title!l]'s jaw."
                                    ...
                                    if finish == "facial":
                                        ...
                                        "As you turn to leave, you see [man_name]'s balls being caressed by [the_person.possessive_title!l] and his thing starting to rise."
                                        if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                            "You go back to your bedroom accompanied by incomprehensive loud blabbering from [the_person.possessive_title!l]'s room."
                                            the_person "Mrmh... Blgrhm..."
                                            man_name "That's it, [wife_name]. My bitch want a shower?"
                                            the_person "Oh, yes, Master! Cover my face with your blessing!"
                                            "Seems [man_name] liked the idea of roleplaying with face-fucking [the_person.possessive_title!l]. She doesn't seem to object."
                                        else:
                                            "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.possessive_title!l]'s room."
                                    elif finish == "drink":
                                        the_person "I want to taste your hot cum. Don't think that your wife allows you to do this!"
                                        ...
                                        if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                            ...
                                            "Seems [man_name] liked the idea of roleplaying with feeding [the_person.possessive_title!l]. She doesn't seem to object."
                                        else:
                                            "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.possessive_title!l]'s room."
                                    elif finish == "usual":
                                        "[the_person.possessive_title] take his penis out of her mouth and looks up at him."
                                        the_person "Yes! Please cum on my breast. It's easier to clean than the furniture around."
                                        man_name "As you wish!"
                                        $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                        $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                        "[man_name] starts grinning as he ejaculates to [the_person.possessive_title!l]'s large boobs."
                                        man_name "Ow, fuck! That was great!"
                                        ...
                                        "[the_person.possessive_title] stands up from the floor and smiles."
                                        the_person "Now go to your room, [the_person.mc_title]. Me and [man_name] need to take a bath."
                                        "You go back to your bedroom accompanied by shower sounds from [the_person.possessive_title!l]'s room."
                                else:
                                    $ the_person.happiness -= 5
                                    $ the_person.draw_person(position = "blowjob", emotion = "angry")
                                    the_person "[the_person.mc_title]! Don't spy on [the_person.possessive_title!l]! Get back to your room now!"
                                    "You go back to your bedroom accompanied by slobbering sounds from [the_person.possessive_title!l]'s room as she keeps sucking [man_name]'s dick."
                            else:
                                while the_person.arousal < 100:
                                ...
                                if finish == "facial":
                                    ...
                                    if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 60:
                                        ...
                                        "Seems [man_name] liked the idea of roleplaying with cumming on [the_person.possessive_title!l]. She doesn't seem to object."
                                    else:
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.possessive_title!l]'s room."
                                elif finish == "drink":
                                    the_person "I want to taste your hot cum. Don't think that your wife allows you to do this!"
                                    ...
                                    "[the_person.possessive_title] take his penis out of her mouth and looks up at him."
                                    the_person "Yes! Please cum on my breasts. It's easier to clean than the furniture."
                                    man_name "As you wish!"
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "[man_name] starts grinning as he ejaculates to [the_person.possessive_title!l]'s large boobs."
                                    ...
                                    the_person "Now go the bathroom, I will join shortly."
                                    "You go back to your bedroom accompanied by shower sounds from [the_person.possessive_title!l]'s room."
            "Get back to bed":
                "You decide that it is wrong to spy on [the_person.possessive_title!l]'s private life, so you go back to your room to sleep."
        ...
        if the_person.get_opinion_score("giving blowjobs") > 0:
            ...
            $ the_person.draw_person(position = "kissing", emotion = "happy")
            "You see [the_person.possessive_title!l] embracing two men, kissing them deeply."
            ...
            "As you open the door a little more, you recognize them . It's [man_name] and [man_name2], [the_person.possessive_title!l] colleagues."
            "You are unsure what to do here."
        menu:
            "Keep looking":
                "You decide to see what they are up to."
                "They go on kissing. After a while [man_name] places his hands on [the_person.possessive_title!l]'s ass, slightly caressing it, while [man_name2] is fondling her tits."
                the_person "Oh, [man_name]. You clearly have some plans for tonight, don't you?."
                if the_person.get_opinion_score("giving blowjobs") > 0:
                ...
                if clothes_number >2:
                    ...
                    if not mom_clothing is None:
                        ...
                        if the_person.outfit.vagina_available():
                            ...
                            "[man_name] takes off her [mom_clothing.name], while [man_name2] and [the_person.possessive_title!l] kiss passionately."
                if clothes_number >3:
                    $ mom_clothing = the_person.choose_strip_clothing_item()
                    if not mom_clothing is None:
                        the_person "I don't mind go even more naked, guys. Who would like to take my [mom_clothing.name] next?"
                        $ the_person.draw_animated_removal (mom_clothing, position = "kissing")
                        if the_person.outfit.vagina_available():
                            "[man_name2] grants her wish, while [man_name] fingers her open pussy."
                        else:
                            "[man_name2] grants her wish, while [the_person.possessive_title!l] caresses [man_name2]'s crouch."
                $ mom_clothing = None
                $ the_person.sluttiness += 2
                ...
                menu:
                    "[the_person.title] lays on the table..." if the_person.outfit.vagina_available():
                        $ the_person.draw_person(position = "missionary", emotion = "happy")
                        "You see as [the_person.possessive_title!l] lays on her table and spreads her legs, smiling broadly."
                        ...
                        "He comes up to the table, kneels in front of it and starts licking [the_person.possessive_title!l]'s pussy."
                        $ the_person.change_arousal(renpy.random.randint(10,50))
                        ...
                        "In one powerful move he enters [the_person.possessive_title!l]. She rolls her eyes and moans."
                        ...
                        while the_person.arousal < 60:
                            "[man_name] moves his dick in [the_person.possessive_title!l] pussy. It goes in and out with a wet sound. Clearly [the_person.title] is having great time."
                        ...
                        "[man_name] takes his cock out off her. You see [the_person.possessive_title!l]'s juices flowing out of her. She is clearly enjoying this."
                        menu:
                            "Keep hiding...":
                                $ hidden = True
                            "Don't hide...":
                                $ hidden = False
                        if not hidden or renpy.random.randint(0,2) == 1:
                            "While the men are changing positions, [the_person.possessive_title!l] turns her head and see that the door is slightly ajar and you standing there."
                            if the_person.sluttiness >=70 or the_person.get_opinion_score("public sex") > 0:
                                ...
                                "You and [man_name] come to the table from both sides and [the_person.possessive_title!l] starts stroking your dicks."
                                ...
                                while the_person.arousal < 100:
                                    "[man_name2] keeps doing [the_person.possessive_title!l]. His hip are smashing into [the_person.possessive_title!l]'s."
                                    ...
                                    $ the_person.change_arousal(renpy.random.randint(10,50))
                                "After being fucked by [man_name2] for quite some time, [the_person.possessive_title!l] seems to be closing to orgasm."
                                the_person "Oh, God! I'm cumming! Fuck me! Fuck me more! Do me more, [man_name2]!"
                                "He starts to pump [the_person.possessive_title!l] real fast, his balls are smashing against [the_person.title]'s ass."
                                $ the_person.run_orgasm()
                                $ the_person.draw_person(position = "missionary", emotion = "orgasm")
                                ...
                                if finish == "facial":
                                    ...
                                    "Both of you come closer. Now [the_person.possessive_title!l] is on her knees with three erected dicks in front of her."
                                    ...
                                    $ cum_on_face_ntr(the_person) #$ the_person.cum_on_face()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "[man_name2] shrugs and starts spraying his semen over [the_person.possessive_title!l] face."
                                    ...
                                    $ cum_on_stomach_ntr(the_person) #$ the_person.cum_on_stomach()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "Seeing [the_person.possessive_title!l] covered in cum is show enough and you start to ejaculate. You finish on [the_person.title]'s tits and there is so much of jizz so it starts falling on her belly."
                                    $ the_person.draw_person(position = "stand2", emotion = "happy")
                                    "[the_person.possessive_title] stands up from the floor and smiles."
                                    the_person "Now go to your room, [the_person.mc_title]. Me and the boys need to take a bath."
                                    if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 70:
                                        "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                        ...
                                        "It seems that men are planning to fuck [the_person.possessive_title!l] all the night..."
                                    else:
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans and men's laughter from [the_person.possessive_title!l]'s room."
                                elif finish == "inside":
                                    the_person "Yes! Do it, [man_name2]! I want you to fill me."
                                    $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                    $ the_person.draw_person(position = "missionary", emotion = "happy")
                                    "After a few hard thrusts, [man_name2] starts spilling his semen into [the_person.possessive_title!l]."
                                    the_person "Yes, [man_name2]! I want it in me!"
                                    "After few seconds [man_name2] gets away [the_person.possessive_title!l]. You see a trace of his white liquid dripping from [the_person.title]'s pussy."
                                    ...
                                    "[man_name] comes to [the_person.possessive_title!l]'s vagina and starts doing her again. As he is well aroused, after a few frictions he grins."
                                    ...
                                    $ the_person.draw_person(position = "stand2", emotion = "happy")
                                    "[the_person.possessive_title] stands up from the bed and smiles."
                                    the_person "Now go to your room, [the_person.mc_title]. Me and guys need to take a bath."
                                    $ the_person.draw_person(position = "walking_away")
                                    "As [the_person.possessive_title!l] starts walking towards bathroom, you see several white drops falling on the floor."
                                    "While she walks past [man_name], he places his hand on her butt."
                                    the_person "First - the shower. Then we will see, dear."
                                    ...
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                        ...
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans and the squeaking bed from [the_person.possessive_title!l]'s room."
                                elif finish == "drink":
                                    the_person "Hold it, [man_name]! I have a better idea."
                                    $ the_person.draw_person(position = "blowjob")
                                    ...
                                    "[man_name2] clearly liked the idea of doing it with his wife."
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "His weakened dick falls out from [the_person.possessive_title!l]'s mouth. She looks up and smiles. She swallows the sperm, but you still see traces of it."
                                    ...
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                        ...
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans and gulping sounds from [the_person.possessive_title!l]'s room."
                                elif finish == "usual":
                                    $ cum_on_stomach_ntr(the_person) #$ the_person.cum_on_stomach()
                                    $ the_person.draw_person(position = "missionary", emotion = "happy")
                                    "[man_name2] pulls out his cock and finishes on [the_person.possessive_title!l] belly."
                                    ...
                                    "[the_person.possessive_title] stands up from the bed and smiles."
                                    the_person "Didn't that turn you on, [the_person.mc_title]?"
                                    the_person "Now go to your room, [the_person.mc_title]. Me and colleagues need to take a bath."
                                    "You go back to your bedroom accompanied by shower sounds from [the_person.possessive_title!l]'s room."
                            else:
                                $ the_person.happiness -= 5
                                $ the_person.draw_person(position = "missionary", emotion = "angry")
                                the_person "[the_person.mc_title]! Don't spy on [the_person.possessive_title!l]! Get beck to your room now!"
                                "You go back to your bedroom accompanied by squeaking sound from [the_person.possessive_title!l]'s room as both men keep pounding her."
                        else:
                            while the_person.arousal < 100:
                                "[man_name2] puts his dick into [the_person.possessive_title!l] pussy. By the look on [the_person.title]'s face she is clearly having great time."
                            ...
                            "He starts to pump [the_person.possessive_title!l] faster and faster, fully burying his dick in her."
                            $ the_person.draw_person(position = "missionary", emotion = "orgasm")
                            $ the_person.run_orgasm()
                            ...
                            if finish == "facial":
                                ...
                                "He comes over. Now [the_person.possessive_title!l] is sitting on the floor with two dicks up to her face."
                                the_person "Would you like to cover my face with your hot cum? I doubt that your wives allows you to do this!"
                                ...
                                $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                "Second load is so huge that it spills from [the_person.possessive_title!l]'s face on her breast."
                                the_person "Liked that, [man_name]? Seeing a girl on her knees with your sperm over her face?"
                                man_name "It really turns me on! I feel I can do another round shortly."
                                the_person "We will discuss it later, guys. First - a shower. I need to wash off it before it dries."
                                $ the_person.draw_person(position = "walking_away", emotion = "happy")
                                "You see them walking away to bathroom. Some white drops fall on the floor."
                                "Both men hands are on [the_person.title]'s ass, but she does not object. As they close the door, you see that [the_person.possessive_title!l] caresses their balls while dicks show signs of returning to life."
                                if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                    "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                    the_person "Do me again, [man_name]. Fuck me harder! Harder! Ahhh... More, please, do me more!"
                                    man_name "On your face, [wife_name]! Looking good bitch!"
                                    man_name2 "And this is for you, [wife_name2]! Aren't you a slut?"
                                    "It seems the guys liked role-playing with [the_person.possessive_title!l] as their fuck doll."
                                else:
                                    "You go back to your bedroom and while drifting to sleep you hear quiet moans and squeaking sounds from [the_person.possessive_title!l]'s room."
                            elif finish == "inside":
                                the_person "Yes! Do it, [man_name2]! I want you to fill me."
                                $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                $ the_person.draw_person(position = "missionary", emotion = "happy")
                                "After a few hard thrusts, [man_name2] starts spilling his semen into [the_person.possessive_title!l]."
                                the_person "Yes, [man_name2]! I want it in me!"
                                "After few seconds [man_name2] gets off [the_person.possessive_title!l]. You see a trace of his white liquid dripping from [the_person.title]'s pussy."
                                ...
                                "[the_person.possessive_title] spreads her legs even further, offering a full view of her cum-drenched pussy."
                                the_person "Here we go. Remember the view next time you fuck your wife. Now [man_name], come here and fill me as well!"
                                "He comes over, enters [the_person.possessive_title!l] pussy and after a few moves starts to grin."
                                $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                $ the_person.draw_person(position = "missionary", emotion = "happy")
                                ...
                                if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 70:
                                    ...
                                    "It seems both men just found the perfect place to deposit their loads, as they seem to do [the_person.possessive_title!l] all night long."
                                else:
                                    "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.possessive_title!l]'s room."
                            elif finish == "drink":
                                ...
                                $ cum_in_mouth_ntr(the_person) #$ the_person.cum_in_mouth()
                                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                "[man_name] comes into [the_person.possessive_title!l]'s mouth and pulls his cock away. She shows it to them, closes her mouth, smiles and swallows it."
                                $ the_person.draw_person(position = "walking_away")
                                ...
                                if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 70:
                                    ...
                                    "It seems [the_person.possessive_title!l]'s mouth gonna keep them awake for a while..."
                                else:
                                    "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.possessive_title!l]'s room."
                            elif finish == "usual":
                                $ cum_on_stomach_ntr(the_person) #$ the_person.cum_on_stomach()
                                ...
                                $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                $ the_person.draw_person(position = "missionary", emotion = "happy")
                                "After being stroked for so long, he finally cums on [the_person.possessive_title!l]'s tits."
                                $ the_person.draw_person(position = "stand2", emotion = "happy")
                                "[the_person.possessive_title] stands up from the bed and smiles."
                                the_person "Didn't that event paid off, dear?"
                    ...
                    "[the_person.title] shows on the bed..." if the_person.outfit.vagina_available() and (the_person.sluttiness > 70 or the_person.get_opinion_score("anal sex") > 0):
                        ...
                        the_person "Oh, you have a wonderful thing here, [man_name]. Now, [man_name2], how about you stick your instrument in my ass? There is some lubricant in mddle drawer."
                        man_name2 "Shit, [the_person.name]... I could only dream of anal. And you butt is so sweet."
                        "He comes up to the table, takes a tube of lubricant, pours some on his dick, then fingers [the_person.possessive_title!l]'s ass with it."
                        the_person "Thanks, [man_name2]. I'm ready. Put it in me."
                        $ the_person.change_arousal(renpy.random.randint(5,20))
                        "[man_name2] comes from behind and starts to slowly push against [the_person.possessive_title!l]'s ass."
                        the_person "Keep going, [man_name2]. It feels so pleasant."
                        "The man is now fully inside [the_person.possessive_title!l]'s ass."
                        ...
                        if the_person.get_opinion_score("being submissive") > 0:
                            ...
                            pass
                        "You just can't believe your eyes - [the_person.possessive_title!l] gets screwed by two men at once!"
                        menu:
                            "Keep hiding...":
                                $ hidden = True
                            "Don't hide...":
                        ...
                        if not hidden or renpy.random.randint(0,2) == 1:
                            if the_person.sluttiness >=70 or the_person.get_opinion_score("public sex") > 0:
                                ...
                                "You stand on the bed in front of [the_person.possessive_title!l] and she starts sucking your dick."
                                "The guys go on doing [the_person.possessive_title!l]'s two holes at once."
                                the_person "Mhhhh.... Ohmmmm..."
                                while the_person.arousal < 100:
                                    "[man_name2] and [man_name] keep fucking [the_person.possessive_title!l] two ways."
                                    the_person "Mhmhmmmmh..."
                                    "Your cock in [the_person.possessive_title!l]'s mouth prevents her from saying anything, she can only moan. On her face you see a mixture of pain and pleasure."
                                    if the_person.get_opinion_score("being submissive") > 0:
                                    ...
                                    $ the_person.change_arousal(renpy.random.randint(10,50))
                                "After being fucked by three of you for quite some time, [the_person.possessive_title!l] seems to be closing to orgasm."
                                the_person "Oh, God! I'm cumming! Fuck me! Fuck me more! Fill my holes!"
                                "Both men start to pump [the_person.possessive_title!l] real fast, their bodies slamming into her."
                                ...
                                $ finish = mom_ntr_select_finish(the_person)
                                if finish == "facial":
                                    the_person "Hold it, giys! I have a better idea."
                                    $ the_person.draw_person(position = "blowjob")
                                    ...
                                    "Three of you come closer. Now [the_person.possessive_title!l] is on her knees with three erected dicks in front of her."
                                    the_person "Would you like to cover my face with your hot cum? I doubt that your wives allows you to do this!"
                                    man_name "No, [wife_name] would never suggest anything like that..."
                                    man_name2 "I once proposed this to [wife_name2]. She called me a pervert who is watching too much porn."
                                    the_person "Well, now you can try the stuff from those movies yourselves!"
                                    ...
                                    "After a few hard thrusts, [man_name] starts spilling his semen into [the_person.possessive_title!l]."
                                    the_person "Yes, [man_name]! I want it in me!"
                                    "After few seconds [man_name] gets away [the_person.possessive_title!l]. You see a trace of his white liquid dripping from [the_person.title]'s pussy."
                                    the_person "Wow, [man_name]! You really needed to blow off some steam! That was a huge load."
                                    ...
                                    "[man_name2] takes his cock from her ass and puts it into [the_person.possessive_title!l]'s vagina and starts doing her. As he is well aroused, after a few frictions he grins."
                                    the_person "Cum in me! Give it all to me!"
                                    $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                    $ the_person.draw_person(position = "doggy")
                                    ...
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                        ...
                                        "It seems that men are planning to fuck [the_person.possessive_title!l]'s holes all the night..."
                                    else:
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans and squeaking sounds from [the_person.possessive_title!l]'s room."
                                elif finish == "drink":
                                    the_person "Hold it, guys! I have a better idea."
                                    ...
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                        ...
                                        "It seems that men are planning to use [the_person.possessive_title!l] as cum dump all the night..."
                                    else:
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans and gulping sounds from [the_person.possessive_title!l]'s room."
                                elif finish == "usual":
                                    $ cum_on_stomach_ntr(the_person) #$ the_person.cum_on_stomach()
                                    "[man_name] pulls out his cock and finishes on [the_person.possessive_title!l] belly."
                                    man_name "Ow, fuck! That was great!"
                                    ...
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    "Aroused by the view you cum on [the_person.possessive_title!l]'s tits."
                                    the_person "Here we go. All finished!"
                                    ...
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                        ...
                                        "It seems that men are planning to have some more fun with [the_person.possessive_title!l]..."
                                    else:
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans and gulping sounds from [the_person.possessive_title!l]'s room."
                            else:
                                $ the_person.happiness -= 5
                                the_person "[the_person.mc_title]! Don't spy on [the_person.possessive_title!l]! Get beck to your room now!"
                                "You go back to your bedroom accompanied by squeaking sounds from [the_person.possessive_title!l]'s room as men keep doing her."
                        else:
                            "The guys go on doing [the_person.possessive_title!l]'s two holes at once."
                            ...
                            while the_person.arousal < 100:
                                ...
                                "As she gets more and more turned on, her screams get louder and louder."
                                $ the_person.change_arousal(renpy.random.randint(10,50))
                            "After being fucked by two men at once for quite some time, [the_person.possessive_title!l] seems to be closing to orgasm."
                            the_person "Oh, God! I'm cumming! Fuck me! Fuck me more! Fill my holes!"
                            "Men start to pump [the_person.possessive_title!l] real fast, their bodies slamming into her."
                            $ the_person.run_orgasm()
                            the_person "Aaaaaahhh...! Fuuuuuuck! Cumming!"
                            ...
                            if finish == "facial":
                                ...
                                $ the_person.draw_person(position = "walking_away", emotion = "happy")
                                "You see them walking away to bathroom. Some white drops fall on the floor."
                                "Both men hands are on [the_person.possessive_title!l]'s ass, but she does not object. As they close the door, you see that [the_person.title] caresses their balls while dicks show signs of returning to life."
                                if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                    "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                    ...
                                    "You go back to your bedroom and while drifting to sleep you hear quiet moans and squeaks from [the_person.possessive_title!l]'s room."
                            elif finish == "inside":
                                the_person "Yes! Do it, [man_name]! I want you to fill me."
                                $ cum_in_vagina_ntr(the_person) #$ the_person.cum_in_vagina()
                                $ the_person.draw_person(position = "doggy")
                                ...
                                $ the_person.draw_person(position = "back_peek", emotion = "happy")
                                "[the_person.possessive_title] stands up from the bed and heads towards bathroom. [man_name] slaps her ass."
                                the_person "Now I need to take a bath. Then we will see on having more fun."
                                $ the_person.draw_person(position = "walking_away")
                                "As [the_person.possessive_title!l] walks towards bathroom, you see several white drops falling on the floor."
                                if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 70:
                                    "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                    ...
                                    "Seems that both men liked to fill [the_person.possessive_title!l] with sperm, as they seem to do [the_person.possessive_title!l] all night long."
                                else:
                                    "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.possessive_title!l]'s room."
                            elif finish == "drink":
                                the_person "Hold it, [man_name2]! I have a better idea."
                                ...
                                "Both of them come closer. Now [the_person.possessive_title!l] is on her knees with two hard dicks in front of her."
                                the_person "I want to taste your hot cum. Don't think that your wife allows you to do this!"
                                man_name2 "No, [wife_name2] never allows anything other than missionary with a condom, she is so prudent and boring at times."
                                man_name "I asked [wife_name] once for a bj. She tried but it was awful and she called it disgusting..."
                                the_person "Well, that's your chance to try something new, guys!"
                                ...
                                $ cum_on_ass_ntr(the_person) #$ the_person.cum_on_ass()
                                $ the_person.draw_person(position = "doggy")
                                "[man_name2] takes his dick out of [the_person.possessive_title!l]'s ass and covers it with his liquid."
                                $ the_person.draw_person(position = "stand2", emotion = "happy")
                                "[the_person.possessive_title] stands up from the bed and smiles."
                    ...
                    "[the_person.title] gets on her knees":
                        ...
                        if not hidden or renpy.random.randint(0,2) == 1:
                            ...
                            if the_person.sluttiness >=70 or the_person.get_opinion_score("public sex") > 0:
                                ...
                                the_person "[the_person.mc_title], don't just stay there, come on in. [the_person.possessive_title] will help you relax as well."
                                "Both [man_name] and [man_name2] don't mind you joining the show as [the_person.possessive_title!l] goes back to sucking them."
                                "You come close to [the_person.possessive_title!l] and take your dick out of your pants."
                                ...
                                if finish == "facial":
                                    ...
                                    $ cum_on_tits_ntr(the_person) #$ the_person.cum_on_tits()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "Second load is so huge that it spills from [the_person.possessive_title!l]'s face onto her breasts."
                                    the_person "Two out, one to go!"
                                    $ cum_on_stomach_ntr(the_person) #$ the_person.cum_on_stomach()
                                    $ the_person.draw_person(position = "blowjob", emotion = "happy")
                                    "Seeing [the_person.possessive_title!l] covered in cum is enough of a show and you too start to ejaculate. You finish on [the_person.possessive_title!l]'s tits and there's so much jizz it starts falling onto her belly."
                                    $ the_person.draw_person(position = "stand2", emotion = "happy")
                                    "[the_person.possessive_title] stands up from the floor and smiles."
                                    the_person "Now go to your room, [the_person.mc_title]. Me and the boys need to take a bath."
                                    $ the_person.draw_person(position = "walking_away", emotion = "happy")
                                    "You see them walking away to the bathroom followed by some white drops dripping towards the floor."
                                    "Both men have their hands on [the_person.possessive_title!l]'s ass, but she does not object. As they close the door, you see that [the_person.title] caresses their balls while their dicks show signs of returning to life."
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                        "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                        the_person "Oh, you are naughty guys! Want some more? Well, why not? As long as you promise to cum on me."
                                        man_name "On your face, [wife_name]! Looking good bitch!"
                                        man_name2 "And this is for you, [wife_name2]! Aren't you a slut?"
                                        "It seems the guys liked role-playing with [the_person.possessive_title!l] as their sperm dump."
                                    else:
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans and bed squeaks from [the_person.possessive_title!l]'s room."
                                elif finish == "drink":
                                    ...
                                    if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                        ...
                                        man_name2 "Open up your mouth, slut!  You gonna be feed with some hot stuff!"
                                        "It seems that men are planning to cum in [the_person.possessive_title!l]'s mouth all the night..."
                                    else:
                                        "You go back to your bedroom and while drifting to sleep you hear quiet moans and gulping sounds from [the_person.possessive_title!l]'s room."
                                elif finish == "usual":
                                    ...
                                    "As he starts to cum, [the_person.possessive_title!l] closes the tip with her hand so he finishes in it."
                                    man_name "Now help me too!"
                                    "[man_name2] places his instrument into [the_person.possessive_title!l]'s hand and she starts moving it. In few moments he cums in her hand."
                                ...
                                $ the_person.draw_person(position = "blowjob", emotion = "angry")
                                the_person "[the_person.mc_title]! Don't spy on [the_person.possessive_title!l]! Get beck to your room now!"
                                "You go back to your bedroom accompanied by gulping sounds from [the_person.possessive_title!l]'s room as she keeps sucking [man_name]'s and [man_name2]'s dicks."
                        else:
                            man_name2 "Oh, [the_person.name], your tongue is driving me crazy! I think I will come soon!"
                            $ finish = mom_ntr_select_finish(the_person)
                            if finish == "facial":
                                ...
                                $ the_person.draw_person(position = "walking_away", emotion = "happy")
                                "You see them walking away to bathroom. Some white drops fall on the floor."
                                "Both men have their hands on [the_person.possessive_title!l]'s ass, but she does not object. As they close the door, you see that [the_person.title] caresses their balls while dicks show signs of returning to life."
                                if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                    "You go back to your bedroom accompanied by talk from [the_person.possessive_title!l]'s room."
                                    the_person "Oh, you are naughty guys! Want some more? Well, why not? As long as you promise to cum on me."
                                    man_name "On your face, [wife_name]! Looking good bitch!"
                                    man_name2 "And this is for you, [wife_name2]! Aren't you a slut?"
                                    "It seems the guys liked role-playing with [the_person.possessive_title!l] as their sperm dump."
                                ...
                                $ cum_in_mouth_ntr(the_person) #$ the_person.cum_in_mouth()
                                $ the_person.draw_person(position = "blowjob", special_modifier="blowjob")
                                "[man_name] comes into [the_person.possessive_title!l]'s mouth and pulls his cock away. You see her mouth is full of cum, she gulps it down licking her lips."
                                $ the_person.draw_person(position = "walking_away")
                                "You see them walking away to bathroom."
                                "[man_name]'s hand is on [the_person.possessive_title!l]'s ass, and [man_name2] caresses her between the legs, but she does not object. As they enter bathroom, men's dicks show signs of returning to life."
                                if the_person.get_opinion_score("being submissive") > 0 or the_person.sluttiness > 70:
                                    "You go back to your bedroom accompanied by screams from [the_person.possessive_title!l]'s room."
                                    the_person "Want more of my mouth? Well, okay if you let me drink your cum!"
                                    man_name2 "Open up your mouth, slut!  You gonna be feed with some hot stuff!"
                                ...
                                if the_person.get_opinion_score("being submissive") > 0  or the_person.sluttiness > 70:
                                    ...
                                    "You go back to your bedroom and while drifting to sleep you hear quiet moans from [the_person.possessive_title!l]'s room."
            "Get back to bed":
                "You decide that it is wrong to interfere into [the_person.possessive_title!l]'s private life so you go back to your room to sleep."
        $ del man_name2
        $ del wife_name2
