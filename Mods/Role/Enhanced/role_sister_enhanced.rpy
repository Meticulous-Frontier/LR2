...
label sister_instathot_label_mom_enhanced(the_sister, the_mom):
    ...
    the_mom.char "Oh, hi [the_mom.mc_title]. I was just about to prepare something to eat, is there anything you need?"
    if first_time:
        ...
        the_mom.char "Okay then, I'll give it a try."
    else:
        mc.name "[the_sister.title] is getting ready to take some more pictures for her Insta-pic."
        mc.name "Do you want to join in?"
        $ scene_manager.update_actor(the_mom, position = "stand2", emotion = "happy")
        the_mom.char "I really should get something to eat, but it was a lot of fun..."
        the_mom.char "Oh what the heck, let's do this and have some fun."
    ...
    if the_mom.judge_outfit(insta_outfit_mom) and not the_mom.wardrobe.has_outfit_with_name(insta_outfit_mom.name):
        ...
        the_mom.char "Thank you! It's so cute, it would be a shame for it to go to waste. Now I really need to get back to the kitchen!"
        $ scene_manager.update_actor(the_mom, position = "walking_away")
        "[the_mom.title] collects her clothing and hurries off to her room."

    else:
        the_mom.char "Well, I need to go get changed and get back to the kitchen."
        $ scene_manager.update_actor(the_mom, position = "walking_away")
        "[the_mom.title] collects her clothing and hurries off to her room."
