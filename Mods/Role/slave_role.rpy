...
label slave_alarm_clock_label(the_person):
    ...
    if the_person.sluttiness < 50:
        ...
        the_person.char "Good morning [the_person.mc_title]. You didn't really specify how you would like to be woke up so I thought I'd improvise... You see; I came in to wake you up and saw this..."
        "She speeds up her strokes."
        the_person.char "I thought that this would be a much nicer way to wake up."
        ...
        the_person.char "Good morning [the_person.mc_title]. I came to wake you up, but then I noticed this..."
