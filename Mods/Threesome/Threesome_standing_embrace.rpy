...
label scene_threesome_standing_embrace_fuck_girl_two_1(the_girl_1, the_girl_2, the_location, the_object, the_round):
    ...
    "[the_girl_2.possessive_title] is arch her back hard as the sensations overwhelm her. She reach back with one hand and runs it through your hair, and does the same with [the_girl_2.title] with her other hand."
    return
