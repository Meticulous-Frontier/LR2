init 1301 python:              #Because Vren Init personality functionns at 1300
    ...
    def myrabelle_possessive_titles(person):
        valid_possessive_titles = [person.title]
        return valid_possessive_titles
    def myrabelle_player_titles(person):
        return mc.name

    myrabelle_personality = Personality("myrabelle", default_prefix = "relaxed",
...
### DIALOGUE ###
label myrabelle_introduction(the_person):
...
label myrabelle_strip_reject(the_person, the_clothing, strip_type = "Full"):
    if the_person.obedience > 130:
...
label myrabelle_strip_obedience_accept(the_person, the_clothing, strip_type = "Full"):
...
label myrabelle_grope_body_reject(the_person):
...
label myrabelle_sex_angry_reject(the_person):
...
label myrabelle_seduction_response(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 50:
...
label myrabelle_seduction_accept_crowded(the_person):
    if the_person.relationship == "Single":
...
label myrabelle_seduction_accept_alone(the_person):
    if the_person.relationship == "Single":
        if the_person.sluttiness < 20:
...
label myrabelle_seduction_refuse(the_person):
    if the_person.sluttiness < 20:
...
label myrabelle_flirt_response(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 50:
...
label myrabelle_flirt_response_low(the_person):
...
label myrabelle_flirt_response_mid(the_person):
    if the_person.is_wearing_uniform():
        if the_person.judge_outfit(the_person.outfit):
    ...
    if mc.location.get_person_count() > 1 and the_person.effective_sluttiness("kissing") < (25 - (5*the_person.get_opinion_score("public_sex"))):
        ...
        menu:
            "Find someplace quiet":
                ...
                call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_myrabelle_47
        ...
        menu:
            "Kiss her":
                ...
                $ the_person.draw_person(position = "kissing", special_modifier = "kissing")
                "You close the final gap and kiss her. She returns the kiss immediately, leaning her body against yours."
                call fuck_person(the_person, start_position = kissing, private = mc.location.get_person_count() < 2, skip_intro = True) from _call_fuck_myrabelle_48
                $ the_person.call_dialogue("sex_review", the_report = _return)
                $ the_person.review_outfit()
...
label myrabelle_flirt_response_girlfriend(the_person):
    ...
    if mc.location.get_person_count() > 1:
        ...
        if the_person.effective_sluttiness("kissing") < (25 - (5*the_person.get_opinion_score("public_sex"))):
            ...
            menu:
                "Find someplace quiet":
                    ...
                    call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_myrabelle_71
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    $ the_person.review_outfit()
            ...
            menu:
                "Make out":
                    ...
                    call fuck_person(the_person, start_position = kissing, private = False, skip_intro = True) from _call_fuck_myrabelle_72
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    $ the_person.review_outfit()
        ...
        menu:
            "Kiss her":
                ...
                call fuck_person(the_person, start_position = kissing, skip_intro = True) from _call_fuck_myrabelle_73
                $ the_person.call_dialogue("sex_review", the_report = _return)
                $ the_person.review_outfit()
...
label myrabelle_flirt_response_affair(the_person):
    ...
    if mc.location.get_person_count() > 1: #There are other people around, she's nervous about people finding out what you're doing.
        if (the_person.get_opinion_score("cheating on men") *15) + the_person.effective_sluttiness() > 50: #SHe's turned on by flirting in public or doesn't think anything is wrong with it
            ...
            menu:
                "Find someplace quiet":
                    ...
                    call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_myrabelle_74
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    $ the_person.review_outfit()
        ...
        menu:
            "Make out":
                ...
                call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_myrabelle_75
                $ the_person.call_dialogue("sex_review", the_report = _return)
                $ the_person.review_outfit()
            "Just flirt":
...
label myrabelle_flirt_response_text(the_person):
...
label myrabelle_cum_mouth(the_person):
    if the_person.obedience > 130:
        if the_person.sluttiness > 60:
...
label myrabelle_cum_pullout(the_person):
...
label myrabelle_cum_condom(the_person):
...
label myrabelle_cum_vagina(the_person):
...
label myrabelle_cum_anal(the_person):
...
label myrabelle_sex_strip(the_person):
    if the_person.sluttiness < 20:
...
label myrabelle_sex_watch(the_person, the_sex_person, the_position):
...
label myrabelle_being_watched(the_person, the_watcher, the_position):
...
label myrabelle_work_enter_greeting(the_person):
...
label myrabelle_sex_end_early(the_person):
    if the_person.sluttiness > 50:
        if the_person.love > 40:
...
label myrabelle_improved_serum_unlock(the_person):
...
label myrabelle_sucking_cock_taboo_break(the_person):
...
label myrabelle_licking_pussy_taboo_break(the_person):
...
label myrabelle_underwear_nudity_taboo_break(the_person, the_clothing):
...
label myrabelle_bare_tits_taboo_break(the_person, the_clothing):
...
label myrabelle_bare_pussy_taboo_break(the_person, the_clothing):
...
label myrabelle_facial_cum_taboo_break(the_person):

    return

label myrabelle_mouth_cum_taboo_break(the_person):

    return

label myrabelle_body_cum_taboo_break(the_person):

    return

label myrabelle_creampie_taboo_break(the_person):
    if the_person.wants_creampie():
        if the_person.event_triggers_dict.get("preg_knows", False):
...
label myrabelle_anal_creampie_taboo_break(the_person):

    return

label myrabelle_sex_toy_taboo_break(the_person):
    pass
    return

label myrabelle_roleplay_taboo_break(the_person):
    pass
    return

label myrabelle_sleepover_yourplace_response(the_person): #Invited her over to spend the night
    if the_person.sluttiness < 80:
...
label myrabelle_sleepover_herplace_response(the_person): #Spending the night at her place
    if the_person.sluttiness < 80:
...
label myrabelle_sleepover_yourplace_sex_start(the_person): #Right before sexy times at your place
...
label myrabelle_sleepover_herplace_sex_start(the_person): #Right before sexy times at her place
...
label myrabelle_sleepover_impressed_response(the_person):  #If you've made her cum a lot
...
label myrabelle_sleepover_good_response(the_person):  #If you've made her cum
    the_person "Ahhh, that was nice..."
    "[the_person.title] lies down in bed and catches her breath."
    the_person "I'm ready to go again if you are!"
    return

label myrabelle_sleepover_bored_response(the_person):  #If she hasn't cum yet
...
label myrabelle_lingerie_shopping_tame_response(the_person):
    the_person "Are you sure? This seems kinda tame..."
    mc.name "I know. I just want to see what it looks like on you."
    return

label myrabelle_lingerie_shopping_excited_response(the_person):
    the_person "Ah, this look great! I bet you will like this!"
    return

label myrabelle_lingerie_shopping_wow_response(the_person):
