...
init -1 python:
    ...
    standard_changing_room_backgrounds = room_background_image("Changing_Room_Background.jpg", darken = False)
    # extra backgrounds
    ...
    standard_electronics_store_backgrounds = room_background_image("Electronics_Store_Background.jpg")
    standard_home_improvement_store_backgrounds = room_background_image("Home_Improvement_Store_Background.jpg")
