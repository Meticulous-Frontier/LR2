...
init 5 python:
    ...
    def strip_club_hire(person, job):
    ...
    def strip_club_move(person, job):
    ...
    strip_club_move_action = Action("Move to new role", is_strip_club_stripper_requirement, "strip_club_move_employee_label", menu_tooltip = "Move [the_person.title] to a different role within the strip club.")
    strip_club_fire_action = Action("Fire her", is_strip_club_stripper_requirement, "strip_club_fire_employee_label", menu_tooltip = "Fire [the_person.title] from her stripper job in your strip club.")
    strip_club_performance_review_action = Action("Review her performance", strip_club_review_requirement, "strip_club_performance_review_label", menu_tooltip = "Review [the_person.title]'s performances on stage.")
...
label strip_club_hire_employee_label(the_person):
    ...
    if the_person is lily:
        ...
        if _return is stripper_role:
            ...
            $ strip_club_hire(the_person, stripclub_stripper_job)
            ...
            $ strip_club_hire(the_person, stripclub_bdsm_performer_job)
            ...
            $ strip_club_hire(the_person, stripclub_waitress_job)
...
label strip_club_move_employee_label(the_person):
    ...
    if _return is stripper_role:
        ...
        $ strip_club_move(the_person, stripclub_stripper_job)
        ...
        $ strip_club_move(the_person, stripclub_waitress_job)
    elif _return is stripclub_bdsm_performer_role:
        ...
        $ strip_club_move(the_person, stripclub_bdsm_performer_job)
    else:
...
label strip_club_fire_employee_label(the_person):
    ...
    menu:
        ...
        "Refuse":
            ...
            $ strip_club_fire(the_person)
    return

label strip_club_performance_review_label(the_person):
