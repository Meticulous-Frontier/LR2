init 2 python:
    ...
    def mc_hire_person_requirement(person):
        ...
        excluded_roles = ["casual_hotwife_role", "casual_FA_role", "stripper_role", "waitress_role", "bdsm_performer_role", "manager_role", "mistress_role", "candace_role"]
...
init 5 python:
    ...
    mc_spend_the_night_action = ActionMod("Spend the night with [the_person.possessive_title!l]", mc_action_spend_the_night_requirement, "mc_spend_the_night_label", menu_tooltip = "Allows you to sleep in this location.", category = "Generic People Actions", initialization = init_action_mod_disabled)
