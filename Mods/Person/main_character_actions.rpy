init 2 python:
    ...
    def mc_hire_person_requirement(person):
        ...
        excluded_roles = ["casual_hotwife_role", "casual_FA_role", "stripper_role", "waitress_role", "bdsm_performer_role", "manager_role", "mistress_role", "candace_role", "college_intern_role"]
