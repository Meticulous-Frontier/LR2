        ...
        if the_person.effective_sluttiness("kissing") < (25 - (5*the_person.get_opinion_score("public_sex"))):
            ...
            menu:
                "Make out":
                    ...
                    call fuck_person(the_person, start_position = kissing, private = False, skip_intro = True) from _call_fuck_kaya_72
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    $ the_person.review_outfit()
    ...
    if mc.location.get_person_count() > 1: #There are other people around, she's nervous about people finding out what you're doing.
        ...
        menu:
            "Make out":
                ...
                call fuck_person(the_person, private = True, start_position = kissing, skip_intro = True) from _call_fuck_kaya_75
                $ the_person.call_dialogue("sex_review", the_report = _return)
                $ the_person.review_outfit()
            "Just flirt":
...
label kaya_surprised_exclaim(the_person):
...
label kaya_vaginal_sex_taboo_break(the_person): #TODO: add a "I dont do anal""you do for me" stle taboo break
