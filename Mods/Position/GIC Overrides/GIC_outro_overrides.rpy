label GIC_outro_cowgirl(the_girl, the_location, the_object):
    ...
    if the_goal == None or the_goal == "get mc off" or the_goal == "anal creampie":
        ...
        if the_goal == "get off":
            the_person.char "Seriously? I haven't finished yet..."
            if mc.condom:
            ...
            the_person.char "You wanna cum inside me? Do you?"
            ...
            the_person.char "Ha! Not a chance."
            ...
            if the_person.on_birth_control or mc.condom:
                the_person.char "Already? I guess I was just too much for you to handle."
                if mc.condom:
            ...
            the_person.char "That's it. I want it on my face!"
            ...
            the_person.char "Ohhh, I can't wait to feel it on my skin."
            if mc.condom:
