...
label intro_SB_anal_standing(the_girl, the_location, the_object):
    "With you arms wrapped around [the_girl.possessive_title!l], you make out for a bit with her back to the [the_object.name]."
...
label scene_SB_anal_standing_1(the_girl, the_location, the_object):
    "Your hips slap against [the_girl.possessive_title!l]'s as you plunder her rectum."
    ...
    menu:
        "Knead her ass":
            ...
            if the_girl.get_opinion_score("being submissive") > 0 or the_girl.obedience > 130:
                ...
                "You give [the_girl.possessive_title!l] a good, hard thrust in response."
        ...
        "Gag her with your fingers" if the_girl.get_opinion_score("being submissive") > 0:
            "You grab a hold of the [the_girl.possessive_title!l]'s hair with one hand. You pull back causing her back to arch and she exclaims in surprise, her mouth opening slightly."
...
label outro_SB_anal_standing(the_girl, the_location, the_object):
    ...
    if the_choice == "Cum inside of her":
        if mc.condom:
            "You pull back on [the_girl.possessive_title!l]'s hips and drive your cock deep inside of her as you cum."
    ...
    if the_choice == "Cum on her face":
        ...
        if mc.condom:
            "You pull your cock out of [the_girl.possessive_title!l]'s ass with a satisfying pop. You pull your condom off as she turns around on gets on her knees in front of you."
        else:
            "You pull your cock out of [the_girl.possessive_title!l]'s ass with a satisfying pop. She immediately turns around on gets on her knees in front of you."
