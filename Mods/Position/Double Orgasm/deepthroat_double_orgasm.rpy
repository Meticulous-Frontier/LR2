...
label deepthroat_double_orgasm(the_girl, the_location, the_object):
    ...
    menu:
        ...
        "Cum in her mouth":
            ...
            $ deepthroat.redraw_scene(the_girl)
            if the_girl.sluttiness > 80:
                "When her [the_girl.title]'s orgasm subsides, she closes her mouth and swallows loudly, smiling at you."
            else:
                if the_girl.outfit.tits_available():
                    $ the_girl.cum_on_tits()
                    $ deepthroat.redraw_scene(the_girl)
                    if the_girl.has_large_tits():
                        "After her orgasm subsides, she let's the cum dribble down her chin on to her nice breasts, giving you a wink."
                    else:
                        "After her orgasm subsides, she let's the cum dribble down her chin on to her perky small breasts, giving you a wink."
                else:
            ...
            if the_girl.get_opinion_score("being submissive") > 0:
                ...
                if the_girl.outfit.vagina_visible():
                    ...
                    if the_item.underwear:
                        "[the_girl.title]'s trembling wet pussy soaked her [the_item.name] and its dripping fluid while she's cumming."
                    else:
