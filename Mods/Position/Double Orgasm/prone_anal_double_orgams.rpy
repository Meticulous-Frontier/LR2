init 5 python:
    prone_anal.double_orgasm = "prone_anal_double_orgasm"
...
label prone_anal_double_orgasm(the_girl, the_location, the_object):
    ...
    if the_choice == "Cum inside of her":
        if mc.condom:
            ...
            "You can feel her [the_girl.pubes_description] ass pulsating all around you as you cum in unison. Her bowels are milking your cum, with only a thin layer of latex keeping it from spilling deep inside her."
            ...
            "You push your weight down on [the_girl.possessive_title]'s hips and drive your cock deep inside of her as you cum. She moans in time with each new shot of hot semen deep inside of her rectum."
            the_girl "Oh fuck..."
            $ the_girl.cum_in_ass()
            $ prone_anal.redraw_scene(the_girl)
            "You can feel her [the_girl.pubes_description] bowels quivering all around you as you cum in unison. Her body is milking your cum, you swear it feels like she's sucking your cock with her intestines."
