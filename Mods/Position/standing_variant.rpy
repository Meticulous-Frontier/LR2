...
label intro_SB_facing_wall(the_girl, the_location, the_object):
    ...
    "You turn [the_girl.possessive_title!l] so she faces away from you and push her up against the [the_object.name]."
    ...
    "You put your hands on [the_girl.possessive_title!l]'s hips and give her a tentative thrust."
...
label scene_SB_facing_wall_1(the_girl, the_location, the_object):
    "You grab [the_girl.possessive_title!l]'s hips and begin thrusting eagerly. Your hips slap against her ass in lewd smacking noises as you fuck her."
    ...
    if the_girl.sex_skills["Vaginal"] < 2: #Inexperienced, option to dominate her a bit
        ...
        menu:
            "Punish Her":
                 "SMACK"
                 "You give [the_girl.possessive_title!l]'s ass a hard swat. It leaves a clear red handprint on her behind."
                 the_girl "Yow!"
                 ...
                 menu:
                     "I wanna creampie you":
                         if the_girl.wants_creampie():
                             ...
                             "You see goosebumps form on the back of [the_girl.possessive_title!l]'s neck"
        ...
        menu:
            "Touch her":
                 "You thrust deep inside [the_girl.possessive_title!l]'s [the_girl.pubes_description] pussy and hold it there for a second. You reach one hand around her hip and trail it down between her legs..."
                 ...
                 menu:
                     ...
                     "Lick it clean":
                         ...
                         if the_girl.has_cum_fetish():
                             ...
                             "For a second, you imagine [the_girl.possessive_title!l] laying on your bed, legs spread wide, while you eat her out..."
...
label scene_SB_facing_wall_2(the_girl, the_location, the_object):
    "You grab one of [the_girl.possessive_title!l]'s legs and lift it up to the side, giving you better access to thrust deep inside her"
    ...
    if mc.sex_skills["Vaginal"] > the_girl.sex_skills["Vaginal"]: #If MC is better at sex than girl
        ...
        "You give [the_girl.possessive_title!l] a few short, shallow thrusts, the shove yourself deep and bottom out. You reach around her body and grope at her breast with your free hand."
        ...
        if the_girl.arousal > 130: #Sex gets more intense the more she has orgasmed
            "After multiple orgasms, [the_girl.possessive_title!l]'s pussy is flooded with her juices. It feels so good to be buried in her soaked, convulsing slit."
            "It is a wonder that [the_girl.possessive_title!l] can even stand."
            $ mc.change_arousal( 5)
        elif the_girl.arousal > 100:
            "The heat and moisture radiating from [the_girl.possessive_title!l]'s groin is intense, having already orgasmed at least once. You groan in appreciation of her eager cunt."
            $ mc.change_arousal( 3)
        else:
        ...
        menu:
            "Lightly spank her pussy":
                ...
                if the_girl.get_opinion_score("being fingered") > 0:
                     ...
                     "You continue giving [the_girl.possessive_title!l]'s mound a few more swats. You can feel her pelvic muscles clench you a few times as you tap her."
                     ...
                     "Looks like she doesn't enjoy having your hands down there."
                      ...
                      "Using your index and middle finger, you give [the_girl.possessive_title!l]'s mound a few more taps, a bit lighter than before."
            ...
            "Play with her asshole":
                "You look down and admire [the_girl.possessive_title!l]'s amazing ass and get a naughty idea."
                "You release her soft titflesh with your hand and bring it up to [the_girl.possessive_title!l]'s mouth. She immediately takes them in her mouth and starts to suck on them, mimicking a blowjob on your fingers."
                ...
                if the_girl.get_opinion_score("anal sex") > 0:
                    "At the sudden stimulation of her back door, [the_girl.possessive_title!l] moans and immediately thrusts her ass back at you."
                    ...
                    "You firmly press two fingers against [the_girl.possessive_title!l]'s puckered opening. Her bottom greedily takes your fingers and soon they are completely sheathed."
                    ...
                    "When you begin to stimulating her backdoor, [the_girl.possessive_title!l] immediately begins to protest."
                    ...
                    "With just your index finger, you trace a few circles around [the_girl.possessive_title!l]'s puckered opening."
                    ...
                    "You slowly push your hips forward, embedding your shaft in between her legs. You move your finger along the pliant walls of [the_girl.possessive_title!l]'s rectum"
        ...
        "The soft, velvet flesh of [the_girl.possessive_title!l]'s cunt is bliss around your dick. It is almost overwhelming how tight she is."
        ...
        menu:
            "Let her fuck you":
                ...
                "Even with just one foot on the floor and the other in the air as you hold it, [the_girl.possessive_title!l] is able to begin gyrating her hips up against you."
                "Enjoying her skill, you stand and watch, entranced as [the_girl.possessive_title!l] stirs her creamy womb with your shaft."
                if the_girl.is_dominant():
                    ...
                    the_girl "[the_girl.mc_title]... You've always been so good to me... Let [the_girl.possessive_title!l] take care of you this time!"
                    $ the_girl.discover_opinion("taking charge")
                    "You can tell [the_girl.possessive_title!l] is enjoying taking charge for a minute in this normally submissive position."
                    $ the_girl.change_arousal(the_girl.get_opinion_score("taking control") * 5)

                $ mc.change_arousal( 5)
                "Having [the_girl.possessive_title!l] take charge for a bit is extremely pleasurable, but eventually you can see her start to grow tired."
                mc.name "Atta girl... it's time for me to set the pace now."
                "You release her leg and continue fucking her."
            "Continue normally":
                "You can tell that [the_girl.possessive_title!l] isn't getting as much pleasure from this position as you are, so you try to mix up your tactics a bit to keep her interested."
                "With your free hand you reach around her and start to fondle her tits."
                if the_girl.has_large_tits() :
                    if the_girl.outfit.tits_available():
                        "You plant a hand on [the_girl.possessive_title!l]'s nice, soft tits and squeeze. Her pliant flesh melts in your hand, and the heat coming form her skin feels amazing."
                        ...
                        "You plant a hand on [the_girl.possessive_title!l]'s big tits and fondle them through her [top_clothing.name]."
                        $ top_clothing = None
                    ...
                    if the_girl.outfit.tits_available():
                        "You run a hand over [the_girl.possessive_title!l]'s dainty tits. You pinch and pull at one of her nipples."
                        ...
                        $ top_clothing = the_girl.outfit.get_upper_top_layer()
                        "You try and feel up [the_girl.possessive_title!l]'s little tits, but her [top_clothing.name] stops you from getting much more than a handful of fabric."
                        $ top_clothing = None
...
label outro_SB_facing_wall(the_girl, the_location, the_object):
    ...
    if the_choice == "Cum inside of her":
        if mc.condom:
            "You pull back on [the_girl.possessive_title!l]'s hips and drive your cock as deep inside of her as you cum. She gasps when she feels you filling the condom deep inside of her."
            ...
            "You push forward as you finally climax, thrusting your cock as deep inside of [the_girl.possessive_title!l] as you can manage. She gasps softly each time your dick pulses and shoots hot cum into her."
            ...
            "Once you finish, you slowly back up and pull yourself out of [the_girl.possessive_title!l]. A stream of semen trickles out of her and down her long legs for a few seconds."
            if the_girl.get_opinion_score("bareback sex") > 0:
    ...
    if the_choice == "Cum on her ass":
        ...
        if mc.condom:
            ...
            "You pull out of [the_girl.possessive_title!l] at the last moment, stroking your shaft as you blow your load over her ass. She wiggles her ass for you as you cover her with your sperm."
        ...
        "You stand back and sigh contentedly, enjoying the sight of [the_girl.possessive_title!l]'s ass covered in your semen."
    if the_choice == "Cum on her face":
        ...
        if mc.condom:
            ...
            "You pull your cock out of [the_girl.possessive_title!l] with a satisfying pop. She immediately turns around on gets on her knees in front of you."
        ...
        if the_girl.get_opinion_score("cum facials"):
            ...
            $ the_girl.draw_person(position = "kneeling1")
            "You let out a shudder moaning as you cum, pumping your sperm onto [the_girl.possessive_title!l]'s face. After your first spurt a big smile spreads across her face as you cover it with your cum."
...
label transition_SB_facing_wall_against_wall(the_girl, the_location, the_object):
    "You decide to turn [the_girl.possessive_title!l] around to face you. You want to feel her chest against yours and kiss her deep while you fuck."
    ...
    "You push forward, slipping your shaft deep inside of [the_girl.possessive_title!l]'s cunt. She gasps and quivers ever so slightly as you start to pump in and out."
...
label transition_default_SB_facing_wall(the_girl, the_location, the_object):
    "You turn [the_girl.possessive_title!l] so she is is facing [the_object.name]."
...
label orgasm_SB_facing_wall(the_girl, the_location, the_object):
    ...
    "After a couple of seconds [the_girl.possessive_title!l] takes a couple of deep breathes. You slow down your pace and give her a chance to recover."
