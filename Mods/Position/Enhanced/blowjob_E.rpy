...
label blowjob_enhanced_kneel_throat_cum(the_girl):
    if the_girl.obedience >= 130 or the_girl.get_opinion_score("drinking cum") > 0: #She takes it like a champ
        ...
        $ ClimaxController.manual_clarity_release("throat", the_person = the_girl)
        ...
        menu:
            "Let her pull back":
                ...
                $ ClimaxController.manual_clarity_release("body", the_person = the_girl)
    ...
    if the_girl.get_opinion_score("drinking cum") < 0:
       ...
       menu:
           ...
           "Hold her in place":
                ...
                $ ClimaxController.manual_clarity_release("mouth", the_person = the_girl)
                $ the_girl.cum_in_mouth()
                $ blowjob.redraw_scene(the_girl)
                $ the_girl.call_dialogue("cum_mouth")
...
label blowjob_enhanced_kneel_face_cum(the_girl):
    if the_girl.has_cum_fetish():
        ...
        if the_girl.has_cum_fetish():
            ...
            menu:
                "Let her off":
                    $ ClimaxController.manual_clarity_release("air", the_person = the_girl)
