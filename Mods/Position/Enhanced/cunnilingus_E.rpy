...
label scene_SB_Oral_Laying_1(the_girl, the_location, the_object):
    ...
    menu:
        ...
        "Finger Her Ass" if the_girl.get_opinion_score("anal sex") > 0:
            ...
            "[the_girl.title]'s hips begin to grind forward and back. With each peek she grinds her clit against your face, and with each trough your finger is fully embedded in her backdoor."
