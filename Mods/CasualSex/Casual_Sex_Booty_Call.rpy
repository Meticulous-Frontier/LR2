...
init 3 python:
    ...
    def get_casual_sex_booty_call_person():
        ...
        for person in known_people_in_the_game():
            ...
            if person.has_role([casual_hotwife_role, casual_FA_role]) and person.event_triggers_dict.get("booty_call", False) and day > person.event_trigger_dict("last_booty_call", 0) + 10:
...
label casual_sex_booty_call_label:
    ...
    menu:
        "Definitely":
            ...
            $ the_person.event_trigger_dict["last_booty_call"] = day
