...
#         "[the_person.title] seems turned on by [the_watcherer.name] watching you and her [the_position.verb]."
#
...
#         the_person "Oh god, you need to get a little of this yourself, [the_watcherer.name]!"
#         $ the_person.change_arousal(1)
#         "[the_person.title] seems turned on by [the_watcherer.name] watching you and her [the_position.verb]."
#
#     elif the_person.sluttiness < the_position.slut_cap and the_watcher.sluttiness >= the_position.slut_cap:
#         #She's into it and encouraged by the slut watching her.
#         the_person "[the_watcherer.name], I'm giving him all I can right now. Any more and he's going to break me!"
#         $ the_person.change_arousal(1)
#         "[the_person.title] seems turned on by [the_watcherer.name] watching you and her [the_position.verb]."
#
#     elif the_person.sluttiness < the_position.slut_cap and the_watcher.sluttiness < the_position.slut_requirement:
