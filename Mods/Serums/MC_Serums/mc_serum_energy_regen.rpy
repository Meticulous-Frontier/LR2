...
init 1 python:  #Associated Perks
    ...
    def perk_energy_regen_large():
        duration = get_mc_serum_duration()
        return Ability_Perk(description = "You naturally regenerate a large amount of energy throughout the day.", toggle = False, usable = False, update_func = perk_energy_regen_large_update, bonus_is_temp = True, duration = duration)
