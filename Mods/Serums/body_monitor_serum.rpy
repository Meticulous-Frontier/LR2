...
label body_monitor_phase_1_label():
    ...
    if mc.location == mc.business.r_div:
        ...
        "You wonder for a moment who could be meant be 'we'. Intrigued you decide to find out right away."
    ...
    person_1 "While she was reading over the data files, she mentioned that she might know of a way to improve the data we are collecting, and I thought that you might be interested in hearing about it as well. Thats why I called you over."
    ...
    mc.name "What did you came up with, [person_2.title]?"
    ...
    "You smile at her apologetic."
    mc.name "Sorry, I didn't mean to startled you."
    ...
    person_2 "While looking over the files, I noticed that some of the data include vital parameters like heartbeat, blood-pressure and body temperature. And I think there is an easier method to gather data that doesn't require the test subjects to be present in the Lab."
    ...
    mc.name "Okay, you got my permission to work on it. But I want you to focus on your current work assignment. I prefer to wait some days longer over seeing your work suffer from it. Understood?"
...
label body_monitor_phase_2_label():
    ...
    the_person "Unfortunately it didn't went as smooth as I had hoped for. While running some simulations with the new program, I ran into a little problem."
    ...
    mc.name "But using them as stand alone program wouldn't cause any problems?"
    the_person "No, [the_person.mc_title]. No problems at all."
    mc.name "Great. Then tell [mc.business.head_researcher.name] that she has green light to use the new program in our future designs. And please give her all the details she needs to know about."
    $ the_person.draw_person(position = "stand4")
    the_person "Yes [the_person.mc_title]! I will inform her right away."
    $ the_person.draw_person(position = "walking_away")
    "Not being able to use the new nanobot program in combination with your other nanobot programs is a unfortunate drawback, but you are sure that the new program will still proof to be very valuable for your business."
...
label body_monitor_phase_3_label():
    ...
    person_1 "Exactly."
    mc.name "Okay. Then we should call in [person_2.name] as well. She is most capable in deciding if any idea you might come up with is feasible or not."
    ...
    "After [person_2.possessive_title] joined you at the desk, you gave her a quick recap about the topic and then shift your attention towards [person_1.possessive_title]"
...
label body_monitor_phase_4_label():
    $ the_person = mc.business.it_director
    $ mc.start_text_convo(person_1)
    the_person "Just wanted to let you know that improved nanobot program is uploaded to the database and ready to use."
    mc.name "That was quicker than I expected. Got any issues?"
    the_person "No, [the_person.mc_title]. Everything went smoothly. First tests showed a slight improvement of vital parameters. But its too early too notice any permanent improvements."
    $ the_person.change_max_energy(1)
